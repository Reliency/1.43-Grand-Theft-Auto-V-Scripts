...
int func_2()//Position - 0x10C
{
	...
	if (system::vdist(unk_0xB3328BA8976B416C(unk_0xFC1458A37D98B502(), 1), vLocal_72) > 100f)
	{
		return 1;
	}
	return 0;
	...
	if (unk_0x6ADD12BF4D6D2587(iParam0))
	{
		switch (iLocal_70[iParam1])
		{
			case 0:
				...
				if (unk_0x78F50AA8F955BEFC(iParam0, -1146898486) != 1)
				{
					unk_0x93F12E7D8D931858(iParam0, 1193033728, 0);
					unk_0xE9B3D12A64CC7C1A(iLocal_68[iParam1], true);
				}
				break;
			...
			case 1:
				...
				if (!unk_0xAB019B170BF1309C(&(Local_71[iParam1 /*4*/])))
				{
				...
				{
					unk_0x2EA90674750EA01E(iParam0, sVar0, 0, 1);
					unk_0xE9B3D12A64CC7C1A(iLocal_68[iParam1], true);
				}
				break;
			...
			case 3:
				...
				if (system::vdist2(unk_0xB3328BA8976B416C(iParam0, 1), unk_0xB3328BA8976B416C(unk_0xFC1458A37D98B502(), 1)) > (50f * 50f))
				{
					iLocal_70[iParam1] = 0;
					return 1;
				}
...
int func_7(int iParam0, int iParam1)//Position - 0x431
{
	...
	if (!unk_0x1E06D00B67177A18())
	{
		...
		else if (iParam1 == func_8(Global_92619) && iParam1 != 0)
		{
			Global_92619 = 0;
		}
	}
...
void func_20()//Position - 0x75F
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_69)
		{
			...
			if (!unk_0xAB019B170BF1309C(&(Local_71[iVar0 /*4*/])))
			{
				unk_0xD9E2C360120FEB7C(&(Local_71[iVar0 /*4*/]));
				if (!unk_0x3B6F9DF9C5FEB3A4(&(Local_71[iVar0 /*4*/])))
				{
					bVar2 = false;
				}
			}
	...
	while (iVar0 < iLocal_68)
	{
		if (iLocal_69[iVar0] != 0)
		{
			iLocal_68[iVar0] = unk_0xAC992EFAD62C33BF(4, iLocal_69[iVar0], vLocal_72 + vLocal_74[iVar0 /*3*/], 0f, 1, true);
			unk_0x48ED7B2293A96722(iLocal_68[iVar0], (fLocal_73 + fLocal_75[iVar0]));
			...
			unk_0x5718F894FDA63A9E(iLocal_68[iVar0], 0);
		}
		iVar0++;
	}
}
...
void func_21()//Position - 0x88C
{
	...
	switch (iLocal_66)
	{
		case 97:
			...
			vLocal_74[3 /*3*/] = { Vector(45,5004f, unk_0x5B811202FCBE9E9D(-205,8167f, -210,4254f), unk_0x5B811202FCBE9E9D(-1416,54f, -1428,501f)) - vLocal_72 };
