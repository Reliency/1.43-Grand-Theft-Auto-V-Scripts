...
void func_15(int iParam0)//Position - 0x5B4
{
	...
	if (iLocal_40 == 0)
	{
		switch (iLocal_41)
		{
			case 0:
				func_106(1);
				iLocal_74 = unk_0xD704C81492296A37("MP_BIG_MESSAGE_FREEMODE");
				func_1(46, 1);
			...
			case 1:
				...
				{
					if (unk_0x34D11AB5BA7922C2(iLocal_74))
					{
						unk_0x008F3E3CC076EA0E(iLocal_74, "SHOW_MISSION_PASSED_MESSAGE");
						func_88("M_FB4P3_P");
						func_88("M_FB4P3");
			...
			case 2:
				if (unk_0x34D11AB5BA7922C2(iLocal_74) && unk_0xEB55C9C28A1E0326())
				{
					if (unk_0x53C562FD2B9E3AB0() < iLocal_75)
					{
						unk_0x0EB9853DF8BC0D87(iLocal_74, 0,5f, 0,3f, 1f, 1f, 255, 255, 255, 255, 0);
					}
					else if (unk_0x53C562FD2B9E3AB0() < iLocal_75 + 100)
					{
						unk_0x008F3E3CC076EA0E(iLocal_74, "TRANSITION_OUT");
						unk_0x271AA5469AF471B3();
		...
		if (!func_75(0f, 0f, 0f, vLocal_52, 0))
		{
			if (func_74(unk_0xFC1458A37D98B502(), vLocal_52, 100f) && !func_73())
			{
				if (func_83(func_72(25)))
				{
					...
					unk_0xDD29FF4BAB8AFF9C(iLocal_51, true, 1);
					if (func_83(iLocal_51))
					{
...
bool func_18(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x97C
{
...
int func_26(int iParam0)//Position - 0x123A
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_28(int iParam0)//Position - 0x1317
{
	int iVar0;
	int iVar1;
...
int func_29()//Position - 0x2B9F
{
	return 0;
}

int func_30()//Position - 0x2BA8
{
	return 1;
}

int func_31()//Position - 0x2BB1
{
	return 1;
}

int func_32()//Position - 0x2BBA
{
...
int func_34(int iParam0)//Position - 0x2C8E
{
	int iVar0;
	char* sVar1;
...
int func_35(int iParam0)//Position - 0x2CD4
{
	int iVar0;
...
int func_36(int iParam0)//Position - 0x2D0F
{
	int iVar0;
...
int func_37(int iParam0)//Position - 0x2D8B
{
	int iVar0;
...
int func_38(int iParam0, int iParam1, bool bParam2)//Position - 0x2E73
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_39(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x2EE4
{
...
void func_41(var uParam0, int iParam1)//Position - 0x3001
{
	if (iParam1 <= 0)
	{
		return;
...
void func_42(var uParam0, int iParam1)//Position - 0x3087
{
...
void func_43(var uParam0, int iParam1)//Position - 0x30BA
{
	int iVar0;
	int iVar1;
...
int func_44(int iParam0, int iParam1)//Position - 0x310B
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_45(int iParam0)//Position - 0x31AD
{
	return (system::shift_right(iParam0, 26) & 31 * func_46(unk_0xC80D31E4B587871C(iParam0, 31), -1, 1)) + 2011;
}

int func_46(bool bParam0, int iParam1, int iParam2)//Position - 0x31D2
{
	if (bParam0)
	{
		return iParam1;
...
int func_47(var uParam0)//Position - 0x31E9
{
	return uParam0 & 15;
}

void func_48(var uParam0, int iParam1)//Position - 0x31F6
{
...
void func_49(var uParam0, int iParam1)//Position - 0x3230
{
...
void func_50(var uParam0, int iParam1)//Position - 0x326B
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_51(var uParam0, int iParam1)//Position - 0x32A7
{
	int iVar0;
	int iVar1;
...
int func_52(int iParam0, int iParam1)//Position - 0x499E
{
	struct<82> Var0;
...
void func_53(int iParam0, var uParam1, int iParam2)//Position - 0x49E0
{
	int iVar0;
...
bool func_54(int iParam0)//Position - 0x4C3C
{
	return iParam0 < 3;
}

void func_55(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)//Position - 0x4C48
{
	if (func_51(&(Global_69678.f_555[0 /*21*/]), iParam0))
	{
...
void func_56(int iParam0, bool bParam1)//Position - 0x4D47
{
	if (iParam0 == -1)
	{
		return;
...
void func_57(int iParam0, int iParam1, bool bParam2)//Position - 0x4DA4
{
	if (iParam0 == -1)
	{
		return;
...
void func_58(var uParam0, var uParam1)//Position - 0x4DDF
{
...
void func_59(int iParam0)//Position - 0x4EAB
{
	if (iParam0 == -1)
	{
		return;
...
int func_60(int iParam0)//Position - 0x4F25
{
	int iVar0;
...
void func_61(int iParam0, var uParam1)//Position - 0x4F88
{
	int iVar0;
...
int func_62(int iParam0)//Position - 0x5233
{
	switch (iParam0)
	{
		case 1:
...
int func_63(int iParam0, var uParam1, var uParam2)//Position - 0x52E3
{
	int iVar0;
	int iVar1;
...
int func_64(int iParam0)//Position - 0x53BD
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_65(var uParam0)//Position - 0x53DD
{
	int iVar0;
...
void func_66(int iParam0)//Position - 0x548C
{
...
void func_67(bool bParam0)//Position - 0x54B3
{
	if (unk_0xC80D31E4B587871C(iLocal_49, 14))
	{
...
void func_68(int iParam0)//Position - 0x559A
{
	int iVar0;
...
int func_69(int iParam0)//Position - 0x55BA
{
	int iVar0;
	int iVar1;
...
int func_70(int iParam0)//Position - 0x55F7
{
	if (func_54(iParam0))
	{
...
bool func_71(int iParam0, int iParam1)//Position - 0x5621
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_72(int iParam0)//Position - 0x5644
{
	if (iParam0 == -1)
	{
		return 0;
...
bool func_74(int iParam0, vector3 vParam1, float fParam2)//Position - 0x567C
{
	return system::vdist2(unk_0xB3328BA8976B416C(iParam0, 1), vParam1) <= (fParam2 * fParam2);
}

bool func_75(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x5699
{
	if (bParam2)
	{
...
void func_76(int iParam0, bool bParam1)//Position - 0x56E0
{
...
bool func_78(bool bParam0)//Position - 0x574F
{
...
void func_79(char* sParam0, int iParam1)//Position - 0x577A
{
...
bool func_82(int iParam0)//Position - 0x5917
{
	return Global_35861 == iParam0;
}

int func_83(int iParam0)//Position - 0x5925
{
	if (func_84(iParam0))
	{
		if (unk_0xB8DE76287EDC4957(iParam0, 0))
...
int func_84(int iParam0)//Position - 0x594F
{
	if (unk_0x6ADD12BF4D6D2587(iParam0))
	{
...
void func_85(int iParam0, int iParam1)//Position - 0x5970
{
...
void func_86(bool bParam0)//Position - 0x59AD
{
	char* sVar0;
...
int func_87()//Position - 0x5A20
{
	func_81();
	return Global_104555.f_2353.f_539.f_4301;
}

void func_88(char* sParam0)//Position - 0x5A39
{
	unk_0x7E099EB35339C80D(sParam0);
	unk_0x9748595E4799A2CF();
}

void func_89(int iParam0, int iParam1)//Position - 0x5A4B
{
...
void func_92(int iParam0, int iParam1, int iParam2)//Position - 0x5B26
{
	bool bVar0;
...
int func_94()//Position - 0x60CF
{
	return Global_25233;
}

int func_95(int iParam0, int iParam1)//Position - 0x60DA
{
	int iVar0;
...
int func_96(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x612B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_97()//Position - 0x65F7
{
	return Global_1312736;
}

int func_98()//Position - 0x6603
{
...
int func_101(int iParam0)//Position - 0x6692
{
	if (iParam0 == 146 || iParam0 == -1)
	{
		return 0;
...
int func_105(int iParam0, int iParam1)//Position - 0x671D
{
	int iVar0;
	int iVar1;
...
void func_106(int iParam0)//Position - 0x675E
{
	Global_71116 = iParam0;
	Global_71117 = iParam0;
}

void func_107()//Position - 0x6772
{
	struct<6> Var0;
...
void func_108(bool bParam0)//Position - 0x68EB
{
	if (bParam0)
	{
...
int func_109(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x695C
{
	struct<15> Var0;
	int iVar1;
...
void func_110(int iParam0)//Position - 0x6AAD
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_111(int iParam0)//Position - 0x6B71
{
	switch (iParam0)
	{
		case 0:
...
void func_112(int iParam0)//Position - 0x6BDB
{
...
void func_114(struct<6> Param0)//Position - 0x6C7C
{
	if (iLocal_42 == 0)
	{
		func_119(Param0);
...
void func_115(struct<6> Param0)//Position - 0x6CA3
{
	if (func_99())
	{
		func_116(Param0, 1);
...
void func_116(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6)//Position - 0x6CC7
{
	struct<4> Var0;
...
struct<4> func_117(bool bParam0)//Position - 0x6D37
{
	struct<4> Var0;
...
struct<4> func_118(bool bParam0)//Position - 0x6DA1
{
	struct<4> Var0;
...
void func_119(struct<6> Param0)//Position - 0x6E0B
{
	if (func_99())
	{
		if (func_120())
...
void func_122(bool bParam0)//Position - 0x6EC2
{
...
void func_123(char* sParam0, char* sParam1)//Position - 0x6ED6
{
	if (unk_0x0DBDCC9C5537E157())
	{
		Global_15813 = 1;
...
struct<6> func_124()//Position - 0x6EF7
{
	struct<6> Var0;
...
void func_125()//Position - 0x6F1B
{
	func_126();
}

void func_126()//Position - 0x6F27
{
	func_130();
	func_127();
}

void func_127()//Position - 0x6F37
{
	if (func_129() == 85)
	{
...
int func_129()//Position - 0x6F98
{
	return Global_71118;
}

void func_130()//Position - 0x6FA4
{
...
void func_132()//Position - 0x704F
{
	func_16();
	func_107();
}

void func_133()//Position - 0x705F
{
	func_147();
	func_143();
	func_140();
	func_107();
	if (func_74(unk_0xFC1458A37D98B502(), vLocal_50, 150f) && !unk_0x0F3033474C49912D(unk_0xFC1458A37D98B502(), -176,9431f, -651,257f, 31,2136f, -150,9563f, -579,7476f, 35,4245f, 50f, 0, 1, 0))
	{
		unk_0x9B8406983378711E(vLocal_50, 6f, 0, 1, 0, 0, false, 0);
		unk_0x4C15495E88D71C61(-169,4253f, -622,0479f, 31,42444f, -162,2762f, -620,509f, 35,42448f, false, 1);
	}
	if (!unk_0xC80D31E4B587871C(iLocal_49, 18))
	{
		if (!func_14(0) && !func_113())
		{
			func_139(sLocal_45[4], 7500, 0);
			unk_0x872F1C1F8587CCC7(&iLocal_49, 18);
		}
	}
	if (unk_0xC80D31E4B587871C(iLocal_49, 0))
	{
		if (unk_0xC80D31E4B587871C(iLocal_49, 1))
		{
			...
			if (func_83(iLocal_51))
			{
				if (!unk_0xA8D0477084E86A92(unk_0xFC1458A37D98B502(), iLocal_51, 0))
				{
					if (unk_0x9EC5112BB1C4047A(iLocal_51))
					{
						func_135();
						func_134(&uLocal_246);
						func_89(35, 0);
						...
						unk_0x4C15495E88D71C61(-169,4253f, -622,0479f, 31,42444f, -162,2762f, -620,509f, 35,42448f, true, 1);
						func_76(4, 0);
					}
				}
			}
	...
	{
		unk_0x0EE72DB1CD8A3B86(&iLocal_49, 18);
		func_134(&uLocal_246);
		unk_0x4C15495E88D71C61(-169,4253f, -622,0479f, 31,42444f, -162,2762f, -620,509f, 35,42448f, true, 1);
		func_76(0, 1);
	}
...
void func_134(var uParam0)//Position - 0x722D
{
	if (*uParam0 == -1)
	{
		return;
...
int func_136(int iParam0)//Position - 0x72CD
{
...
bool func_137(char* sParam0, int iParam1, char* sParam2)//Position - 0x72FD
{
...
void func_138(int iParam0)//Position - 0x731B
{
...
void func_139(char* sParam0, int iParam1, int iParam2)//Position - 0x733B
{
	iParam2 = iParam2;
...
void func_140()//Position - 0x7354
{
	switch (iLocal_38)
	{
		case 0:
			if (((!unk_0xA6DECE14FC9A8C51(iLocal_245) && unk_0xC80D31E4B587871C(iLocal_49, 0)) && !unk_0xC80D31E4B587871C(iLocal_49, 1)) && unk_0xC80D31E4B587871C(iLocal_49, 18))
			{
...
int func_141(vector3 vParam0, int iParam1)//Position - 0x73CC
{
	int iVar0;
...
float func_142(bool bParam0, float fParam1, float fParam2)//Position - 0x73F8
{
	if (bParam0)
	{
		return fParam1;
	...
	if (func_101(35))
	{
		if (iLocal_38 == 0)
		{
			if (!unk_0xC80D31E4B587871C(iLocal_49, 1))
			{
				if (func_83(iLocal_51))
				{
					unk_0x0C88267282FD588F(iLocal_51, vLocal_50, 4f, 4f, 2f, 1, 1, 0);
					if (unk_0x0F3033474C49912D(iLocal_51, -168,8162f, -619,9002f, 31,42446f, -162,6423f, -622,0781f, 33,42446f, 4,14f, 0, 1, 0))
					{
						func_146(24, 46);
			...
			{
				if (!func_74(iLocal_51, vLocal_50, 10f) || unk_0xF69AD934E7664A7C(iLocal_51))
				{
					unk_0x0EE72DB1CD8A3B86(&iLocal_49, 1);
				}
			}
...
int func_144(float fParam0, int iParam1)//Position - 0x74D1
{
	int iVar0;
...
int func_145(int iParam0)//Position - 0x7555
{
	vector3 vVar0;
...
void func_146(int iParam0, int iParam1)//Position - 0x760A
{
	func_4(iParam0);
...
void func_147()//Position - 0x7659
{
	int iVar0;
	int iVar1;
	
	if ((Global_35861 == 15 && !func_163()) || func_101(35))
	{
		if (iLocal_38 == 0)
		{
							...
							if (func_83(iVar0))
							{
								if (!func_162(iVar0))
								{
									if (func_155(iVar0) && !func_154())
									{
										...
										{
											if (!unk_0xC80D31E4B587871C(iLocal_49, 19))
											{
												func_68(9);
												unk_0x872F1C1F8587CCC7(&iLocal_49, 19);
											}
											else if (func_69(unk_0xFC1458A37D98B502()) == 0)
											{
												func_68(17);
											}
											else
...
int func_148(int iParam0)//Position - 0x7935
{
...
void func_149(int iParam0)//Position - 0x7966
{
	if (Global_14615)
	{
		func_151(0, 0);
...
void func_151(bool bParam0, bool bParam1)//Position - 0x79FD
{
	if (bParam0)
	{
		if (func_14(0))
...
int func_153(int iParam0)//Position - 0x7A8F
{
...
int func_155(int iParam0)//Position - 0x7B17
{
...
int func_156(int iParam0)//Position - 0x7B41
{
	int iVar0;
...
int func_157(int iParam0)//Position - 0x7B62
{
...
int func_158(int iParam0)//Position - 0x7B8F
{
	int iVar0;
...
int func_159(int iParam0)//Position - 0x7BE3
{
	int iVar0;
...
int func_160(int iParam0)//Position - 0x7C28
{
	int iVar0;
...
int func_162(int iParam0)//Position - 0x7CEA
{
	if (unk_0xB80A4DA4C06A76F1(iParam0, "GetawayVehicleValid"))
	{
		return 1;
...
int func_165(var uParam0)//Position - 0x7D75
{
	char* sVar0;
...
int func_166()//Position - 0x7DB8
{
	if (func_168(&uLocal_80, Local_44.f_8, sLocal_79, Local_44.f_4, 9, 1, 0, 0, 0))
	{
		iLocal_40 = 1;
		func_167(192, unk_0xB3328BA8976B416C(unk_0xFC1458A37D98B502(), 1));
		return 1;
	}
	return 0;
}

void func_167(int iParam0, vector3 vParam1)//Position - 0x7DF2
{
	int iVar0;
...
bool func_168(var uParam0, var uParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8)//Position - 0x7E41
{
...
int func_169(char* sParam0, int iParam1, bool bParam2)//Position - 0x7EA0
{
	Global_15757 = 0;
...
bool func_175(int iParam0, int iParam1)//Position - 0x83C5
{
	switch (iParam0)
	{
		case 5:
...
void func_177(var uParam0, var uParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x8457
{
...
void func_179(int iParam0, var uParam1)//Position - 0x84C7
{
	int iVar0;
	...
	func_180(&uLocal_80, Local_44, unk_0xFC1458A37D98B502(), Local_44.f_1, 0, 1);
	func_180(&uLocal_80, Local_44.f_2, 0, Local_44.f_3, 0, 1);
	Local_44.f_4 = uParam1;
}

void func_180(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x863D
{
...
void func_181(int iParam0, int iParam1, bool bParam2)//Position - 0x86D8
{
	Global_3009 = iParam0;
	if (Global_117[iParam0 /*10*/].f_8 != 140)
	{
...
char* func_185(int iParam0)//Position - 0xA1AD
{
	char* sVar0;
...
int func_186(var uParam0)//Position - 0xA2BA
{
...
int func_187(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xA30C
{
	int iVar0;
...
void func_188(var uParam0, int iParam1)//Position - 0xA443
{
	int iVar0;
...
bool func_189(int iParam0)//Position - 0xA492
{
	return func_190(iParam0, Global_35861);
}

int func_190(int iParam0, int iParam1)//Position - 0xA4A3
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_191(int iParam0)//Position - 0xA684
{
	if (Global_35861 == 15)
	{
		return 0;
...
int func_193(int iParam0)//Position - 0xA6CF
{
	if (Global_16871 == 0)
	{
		return 0;
...
void func_195()//Position - 0xA74E
{
	int iVar0;
	int iVar1;
	
	if (((((((Global_35861 == 15 && iLocal_37 != 3) && unk_0xC80D31E4B587871C(iLocal_49, 5)) && !func_163()) && Global_70853 == -1) && !func_205()) && !func_82(9)) || func_101(35))
	{
		func_204();
		func_203();
		switch (iLocal_39)
	...
	else if (((((((Global_35861 != 15 || Global_35861 != 0) || Global_35861 != 2) || Global_35861 != 4) || Global_35861 != 17) || func_163()) || Global_70853 == -1) || Global_103610)
	{
		iVar1 = 0;
		if (func_196())
		{
...
bool func_196()//Position - 0xA8DF
{
	return unk_0x8F05914DD835E69F(Global_104555.f_18073.f_395);
}

void func_197(int iParam0, bool bParam1)//Position - 0xA8F5
{
	switch (iLocal_39)
	{
		case 1:
			if ((!unk_0xF491DD47B88AA84E() && !func_200(func_87())) && !func_199())
			{
...
void func_198(char* sParam0, int iParam1)//Position - 0xAA05
{
	unk_0x67129637F30DEB3F(sParam0);
	unk_0x376CFA11DE0FE521(0, 0, 1, iParam1);
}

int func_199()//Position - 0xAA1C
{
...
int func_200(int iParam0)//Position - 0xAA36
{
	int iVar0;
...
int func_201(int iParam0)//Position - 0xAA80
{
	int iVar0;
...
void func_202(int iParam0, int iParam1)//Position - 0xAB37
{
	int iVar0;
	...
	if (iLocal_37 == 0 || iLocal_37 == 1)
	{
		switch (iLocal_38)
		{
			case 0:
				...
				{
					if (((((((!func_2(func_3(7)) && !func_2(func_3(8))) && !func_2(func_3(10))) && !func_2(func_3(11))) && !func_2(func_3(12))) && !func_2(func_3(13))) && !func_196()) && !Global_103195)
					{
						unk_0x872F1C1F8587CCC7(&iLocal_49, 15);
						unk_0x3E80C2F7BC665259(1);
					}
...
int func_213()//Position - 0xB081
{
	if (((((Global_35861 == 15 && !func_163()) && Global_70853 == -1) && !func_196()) && !func_214(1112014848)) && !Global_103610)
	{
		return 1;
	}
	return 0;
...
int func_214(float fParam0)//Position - 0xB0CF
{
	if (iLocal_42 == 1)
	{
...
int func_217(int iParam0)//Position - 0xB1DB
{
	return func_218(iParam0, 6, 1);
}

int func_218(int iParam0, int iParam1, bool bParam2)//Position - 0xB1EB
{
	if (bParam2)
	{
	...
	else if (unk_0x3A711520F83BAE98())
	{
		if (func_94() == 0)
		{
			return unk_0xC80D31E4B587871C(func_219(func_221(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_219(int iParam0, int iParam1, int iParam2)//Position - 0xB24B
{
	int iVar0;
	var uVar1;
	...
	iVar0 = Global_2523060[iParam0 /*3*/][func_220(iParam1)];
...
int func_220(var uParam0)//Position - 0xB27D
{
	int iVar0;
	int iVar1;
...
int func_221(int iParam0)//Position - 0xB2B1
{
	switch (iParam0)
	{
		case 0:
...
int func_222(int iParam0)//Position - 0xB596
{
	if (func_84(iParam0))
	{
...
void func_223(char* sParam0, int iParam1)//Position - 0xB5B6
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < Global_104555.f_20380.f_145)
	{
		if (unk_0x74C475EB8E73D398(sParam0, &(Global_104555.f_20380[iVar0 /*16*/])))
		{
			...
			func_225((Global_104555.f_20380.f_145 - 1));
...
void func_225(int iParam0)//Position - 0xB783
{
...
void func_226(int iParam0, int iParam1)//Position - 0xB81B
{
...
int func_227(int iParam0)//Position - 0xB92B
{
...
void func_228(int iParam0)//Position - 0xB957
{
	iLocal_42 = iParam0;
	if (iLocal_42 == 0)
	{
...
char* func_230(int iParam0)//Position - 0xBBFA
{
	char* sVar0;
...
struct<8> func_232(char* sParam0, vector3 vParam1, vector3 vParam2, float fParam3)//Position - 0xD0FC
{
	struct<8> Var0;
...
void func_233(int iParam0, bool bParam1)//Position - 0xD127
{
	if (func_83(iLocal_51))
	{
		func_19(&iLocal_51);
...
int func_234(int iParam0)//Position - 0xD14F
{
	int iVar0;
	int iVar1;
...
void func_236(bool bParam0)//Position - 0xD1CF
{
	char* sVar0;
...
void func_237()//Position - 0xD29C
{
	StringCopy(&(Global_2161[3 /*16*/].f_8), "CELL_SFUN_NULL", 32);
}

void func_238()//Position - 0xD2B2
{
	StringCopy(&(Global_2161[2 /*16*/].f_8), "CELL_SFUN_NULL", 32);
}

void func_239()//Position - 0xD2C8
{
	StringCopy(&(Global_2161[1 /*16*/].f_8), "CELL_SFUN_NULL", 32);
}

void func_240()//Position - 0xD2DE
{
	StringCopy(&(Global_2161[0 /*16*/].f_8), "CELL_SFUN_NULL", 32);
}

void func_241(char* sParam0)//Position - 0xD2F4
{
	StringCopy(&(Global_2161[0 /*16*/].f_8), sParam0, 32);
}

void func_242(char* sParam0)//Position - 0xD308
{
	StringCopy(&(Global_2161[2 /*16*/].f_8), sParam0, 32);
}

void func_243(char* sParam0)//Position - 0xD31C
{
	StringCopy(&(Global_2161[1 /*16*/].f_8), sParam0, 32);
}

void func_244(char* sParam0)//Position - 0xD330
{
	StringCopy(&(Global_2161[3 /*16*/].f_8), sParam0, 32);
}

void func_245(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0xD344
{
	func_246(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_246(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0xD364
{
	int iVar0;
...
int func_247(var uParam0, int iParam1)//Position - 0xD536
{
	if (iParam1 == -1)
	{
		return 0;
...
float func_248(int iParam0)//Position - 0xD581
{
	if (iParam0 == -1)
	{
		return 0f;
...
Vector3 func_249(int iParam0)//Position - 0xD5B7
{
	if (iParam0 == -1)
	{
		return 0f, 0f, 0f;
...
int func_250(int iParam0)//Position - 0xD5F1
{
	int iVar0;
	int iVar1;
