...
void __EntryFunction__()//Position - 0x0
{
	...
	if (unk_0x7D9C4B359376D38A(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_103642[Var0 /*10*/].f_9 != -1)
			{
				...
				func_284(&(Global_103642[Var0 /*10*/].f_9));
			}
		}
		func_269(&Var0, 1);
	}
	...
	while (true)
	{
		...
		func_201(Var0);
		func_194(&iLocal_54, &(Var0.f_9), vVar1);
		if (iLocal_55 == 0)
		{
			if (Var0 == 22)
			{
				...
				{
					if (func_193(Var0.f_28[1]))
					{
						func_285("Trying to set Mary Ann boyfriend component variation");
						unk_0x6A39A6ADDC38ABE4("MaryAnnes_Friend", Var0.f_28[1], 0);
						unk_0x7B9E2A8E7B7BA218("MaryAnnes_Friend", 0, 0, 0, 0);
						iLocal_55 = 1;
					}
				}
			}
		...
		if (Var0 == 21)
		{
			func_190(&Var0, vVar1, "FAN1AU", "FAN1_AMB", 3, "MARYANN", 1500);
		}
		else if (Var0 == 22)
		{
			func_185(&Var0, vVar1, "FAN2AU", "FAN2_AMB", 3, "MARYANN", 5000, 1101004800);
		}
		else if (Var0 == 23)
		{
			if (iLocal_56 == 0)
			{
				if (func_190(&Var0, vVar1, "FAN3AUD", "FAN3_AMB", 3, "MARYANN", 50))
				{
					iLocal_56 = 1;
				}
			}
...
void func_4(int iParam0)//Position - 0x479
{
	int iVar0;
	int iVar1;
...
void func_6(int iParam0)//Position - 0x686
{
	switch (iParam0)
	{
		case 2:
...
void func_7(int iParam0)//Position - 0xA6E
{
	Global_55896 = 1;
	Global_55899 = 1;
	if (Global_67998 > 15)
...
void func_8(int iParam0)//Position - 0xAB9
{
...
struct<2> func_9(int iParam0)//Position - 0xAED
{
	struct<2> Var0;
	char[] cVar1[8];
...
void func_13()//Position - 0xBDF
{
	Global_56062 = 0;
}

void func_14()//Position - 0xBEB
{
	Global_55922 = 0;
...
var func_15(int iParam0)//Position - 0xC3F
{
	var uVar0;
...
void func_17(int iParam0)//Position - 0xC7D
{
	Global_71116 = iParam0;
	Global_71117 = iParam0;
}

void func_18()//Position - 0xC91
{
	int iVar0;
...
void func_21(char* sParam0)//Position - 0xD36
{
...
void func_22(char[4] cParam0, int iParam1)//Position - 0xD49
{
	unk_0x0EE72DB1CD8A3B86(&(Global_92833.f_20), 17);
	func_23(cParam0, iParam1, 0);
}

void func_23(char[4] cParam0, int iParam1, int iParam2)//Position - 0xD66
{
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x1A3F
{
	int iVar0;
	int iVar1;
...
int func_26(var uParam0)//Position - 0x28C7
{
...
void func_27(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x28E9
{
	int iVar0;
...
int func_28(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2971
{
...
int func_29(int iParam0)//Position - 0x29B1
{
	int iVar0;
...
void func_30(var uParam0, int iParam1, int iParam2)//Position - 0x29DF
{
...
int func_31(int iParam0)//Position - 0x2ABB
{
	int iVar0;
...
int func_32(int iParam0)//Position - 0x2AFD
{
	int iVar0;
...
int func_33(int iParam0, int iParam1, int iParam2)//Position - 0x2B60
{
	int iVar0;
...
int func_34(int iParam0, int iParam1)//Position - 0x2BEE
{
	struct<82> Var0;
...
void func_35(int iParam0, var uParam1, int iParam2)//Position - 0x2C30
{
	int iVar0;
...
int func_38(int iParam0)//Position - 0x3143
{
	switch (iParam0)
	{
		case 1:
...
int func_39(int iParam0, var uParam1, var uParam2)//Position - 0x31F3
{
	int iVar0;
	int iVar1;
...
int func_40(int iParam0)//Position - 0x32CD
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_41(var uParam0)//Position - 0x32ED
{
	int iVar0;
...
int func_42(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x339E
{
	char* sVar0;
...
int func_43(int iParam0, int iParam1, bool bParam2)//Position - 0x34CD
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_44(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x353E
{
...
int func_45(int iParam0)//Position - 0x3617
{
	int iVar0;
	int iVar1;
...
int func_46(int iParam0)//Position - 0x3654
{
	if (func_36(iParam0))
	{
...
void func_47(int iParam0, var uParam1, int iParam2)//Position - 0x367E
{
	int iVar0;
	int iVar1;
...
int func_48(int iParam0, int iParam1, int iParam2)//Position - 0x3828
{
	int iVar0;
	var uVar1;
...
int func_49(var uParam0)//Position - 0x385A
{
	int iVar0;
	int iVar1;
...
int func_50()//Position - 0x388E
{
	return Global_1312736;
}

int func_51(int iParam0, int iParam1)//Position - 0x389A
{
	var uVar0;
	var uVar1;
...
void func_52(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x38C6
{
	int iVar0;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3E0E
{
	int iVar0;
...
int func_54()//Position - 0x404F
{
	func_55();
	return Global_104555.f_2353.f_539.f_4301;
}

void func_55()//Position - 0x4068
{
	int iVar0;
...
bool func_56(int iParam0)//Position - 0x4165
{
	return Global_35861 == iParam0;
}

void func_57(int iParam0, bool bParam1)//Position - 0x4173
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_58(int iParam0, var uParam1)//Position - 0x4266
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_59(int iParam0)//Position - 0x44F0
{
	switch (iParam0)
	{
		case -1258515792:
...
int func_60(int iParam0)//Position - 0x458B
{
...
int func_61(int iParam0, int iParam1)//Position - 0x46FF
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_62(int iParam0, var uParam1)//Position - 0x5270
{
	int iVar0;
	int iVar1;
...
int func_63(int iParam0)//Position - 0x52AB
{
	int iVar0;
...
void func_64(int iParam0)//Position - 0x551F
{
	int iVar0;
...
void func_65(var uParam0, int iParam1)//Position - 0x555B
{
	int iVar0;
	vector3 vVar1;
	var uVar2;
...
int func_66(vector3 vParam0, char* sParam1, vector3 vParam2)//Position - 0x5AB6
{
	int iVar0;
	int iVar1;
...
bool func_67(int iParam0, var uParam1, var uParam2)//Position - 0x5AFA
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_68(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x61B1
{
	if (bParam2)
	{
...
int func_69(var uParam0)//Position - 0x61F8
{
...
bool func_70(int iParam0)//Position - 0x6253
{
	return func_71(iParam0, 0, 1);
}

int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x6263
{
	if (bParam2)
	{
...
int func_72(int iParam0)//Position - 0x62C3
{
	switch (iParam0)
	{
		case 0:
...
int func_73()//Position - 0x65A8
{
	return Global_25233;
}

int func_74(int iParam0)//Position - 0x65B3
{
	return func_71(iParam0, 5, 1);
}

int func_75(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x65C3
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0, bool bParam1)//Position - 0x6665
{
	switch (iParam0)
	{
		case -1:
...
int func_77(int iParam0)//Position - 0x6C04
{
	if (iParam0 != func_86())
	{
...
Vector3 func_78(int iParam0, int iParam1)//Position - 0x6C62
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_79(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6D10
{
	struct<4> Var0;
	vector3 vVar1;
	struct<4> Var2;
...
Vector3 func_80(vector3 vParam0, float fParam1)//Position - 0x6DA5
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
struct<6> func_81(int iParam0)//Position - 0x6DE9
{
	struct<6> Var0;
...
struct<6> func_82(int iParam0)//Position - 0x6F6D
{
	return func_83(iParam0);
}

struct<6> func_83(int iParam0)//Position - 0x6F7B
{
	struct<6> Var0;
...
int func_84(int iParam0, var uParam1)//Position - 0x7A42
{
	switch (iParam0)
	{
		case 0:
...
int func_85(int iParam0)//Position - 0x7AC4
{
	if (iParam0 != func_86())
	{
...
int func_86()//Position - 0x7B22
{
	return -1;
}

Vector3 func_87(int iParam0)//Position - 0x7B2B
{
	switch (iParam0)
	{
		case 1:
...
int func_88(int iParam0)//Position - 0x7CC8
{
	return func_71(iParam0, 0, 0);
}

int func_89(int iParam0)//Position - 0x7CD8
{
	switch (iParam0)
	{
		case -1:
...
bool func_90()//Position - 0x7F65
{
	return Global_92885.f_315 > 0;
}

var func_91()//Position - 0x7F76
{
	var uVar0;
...
void func_92(var uParam0, int iParam1)//Position - 0x7FBC
{
	if (iParam1 <= 0)
	{
		return;
...
void func_93(var uParam0, int iParam1)//Position - 0x8045
{
...
void func_94(var uParam0, int iParam1)//Position - 0x8078
{
	int iVar0;
	int iVar1;
...
int func_95(int iParam0, int iParam1)//Position - 0x80C9
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_96(int iParam0)//Position - 0x816B
{
	return (system::shift_right(iParam0, 26) & 31 * func_97(unk_0xC80D31E4B587871C(iParam0, 31), -1, 1)) + 2011;
}

int func_97(bool bParam0, int iParam1, int iParam2)//Position - 0x8190
{
	if (bParam0)
	{
		return iParam1;
...
int func_98(var uParam0)//Position - 0x81A7
{
	return uParam0 & 15;
}

void func_99(var uParam0, int iParam1)//Position - 0x81B4
{
...
void func_100(var uParam0, int iParam1)//Position - 0x81EE
{
...
void func_101(var uParam0, int iParam1)//Position - 0x8229
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_102()//Position - 0x8265
{
	func_55();
	return Global_104555.f_2353.f_539.f_4301;
}

void func_103(int iParam0)//Position - 0x827E
{
	var uVar0;
	vector3 vVar1[24];
...
void func_104(char* sParam0, int iParam1, int iParam2)//Position - 0x82D7
{
...
bool func_105(bool bParam0)//Position - 0x8319
{
...
struct<2> func_106(int iParam0)//Position - 0x8344
{
	struct<2> Var0;
...
void func_107(int iParam0, var uParam1)//Position - 0x8791
{
	switch (iParam0)
	{
		case 0:
...
int func_109(int iParam0)//Position - 0x9A69
{
	switch (iParam0)
	{
		case 0:
...
int func_110(int iParam0)//Position - 0x9DAF
{
	int iVar0;
...
void func_111(int iParam0)//Position - 0x9E53
{
	struct<2> Var0;
...
void func_112(int iParam0)//Position - 0x9EEE
{
	if (iParam0 < 63)
	{
		func_113();
...
void func_114(int iParam0)//Position - 0x9F4C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_115(int iParam0)//Position - 0x9FA5
{
...
int func_116(int iParam0)//Position - 0xA028
{
	int iVar0;
...
void func_117(int iParam0, int iParam1, int iParam2)//Position - 0xA059
{
	func_118(iParam0, iParam1, iParam2, 0, 0);
}

void func_118(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0xA06D
{
	int iVar0;
...
int func_120(int iParam0, int iParam1, int iParam2)//Position - 0xA115
{
...
int func_121(int iParam0, int iParam1, int iParam2)//Position - 0xA130
{
	int iVar0;
...
int func_122(int iParam0)//Position - 0xA17C
{
	int iVar0;
...
int func_123(int iParam0)//Position - 0xA1C5
{
	if (func_193(iParam0))
	{
		if (!unk_0x3AB6A1A9084FB0A4(iParam0))
...
int func_124(int iParam0)//Position - 0xA1E5
{
	switch (iParam0)
	{
		case 5:
...
int func_126(int iParam0)//Position - 0xA2B5
{
	switch (iParam0)
	{
		case 5:
...
void func_127(var uParam0, bool bParam1, bool bParam2)//Position - 0xA308
{
	int iVar0;
	...
	while (iVar0 < 6)
	{
		if (func_193(uParam0->f_28[iVar0]))
		{
	...
	while (iVar0 < 6)
	{
		if (func_193(uParam0->f_41[iVar0]))
		{
...
int func_128(int iParam0)//Position - 0xA3FD
{
	switch (iParam0)
	{
		case 5:
...
void func_129(bool bParam0)//Position - 0xA468
{
	int iVar0;
...
void func_130(bool bParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xA4A4
{
	if (bParam0)
	{
...
bool func_131()//Position - 0xA5BD
{
	return unk_0xC80D31E4B587871C(Global_1595693[unk_0x9EB17624F44A8DA4() /*680*/].f_39.f_18, 14);
}

bool func_132(int iParam0, int iParam1)//Position - 0xA5DA
{
	bool bVar0;
...
int func_133(int iParam0, bool bParam1)//Position - 0xA625
{
	int iVar0;
	int iVar1;
...
int func_134(int iParam0)//Position - 0xA666
{
...
bool func_135()//Position - 0xA6A8
{
	return unk_0xC80D31E4B587871C(Global_2359302, 3);
}

int func_136(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xA6B9
{
	int iVar0;
...
void func_138(int iParam0)//Position - 0xA713
{
	if (iParam0 == 1)
	{
...
int func_139(char* sParam0)//Position - 0xA736
{
...
void func_140()//Position - 0xA773
{
	Global_14622 = 0;
	func_141();
}

void func_141()//Position - 0xA783
{
...
int func_145(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xA869
{
...
void func_146(int iParam0)//Position - 0xA9F8
{
	if (!unk_0x191BE1BC8F26F3C1(iParam0, 0))
	{
...
void func_148(int iParam0)//Position - 0xAA75
{
...
void func_149(int iParam0)//Position - 0xAA9E
{
	if (Global_14615)
	{
		func_150(0, 0);
...
void func_150(bool bParam0, bool bParam1)//Position - 0xAB0E
{
	if (bParam0)
	{
		if (func_151(0))
...
int func_151(int iParam0)//Position - 0xAB82
{
	if (iParam0 == 1)
	{
		if (Global_14453.f_1 > 3)
...
int func_152(int iParam0)//Position - 0xABDC
{
...
int func_153(int iParam0)//Position - 0xAC1D
{
	int iVar0;
...
void func_154(int iParam0)//Position - 0xAC62
{
...
int func_155(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xAC94
{
	int iVar0;
...
void func_156(var uParam0, int iParam1)//Position - 0xADCB
{
	int iVar0;
...
bool func_157(int iParam0)//Position - 0xAE1A
{
	return func_158(iParam0, Global_35861);
}

int func_158(int iParam0, int iParam1)//Position - 0xAE2B
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_159(int iParam0)//Position - 0xB00C
{
	if (Global_35861 == 15)
	{
		return 0;
...
int func_160()//Position - 0xB02E
{
	return func_161(unk_0x436287B7DB306165(), 0);
}

int func_161(char* sParam0, int iParam1)//Position - 0xB03F
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
void func_163(int iParam0, int iParam1)//Position - 0xB0AC
{
	switch (iParam0)
	{
		case 0:
...
int func_164(vector3 vParam0, bool bParam1)//Position - 0xB533
{
	int iVar0;
...
float func_165(bool bParam0, float fParam1, float fParam2)//Position - 0xB55F
{
	if (bParam0)
	{
		return fParam1;
...
int func_166(int iParam0)//Position - 0xB576
{
	switch (iParam0)
	{
		case 0:
...
int func_167(int iParam0, int iParam1)//Position - 0xB605
{
	switch (iParam0->f_16)
	{
		case 0:
			if (*iParam0 == 12)
			{
				...
				else if (func_193(iParam0->f_28[0]))
				{
					if (func_169(iParam0))
					{
						if (func_173(2))
		...
		case 5:
			if (*iParam0 == 6)
			{
				if (unk_0x88DDBE9908752BF0(unk_0xFC1458A37D98B502(), 0))
				{
					if (func_193(unk_0xDFD115BB10FE46A9(unk_0xFC1458A37D98B502(), 0)))
					{
...
void func_168()//Position - 0xBDE8
{
	func_27(&(Global_95149.f_2875), &Global_95149, 0, 1, 1, 0);
}

int func_169(var uParam0)//Position - 0xBE03
{
	float fVar0;
...
void func_170(int iParam0, int iParam1)//Position - 0xBE91
{
	if (iParam0 == 1)
	{
		if (!func_126(iParam1))
...
int func_171(bool bParam0)//Position - 0xBEF5
{
	int iVar0;
...
int func_172(int iParam0)//Position - 0xBF8C
{
	if (func_193(iParam0))
	{
		if (unk_0xB8DE76287EDC4957(iParam0, 0))
...
int func_173(int iParam0)//Position - 0xBFB6
{
	int iVar0;
...
var func_174()//Position - 0xC6E0
{
	return Global_92872.f_1;
}

int func_175()//Position - 0xC6EE
{
	if (Global_89900 != -1)
	{
...
bool func_178()//Position - 0xC758
{
	return Global_92885.f_316 > 0;
}

bool func_179(int iParam0, int iParam1)//Position - 0xC769
{
	switch (iParam0)
	{
		case 5:
...
var func_180()//Position - 0xC7A4
{
	return Global_1312854;
}

int func_181()//Position - 0xC7B0
{
	if (!unk_0x3A711520F83BAE98())
	{
...
void func_182(int iParam0)//Position - 0xC7CC
{
	if (iLocal_57 == -1)
	{
		iLocal_57 = unk_0x53C562FD2B9E3AB0();
	}
	if ((unk_0x53C562FD2B9E3AB0() - iLocal_57) >= 900)
	{
		if (func_193(iParam0->f_28[0]))
		{
			if (!func_142())
			{
				func_183(iParam0->f_28[0], "PUSHUP_BREATH", "MARYANN", 6);
				iLocal_57 = unk_0x53C562FD2B9E3AB0();
			}
		}
	}
...
void func_183(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xC81C
{
	unk_0xE44A9E63DC81244A(iParam0, sParam1, sParam2, func_184(iParam3), 0);
}

int func_184(int iParam0)//Position - 0xC835
{
	int iVar0;
...
int func_185(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xCA2A
{
	var uVar0;
	
	if ((((func_193(unk_0xFC1458A37D98B502()) && func_193(iParam0->f_28[0])) && !func_142()) && (unk_0x53C562FD2B9E3AB0() - iParam0->f_60) > iParam6) && func_189(unk_0xFC1458A37D98B502(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
...
void func_186(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCAB2
{
...
void func_187(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCAED
{
...
void func_188(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xCB43
{
...
float func_189(int iParam0, vector3 vParam1, bool bParam2)//Position - 0xCBDE
{
	vector3 vVar0;
...
int func_190(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6)//Position - 0xCC18
{
	var uVar0;
	...
	if (func_173(2))
	{
		if (!func_142())
		{
			if (((func_193(unk_0xFC1458A37D98B502()) && func_193(iParam0->f_28[0])) && (unk_0x53C562FD2B9E3AB0() - iParam0->f_60) > iParam6) && func_189(unk_0xFC1458A37D98B502(), vParam1, 1) < 20f)
			{
				uVar0 = 16;
				func_188(&uVar0, iParam4, iParam0->f_28[0], sParam5, 0, 1);
				func_186(&uVar0, cParam2, sParam3, 7, 0, 0);
		...
		{
			if (func_193(unk_0xFC1458A37D98B502()))
			{
				if (func_189(unk_0xFC1458A37D98B502(), vParam1, 1) >= 20f)
				{
					func_140();
				}
			}
...
int func_191(char* sParam0)//Position - 0xCCDA
{
	struct<6> Var0;
...
struct<6> func_192()//Position - 0xCCFA
{
	struct<6> Var0;
...
int func_193(int iParam0)//Position - 0xCD1E
{
	if (unk_0x6ADD12BF4D6D2587(iParam0))
	{
		if (!unk_0x191BE1BC8F26F3C1(iParam0, 0))
...
void func_194(int iParam0, char* sParam1, vector3 vParam2)//Position - 0xCD3F
{
	if (unk_0x5BEF7A5AB8F17255(unk_0x9EB17624F44A8DA4()))
	{
		if (!unk_0xAB019B170BF1309C(sParam1))
		{
			...
			{
				if (func_189(unk_0xFC1458A37D98B502(), vParam2, 1) <= 100f)
				{
					func_197(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_189(unk_0xFC1458A37D98B502(), vParam2, 1) > 120f)
				{
					func_199(iParam0);
				}
			}
...
void func_195(int iParam0, bool bParam1)//Position - 0xCE30
{
	if (iParam0 == -1)
	{
		return;
...
int func_196(int iParam0)//Position - 0xCE6C
{
	if (Global_70852 == iParam0)
	{
		if (Global_70853 == -1)
...
void func_197(int iParam0, int iParam1)//Position - 0xCEA5
{
	bool bVar0;
	int iVar1;
...
bool func_198()//Position - 0xCF43
{
	return Global_90287;
}

void func_199(int iParam0)//Position - 0xCF4F
{
	unk_0x7042DDDE71665936(0);
	unk_0xA6C03E3E2533F8F3();
	func_200(iParam0);
...
void func_200(int iParam0)//Position - 0xCF66
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_201(int iParam0)//Position - 0xD04E
{
	if (iParam0 == -1)
	{
		iParam0 = func_160();
...
int func_202(var uParam0, bool bParam1)//Position - 0xD076
{
	struct<27> Var0;
	...
	if ((func_239(*uParam0) || func_237(*uParam0)) || Global_71101 == 1)
	{
		return 1;
	}
	if (!unk_0x42F1FE4C7EC5F51E())
	...
	if (func_206(&(uParam0->f_48)) && bParam1)
	{
		func_203(uParam0->f_28[0], &(uParam0->f_48), *uParam0);
	}
	return 1;
}

void func_203(int iParam0, var uParam1, int iParam2)//Position - 0xD2E9
{
	int iVar0;
	int iVar1;
	...
	if (func_193(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_205(uParam1) || !unk_0xA5F6598E13F98E08(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_204(iParam2) && !unk_0xCA3C40448996C9BA(iParam0, unk_0xFC1458A37D98B502(), 25f))
					{
						unk_0xAC838A977FB6E6BC(iParam0, unk_0xFC1458A37D98B502(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_205(uParam1) && uParam1->f_4 == 0) && unk_0xBE3C4023003180FC(unk_0xB3328BA8976B416C(unk_0xFC1458A37D98B502(), 1), unk_0xB3328BA8976B416C(iParam0, 1), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_204(iParam2) || unk_0xCA3C40448996C9BA(iParam0, unk_0xFC1458A37D98B502(), 10f))
				{
					if (func_68(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						unk_0x12C9D41D52A560D6(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
...
int func_204(int iParam0)//Position - 0xD641
{
...
int func_205(var uParam0)//Position - 0xD661
{
...
int func_206(var uParam0)//Position - 0xD679
{
...
void func_207(var uParam0)//Position - 0xD69E
{
	int iVar0;
	int iVar1;
...
void func_208(int iParam0)//Position - 0xD9A2
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
...
void func_209(var uParam0)//Position - 0xD9CD
{
	int iVar0;
...
int func_210(var uParam0, bool bParam1, bool bParam2)//Position - 0xDA4D
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (unk_0x6ADD12BF4D6D2587(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_211(unk_0xFC1458A37D98B502(), uParam0->f_35[iVar0]))
							{
...
int func_211(int iParam0, int iParam1)//Position - 0xDC0B
{
	int iVar0;
...
int func_212(var uParam0, bool bParam1, int iParam2)//Position - 0xDC3B
{
	int iVar0;
	int iVar1;
...
int func_213(int iParam0)//Position - 0xDEF7
{
...
int func_214(int iParam0, float fParam1)//Position - 0xDF2B
{
	float fVar0;
	
	if (func_193(unk_0xFC1458A37D98B502()) && func_193(iParam0))
	{
		if (func_225(iParam0) || unk_0x7B46BDDD99441E94(unk_0x9EB17624F44A8DA4(), iParam0))
		{
...
bool func_215(int iParam0, float fParam1)//Position - 0xDFA1
{
	return func_216(iParam0, unk_0xFC1458A37D98B502(), fParam1, 1, 250, 7);
}

bool func_216(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xDFB9
{
	var uVar0;
	vector3 vVar1;
	int iVar2;
	...
	if (!func_193(iParam0) || !func_193(iParam1))
	{
		if (iVar2 != -1)
		{
	...
	uVar0 = func_217(&(Local_37[iVar2 /*4*/]), vVar1, iParam1, &(Local_37[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (unk_0x53C562FD2B9E3AB0() - Local_37[iVar2 /*4*/].f_3) < iParam4);
}

int func_217(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xE07A
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
	...
	if (*uParam0 == 0)
	{
		vVar1 = { func_218(iParam2, iParam5) };
...
Vector3 func_218(int iParam0, int iParam1)//Position - 0xE1A6
{
	int iVar0;
...
int func_220(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE2B5
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_222(unk_0xB3328BA8976B416C(iParam1, 1) - unk_0xB3328BA8976B416C(iParam0, 1)) };
	...
	{
		vVar1 = { func_222(unk_0xD0E00576168D19BB(iParam0, 31086, 0f, 5f, 0f) - unk_0xD0E00576168D19BB(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar2 = func_221(vVar1, vVar0);
...
float func_221(vector3 vParam0, vector3 vParam1)//Position - 0xE346
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

Vector3 func_222(vector3 vParam0)//Position - 0xE367
{
	float fVar0;
	float fVar1;
...
void func_223(var uParam0)//Position - 0xE3A6
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_224(int iParam0, int iParam1)//Position - 0xE3C1
{
	int iVar0;
...
int func_225(int iParam0)//Position - 0xE400
{
...
int func_226(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE428
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_227(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE523
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_228(int iParam0, float fParam1)//Position - 0xE62F
{
	var uVar0;
	vector3 vVar1;
	...
	{
		if (func_229(iParam0, vVar1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_229(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0xE6C4
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_222(vParam1 - unk_0xB3328BA8976B416C(iParam0, 1)) };
	if (fParam2 < 0,1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_230(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xE752
{
	if (bParam1)
	{
		if (unk_0x08765A6321A42CA1(unk_0xFC1458A37D98B502()))
...
int func_231(int iParam0)//Position - 0xE79A
{
...
void func_232(int iParam0)//Position - 0xE7E4
{
	int iVar0;
...
int func_233(int iParam0)//Position - 0xE881
{
	if (iParam0 == -1)
	{
		iParam0 = func_160();
...
int func_234(int iParam0)//Position - 0xE919
{
...
int func_237(int iParam0)//Position - 0xE99B
{
	if ((func_238() && Global_92833.f_11 == 6) && iParam0 == func_161(&(Global_92833.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_239(int iParam0)//Position - 0xEA0D
{
	if (func_105(0))
	{
...
int func_242(var uParam0)//Position - 0xEAE8
{
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_248(&(uParam0->f_48), "rcmfanatic3", "ef_3_rcm_loop_maryann", 0);
			iLocal_51 = 1;
			break;
		...
		case 2:
			...
			{
				if (func_243(&(uParam0->f_28[0]), 61, -915,6f, 6139,192f, 5,525f, 111,24f, "FANATIC LAUNCHER RC", 1))
				{
			...
			if (!unk_0x6ADD12BF4D6D2587(uParam0->f_41[0]))
			{
				...
				uParam0->f_41[0] = unk_0x5E35CF35E65D69B9(iVar0[1], vVar3, true, true, false);
			...
			if (!unk_0x6ADD12BF4D6D2587(uParam0->f_41[1]))
			{
				...
				uParam0->f_41[1] = unk_0x5E35CF35E65D69B9(iVar0[2], vVar3, true, true, false);
			...
			if (!unk_0x6ADD12BF4D6D2587(uParam0->f_41[2]))
			{
				...
				uParam0->f_41[2] = unk_0x5E35CF35E65D69B9(iVar0[3], vVar3, true, true, false);
			...
			if (!unk_0x6ADD12BF4D6D2587(uParam0->f_41[3]))
			{
				...
				uParam0->f_41[3] = unk_0x5E35CF35E65D69B9(iVar0[4], vVar3, true, true, false);
...
int func_243(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)//Position - 0xEEA8
{
	if (func_244(iParam0, iParam1, vParam2, fParam3, 1))
	{
		if (unk_0x6ADD12BF4D6D2587(*iParam0))
		{
			if (!unk_0x191BE1BC8F26F3C1(*iParam0, 0))
...
int func_244(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)//Position - 0xEF04
{
	int iVar0;
...
int func_245(var uParam0, int iParam1)//Position - 0xEF92
{
	int iVar0;
...
int func_246(var uParam0)//Position - 0xEFD8
{
	if (func_206(uParam0))
	{
...
int func_247(int iParam0)//Position - 0xF002
{
	int iVar0;
...
void func_248(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xF033
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_249(var uParam0)//Position - 0xF06F
{
	int iVar0[3];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_248(&(uParam0->f_48), "rcm_fanatic2", "ef_2_rcm__maryann_biking_maryann", 0);
			iLocal_51 = 1;
			break;
		...
		case 2:
			...
			if (!unk_0x6ADD12BF4D6D2587(uParam0->f_28[0]))
			{
				if (!func_243(&(uParam0->f_28[0]), 61, 809,66f, 1279,76f, 360,49f, 122,53f, "FANATIC LAUNCHER RC", 1))
				{
					bVar2 = false;
				}
			}
			...
			{
				func_253(&(uParam0->f_28[1]), iVar0[1], 808,43f, 1279,16f, 360,47f, -79,11f, 26);
				if (func_193(uParam0->f_28[1]))
				{
			...
			{
				func_251(&(uParam0->f_35[0]), iVar0[2], 808,35f, 1277,2f, 360,15f, 216,5f);
			}
			if (!unk_0x6ADD12BF4D6D2587(uParam0->f_35[1]))
			{
				func_251(&(uParam0->f_35[1]), iVar0[2], 807,89f, 1275,73f, 360,18f, 208,2f);
			}
			if (bVar2)
			{
				iLocal_51 = 3;
		...
		case 3:
			...
			while (iVar1 <= 1)
			{
				if (func_193(uParam0->f_35[iVar1]))
				{
			...
			if (unk_0x3A801AA34DD821BE("rcm_fanatic2"))
			{
				if (func_193(uParam0->f_28[1]))
				{
					...
					func_285("Playing Mary Ann's friend anim...");
				}
			}
			func_250();
			iVar1 = 0;
...
void func_251(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xF3B3
{
	func_252(iParam0);
...
void func_252(int iParam0)//Position - 0xF3F5
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
...
void func_253(int iParam0, int iParam1, vector3 vParam2, float fParam3, int iParam4)//Position - 0xF491
{
	func_254(iParam0);
	*iParam0 = unk_0xAC992EFAD62C33BF(iParam4, iParam1, vParam2, fParam3, 0, false);
}

void func_254(int iParam0)//Position - 0xF4B2
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
		if (!unk_0x191BE1BC8F26F3C1(*iParam0, 0))
...
int func_255(var uParam0)//Position - 0xF4F3
{
	int iVar0[1];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_248(&(uParam0->f_48), "rcmfanatic1", "ef_1_rcm_mary_ann_streching_base", 0);
		...
		case 2:
			...
			if (!unk_0x6ADD12BF4D6D2587(uParam0->f_28[0]))
			{
				if (func_243(&(uParam0->f_28[0]), 61, -1878,27f, -440,55f, 46,23f, 165,94f, "FANATIC LAUNCHER RC", 1))
				{
...
int func_256(int iParam0)//Position - 0xF64E
{
	struct<27> Var0;
	int iVar1;
...
int func_257(int iParam0)//Position - 0xF6A2
{
	char* sVar0;
...
int func_258(int iParam0)//Position - 0xF75B
{
	var uVar0;
...
int func_259(int iParam0)//Position - 0xF81C
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_260(int iParam0, char* sParam1)//Position - 0xF8A1
{
...
bool func_261(int iParam0)//Position - 0xF983
{
...
bool func_262(int iParam0)//Position - 0xF9B1
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_263(int iParam0)//Position - 0xF9DF
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_264(int iParam0)//Position - 0xFA0D
{
	if (func_234(iParam0))
	{
		return 0;
...
void func_265()//Position - 0xFA42
{
	func_285("Running end routines.");
	Global_104273 = (Global_104273 - 1);
}

int func_266(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xFA5C
{
	int iVar0;
...
int func_267(int iParam0, vector3 vParam1, float fParam2, var uParam3)//Position - 0xFAC1
{
	int iVar0;
	struct<7> Var1;
...
int func_268(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0xFB3F
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_269(int iParam0, bool bParam1)//Position - 0xFBBA
{
	char* sVar0;
...
void func_270(char* sParam0)//Position - 0xFC5E
{
	if (!unk_0xAB019B170BF1309C(sParam0))
	{
		if (func_191(sParam0))
...
void func_271()//Position - 0xFC7D
{
	Global_14622 = 0;
	func_272();
}

void func_272()//Position - 0xFC8D
{
	unk_0x495EB1DD7306493A();
	Global_16767 = 0;
	if (unk_0x42111BD51D233AAB())
...
int func_273(var uParam0)//Position - 0xFCAE
{
	if (func_206(uParam0))
	{
		if (unk_0x3A801AA34DD821BE(*uParam0))
...
void func_274(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xFCE4
{
...
void func_275(var uParam0, bool bParam1)//Position - 0xFD04
{
	func_276(&(uParam0->f_41), bParam1);
}

void func_276(var uParam0, bool bParam1)//Position - 0xFD16
{
	int iVar0;
...
void func_277(int iParam0, bool bParam1)//Position - 0xFD54
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
		if (unk_0x6049C20F5D5C185B(*iParam0))
...
void func_278(var uParam0, bool bParam1)//Position - 0xFD8F
{
	func_279(&(uParam0->f_35), bParam1);
}

void func_279(var uParam0, bool bParam1)//Position - 0xFDA1
{
	int iVar0;
...
void func_280(int iParam0)//Position - 0xFDDE
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
...
void func_281(var uParam0, int iParam1)//Position - 0xFE16
{
	func_282(&(uParam0->f_28), iParam1);
}

void func_282(var uParam0, int iParam1)//Position - 0xFE28
{
	int iVar0;
...
void func_283(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xFE69
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
		if (!unk_0x3AB6A1A9084FB0A4(*iParam0))
...
void func_284(var uParam0)//Position - 0xFEB9
{
	if (*uParam0 == -1)
	{
		return;
...
void func_285(char* sParam0)//Position - 0xFEF6
{
	if (!unk_0xAB019B170BF1309C(sParam0))
	{
	}
...
void func_286(var uParam0)//Position - 0xFF08
{
	*uParam0 = -1;
...
void func_287()//Position - 0xFF3B
{
	func_285("Running start routines.");
	Global_104273++;
}

int func_288(int iParam0)//Position - 0xFF55
{
	if (!func_36(iParam0))
	{
		return Global_104555.f_28020[iParam0 /*29*/];
