...
void __EntryFunction__()//Position - 0x0
{
	...
	if (unk_0x7D9C4B359376D38A(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_103642[Var0 /*10*/].f_9 != -1)
			{
				...
				func_263(&(Global_103642[Var0 /*10*/].f_9));
			}
		}
		func_250(&Var0, 1);
	}
	if (!func_247(&iVar2, &Var0, vVar1, 1f))
	{
		func_246();
	...
	while (true)
	{
		...
		func_193(Var0);
		func_186(&iLocal_53, &uLocal_54, &(Var0.f_9), vVar1, -1295,84f, 4641,98f, 105,33f, -1301,43f, 4641,21f, 105,62f);
		func_179(&Var0, vVar1, "SAS1AUD", "SAS1_AMB", 4, "HUNTER", 10000);
		if (func_164(&Var0, 0))
		{
			if (!func_2(&Var0))
			{
...
int func_2(int iParam0)//Position - 0x24C
{
	struct<4> Var0;
	char* sVar1;
...
void func_4(int iParam0)//Position - 0x3CC
{
	int iVar0;
	int iVar1;
...
void func_6(int iParam0)//Position - 0x5D9
{
	switch (iParam0)
	{
		case 2:
...
void func_7(int iParam0)//Position - 0x9C1
{
	Global_55896 = 1;
	Global_55899 = 1;
	if (Global_67998 > 15)
...
void func_8(int iParam0)//Position - 0xA0C
{
...
struct<2> func_9(int iParam0)//Position - 0xA40
{
	struct<2> Var0;
	char[] cVar1[8];
...
void func_13()//Position - 0xB32
{
	Global_56062 = 0;
}

void func_14()//Position - 0xB3E
{
	Global_55922 = 0;
...
var func_15(int iParam0)//Position - 0xB92
{
	var uVar0;
...
void func_17(int iParam0)//Position - 0xBD0
{
	Global_71116 = iParam0;
	Global_71117 = iParam0;
}

void func_18()//Position - 0xBE4
{
	int iVar0;
...
void func_21(char* sParam0)//Position - 0xC89
{
...
void func_22(char[4] cParam0, int iParam1)//Position - 0xC9C
{
	unk_0x0EE72DB1CD8A3B86(&(Global_92833.f_20), 17);
	func_23(cParam0, iParam1, 0);
}

void func_23(char[4] cParam0, int iParam1, int iParam2)//Position - 0xCB9
{
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x1992
{
	int iVar0;
	int iVar1;
...
int func_26(var uParam0)//Position - 0x281A
{
...
void func_27(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x283C
{
	int iVar0;
...
int func_28(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x28C4
{
...
int func_29(int iParam0)//Position - 0x2904
{
	int iVar0;
...
void func_30(var uParam0, int iParam1, int iParam2)//Position - 0x2932
{
...
int func_31(int iParam0)//Position - 0x2A0E
{
	int iVar0;
...
int func_32(int iParam0)//Position - 0x2A50
{
	int iVar0;
...
int func_33(int iParam0, int iParam1, int iParam2)//Position - 0x2AB3
{
	int iVar0;
...
int func_34(int iParam0, int iParam1)//Position - 0x2B41
{
	struct<82> Var0;
...
void func_35(int iParam0, var uParam1, int iParam2)//Position - 0x2B83
{
	int iVar0;
...
bool func_36(int iParam0)//Position - 0x2DDF
{
	return iParam0 < 3;
}

void func_37(int iParam0, var uParam1)//Position - 0x2DEB
{
	int iVar0;
...
int func_38(int iParam0)//Position - 0x3096
{
	switch (iParam0)
	{
		case 1:
...
int func_39(int iParam0, var uParam1, var uParam2)//Position - 0x3146
{
	int iVar0;
	int iVar1;
...
int func_40(int iParam0)//Position - 0x3220
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_41(var uParam0)//Position - 0x3240
{
	int iVar0;
...
int func_42(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x32F1
{
	char* sVar0;
...
int func_43(int iParam0, int iParam1, bool bParam2)//Position - 0x3420
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_44(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x3491
{
...
int func_45(int iParam0)//Position - 0x356A
{
	int iVar0;
	int iVar1;
...
int func_46(int iParam0)//Position - 0x35A7
{
	if (func_36(iParam0))
	{
...
void func_47(int iParam0, var uParam1, int iParam2)//Position - 0x35D1
{
	int iVar0;
	int iVar1;
...
int func_48(int iParam0, int iParam1, int iParam2)//Position - 0x377B
{
	int iVar0;
	var uVar1;
...
int func_49(var uParam0)//Position - 0x37AD
{
	int iVar0;
	int iVar1;
...
int func_50()//Position - 0x37E1
{
	return Global_1312736;
}

int func_51(int iParam0, int iParam1)//Position - 0x37ED
{
	var uVar0;
	var uVar1;
...
void func_52(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x3819
{
	int iVar0;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3D61
{
	int iVar0;
...
int func_54()//Position - 0x3FA2
{
	func_55();
	return Global_104555.f_2353.f_539.f_4301;
}

void func_55()//Position - 0x3FBB
{
	int iVar0;
...
bool func_56(int iParam0)//Position - 0x40BB
{
	return Global_35861 == iParam0;
}

void func_57(int iParam0, bool bParam1)//Position - 0x40C9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_58(int iParam0, var uParam1)//Position - 0x41BC
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_59(int iParam0)//Position - 0x4446
{
	switch (iParam0)
	{
		case -1258515792:
...
int func_60(int iParam0)//Position - 0x44E1
{
...
int func_61(int iParam0, int iParam1)//Position - 0x4655
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_62(int iParam0, var uParam1)//Position - 0x51C6
{
	int iVar0;
	int iVar1;
...
int func_63(int iParam0)//Position - 0x5201
{
	int iVar0;
...
void func_64(int iParam0)//Position - 0x5475
{
	int iVar0;
...
void func_65(var uParam0, int iParam1)//Position - 0x54B1
{
	int iVar0;
	vector3 vVar1;
	var uVar2;
...
int func_66(vector3 vParam0, char* sParam1, vector3 vParam2)//Position - 0x5A0C
{
	int iVar0;
	int iVar1;
...
bool func_67(int iParam0, var uParam1, var uParam2)//Position - 0x5A50
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_68(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x6107
{
	if (bParam2)
	{
...
int func_69(var uParam0)//Position - 0x614E
{
...
bool func_70(int iParam0)//Position - 0x61A9
{
	return func_71(iParam0, 0, 1);
}

int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x61B9
{
	if (bParam2)
	{
...
int func_72(int iParam0)//Position - 0x6219
{
	switch (iParam0)
	{
		case 0:
...
int func_73()//Position - 0x64FE
{
	return Global_25233;
}

int func_74(int iParam0)//Position - 0x6509
{
	return func_71(iParam0, 5, 1);
}

int func_75(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x6519
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0, bool bParam1)//Position - 0x65BB
{
	switch (iParam0)
	{
		case -1:
...
int func_77(int iParam0)//Position - 0x6B5A
{
	if (iParam0 != func_86())
	{
...
Vector3 func_78(int iParam0, int iParam1)//Position - 0x6BB8
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_79(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6C66
{
	struct<4> Var0;
	vector3 vVar1;
	struct<4> Var2;
...
Vector3 func_80(vector3 vParam0, float fParam1)//Position - 0x6CFB
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
struct<6> func_81(int iParam0)//Position - 0x6D3F
{
	struct<6> Var0;
...
struct<6> func_82(int iParam0)//Position - 0x6EC3
{
	return func_83(iParam0);
}

struct<6> func_83(int iParam0)//Position - 0x6ED1
{
	struct<6> Var0;
...
int func_84(int iParam0, var uParam1)//Position - 0x7998
{
	switch (iParam0)
	{
		case 0:
...
int func_85(int iParam0)//Position - 0x7A1A
{
	if (iParam0 != func_86())
	{
...
int func_86()//Position - 0x7A78
{
	return -1;
}

Vector3 func_87(int iParam0)//Position - 0x7A81
{
	switch (iParam0)
	{
		case 1:
...
int func_88(int iParam0)//Position - 0x7C1E
{
	return func_71(iParam0, 0, 0);
}

int func_89(int iParam0)//Position - 0x7C2E
{
	switch (iParam0)
	{
		case -1:
...
bool func_90()//Position - 0x7EBB
{
	return Global_92885.f_315 > 0;
}

var func_91()//Position - 0x7ECC
{
	var uVar0;
...
void func_92(var uParam0, int iParam1)//Position - 0x7F12
{
	if (iParam1 <= 0)
	{
		return;
...
void func_93(var uParam0, int iParam1)//Position - 0x7F98
{
...
void func_94(var uParam0, int iParam1)//Position - 0x7FCB
{
	int iVar0;
	int iVar1;
...
int func_95(int iParam0, int iParam1)//Position - 0x801D
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_96(int iParam0)//Position - 0x80BF
{
	return (system::shift_right(iParam0, 26) & 31 * func_97(unk_0xC80D31E4B587871C(iParam0, 31), -1, 1)) + 2011;
}

int func_97(bool bParam0, int iParam1, int iParam2)//Position - 0x80E4
{
	if (bParam0)
	{
		return iParam1;
...
int func_98(var uParam0)//Position - 0x80FB
{
	return uParam0 & 15;
}

void func_99(var uParam0, int iParam1)//Position - 0x8108
{
...
void func_100(var uParam0, int iParam1)//Position - 0x8142
{
...
void func_101(var uParam0, int iParam1)//Position - 0x817D
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_102()//Position - 0x81B9
{
	func_55();
	return Global_104555.f_2353.f_539.f_4301;
}

void func_103(int iParam0)//Position - 0x81D2
{
	var uVar0;
	vector3 vVar1[24];
...
void func_104(char* sParam0, int iParam1, int iParam2)//Position - 0x822B
{
...
bool func_105(bool bParam0)//Position - 0x826D
{
...
struct<2> func_106(int iParam0)//Position - 0x8298
{
	struct<2> Var0;
...
void func_107(int iParam0, var uParam1)//Position - 0x86E5
{
	switch (iParam0)
	{
		case 0:
...
int func_109(int iParam0)//Position - 0x99BD
{
	switch (iParam0)
	{
		case 0:
...
int func_110(int iParam0)//Position - 0x9D03
{
	int iVar0;
...
void func_111(int iParam0)//Position - 0x9DA7
{
	struct<2> Var0;
...
void func_112(int iParam0)//Position - 0x9E42
{
	if (iParam0 < 63)
	{
		func_113();
...
void func_114(int iParam0)//Position - 0x9EA0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_115(int iParam0)//Position - 0x9EF9
{
...
int func_116(int iParam0)//Position - 0x9F7C
{
	int iVar0;
...
void func_117(int iParam0, int iParam1, int iParam2)//Position - 0x9FAD
{
	func_118(iParam0, iParam1, iParam2, 0, 0);
}

void func_118(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x9FC1
{
	int iVar0;
...
int func_120(int iParam0, int iParam1, int iParam2)//Position - 0xA069
{
...
int func_121(int iParam0, int iParam1, int iParam2)//Position - 0xA084
{
	int iVar0;
...
int func_122(int iParam0)//Position - 0xA0D0
{
	int iVar0;
...
int func_123(int iParam0)//Position - 0xA119
{
	if (func_124(iParam0))
	{
		if (!unk_0x3AB6A1A9084FB0A4(iParam0))
...
int func_124(int iParam0)//Position - 0xA139
{
	if (unk_0x6ADD12BF4D6D2587(iParam0))
	{
...
int func_125(int iParam0)//Position - 0xA15A
{
	switch (iParam0)
	{
		case 5:
...
int func_127(int iParam0)//Position - 0xA22A
{
	switch (iParam0)
	{
		case 5:
...
void func_128(var uParam0, bool bParam1, bool bParam2)//Position - 0xA27D
{
	int iVar0;
...
int func_129(int iParam0)//Position - 0xA372
{
	switch (iParam0)
	{
		case 5:
...
void func_130(bool bParam0)//Position - 0xA3DD
{
	int iVar0;
...
void func_131(bool bParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xA419
{
	if (bParam0)
	{
...
bool func_132()//Position - 0xA532
{
	return unk_0xC80D31E4B587871C(Global_1595693[unk_0x9EB17624F44A8DA4() /*680*/].f_39.f_18, 14);
}

bool func_133(int iParam0, int iParam1)//Position - 0xA54F
{
	bool bVar0;
...
int func_134(int iParam0, bool bParam1)//Position - 0xA59A
{
	int iVar0;
	int iVar1;
...
int func_135(int iParam0)//Position - 0xA5DB
{
...
bool func_136()//Position - 0xA61D
{
	return unk_0xC80D31E4B587871C(Global_2359302, 3);
}

int func_137(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xA62E
{
	int iVar0;
...
void func_139(int iParam0)//Position - 0xA688
{
	if (iParam0 == 1)
	{
...
int func_140(char* sParam0)//Position - 0xA6AB
{
...
void func_141()//Position - 0xA6E8
{
	Global_14622 = 0;
	func_142();
}

void func_142()//Position - 0xA6F8
{
...
int func_146(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xA7DE
{
...
void func_147(int iParam0)//Position - 0xA96D
{
	if (!unk_0x191BE1BC8F26F3C1(iParam0, 0))
	{
...
void func_149(int iParam0)//Position - 0xA9EA
{
...
void func_150(int iParam0)//Position - 0xAA13
{
	if (Global_14615)
	{
		func_151(0, 0);
...
void func_151(bool bParam0, bool bParam1)//Position - 0xAA83
{
	if (bParam0)
	{
		if (func_152(0))
...
int func_152(int iParam0)//Position - 0xAAF7
{
	if (iParam0 == 1)
	{
		if (Global_14453.f_1 > 3)
...
int func_153(int iParam0)//Position - 0xAB51
{
...
int func_154(int iParam0)//Position - 0xAB92
{
	int iVar0;
...
void func_155(int iParam0)//Position - 0xABD7
{
...
int func_156(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xAC09
{
	int iVar0;
...
void func_157(var uParam0, int iParam1)//Position - 0xAD40
{
	int iVar0;
...
bool func_158(int iParam0)//Position - 0xAD8F
{
	return func_159(iParam0, Global_35861);
}

int func_159(int iParam0, int iParam1)//Position - 0xADA0
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_160(int iParam0)//Position - 0xAF81
{
	if (Global_35861 == 15)
	{
		return 0;
...
int func_161()//Position - 0xAFA3
{
	return func_162(unk_0x436287B7DB306165(), 0);
}

int func_162(char* sParam0, int iParam1)//Position - 0xAFB4
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_164(var uParam0, int iParam1)//Position - 0xB021
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_165()//Position - 0xB804
{
	func_27(&(Global_95149.f_2875), &Global_95149, 0, 1, 1, 0);
}

int func_166(var uParam0)//Position - 0xB81F
{
	float fVar0;
...
void func_167(int iParam0, int iParam1)//Position - 0xB8AD
{
	if (iParam0 == 1)
	{
		if (!func_127(iParam1))
...
int func_168(bool bParam0)//Position - 0xB911
{
	int iVar0;
...
int func_169(int iParam0)//Position - 0xB9A8
{
	if (func_124(iParam0))
	{
		if (unk_0xB8DE76287EDC4957(iParam0, 0))
...
int func_170(int iParam0)//Position - 0xB9D2
{
	int iVar0;
...
var func_171()//Position - 0xC0F2
{
	return Global_92872.f_1;
}

int func_172()//Position - 0xC100
{
	if (Global_89900 != -1)
	{
...
bool func_175()//Position - 0xC16A
{
	return Global_92885.f_316 > 0;
}

bool func_176(int iParam0, int iParam1)//Position - 0xC17B
{
	switch (iParam0)
	{
		case 5:
...
var func_177()//Position - 0xC1B6
{
	return Global_1312854;
}

int func_178()//Position - 0xC1C2
{
	if (!unk_0x3A711520F83BAE98())
	{
...
int func_179(var uParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6)//Position - 0xC1DE
{
	var uVar0;
	...
	if (func_170(2))
	{
		if (!func_143())
		{
			if (((func_124(unk_0xFC1458A37D98B502()) && func_124(uParam0->f_28[0])) && (unk_0x53C562FD2B9E3AB0() - uParam0->f_60) > iParam6) && func_185(unk_0xFC1458A37D98B502(), vParam1, 1) < 20f)
			{
				uVar0 = 16;
		...
		else if (func_180(sParam3))
		{
			if (func_124(unk_0xFC1458A37D98B502()))
			{
				if (func_185(unk_0xFC1458A37D98B502(), vParam1, 1) >= 20f)
				{
					func_141();
				}
			}
...
int func_180(char* sParam0)//Position - 0xC2A0
{
	struct<6> Var0;
...
struct<6> func_181()//Position - 0xC2C0
{
	struct<6> Var0;
...
void func_182(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC2E4
{
...
void func_183(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC31F
{
...
void func_184(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xC375
{
...
float func_185(int iParam0, vector3 vParam1, bool bParam2)//Position - 0xC410
{
	vector3 vVar0;
...
void func_186(int iParam0, var uParam1, char* sParam2, vector3 vParam3, vector3 vParam4, vector3 vParam5)//Position - 0xC44A
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	if (unk_0x5BEF7A5AB8F17255(unk_0x9EB17624F44A8DA4()))
	{
		if (!unk_0xAB019B170BF1309C(sParam2))
		{
			...
			{
				if (func_185(unk_0xFC1458A37D98B502(), vParam3, 1) <= 100f)
				{
					func_189(iParam0, 1);
				}
			}
			else
			{
				...
				{
					fVar0 = func_185(unk_0xFC1458A37D98B502(), vParam4, 1);
					fVar1 = func_185(unk_0xFC1458A37D98B502(), vParam5, 1);
					fVar2 = (fVar0 - fVar1);
					if (fVar2 < 0f)
					{
						fVar2 = (fVar2 * -1f);
					...
					if (fVar2 > 0,5f)
					{
						if (fVar0 < fVar1)
						{
							...
							{
								unk_0xA6C03E3E2533F8F3();
								unk_0x79E39A06DE88EFE2(sParam2, 5, 8);
								func_187(*iParam0, 1);
								*uParam1 = 1;
							}
						}
						...
						{
							unk_0xA6C03E3E2533F8F3();
							unk_0x79E39A06DE88EFE2(sParam2, 6, 8);
							func_187(*iParam0, 1);
							*uParam1 = 2;
						}
					}
				}
				if (func_185(unk_0xFC1458A37D98B502(), vParam3, 1) > 120f)
				{
					func_190(iParam0);
				}
			}
...
void func_187(int iParam0, bool bParam1)//Position - 0xC568
{
	if (iParam0 == -1)
	{
		return;
...
int func_188(int iParam0)//Position - 0xC5A4
{
	if (Global_70852 == iParam0)
	{
		if (Global_70853 == -1)
...
void func_189(int iParam0, int iParam1)//Position - 0xC5DD
{
	bool bVar0;
	int iVar1;
...
void func_190(int iParam0)//Position - 0xC67B
{
	unk_0x7042DDDE71665936(0);
	unk_0xA6C03E3E2533F8F3();
	func_191(iParam0);
...
void func_191(int iParam0)//Position - 0xC692
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool func_192()//Position - 0xC77A
{
	return Global_90287;
}

void func_193(int iParam0)//Position - 0xC786
{
	if (iParam0 == -1)
	{
		iParam0 = func_161();
...
int func_194(var uParam0, bool bParam1)//Position - 0xC7AE
{
	struct<27> Var0;
...
void func_195(int iParam0, var uParam1, int iParam2)//Position - 0xCA21
{
	int iVar0;
	int iVar1;
...
int func_196(int iParam0)//Position - 0xCD79
{
...
int func_197(var uParam0)//Position - 0xCD99
{
...
int func_198(var uParam0)//Position - 0xCDB1
{
...
void func_199(var uParam0)//Position - 0xCDD6
{
	int iVar0;
	int iVar1;
...
void func_200(int iParam0)//Position - 0xD0DA
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
...
void func_201(var uParam0)//Position - 0xD105
{
	int iVar0;
...
int func_202(var uParam0, bool bParam1, bool bParam2)//Position - 0xD185
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_203(int iParam0, int iParam1)//Position - 0xD343
{
	int iVar0;
...
int func_204(var uParam0, bool bParam1, int iParam2)//Position - 0xD373
{
	int iVar0;
	int iVar1;
...
int func_205(int iParam0)//Position - 0xD62F
{
...
int func_206(int iParam0, float fParam1)//Position - 0xD663
{
	float fVar0;
...
bool func_207(int iParam0, float fParam1)//Position - 0xD6D9
{
	return func_208(iParam0, unk_0xFC1458A37D98B502(), fParam1, 1, 250, 7);
}

bool func_208(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD6F1
{
	var uVar0;
	vector3 vVar1;
	int iVar2;
...
int func_209(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xD7B2
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
Vector3 func_210(int iParam0, int iParam1)//Position - 0xD8DE
{
	int iVar0;
...
int func_212(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xD9ED
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
...
float func_213(vector3 vParam0, vector3 vParam1)//Position - 0xDA7E
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

Vector3 func_214(vector3 vParam0)//Position - 0xDA9F
{
	float fVar0;
	float fVar1;
...
void func_215(var uParam0)//Position - 0xDADE
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_216(int iParam0, int iParam1)//Position - 0xDAF9
{
	int iVar0;
...
int func_217(int iParam0)//Position - 0xDB38
{
...
int func_218(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xDB60
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_219(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xDC5B
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_220(int iParam0, float fParam1)//Position - 0xDD67
{
	var uVar0;
	vector3 vVar1;
...
int func_221(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0xDDFC
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
...
int func_222(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xDE8A
{
	if (bParam1)
	{
		if (unk_0x08765A6321A42CA1(unk_0xFC1458A37D98B502()))
...
int func_223(int iParam0)//Position - 0xDED2
{
...
void func_224(int iParam0)//Position - 0xDF1C
{
	int iVar0;
...
int func_225(int iParam0)//Position - 0xDFB9
{
	if (iParam0 == -1)
	{
		iParam0 = func_161();
...
int func_226(int iParam0)//Position - 0xE051
{
...
int func_229(int iParam0)//Position - 0xE0D3
{
...
int func_231(int iParam0)//Position - 0xE145
{
	if (func_105(0))
	{
...
int func_232(int iParam0)//Position - 0xE16D
{
	if (!func_233(iParam0))
	{
		return 0;
...
int func_233(var uParam0)//Position - 0xE18C
{
	int iVar0[3];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (((!func_236(&iVar0) || !unk_0x3A801AA34DD821BE("rcmlastone1")) || !unk_0x0A198E59F03B0E6F(joaat("weapon_pumpshotgun"))) || !unk_0x0A198E59F03B0E6F(joaat("weapon_sniperrifle")))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			bVar2 = true;
			uParam0->f_28[0] = unk_0xAC992EFAD62C33BF(25, iLocal_52, -1299,02f, 4639,86f, 106,66f, 345,7769f, 1, true);
			...
			if (!unk_0x6ADD12BF4D6D2587(uParam0->f_35[0]))
			{
				func_234(&(uParam0->f_35[0]), iVar0[1], -1303,163f, 4648,085f, 104,9664f, 293,1504f);
				if (unk_0x6ADD12BF4D6D2587(uParam0->f_35[0]))
				{
...
void func_234(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xE378
{
	func_235(iParam0);
...
void func_235(int iParam0)//Position - 0xE3BA
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
...
int func_236(int iParam0)//Position - 0xE456
{
	int iVar0;
...
int func_237(int iParam0)//Position - 0xE487
{
	struct<27> Var0;
	int iVar1;
...
int func_238(int iParam0)//Position - 0xE4DB
{
	char* sVar0;
...
int func_239(int iParam0)//Position - 0xE594
{
	var uVar0;
...
int func_240(int iParam0)//Position - 0xE655
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_241(int iParam0, char* sParam1)//Position - 0xE6DA
{
...
bool func_242(int iParam0)//Position - 0xE7BC
{
...
bool func_243(int iParam0)//Position - 0xE7EA
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_244(int iParam0)//Position - 0xE818
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_245(int iParam0)//Position - 0xE846
{
	if (func_226(iParam0))
	{
		return 0;
...
void func_246()//Position - 0xE87B
{
	func_264("Running end routines.");
	Global_104273 = (Global_104273 - 1);
}

int func_247(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xE895
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_248((*iParam0)[0], vParam2, fParam3, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_248((*iParam0)[iVar0], vParam2, fParam3, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_248(int iParam0, vector3 vParam1, float fParam2, var uParam3)//Position - 0xE8FA
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_249(Var1.f_6, vParam1, fParam2, 0))
	{
...
int func_249(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0xE978
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_250(int iParam0, bool bParam1)//Position - 0xE9F3
{
	if (bParam1)
	{
...
int func_251(var uParam0)//Position - 0xEA49
{
	if (func_198(uParam0))
	{
...
void func_252(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xEA7F
{
...
void func_253(var uParam0, bool bParam1)//Position - 0xEA9F
{
	func_254(&(uParam0->f_41), bParam1);
}

void func_254(var uParam0, bool bParam1)//Position - 0xEAB1
{
	int iVar0;
...
void func_255(int iParam0, bool bParam1)//Position - 0xEAEF
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
		if (unk_0x6049C20F5D5C185B(*iParam0))
...
void func_256(var uParam0, bool bParam1)//Position - 0xEB2A
{
	func_257(&(uParam0->f_35), bParam1);
}

void func_257(var uParam0, bool bParam1)//Position - 0xEB3C
{
	int iVar0;
...
void func_258(int iParam0)//Position - 0xEB79
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
...
void func_259(var uParam0, int iParam1)//Position - 0xEBB1
{
	func_260(&(uParam0->f_28), iParam1);
}

void func_260(var uParam0, int iParam1)//Position - 0xEBC3
{
	int iVar0;
...
void func_261(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xEC04
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
		if (!unk_0x3AB6A1A9084FB0A4(*iParam0))
...
void func_262(int iParam0)//Position - 0xEC54
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
		if (!unk_0x191BE1BC8F26F3C1(*iParam0, 0))
...
void func_263(var uParam0)//Position - 0xEC95
{
	if (*uParam0 == -1)
	{
		return;
...
void func_264(char* sParam0)//Position - 0xECD2
{
	if (!unk_0xAB019B170BF1309C(sParam0))
	{
	}
...
void func_265(var uParam0)//Position - 0xECE4
{
	*uParam0 = -1;
