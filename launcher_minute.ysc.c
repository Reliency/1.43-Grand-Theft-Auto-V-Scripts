...
void __EntryFunction__()//Position - 0x0
{
	...
	iLocal_52 = func_288(56);
	iLocal_53 = func_288(57);
	iLocal_54 = func_288(59);
	...
	if (!func_265(&iVar2, &Var0, vVar1, 1f))
	{
		func_264();
	...
	if (Var0 == 32)
	{
		unk_0x4C15495E88D71C61(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), false, 1);
		unk_0x2EB451A3616DA1F8(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), 0);
		unk_0x247EAA2E93D4A021(vVar1, 40f, 1, 0, 0, false);
	}
	else if (Var0 == 34)
	{
		iLocal_57 = func_240();
	...
	while (true)
	{
		...
		{
			func_204();
			if (func_203(Var0.f_35[1]))
			{
				if (!func_202(329,513f, 3402,691f, 36,258f, unk_0xB3328BA8976B416C(Var0.f_35[1], 1), 1056964608))
				{
					func_285("Player has moved SURFER2 vehicle [TERMINATING]");
					func_199(&Var0);
					func_268(&Var0, 1);
				}
			}
		...
		if (Var0 == 32)
		{
			func_187(&Var0, vVar1, "MIN1AUD", "MIN1_AMB", 3, "JOE", 4, "JOSEF", &uLocal_59);
		}
		else if (Var0 == 34)
		{
			func_182(&Var0, vVar1, "MIN3AUD", "MIN3_AMB", 3, "MANUEL", 5000, 1101004800);
		}
		if (func_168(&Var0, 0))
		{
			if (func_167(Var0))
			{
				func_164(Var0, &iLocal_58);
			}
			if (!func_2(&Var0))
			{
				func_268(&Var0, 1);
...
void func_4(int iParam0)//Position - 0x519
{
	int iVar0;
	int iVar1;
...
void func_6(int iParam0)//Position - 0x726
{
	switch (iParam0)
	{
		case 2:
...
void func_7(int iParam0)//Position - 0xB0E
{
	Global_55896 = 1;
	Global_55899 = 1;
	if (Global_67998 > 15)
...
struct<2> func_9(int iParam0)//Position - 0xB8D
{
	struct<2> Var0;
	char[] cVar1[8];
...
void func_13()//Position - 0xC7F
{
	Global_56062 = 0;
}

void func_14()//Position - 0xC8B
{
	Global_55922 = 0;
...
var func_15(int iParam0)//Position - 0xCDF
{
	var uVar0;
...
void func_17(int iParam0)//Position - 0xD1D
{
	Global_71116 = iParam0;
	Global_71117 = iParam0;
}

void func_18()//Position - 0xD31
{
	int iVar0;
...
void func_21(char* sParam0)//Position - 0xDD6
{
...
void func_22(char[4] cParam0, int iParam1)//Position - 0xDE9
{
	unk_0x0EE72DB1CD8A3B86(&(Global_92833.f_20), 17);
	func_23(cParam0, iParam1, 0);
}

void func_23(char[4] cParam0, int iParam1, int iParam2)//Position - 0xE06
{
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x1ADF
{
	int iVar0;
	int iVar1;
...
int func_26(var uParam0)//Position - 0x2967
{
...
void func_27(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2989
{
	int iVar0;
...
int func_28(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2A11
{
...
int func_29(int iParam0)//Position - 0x2A51
{
	int iVar0;
...
void func_30(var uParam0, int iParam1, int iParam2)//Position - 0x2A7F
{
...
int func_31(int iParam0)//Position - 0x2B5B
{
	int iVar0;
...
int func_32(int iParam0)//Position - 0x2B9D
{
	int iVar0;
...
int func_33(int iParam0, int iParam1, int iParam2)//Position - 0x2C00
{
	int iVar0;
...
int func_34(int iParam0, int iParam1)//Position - 0x2C8E
{
	struct<82> Var0;
...
void func_35(int iParam0, var uParam1, int iParam2)//Position - 0x2CD0
{
	int iVar0;
...
bool func_36(int iParam0)//Position - 0x2F2C
{
	return iParam0 < 3;
}

void func_37(int iParam0, var uParam1)//Position - 0x2F38
{
	int iVar0;
...
int func_38(int iParam0)//Position - 0x31E3
{
	switch (iParam0)
	{
		case 1:
...
int func_39(int iParam0, var uParam1, var uParam2)//Position - 0x3293
{
	int iVar0;
	int iVar1;
...
int func_40(int iParam0)//Position - 0x336D
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_41(var uParam0)//Position - 0x338D
{
	int iVar0;
...
int func_42(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x343E
{
	char* sVar0;
...
int func_43(int iParam0, int iParam1, bool bParam2)//Position - 0x356D
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_44(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x35DE
{
...
int func_45(int iParam0)//Position - 0x36B7
{
	int iVar0;
	int iVar1;
...
int func_46(int iParam0)//Position - 0x36F4
{
	if (func_36(iParam0))
	{
...
void func_47(int iParam0, var uParam1, int iParam2)//Position - 0x371E
{
	int iVar0;
	int iVar1;
...
int func_48(int iParam0, int iParam1, int iParam2)//Position - 0x38C8
{
	int iVar0;
	var uVar1;
...
int func_49(var uParam0)//Position - 0x38FA
{
	int iVar0;
	int iVar1;
...
int func_50()//Position - 0x392E
{
	return Global_1312736;
}

int func_51(int iParam0, int iParam1)//Position - 0x393A
{
	var uVar0;
	var uVar1;
...
void func_52(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x3966
{
	int iVar0;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3EAE
{
	int iVar0;
...
int func_54()//Position - 0x40F0
{
	func_55();
	return Global_104555.f_2353.f_539.f_4301;
}

void func_55()//Position - 0x4109
{
	int iVar0;
...
bool func_56(int iParam0)//Position - 0x4206
{
	return Global_35861 == iParam0;
}

void func_57(int iParam0, bool bParam1)//Position - 0x4214
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_58(int iParam0, var uParam1)//Position - 0x4307
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_59(int iParam0)//Position - 0x4591
{
	switch (iParam0)
	{
		case -1258515792:
...
int func_60(int iParam0)//Position - 0x462C
{
...
int func_61(int iParam0, int iParam1)//Position - 0x47A0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_62(int iParam0, var uParam1)//Position - 0x5311
{
	int iVar0;
	int iVar1;
...
int func_63(int iParam0)//Position - 0x534C
{
	int iVar0;
...
void func_64(int iParam0)//Position - 0x55C0
{
	int iVar0;
...
void func_65(var uParam0, int iParam1)//Position - 0x55FC
{
	int iVar0;
	vector3 vVar1;
	var uVar2;
...
int func_66(vector3 vParam0, char* sParam1, vector3 vParam2)//Position - 0x5B57
{
	int iVar0;
	int iVar1;
...
bool func_67(int iParam0, var uParam1, var uParam2)//Position - 0x5B9B
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_68(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x6252
{
	if (bParam2)
	{
...
int func_69(var uParam0)//Position - 0x6299
{
...
bool func_70(int iParam0)//Position - 0x62F4
{
	return func_71(iParam0, 0, 1);
}

int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x6304
{
	if (bParam2)
	{
...
int func_72(int iParam0)//Position - 0x6364
{
	switch (iParam0)
	{
		case 0:
...
int func_73()//Position - 0x6649
{
	return Global_25233;
}

int func_74(int iParam0)//Position - 0x6654
{
	return func_71(iParam0, 5, 1);
}

int func_75(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x6664
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0, bool bParam1)//Position - 0x6706
{
	switch (iParam0)
	{
		case -1:
...
int func_77(int iParam0)//Position - 0x6CA5
{
	if (iParam0 != func_86())
	{
...
Vector3 func_78(int iParam0, int iParam1)//Position - 0x6D03
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_79(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6DB1
{
	struct<4> Var0;
	vector3 vVar1;
	struct<4> Var2;
...
Vector3 func_80(vector3 vParam0, float fParam1)//Position - 0x6E46
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
struct<6> func_81(int iParam0)//Position - 0x6E8A
{
	struct<6> Var0;
...
struct<6> func_82(int iParam0)//Position - 0x700E
{
	return func_83(iParam0);
}

struct<6> func_83(int iParam0)//Position - 0x701C
{
	struct<6> Var0;
...
int func_84(int iParam0, var uParam1)//Position - 0x7AE3
{
	switch (iParam0)
	{
		case 0:
...
int func_85(int iParam0)//Position - 0x7B65
{
	if (iParam0 != func_86())
	{
...
int func_86()//Position - 0x7BC3
{
	return -1;
}

Vector3 func_87(int iParam0)//Position - 0x7BCC
{
	switch (iParam0)
	{
		case 1:
...
int func_88(int iParam0)//Position - 0x7D69
{
	return func_71(iParam0, 0, 0);
}

int func_89(int iParam0)//Position - 0x7D79
{
	switch (iParam0)
	{
		case -1:
...
bool func_90()//Position - 0x8007
{
	return Global_92885.f_315 > 0;
}

var func_91()//Position - 0x8018
{
	var uVar0;
...
void func_92(var uParam0, int iParam1)//Position - 0x805E
{
	if (iParam1 <= 0)
	{
		return;
...
void func_93(var uParam0, int iParam1)//Position - 0x80E4
{
...
void func_94(var uParam0, int iParam1)//Position - 0x8117
{
	int iVar0;
	int iVar1;
...
int func_95(int iParam0, int iParam1)//Position - 0x8168
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_96(int iParam0)//Position - 0x820A
{
	return (system::shift_right(iParam0, 26) & 31 * func_97(unk_0xC80D31E4B587871C(iParam0, 31), -1, 1)) + 2011;
}

int func_97(bool bParam0, int iParam1, int iParam2)//Position - 0x822F
{
	if (bParam0)
	{
		return iParam1;
...
int func_98(var uParam0)//Position - 0x8246
{
	return uParam0 & 15;
}

void func_99(var uParam0, int iParam1)//Position - 0x8253
{
...
void func_100(var uParam0, int iParam1)//Position - 0x828D
{
...
void func_101(var uParam0, int iParam1)//Position - 0x82C8
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_102()//Position - 0x8304
{
	func_55();
	return Global_104555.f_2353.f_539.f_4301;
}

void func_103(int iParam0)//Position - 0x831D
{
	var uVar0;
	vector3 vVar1[24];
...
void func_104(char* sParam0, int iParam1, int iParam2)//Position - 0x8376
{
...
bool func_105(bool bParam0)//Position - 0x83B8
{
...
struct<2> func_106(int iParam0)//Position - 0x83E3
{
	struct<2> Var0;
...
void func_107(int iParam0, var uParam1)//Position - 0x8830
{
	switch (iParam0)
	{
		case 0:
...
int func_109(int iParam0)//Position - 0x9B08
{
	switch (iParam0)
	{
		case 0:
...
int func_110(int iParam0)//Position - 0x9E4E
{
	int iVar0;
...
void func_111(int iParam0)//Position - 0x9EF2
{
	struct<2> Var0;
...
void func_112(int iParam0)//Position - 0x9F8D
{
	if (iParam0 < 63)
	{
		func_113();
...
void func_114(int iParam0)//Position - 0x9FEB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_115(int iParam0)//Position - 0xA044
{
...
int func_116(int iParam0)//Position - 0xA0C7
{
	int iVar0;
...
void func_117(int iParam0, int iParam1, int iParam2)//Position - 0xA0F8
{
	func_118(iParam0, iParam1, iParam2, 0, 0);
}

void func_118(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0xA10C
{
	int iVar0;
...
int func_120(int iParam0, int iParam1, int iParam2)//Position - 0xA1B4
{
...
int func_121(int iParam0, int iParam1, int iParam2)//Position - 0xA1CF
{
	int iVar0;
...
int func_122(int iParam0)//Position - 0xA21B
{
	int iVar0;
...
int func_123(int iParam0)//Position - 0xA264
{
	if (func_124(iParam0))
	{
		if (!unk_0x3AB6A1A9084FB0A4(iParam0))
...
int func_124(int iParam0)//Position - 0xA284
{
	if (unk_0x6ADD12BF4D6D2587(iParam0))
	{
...
int func_125(int iParam0)//Position - 0xA2A5
{
	switch (iParam0)
	{
		case 5:
...
int func_127(int iParam0)//Position - 0xA375
{
	switch (iParam0)
	{
		case 5:
...
void func_128(var uParam0, bool bParam1, bool bParam2)//Position - 0xA3C8
{
	int iVar0;
...
int func_129(int iParam0)//Position - 0xA4BD
{
	switch (iParam0)
	{
		case 5:
...
void func_130(bool bParam0)//Position - 0xA528
{
	int iVar0;
...
void func_131(bool bParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xA564
{
	if (bParam0)
	{
...
bool func_132()//Position - 0xA67D
{
	return unk_0xC80D31E4B587871C(Global_1595693[unk_0x9EB17624F44A8DA4() /*680*/].f_39.f_18, 14);
}

bool func_133(int iParam0, int iParam1)//Position - 0xA69A
{
	bool bVar0;
...
int func_134(int iParam0, bool bParam1)//Position - 0xA6E5
{
	int iVar0;
	int iVar1;
...
int func_135(int iParam0)//Position - 0xA726
{
...
bool func_136()//Position - 0xA768
{
	return unk_0xC80D31E4B587871C(Global_2359302, 3);
}

int func_137(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xA779
{
	int iVar0;
...
void func_139(int iParam0)//Position - 0xA7D3
{
	if (iParam0 == 1)
	{
...
int func_140(char* sParam0)//Position - 0xA7F6
{
...
void func_141()//Position - 0xA833
{
	Global_14622 = 0;
	func_142();
}

void func_142()//Position - 0xA843
{
...
int func_146(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xA929
{
...
void func_147(int iParam0)//Position - 0xAAB8
{
	if (!unk_0x191BE1BC8F26F3C1(iParam0, 0))
	{
...
void func_149(int iParam0)//Position - 0xAB35
{
...
void func_150(int iParam0)//Position - 0xAB5E
{
	if (Global_14615)
	{
		func_151(0, 0);
...
void func_151(bool bParam0, bool bParam1)//Position - 0xABCE
{
	if (bParam0)
	{
		if (func_152(0))
...
int func_152(int iParam0)//Position - 0xAC42
{
	if (iParam0 == 1)
	{
		if (Global_14453.f_1 > 3)
...
int func_153(int iParam0)//Position - 0xAC9C
{
...
int func_154(int iParam0)//Position - 0xACDD
{
	int iVar0;
...
void func_155(int iParam0)//Position - 0xAD22
{
...
int func_156(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xAD54
{
	int iVar0;
...
void func_157(var uParam0, int iParam1)//Position - 0xAE8B
{
	int iVar0;
...
bool func_158(int iParam0)//Position - 0xAEDA
{
	return func_159(iParam0, Global_35861);
}

int func_159(int iParam0, int iParam1)//Position - 0xAEEB
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_160(int iParam0)//Position - 0xB0CC
{
	if (Global_35861 == 15)
	{
		return 0;
...
int func_161()//Position - 0xB0EE
{
	return func_162(unk_0x436287B7DB306165(), 0);
}

int func_162(char* sParam0, int iParam1)//Position - 0xB0FF
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
void func_164(int iParam0, int iParam1)//Position - 0xB16C
{
	switch (iParam0)
	{
		case 0:
...
int func_165(vector3 vParam0, bool bParam1)//Position - 0xB5F3
{
	int iVar0;
...
float func_166(bool bParam0, float fParam1, float fParam2)//Position - 0xB61F
{
	if (bParam0)
	{
		return fParam1;
...
int func_167(int iParam0)//Position - 0xB636
{
	switch (iParam0)
	{
		case 0:
...
int func_168(int iParam0, int iParam1)//Position - 0xB6C5
{
	switch (iParam0->f_16)
	{
		case 0:
...
void func_169()//Position - 0xBEA8
{
	func_27(&(Global_95149.f_2875), &Global_95149, 0, 1, 1, 0);
}

int func_170(var uParam0)//Position - 0xBEC3
{
	float fVar0;
...
void func_171(int iParam0, int iParam1)//Position - 0xBF51
{
	if (iParam0 == 1)
	{
		if (!func_127(iParam1))
...
int func_172(bool bParam0)//Position - 0xBFB5
{
	int iVar0;
...
int func_173(int iParam0)//Position - 0xC04D
{
	int iVar0;
...
var func_174()//Position - 0xC76A
{
	return Global_92872.f_1;
}

int func_175()//Position - 0xC778
{
	if (Global_89900 != -1)
	{
...
bool func_178()//Position - 0xC7E2
{
	return Global_92885.f_316 > 0;
}

bool func_179(int iParam0, int iParam1)//Position - 0xC7F3
{
	switch (iParam0)
	{
		case 5:
...
var func_180()//Position - 0xC82E
{
	return Global_1312854;
}

int func_181()//Position - 0xC83A
{
	if (!unk_0x3A711520F83BAE98())
	{
...
int func_182(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xC856
{
	var uVar0;
	
	if ((((func_124(unk_0xFC1458A37D98B502()) && func_124(iParam0->f_28[0])) && !func_143()) && (unk_0x53C562FD2B9E3AB0() - iParam0->f_60) > iParam6) && func_186(unk_0xFC1458A37D98B502(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
...
void func_183(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC8DE
{
...
void func_184(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC919
{
...
void func_185(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xC96F
{
...
float func_186(int iParam0, vector3 vParam1, bool bParam2)//Position - 0xCA0A
{
	vector3 vVar0;
...
int func_187(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)//Position - 0xCA44
{
	var uVar0;
	...
	if (!*uParam8 == 3)
	{
		if (func_173(2))
		{
			if (!func_143())
			{
				if (((func_124(unk_0xFC1458A37D98B502()) && func_124(iParam0->f_28[0])) && func_124(iParam0->f_28[1])) && func_186(unk_0xFC1458A37D98B502(), vParam1, 1) < 20f)
				{
					func_285("start conversation");
					uVar0 = 16;
					if (*uParam8 == 0)
					{
						func_185(&uVar0, iParam4, iParam0->f_28[0], sParam5, 0, 1);
						func_185(&uVar0, iParam6, iParam0->f_28[1], sParam7, 0, 1);
						func_183(&uVar0, cParam2, sParam3, 7, 0, 0);
						*uParam8 = 2;
					}
					else if (*uParam8 == 2)
					{
						func_285("conversation ended");
						*uParam8 = 3;
						return 1;
					}
				}
			}
			else if (((func_189(sParam3) && !*uParam8 == 1) && func_124(unk_0xFC1458A37D98B502())) && func_186(unk_0xFC1458A37D98B502(), vParam1, 1) >= 20f)
			{
				func_285("pause conversation");
				func_188(1);
				*uParam8 = 1;
			}
			if (func_186(unk_0xFC1458A37D98B502(), vParam1, 1) < 20f && *uParam8 == 1)
			{
				func_285("unpause conversation");
				func_188(0);
				*uParam8 = 2;
			}
		}
...
void func_188(int iParam0)//Position - 0xCB8F
{
	Global_16767 = iParam0;
}

int func_189(char* sParam0)//Position - 0xCB9C
{
	struct<6> Var0;
...
struct<6> func_190()//Position - 0xCBBC
{
	struct<6> Var0;
...
void func_191(int iParam0, char* sParam1, vector3 vParam2)//Position - 0xCBE0
{
	if (unk_0x5BEF7A5AB8F17255(unk_0x9EB17624F44A8DA4()))
	{
		if (!unk_0xAB019B170BF1309C(sParam1))
		{
			...
			{
				if (func_186(unk_0xFC1458A37D98B502(), vParam2, 1) <= 100f)
				{
					func_194(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_186(unk_0xFC1458A37D98B502(), vParam2, 1) > 120f)
				{
					func_196(iParam0);
				}
			}
...
void func_192(int iParam0, bool bParam1)//Position - 0xCCD1
{
	if (iParam0 == -1)
	{
		return;
...
int func_193(int iParam0)//Position - 0xCD0D
{
	if (Global_70852 == iParam0)
	{
		if (Global_70853 == -1)
...
void func_194(int iParam0, int iParam1)//Position - 0xCD46
{
	bool bVar0;
	int iVar1;
...
bool func_195()//Position - 0xCDE4
{
	return Global_90287;
}

void func_196(int iParam0)//Position - 0xCDF0
{
	unk_0x7042DDDE71665936(0);
	unk_0xA6C03E3E2533F8F3();
	func_197(iParam0);
...
void func_197(int iParam0)//Position - 0xCE07
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_198(int iParam0)//Position - 0xCEEF
{
	if (iParam0 == -1)
	{
		iParam0 = func_161();
...
void func_199(var uParam0)//Position - 0xCF17
{
	int iVar0;
	int iVar1;
...
void func_200(int iParam0)//Position - 0xD21B
{
	int iVar0;
...
void func_201(int iParam0)//Position - 0xD2B8
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
...
int func_202(struct<2> Param0, float fParam1, struct<2> Param2, float fParam3, float fParam4)//Position - 0xD2E3
{
	if (fParam4 < 0f)
	{
		fParam4 = 0f;
...
int func_203(int iParam0)//Position - 0xD31C
{
	if (func_124(iParam0))
	{
		if (unk_0xB8DE76287EDC4957(iParam0, 0))
...
void func_204()//Position - 0xD346
{
	if (unk_0x8AD07B6FC24F47C4())
	{
		unk_0x7B9E2A8E7B7BA218("Joe", 1, 0, 0, 0);
		unk_0x7B9E2A8E7B7BA218("Josef", 0, 0, 0, 0);
		unk_0x7B9E2A8E7B7BA218("Josef", 1, 0, 0, 0);
	}
}

int func_205(var uParam0, bool bParam1)//Position - 0xD379
{
	struct<27> Var0;
...
void func_206(int iParam0, var uParam1, int iParam2)//Position - 0xD5EC
{
	int iVar0;
	int iVar1;
...
int func_207(int iParam0)//Position - 0xD944
{
...
int func_208(var uParam0)//Position - 0xD964
{
...
int func_209(var uParam0)//Position - 0xD97C
{
...
void func_210(var uParam0)//Position - 0xD9A1
{
	int iVar0;
...
int func_211(var uParam0, bool bParam1, bool bParam2)//Position - 0xDA21
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (unk_0x6ADD12BF4D6D2587(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_212(unk_0xFC1458A37D98B502(), uParam0->f_35[iVar0]))
							{
...
int func_212(int iParam0, int iParam1)//Position - 0xDBDF
{
	int iVar0;
...
int func_213(var uParam0, bool bParam1, int iParam2)//Position - 0xDC0F
{
	int iVar0;
	int iVar1;
...
int func_214(int iParam0)//Position - 0xDECB
{
...
int func_215(int iParam0, float fParam1)//Position - 0xDEFF
{
	float fVar0;
	
	if (func_124(unk_0xFC1458A37D98B502()) && func_124(iParam0))
	{
		if (func_226(iParam0) || unk_0x7B46BDDD99441E94(unk_0x9EB17624F44A8DA4(), iParam0))
		{
...
bool func_216(int iParam0, float fParam1)//Position - 0xDF75
{
	return func_217(iParam0, unk_0xFC1458A37D98B502(), fParam1, 1, 250, 7);
}

bool func_217(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xDF8D
{
	var uVar0;
	vector3 vVar1;
	int iVar2;
...
int func_218(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xE04E
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
Vector3 func_219(int iParam0, int iParam1)//Position - 0xE17A
{
	int iVar0;
	...
	{
		return unk_0xD0E00576168D19BB(iParam0, 63931/*func_268*/, 0f, 0f, 0f);
	}
	else if (iParam1 == 6)
	{
...
int func_221(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE289
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_223(unk_0xB3328BA8976B416C(iParam1, 1) - unk_0xB3328BA8976B416C(iParam0, 1)) };
	...
	{
		vVar1 = { func_223(unk_0xD0E00576168D19BB(iParam0, 31086, 0f, 5f, 0f) - unk_0xD0E00576168D19BB(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_222(vector3 vParam0, vector3 vParam1)//Position - 0xE31A
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

Vector3 func_223(vector3 vParam0)//Position - 0xE33B
{
	float fVar0;
	float fVar1;
...
void func_224(var uParam0)//Position - 0xE37A
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_225(int iParam0, int iParam1)//Position - 0xE395
{
	int iVar0;
...
int func_226(int iParam0)//Position - 0xE3D4
{
...
int func_227(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE3FC
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_228(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE4F7
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_229(int iParam0, float fParam1)//Position - 0xE603
{
	var uVar0;
	vector3 vVar1;
...
int func_230(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0xE698
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_223(vParam1 - unk_0xB3328BA8976B416C(iParam0, 1)) };
	if (fParam2 < 0,1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_231(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xE726
{
	if (bParam1)
	{
		if (unk_0x08765A6321A42CA1(unk_0xFC1458A37D98B502()))
...
int func_232(int iParam0)//Position - 0xE76E
{
...
int func_233(int iParam0)//Position - 0xE7B8
{
	if (iParam0 == -1)
	{
		iParam0 = func_161();
...
int func_234(int iParam0)//Position - 0xE850
{
...
int func_237(int iParam0)//Position - 0xE8D2
{
	if ((func_238() && Global_92833.f_11 == 6) && iParam0 == func_162(&(Global_92833.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_239(int iParam0)//Position - 0xE944
{
	if (func_105(0))
	{
...
int func_240()//Position - 0xE96C
{
	return unk_0xCB389937EDB1519A(-309,1f, 6205,4f, 30f, -279,33f, 6217,98f, 40f, 0, 1, 1, 1);
}

int func_241(int iParam0)//Position - 0xE99A
{
	switch (*iParam0)
	{
		case 32:
...
int func_242(var uParam0)//Position - 0xE9F8
{
	int iVar0[5];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_251(&(uParam0->f_48), "rcmminute3base", "base", "beckon");
		...
		case 2:
			...
			{
				func_248(&(uParam0->f_41[0]), iVar0[3], -303,74f, 6211,56f, 30,49f, -176,77f);
			...
			{
				if (func_245(&(uParam0->f_28[0]), 59, uParam0->f_48.f_5, -2,8f, "RCM MINUTE - MANUEL", 1))
				{
			...
			{
				func_243(&(uParam0->f_35[0]), iVar0[0], -281,93f, 6198,32f, 30,77f, -135,32f);
				unk_0x207466E78DA21033(uParam0->f_35[0], 1);
				unk_0x2E4932E63763FE26(iVar0[0], true);
			}
			if (!unk_0x6ADD12BF4D6D2587(uParam0->f_35[1]))
			{
				func_243(&(uParam0->f_35[1]), iVar0[1], -291,72f, 6208,33f, 30,87f, -134,5016f);
				unk_0x207466E78DA21033(uParam0->f_35[1], 0);
				unk_0x2E4932E63763FE26(iVar0[1], true);
			}
			if (!unk_0x6ADD12BF4D6D2587(uParam0->f_41[1]))
			{
				func_248(&(uParam0->f_41[1]), iVar0[4], -303,74f, 6211,56f, 30,49f, -176,77f);
				unk_0xA9D382E7BA095148(uParam0->f_41[1], uParam0->f_28[0], unk_0xDD09837E5235FE91(uParam0->f_28[0], 18905), 0,12f, 0f, 0,03f, 90f, 0f, 90f, 0, 0, 0, 0, 2, 1);
			}
			if (bVar2)
			{
				iLocal_51 = 3;
...
void func_243(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xED19
{
	func_244(iParam0);
...
void func_244(int iParam0)//Position - 0xED5B
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
...
int func_245(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)//Position - 0xEDF7
{
...
int func_246(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)//Position - 0xEE53
{
	int iVar0;
...
int func_247(var uParam0, int iParam1)//Position - 0xEEE1
{
	int iVar0;
...
void func_248(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xEF27
{
	func_201(iParam0);
...
int func_249(var uParam0)//Position - 0xEF4E
{
	if (func_209(uParam0))
	{
...
int func_250(int iParam0)//Position - 0xEF78
{
	int iVar0;
...
void func_251(var uParam0, char* sParam1, char* sParam2, char* sParam3)//Position - 0xEFA9
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
int func_252(var uParam0)//Position - 0xEFE5
{
	int iVar0[1];
	int iVar1;
	...
	switch (iLocal_51)
	{
		...
		case 2:
			func_243(&(uParam0->f_35[0]), iVar0[0], 20,8f, 4532,65f, 104,66f, 284,7f);
			if (unk_0x6ADD12BF4D6D2587(uParam0->f_35[0]))
			{
				unk_0x4BEFCD5DAE410A90(uParam0->f_35[0], 2);
				unk_0x6F861F183C9CF6FB(uParam0->f_35[0], 5, false);
				unk_0xF95D8D0BCEC9D59A(uParam0->f_35[0], 14f);
				unk_0x2E4932E63763FE26(iVar0[0], true);
			}
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
...
int func_253(var uParam0)//Position - 0xF0F8
{
	int iVar0[4];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			unk_0x6450931B826B49D9("rcmminute1");
			unk_0x247EAA2E93D4A021(321,69f, 3408,64f, 35,34f, 10f, 1, 0, 0, false);
			iLocal_51 = 1;
			break;
		
		case 1:
			unk_0x247EAA2E93D4A021(321,69f, 3408,64f, 35,34f, 10f, 1, 0, 0, false);
			if (!func_250(&iVar0) || !unk_0x3A801AA34DD821BE("rcmminute1"))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			if (!unk_0x6ADD12BF4D6D2587(uParam0->f_28[0]))
			{
				if (func_245(&(uParam0->f_28[0]), 56, 329,3f, 3404,2f, 35,8f, -174,9f, "RCM MINUTE - JOE", 1))
				{
			...
			{
				if (func_245(&(uParam0->f_28[1]), 57, 328,1f, 3403,8f, 35,8f, -149,6f, "RCM MINUTE - JOSEF", 1))
				{
			...
			if (!unk_0x6ADD12BF4D6D2587(uParam0->f_35[0]))
			{
				func_243(&(uParam0->f_35[0]), iVar0[0], 321,69f, 3408,64f, 35,34f, -105,8f);
				func_254(uParam0->f_35[0], iVar0[0]);
			}
			if (!unk_0x6ADD12BF4D6D2587(uParam0->f_35[1]))
			{
				func_243(&(uParam0->f_35[1]), iVar0[1], 329,49f, 3402,71f, 36,29f, 284,36f);
				func_254(uParam0->f_35[1], iVar0[1]);
				unk_0xCF5EB2CB1B30F02C(uParam0->f_35[1], 0);
			}
			if (bVar2)
			{
				iLocal_51 = 3;
		...
		case 3:
			if (unk_0x3A801AA34DD821BE("rcmminute1"))
			{
				if (func_124(uParam0->f_28[0]))
				{
					if (!unk_0xA5F6598E13F98E08(uParam0->f_28[0], "rcmminute1", "base_joe", 3))
					{
						unk_0xB8E08BD5B184DF4E(uParam0->f_28[0]);
						unk_0x12C9D41D52A560D6(uParam0->f_28[0], "rcmminute1", "base_joe", 8f, -8f, -1, 1, 0, 0, 0, 0);
				...
				if (func_124(uParam0->f_28[1]))
				{
					...
					unk_0x12C9D41D52A560D6(uParam0->f_28[1], "rcmminute1", "base_josef", 8f, -8f, -1, 1, 0, 0, 0, 0);
					unk_0xAE01EF4BC84AFE7C(uParam0->f_28[1], 185, true);
				}
			}
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
...
void func_254(int iParam0, int iParam1)//Position - 0xF419
{
	if (unk_0x6ADD12BF4D6D2587(iParam0))
	{
		unk_0x6862DF5504F63883(iParam0, 0);
...
int func_255(int iParam0)//Position - 0xF44F
{
	struct<27> Var0;
	int iVar1;
...
int func_256(int iParam0)//Position - 0xF4A3
{
	char* sVar0;
...
int func_257(int iParam0)//Position - 0xF55C
{
	var uVar0;
...
int func_258(int iParam0)//Position - 0xF61D
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_259(int iParam0, char* sParam1)//Position - 0xF6A2
{
...
bool func_260(int iParam0)//Position - 0xF784
{
...
bool func_261(int iParam0)//Position - 0xF7B2
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_262(int iParam0)//Position - 0xF7E0
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_263(int iParam0)//Position - 0xF80E
{
	if (func_234(iParam0))
	{
		return 0;
...
void func_264()//Position - 0xF843
{
	func_285("Running end routines.");
	Global_104273 = (Global_104273 - 1);
}

int func_265(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xF85D
{
	int iVar0;
...
int func_266(int iParam0, vector3 vParam1, float fParam2, var uParam3)//Position - 0xF8C2
{
	int iVar0;
	struct<7> Var1;
...
int func_267(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0xF940
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_268(int iParam0, bool bParam1)//Position - 0xF9BB
{
	char* sVar0;
	...
	if (*iParam0 == 32)
	{
		unk_0x4C15495E88D71C61(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), true, 1);
	}
	else if (*iParam0 == 34)
	{
		unk_0xCA107A9AAF17E75F(iLocal_57, 0);
	}
	func_272(&(iParam0->f_48));
	if (iLocal_56 != -1)
	{
...
void func_269(char* sParam0)//Position - 0xFAA8
{
	if (!unk_0xAB019B170BF1309C(sParam0))
	{
		if (func_189(sParam0))
...
void func_270()//Position - 0xFAC7
{
	Global_14622 = 0;
	func_271();
}

void func_271()//Position - 0xFAD7
{
	unk_0x495EB1DD7306493A();
	Global_16767 = 0;
	if (unk_0x42111BD51D233AAB())
...
int func_272(var uParam0)//Position - 0xFAF8
{
	if (func_209(uParam0))
	{
		if (unk_0x3A801AA34DD821BE(*uParam0))
...
void func_273(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xFB2E
{
...
void func_274(var uParam0, bool bParam1)//Position - 0xFB4E
{
	func_275(&(uParam0->f_41), bParam1);
}

void func_275(var uParam0, bool bParam1)//Position - 0xFB60
{
	int iVar0;
...
void func_276(int iParam0, bool bParam1)//Position - 0xFB9E
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
		if (unk_0x6049C20F5D5C185B(*iParam0))
...
void func_277(var uParam0, bool bParam1)//Position - 0xFBD9
{
	func_278(&(uParam0->f_35), bParam1);
}

void func_278(var uParam0, bool bParam1)//Position - 0xFBEB
{
	int iVar0;
...
void func_279(int iParam0)//Position - 0xFC28
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
...
void func_280(var uParam0, int iParam1)//Position - 0xFC60
{
	func_281(&(uParam0->f_28), iParam1);
}

void func_281(var uParam0, int iParam1)//Position - 0xFC72
{
	int iVar0;
...
void func_282(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xFCB3
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
		if (!unk_0x3AB6A1A9084FB0A4(*iParam0))
...
void func_283(int iParam0)//Position - 0xFD03
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
		if (!unk_0x191BE1BC8F26F3C1(*iParam0, 0))
...
void func_284(var uParam0)//Position - 0xFD44
{
	if (*uParam0 == -1)
	{
		return;
...
void func_285(char* sParam0)//Position - 0xFD81
{
	if (!unk_0xAB019B170BF1309C(sParam0))
	{
	}
...
void func_286(var uParam0)//Position - 0xFD93
{
	*uParam0 = -1;
...
void func_287()//Position - 0xFDC6
{
	func_285("Running start routines.");
	Global_104273++;
}

int func_288(int iParam0)//Position - 0xFDE0
{
	if (!func_36(iParam0))
	{
		return Global_104555.f_28020[iParam0 /*29*/];
