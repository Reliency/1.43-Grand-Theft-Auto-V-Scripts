...
void __EntryFunction__()//Position - 0x0
{
	...
	func_24(vVar0);
	bLocal_4 = func_4();
	vLocal_5 = { unk_0xB3328BA8976B416C(unk_0xFC1458A37D98B502(), 0) };
	func_1();
	while (true)
	{
		system::wait(0);
	...
	while (iVar0 < 20)
	{
		if (func_3(iVar0, &iVar1, &vVar2, &vVar3, &iVar5))
		{
			if (func_2(vVar3, 0f, 0f, 0f, 0))
			{
				...
				unk_0x872F1C1F8587CCC7(&iVar4, 4);
				unk_0x872F1C1F8587CCC7(&iVar4, 3);
				if (iVar1 == joaat("pickup_money_case"))
				{
					if (bLocal_4)
					{
						iLocal_3[iVar0] = unk_0x06583789B8C15A6C(iVar1, vVar2, iVar4, iVar5, 1, 0);
					}
				}
				else if (system::vdist2(vVar2, vLocal_5) > 400f)
				{
					...
					else if ((iVar1 == joaat("pickup_weapon_grenadelauncher") || iVar1 == joaat("pickup_weapon_rpg")) || iVar1 == joaat("pickup_weapon_mg"))
					{
						if (bLocal_4)
						{
							iLocal_3[iVar0] = unk_0x06583789B8C15A6C(iVar1, vVar2, iVar4, -1, 1, 0);
						}
					}
					else
					{
			...
			else
			{
				...
				if (iVar1 == joaat("pickup_money_case"))
				{
					if (bLocal_4)
					{
						iLocal_3[iVar0] = unk_0x85CE54AA667066FE(iVar1, vVar2, vVar3, iVar4, 10000, 2, 1, 0);
					}
				}
				else if (system::vdist2(vVar2, vLocal_5) > 400f)
				{
					if (iVar1 == joaat("pickup_armour_standard"))
					{
						iLocal_3[iVar0] = unk_0x85CE54AA667066FE(iVar1, vVar2, vVar3, iVar4, -1, 2, 1, 0);
					}
					else if ((iVar1 == joaat("pickup_weapon_grenadelauncher") || iVar1 == joaat("pickup_weapon_rpg")) || iVar1 == joaat("pickup_weapon_mg"))
					{
						if (bLocal_4)
...
{
	return (system::shift_right(iParam0, 26) & 31 * func_12(unk_0xC80D31E4B587871C(iParam0, 31), -1, 1)) + 2011;
}
...
void func_27()//Position - 0x20E1
{
	...
	while (iVar0 < 20)
	{
		if (unk_0xB8B3E5529EDB87D4(iLocal_3[iVar0]))
		{
			unk_0x60727D07B2D72C82(iLocal_3[iVar0]);
		}
		iVar0++;
	}
}
