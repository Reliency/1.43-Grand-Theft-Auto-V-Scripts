...
void __EntryFunction__()//Position - 0x0
{
	...
	if (unk_0x7D9C4B359376D38A(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_103642[Var0 /*10*/].f_9 != -1)
			{
				...
				func_266(&(Global_103642[Var0 /*10*/].f_9));
			}
		}
		func_254(&Var0, 1);
	}
	iVar2[0] = 24;
	if (!func_251(&iVar2, &Var0, vVar1, 1f))
	{
		func_250();
	...
	iLocal_54 = unk_0xCB389937EDB1519A(-103,0011f, -1281,636f, 26,3686f, -23,246f, -1241,361f, 30,335f, 0, 1, 1, 1);
	...
	while (true)
	{
		...
		func_190(Var0);
		func_183(&iLocal_53, &(Var0.f_9), vVar1);
		func_178(&Var0, vVar1, "HAO1AU", "HAO1_HCO", 3, "HAO", 5000, 1101004800);
		if (func_164(&Var0, 0))
		{
			if (!func_2(&Var0))
			{
...
int func_2(int iParam0)//Position - 0x2E7
{
	struct<4> Var0;
	char* sVar1;
...
void func_4(int iParam0)//Position - 0x469
{
	int iVar0;
	int iVar1;
...
void func_6(int iParam0)//Position - 0x676
{
	switch (iParam0)
	{
		case 2:
...
void func_7(int iParam0)//Position - 0xA5E
{
	Global_55896 = 1;
	Global_55899 = 1;
	if (Global_67998 > 15)
...
void func_8(int iParam0)//Position - 0xAA9
{
...
struct<2> func_9(int iParam0)//Position - 0xADD
{
	struct<2> Var0;
	char[] cVar1[8];
...
void func_13()//Position - 0xBCF
{
	Global_56062 = 0;
}

void func_14()//Position - 0xBDB
{
	Global_55922 = 0;
...
var func_15(int iParam0)//Position - 0xC2F
{
	var uVar0;
...
void func_17(int iParam0)//Position - 0xC6D
{
	Global_71116 = iParam0;
	Global_71117 = iParam0;
}

void func_18()//Position - 0xC81
{
	int iVar0;
...
void func_21(char* sParam0)//Position - 0xD26
{
...
void func_22(char[4] cParam0, int iParam1)//Position - 0xD39
{
	unk_0x0EE72DB1CD8A3B86(&(Global_92833.f_20), 17);
	func_23(cParam0, iParam1, 0);
}

void func_23(char[4] cParam0, int iParam1, int iParam2)//Position - 0xD56
{
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x1A2F
{
	int iVar0;
	int iVar1;
...
int func_26(var uParam0)//Position - 0x28B7
{
...
void func_27(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x28D9
{
	int iVar0;
...
int func_28(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2961
{
...
int func_29(int iParam0)//Position - 0x29A1
{
	int iVar0;
...
void func_30(var uParam0, int iParam1, int iParam2)//Position - 0x29CF
{
...
int func_31(int iParam0)//Position - 0x2AAB
{
	int iVar0;
...
int func_32(int iParam0)//Position - 0x2AED
{
	int iVar0;
...
int func_33(int iParam0, int iParam1, int iParam2)//Position - 0x2B50
{
	int iVar0;
...
int func_34(int iParam0, int iParam1)//Position - 0x2BDE
{
	struct<82> Var0;
...
void func_35(int iParam0, var uParam1, int iParam2)//Position - 0x2C20
{
	int iVar0;
...
bool func_36(int iParam0)//Position - 0x2E7C
{
	return iParam0 < 3;
}

void func_37(int iParam0, var uParam1)//Position - 0x2E88
{
	int iVar0;
...
int func_38(int iParam0)//Position - 0x3133
{
	switch (iParam0)
	{
		case 1:
...
int func_39(int iParam0, var uParam1, var uParam2)//Position - 0x31E3
{
	int iVar0;
	int iVar1;
...
int func_40(int iParam0)//Position - 0x32BD
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_41(var uParam0)//Position - 0x32DD
{
	int iVar0;
...
int func_42(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x338E
{
	char* sVar0;
...
int func_43(int iParam0, int iParam1, bool bParam2)//Position - 0x34BD
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_44(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x352E
{
...
int func_45(int iParam0)//Position - 0x3607
{
	int iVar0;
	int iVar1;
...
int func_46(int iParam0)//Position - 0x3644
{
	if (func_36(iParam0))
	{
...
void func_47(int iParam0, var uParam1, int iParam2)//Position - 0x366E
{
	int iVar0;
	int iVar1;
...
int func_48(int iParam0, int iParam1, int iParam2)//Position - 0x3818
{
	int iVar0;
	var uVar1;
...
int func_49(var uParam0)//Position - 0x384A
{
	int iVar0;
	int iVar1;
...
int func_50()//Position - 0x387E
{
	return Global_1312736;
}

int func_51(int iParam0, int iParam1)//Position - 0x388A
{
	var uVar0;
	var uVar1;
...
void func_52(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x38B6
{
	int iVar0;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3DFE
{
	int iVar0;
...
int func_54()//Position - 0x4040
{
	func_55();
	return Global_104555.f_2353.f_539.f_4301;
}

void func_55()//Position - 0x4059
{
	int iVar0;
...
bool func_56(int iParam0)//Position - 0x4156
{
	return Global_35861 == iParam0;
}

void func_57(int iParam0, bool bParam1)//Position - 0x4164
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_58(int iParam0, var uParam1)//Position - 0x4257
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_59(int iParam0)//Position - 0x44E1
{
	switch (iParam0)
	{
		case -1258515792:
...
int func_60(int iParam0)//Position - 0x457C
{
...
int func_61(int iParam0, int iParam1)//Position - 0x46F0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_62(int iParam0, var uParam1)//Position - 0x5261
{
	int iVar0;
	int iVar1;
...
int func_63(int iParam0)//Position - 0x529C
{
	int iVar0;
...
void func_64(int iParam0)//Position - 0x5510
{
	int iVar0;
...
void func_65(var uParam0, int iParam1)//Position - 0x554C
{
	int iVar0;
	vector3 vVar1;
	var uVar2;
...
int func_66(vector3 vParam0, char* sParam1, vector3 vParam2)//Position - 0x5AA7
{
	int iVar0;
	int iVar1;
...
bool func_67(int iParam0, var uParam1, var uParam2)//Position - 0x5AEB
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_68(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x61A2
{
	if (bParam2)
	{
...
int func_69(var uParam0)//Position - 0x61E9
{
...
bool func_70(int iParam0)//Position - 0x6244
{
	return func_71(iParam0, 0, 1);
}

int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x6254
{
	if (bParam2)
	{
...
int func_72(int iParam0)//Position - 0x62B4
{
	switch (iParam0)
	{
		case 0:
...
int func_73()//Position - 0x6599
{
	return Global_25233;
}

int func_74(int iParam0)//Position - 0x65A4
{
	return func_71(iParam0, 5, 1);
}

int func_75(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x65B4
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0, bool bParam1)//Position - 0x6656
{
	switch (iParam0)
	{
		case -1:
...
int func_77(int iParam0)//Position - 0x6BF5
{
	if (iParam0 != func_86())
	{
...
Vector3 func_78(int iParam0, int iParam1)//Position - 0x6C53
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_79(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6D01
{
	struct<4> Var0;
	vector3 vVar1;
	struct<4> Var2;
...
Vector3 func_80(vector3 vParam0, float fParam1)//Position - 0x6D96
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
struct<6> func_81(int iParam0)//Position - 0x6DDA
{
	struct<6> Var0;
...
struct<6> func_82(int iParam0)//Position - 0x6F5E
{
	return func_83(iParam0);
}

struct<6> func_83(int iParam0)//Position - 0x6F6C
{
	struct<6> Var0;
...
int func_84(int iParam0, var uParam1)//Position - 0x7A33
{
	switch (iParam0)
	{
		case 0:
...
int func_85(int iParam0)//Position - 0x7AB5
{
	if (iParam0 != func_86())
	{
...
int func_86()//Position - 0x7B13
{
	return -1;
}

Vector3 func_87(int iParam0)//Position - 0x7B1C
{
	switch (iParam0)
	{
		case 1:
...
int func_88(int iParam0)//Position - 0x7CB9
{
	return func_71(iParam0, 0, 0);
}

int func_89(int iParam0)//Position - 0x7CC9
{
	switch (iParam0)
	{
		case -1:
...
bool func_90()//Position - 0x7F56
{
	return Global_92885.f_315 > 0;
}

var func_91()//Position - 0x7F67
{
	var uVar0;
...
void func_92(var uParam0, int iParam1)//Position - 0x7FAD
{
	if (iParam1 <= 0)
	{
		return;
...
void func_93(var uParam0, int iParam1)//Position - 0x8035
{
...
void func_94(var uParam0, int iParam1)//Position - 0x8068
{
	int iVar0;
	int iVar1;
...
int func_95(int iParam0, int iParam1)//Position - 0x80B9
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_96(int iParam0)//Position - 0x815B
{
	return (system::shift_right(iParam0, 26) & 31 * func_97(unk_0xC80D31E4B587871C(iParam0, 31), -1, 1)) + 2011;
}

int func_97(bool bParam0, int iParam1, int iParam2)//Position - 0x8180
{
	if (bParam0)
	{
		return iParam1;
...
int func_98(var uParam0)//Position - 0x8197
{
	return uParam0 & 15;
}

void func_99(var uParam0, int iParam1)//Position - 0x81A4
{
...
void func_100(var uParam0, int iParam1)//Position - 0x81DE
{
...
void func_101(var uParam0, int iParam1)//Position - 0x8219
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_102()//Position - 0x8255
{
	func_55();
	return Global_104555.f_2353.f_539.f_4301;
}

void func_103(int iParam0)//Position - 0x826E
{
	var uVar0;
	vector3 vVar1[24];
...
void func_104(char* sParam0, int iParam1, int iParam2)//Position - 0x82C7
{
...
bool func_105(bool bParam0)//Position - 0x8309
{
...
struct<2> func_106(int iParam0)//Position - 0x8334
{
	struct<2> Var0;
...
void func_107(int iParam0, var uParam1)//Position - 0x8781
{
	switch (iParam0)
	{
		case 0:
...
int func_109(int iParam0)//Position - 0x9A59
{
	switch (iParam0)
	{
		case 0:
...
int func_110(int iParam0)//Position - 0x9D9F
{
	int iVar0;
...
void func_111(int iParam0)//Position - 0x9E43
{
	struct<2> Var0;
...
void func_112(int iParam0)//Position - 0x9EDE
{
	if (iParam0 < 63)
	{
		func_113();
...
void func_114(int iParam0)//Position - 0x9F3C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_115(int iParam0)//Position - 0x9F95
{
...
int func_116(int iParam0)//Position - 0xA018
{
	int iVar0;
...
void func_117(int iParam0, int iParam1, int iParam2)//Position - 0xA049
{
	func_118(iParam0, iParam1, iParam2, 0, 0);
}

void func_118(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0xA05D
{
	int iVar0;
...
int func_120(int iParam0, int iParam1, int iParam2)//Position - 0xA105
{
...
int func_121(int iParam0, int iParam1, int iParam2)//Position - 0xA120
{
	int iVar0;
...
int func_122(int iParam0)//Position - 0xA16C
{
	int iVar0;
...
int func_123(int iParam0)//Position - 0xA1B5
{
	if (func_124(iParam0))
	{
		if (!unk_0x3AB6A1A9084FB0A4(iParam0))
...
int func_124(int iParam0)//Position - 0xA1D5
{
	if (unk_0x6ADD12BF4D6D2587(iParam0))
	{
...
int func_125(int iParam0)//Position - 0xA1F6
{
	switch (iParam0)
	{
		case 5:
...
int func_127(int iParam0)//Position - 0xA2C6
{
	switch (iParam0)
	{
		case 5:
...
void func_128(var uParam0, bool bParam1, bool bParam2)//Position - 0xA319
{
	int iVar0;
...
int func_129(int iParam0)//Position - 0xA40E
{
	switch (iParam0)
	{
		case 5:
...
void func_130(bool bParam0)//Position - 0xA479
{
	int iVar0;
...
void func_131(bool bParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xA4B5
{
	if (bParam0)
	{
...
bool func_132()//Position - 0xA5CE
{
	return unk_0xC80D31E4B587871C(Global_1595693[unk_0x9EB17624F44A8DA4() /*680*/].f_39.f_18, 14);
}

bool func_133(int iParam0, int iParam1)//Position - 0xA5EB
{
	bool bVar0;
...
int func_134(int iParam0, bool bParam1)//Position - 0xA636
{
	int iVar0;
	int iVar1;
...
int func_135(int iParam0)//Position - 0xA677
{
...
bool func_136()//Position - 0xA6B9
{
	return unk_0xC80D31E4B587871C(Global_2359302, 3);
}

int func_137(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xA6CA
{
	int iVar0;
...
void func_139(int iParam0)//Position - 0xA724
{
	if (iParam0 == 1)
	{
...
int func_140(char* sParam0)//Position - 0xA747
{
...
void func_141()//Position - 0xA784
{
	Global_14622 = 0;
	func_142();
}

void func_142()//Position - 0xA794
{
...
int func_146(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xA87A
{
...
void func_147(int iParam0)//Position - 0xAA09
{
	if (!unk_0x191BE1BC8F26F3C1(iParam0, 0))
	{
...
void func_149(int iParam0)//Position - 0xAA86
{
...
void func_150(int iParam0)//Position - 0xAAAF
{
	if (Global_14615)
	{
		func_151(0, 0);
...
void func_151(bool bParam0, bool bParam1)//Position - 0xAB1F
{
	if (bParam0)
	{
		if (func_152(0))
...
int func_152(int iParam0)//Position - 0xAB93
{
	if (iParam0 == 1)
	{
		if (Global_14453.f_1 > 3)
...
int func_153(int iParam0)//Position - 0xABED
{
...
int func_154(int iParam0)//Position - 0xAC2E
{
	int iVar0;
...
void func_155(int iParam0)//Position - 0xAC73
{
...
int func_156(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xACA5
{
	int iVar0;
...
void func_157(var uParam0, int iParam1)//Position - 0xADDC
{
	int iVar0;
...
bool func_158(int iParam0)//Position - 0xAE2B
{
	return func_159(iParam0, Global_35861);
}

int func_159(int iParam0, int iParam1)//Position - 0xAE3C
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_160(int iParam0)//Position - 0xB01D
{
	if (Global_35861 == 15)
	{
		return 0;
...
int func_161()//Position - 0xB03F
{
	return func_162(unk_0x436287B7DB306165(), 0);
}

int func_162(char* sParam0, int iParam1)//Position - 0xB050
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_164(var uParam0, int iParam1)//Position - 0xB0BD
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_165()//Position - 0xB8A0
{
	func_27(&(Global_95149.f_2875), &Global_95149, 0, 1, 1, 0);
}

int func_166(var uParam0)//Position - 0xB8BB
{
	float fVar0;
...
void func_167(int iParam0, int iParam1)//Position - 0xB949
{
	if (iParam0 == 1)
	{
		if (!func_127(iParam1))
...
int func_168(bool bParam0)//Position - 0xB9AD
{
	int iVar0;
...
int func_169(int iParam0)//Position - 0xBA44
{
	int iVar0;
...
var func_170()//Position - 0xC162
{
	return Global_92872.f_1;
}

int func_171()//Position - 0xC170
{
	if (Global_89900 != -1)
	{
...
bool func_174()//Position - 0xC1DA
{
	return Global_92885.f_316 > 0;
}

bool func_175(int iParam0, int iParam1)//Position - 0xC1EB
{
	switch (iParam0)
	{
		case 5:
...
var func_176()//Position - 0xC226
{
	return Global_1312854;
}

int func_177()//Position - 0xC232
{
	if (!unk_0x3A711520F83BAE98())
	{
...
int func_178(var uParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xC24E
{
	var uVar0;
	
	if ((((func_124(unk_0xFC1458A37D98B502()) && func_124(uParam0->f_28[0])) && !func_143()) && (unk_0x53C562FD2B9E3AB0() - uParam0->f_60) > iParam6) && func_182(unk_0xFC1458A37D98B502(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
		func_181(&uVar0, iParam4, uParam0->f_28[0], sParam5, 0, 1);
		func_179(&uVar0, cParam2, sParam3, 7, 0, 0);
...
void func_179(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC2D6
{
...
void func_180(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC311
{
...
void func_181(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xC367
{
...
float func_182(int iParam0, vector3 vParam1, bool bParam2)//Position - 0xC402
{
	vector3 vVar0;
...
void func_183(int iParam0, char* sParam1, vector3 vParam2)//Position - 0xC43C
{
	if (unk_0x5BEF7A5AB8F17255(unk_0x9EB17624F44A8DA4()))
	{
		if (!unk_0xAB019B170BF1309C(sParam1))
		{
			...
			{
				if (func_182(unk_0xFC1458A37D98B502(), vParam2, 1) <= 100f)
				{
					func_186(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_182(unk_0xFC1458A37D98B502(), vParam2, 1) > 120f)
				{
					func_188(iParam0);
				}
			}
...
void func_184(int iParam0, bool bParam1)//Position - 0xC52D
{
	if (iParam0 == -1)
	{
		return;
...
int func_185(int iParam0)//Position - 0xC569
{
	if (Global_70852 == iParam0)
	{
		if (Global_70853 == -1)
...
void func_186(int iParam0, int iParam1)//Position - 0xC5A2
{
	bool bVar0;
	int iVar1;
...
bool func_187()//Position - 0xC640
{
	return Global_90287;
}

void func_188(int iParam0)//Position - 0xC64C
{
	unk_0x7042DDDE71665936(0);
	unk_0xA6C03E3E2533F8F3();
	func_189(iParam0);
...
void func_189(int iParam0)//Position - 0xC663
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_190(int iParam0)//Position - 0xC74B
{
	if (iParam0 == -1)
	{
		iParam0 = func_161();
...
void func_191(var uParam0)//Position - 0xC773
{
	int iVar0;
	int iVar1;
...
void func_192(int iParam0)//Position - 0xCA77
{
	int iVar0;
...
void func_193(int iParam0)//Position - 0xCB14
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
...
int func_194(struct<2> Param0, float fParam1, struct<2> Param2, float fParam3, float fParam4)//Position - 0xCB3F
{
	if (fParam4 < 0f)
	{
		fParam4 = 0f;
...
int func_195(int iParam0)//Position - 0xCB78
{
	if (func_124(iParam0))
	{
		if (unk_0xB8DE76287EDC4957(iParam0, 0))
...
int func_196(var uParam0, bool bParam1)//Position - 0xCBA2
{
	struct<27> Var0;
...
void func_197(int iParam0, var uParam1, int iParam2)//Position - 0xCE15
{
	int iVar0;
	int iVar1;
...
int func_198(int iParam0)//Position - 0xD16D
{
...
int func_199(var uParam0)//Position - 0xD18D
{
...
int func_200(var uParam0)//Position - 0xD1A5
{
...
void func_201(var uParam0)//Position - 0xD1CA
{
	int iVar0;
...
int func_202(var uParam0, bool bParam1, bool bParam2)//Position - 0xD24A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_203(int iParam0, int iParam1)//Position - 0xD408
{
	int iVar0;
...
int func_204(var uParam0, bool bParam1, int iParam2)//Position - 0xD438
{
	int iVar0;
	int iVar1;
...
int func_205(int iParam0)//Position - 0xD6F4
{
...
int func_206(int iParam0, float fParam1)//Position - 0xD728
{
	float fVar0;
...
bool func_207(int iParam0, float fParam1)//Position - 0xD79E
{
	return func_208(iParam0, unk_0xFC1458A37D98B502(), fParam1, 1, 250, 7);
}

bool func_208(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD7B6
{
	var uVar0;
	vector3 vVar1;
	int iVar2;
...
int func_209(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xD877
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
Vector3 func_210(int iParam0, int iParam1)//Position - 0xD9A3
{
	int iVar0;
...
int func_212(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xDAB2
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
...
float func_213(vector3 vParam0, vector3 vParam1)//Position - 0xDB43
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

Vector3 func_214(vector3 vParam0)//Position - 0xDB64
{
	float fVar0;
	float fVar1;
...
void func_215(var uParam0)//Position - 0xDBA3
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_216(int iParam0, int iParam1)//Position - 0xDBBE
{
	int iVar0;
...
int func_217(int iParam0)//Position - 0xDBFD
{
...
int func_218(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xDC25
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_219(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xDD20
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_220(int iParam0, float fParam1)//Position - 0xDE2C
{
	var uVar0;
	vector3 vVar1;
...
int func_221(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0xDEC1
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
...
int func_222(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xDF4F
{
	if (bParam1)
	{
		if (unk_0x08765A6321A42CA1(unk_0xFC1458A37D98B502()))
...
int func_223(int iParam0)//Position - 0xDF97
{
...
int func_224(int iParam0)//Position - 0xDFE1
{
	if (iParam0 == -1)
	{
		iParam0 = func_161();
...
int func_225(int iParam0)//Position - 0xE079
{
...
int func_228(int iParam0)//Position - 0xE0FB
{
...
int func_230(int iParam0)//Position - 0xE16D
{
	if (func_105(0))
	{
...
int func_232(var uParam0)//Position - 0xE1B4
{
	int iVar0[4];
	int iVar1;
	int iVar2;
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_239(&iVar0) || !unk_0x3A801AA34DD821BE(sVar3))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			if (!unk_0x6ADD12BF4D6D2587(uParam0->f_35[0]))
			{
				...
				unk_0xA9EF3F93CBFFF6D0(uParam0->f_35[0], 0, 2, false);
				unk_0xA9EF3F93CBFFF6D0(uParam0->f_35[0], 1, 1, false);
				unk_0xA9EF3F93CBFFF6D0(uParam0->f_35[0], 2, 1, false);
				unk_0xA9EF3F93CBFFF6D0(uParam0->f_35[0], 3, 1, false);
				unk_0xA9EF3F93CBFFF6D0(uParam0->f_35[0], 4, 1, false);
				unk_0xA9EF3F93CBFFF6D0(uParam0->f_35[0], 6, 0, false);
				unk_0xA9EF3F93CBFFF6D0(uParam0->f_35[0], 7, 2, false);
				unk_0xA9EF3F93CBFFF6D0(uParam0->f_35[0], 10, 0, false);
				unk_0xA9EF3F93CBFFF6D0(uParam0->f_35[0], 23, 20, false);
				unk_0x4705D420368126DF(uParam0->f_35[0], 18, true);
				unk_0x4705D420368126DF(uParam0->f_35[0], 17, true);
				unk_0x4705D420368126DF(uParam0->f_35[0], 22, true);
		...
		case 3:
			...
			{
				iVar5 = unk_0xD323488FDDE4A80F(uParam0->f_35[0], "chassis_dummy");
				vVar6 = { unk_0xDCD8BDD2E10C660E(uParam0->f_35[0], iVar5) };
				iVar2 = unk_0x8383F9C605E523B7(vVar6, unk_0xDB824D597B53CC40(uParam0->f_35[0], 2), 2);
				unk_0xD0E12C501EE26329(iVar2, true);
				unk_0x7122D672EBE0EA6E(iVar2, false);
				unk_0x8E628F774C748D93(uParam0->f_28[0], iVar2, sVar3, "hao_base", 8f, -8f, 9, 16, 1148846080, 0);
...
void func_233(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xE61D
{
	func_193(iParam0);
...
void func_234(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xE644
{
	func_235(iParam0);
...
void func_235(int iParam0)//Position - 0xE686
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
...
int func_236(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)//Position - 0xE722
{
	if (func_237(iParam0, iParam1, vParam2, fParam3, 1))
	{
		if (unk_0x6ADD12BF4D6D2587(*iParam0))
		{
			if (!unk_0x191BE1BC8F26F3C1(*iParam0, 0))
...
int func_237(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)//Position - 0xE77E
{
	int iVar0;
...
int func_238(var uParam0, int iParam1)//Position - 0xE80C
{
	int iVar0;
...
int func_239(int iParam0)//Position - 0xE852
{
	int iVar0;
...
int func_240(int iParam0)//Position - 0xE883
{
	int iVar0;
...
int func_241(int iParam0)//Position - 0xE8EB
{
	struct<27> Var0;
	int iVar1;
...
int func_242(int iParam0)//Position - 0xE93F
{
	char* sVar0;
...
int func_243(int iParam0)//Position - 0xE9F8
{
	var uVar0;
...
int func_244(int iParam0)//Position - 0xEAB9
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_245(int iParam0, char* sParam1)//Position - 0xEB3E
{
...
bool func_246(int iParam0)//Position - 0xEC20
{
...
bool func_247(int iParam0)//Position - 0xEC4E
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_248(int iParam0)//Position - 0xEC7C
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_249(int iParam0)//Position - 0xECAA
{
	if (func_225(iParam0))
	{
		return 0;
...
void func_250()//Position - 0xECDF
{
	func_267("Running end routines.");
	Global_104273 = (Global_104273 - 1);
}

int func_251(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xECF9
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_252((*iParam0)[0], vParam2, fParam3, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_252((*iParam0)[iVar0], vParam2, fParam3, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_252(int iParam0, vector3 vParam1, float fParam2, var uParam3)//Position - 0xED5E
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_253(Var1.f_6, vParam1, fParam2, 0))
	{
...
int func_253(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0xEDDC
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_254(int iParam0, bool bParam1)//Position - 0xEE57
{
	if (bParam1)
	{
	...
	unk_0xCA107A9AAF17E75F(iLocal_54, 0);
	if (bParam1)
	{
		func_190(*iParam0);
	}
...
void func_255(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xEEAB
{
...
void func_256(var uParam0, bool bParam1)//Position - 0xEECB
{
	func_257(&(uParam0->f_41), bParam1);
}

void func_257(var uParam0, bool bParam1)//Position - 0xEEDD
{
	int iVar0;
...
void func_258(int iParam0, bool bParam1)//Position - 0xEF1B
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
		if (unk_0x6049C20F5D5C185B(*iParam0))
...
void func_259(var uParam0, bool bParam1)//Position - 0xEF56
{
	func_260(&(uParam0->f_35), bParam1);
}

void func_260(var uParam0, bool bParam1)//Position - 0xEF68
{
	int iVar0;
...
void func_261(int iParam0)//Position - 0xEFA5
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
...
void func_262(var uParam0, int iParam1)//Position - 0xEFDD
{
	func_263(&(uParam0->f_28), iParam1);
}

void func_263(var uParam0, int iParam1)//Position - 0xEFEF
{
	int iVar0;
...
void func_264(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xF030
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
		if (!unk_0x3AB6A1A9084FB0A4(*iParam0))
...
void func_265(int iParam0)//Position - 0xF080
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
		if (!unk_0x191BE1BC8F26F3C1(*iParam0, 0))
...
void func_266(var uParam0)//Position - 0xF0C1
{
	if (*uParam0 == -1)
	{
		return;
...
void func_267(char* sParam0)//Position - 0xF0FE
{
	if (!unk_0xAB019B170BF1309C(sParam0))
	{
	}
...
void func_268(var uParam0)//Position - 0xF110
{
	*uParam0 = -1;
...
void func_269()//Position - 0xF143
{
	func_267("Running start routines.");
	Global_104273++;
}

int func_270(int iParam0)//Position - 0xF15D
{
	if (!func_36(iParam0))
	{
		return Global_104555.f_28020[iParam0 /*29*/];
