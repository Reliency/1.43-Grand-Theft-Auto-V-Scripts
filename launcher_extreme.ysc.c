...
void __EntryFunction__()//Position - 0x0
{
	...
	iLocal_52 = func_283(52);
	iLocal_53 = joaat("a_c_retriever");
	iLocal_54 = -1;
	iLocal_56 = unk_0xD0CA83418A236CB4();
	...
	if (unk_0x7D9C4B359376D38A(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_103642[Var0 /*10*/].f_9 != -1)
			{
				...
				func_279(&(Global_103642[Var0 /*10*/].f_9));
			}
		}
		func_267(&Var0, 1);
	}
	...
	if (Var0 == 17)
	{
		iLocal_57 = unk_0xCB389937EDB1519A(vVar1 - Vector(40f, 40f, 40f), vVar1 + Vector(40f, 40f, 40f), 0, 1, 1, 1);
		unk_0xFA85ECEE588094C7("WORLD_VEHICLE_SALTON_DIRT_BIKE", 0);
	}
	else if (Var0 == 18)
	{
		iLocal_57 = unk_0xCB389937EDB1519A(-1040f, -2870f, 0f, -910f, -2740f, 50f, 0, 0, 1, 1);
	}
	...
	while (true)
	{
		...
		func_199(Var0);
		func_192(&iLocal_54, &(Var0.f_9), vVar1);
		if (Var0 == 18)
		{
			func_191(&Var0);
			func_186(&Var0, vVar1, "EXT2AU", "EXT2_AMB", 3, "DOM", 5000, 1101004800);
		}
		else if (Var0 == 19)
		{
			func_191(&Var0);
			if (unk_0xCCCA18C9A006FF83(iLocal_56))
			{
				func_186(&Var0, vVar1, "EXT3AUD", "EXT_AMB", 3, "DOM", 8000, 1101004800);
			}
			if ((((((!func_185() && func_184(Var0.f_28[0])) && !unk_0xAFFA17B5D5E2F248(Var0.f_28[0])) && unk_0xCCCA18C9A006FF83(iLocal_56)) && unk_0x1CF95440F1970B4F("EXTREME_04_DOM_A", false, -1)) && unk_0x1CF95440F1970B4F("EXTREME_04_DOM_B", false, -1)) && unk_0x1CF95440F1970B4F("EXTREME_04_DOM_C", false, -1))
			{
				unk_0x7CC4363AEEF7EF34(iLocal_56, "DOM_BREATHING", Var0.f_28[0], "EXTREME_03_SOUNDSET", 0, 0);
			}
			if ((iLocal_55 == 0 && func_184(unk_0xFC1458A37D98B502())) && unk_0x0C88267282FD588F(unk_0xFC1458A37D98B502(), vVar1, Var0.f_15, Var0.f_15, Var0.f_15, false, false, 0))
			{
		...
		if (func_168(&Var0, 0) || func_166(&Var0))
		{
			...
			{
				unk_0x0B9D04994D02CC2F(iLocal_56);
			}
			if (func_1(&Var0))
			{
				func_267(&Var0, 0);
...
void func_4(int iParam0)//Position - 0x58A
{
	int iVar0;
	int iVar1;
...
void func_6(int iParam0)//Position - 0x797
{
	switch (iParam0)
	{
		case 2:
...
void func_7(int iParam0)//Position - 0xB7F
{
	Global_55896 = 1;
	Global_55899 = 1;
	if (Global_67998 > 15)
...
void func_8(int iParam0)//Position - 0xBCA
{
...
struct<2> func_9(int iParam0)//Position - 0xBFE
{
	struct<2> Var0;
	char[] cVar1[8];
...
void func_13()//Position - 0xCF0
{
	Global_56062 = 0;
}

void func_14()//Position - 0xCFC
{
	Global_55922 = 0;
...
var func_15(int iParam0)//Position - 0xD50
{
	var uVar0;
...
void func_17(int iParam0)//Position - 0xD8E
{
	Global_71116 = iParam0;
	Global_71117 = iParam0;
}

void func_18()//Position - 0xDA2
{
	int iVar0;
...
void func_21(char* sParam0)//Position - 0xE47
{
...
void func_22(char[4] cParam0, int iParam1)//Position - 0xE5A
{
	unk_0x0EE72DB1CD8A3B86(&(Global_92833.f_20), 17);
	func_23(cParam0, iParam1, 0);
}

void func_23(char[4] cParam0, int iParam1, int iParam2)//Position - 0xE77
{
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x1B50
{
	int iVar0;
	int iVar1;
...
int func_40(int iParam0)//Position - 0x33DE
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_41(var uParam0)//Position - 0x33FE
{
	int iVar0;
...
int func_42(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x34AF
{
	char* sVar0;
...
int func_43(int iParam0, int iParam1, bool bParam2)//Position - 0x35DE
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_44(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x364F
{
...
int func_45(int iParam0)//Position - 0x3728
{
	int iVar0;
	int iVar1;
...
int func_46(int iParam0)//Position - 0x3765
{
	if (func_36(iParam0))
	{
...
void func_47(int iParam0, var uParam1, int iParam2)//Position - 0x378F
{
	int iVar0;
	int iVar1;
...
int func_48(int iParam0, int iParam1, int iParam2)//Position - 0x3939
{
	int iVar0;
	var uVar1;
...
int func_49(var uParam0)//Position - 0x396B
{
	int iVar0;
	int iVar1;
...
int func_50()//Position - 0x399F
{
	return Global_1312736;
}

int func_51(int iParam0, int iParam1)//Position - 0x39AB
{
	var uVar0;
	var uVar1;
...
void func_52(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x39D7
{
	int iVar0;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3F1F
{
	int iVar0;
...
int func_54()//Position - 0x4161
{
	func_55();
	return Global_104555.f_2353.f_539.f_4301;
}

void func_55()//Position - 0x417A
{
	int iVar0;
...
bool func_56(int iParam0)//Position - 0x4277
{
	return Global_35861 == iParam0;
}

void func_57(int iParam0, bool bParam1)//Position - 0x4285
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_58(int iParam0, var uParam1)//Position - 0x4378
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_59(int iParam0)//Position - 0x4602
{
	switch (iParam0)
	{
		case -1258515792:
...
int func_60(int iParam0)//Position - 0x469D
{
...
int func_61(int iParam0, int iParam1)//Position - 0x4811
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_62(int iParam0, var uParam1)//Position - 0x5382
{
	int iVar0;
	int iVar1;
...
int func_63(int iParam0)//Position - 0x53BD
{
	int iVar0;
...
void func_64(int iParam0)//Position - 0x5631
{
	int iVar0;
...
void func_65(var uParam0, int iParam1)//Position - 0x566D
{
	int iVar0;
	vector3 vVar1;
	var uVar2;
...
int func_66(vector3 vParam0, char* sParam1, vector3 vParam2)//Position - 0x5BC8
{
	int iVar0;
	int iVar1;
...
bool func_67(int iParam0, var uParam1, var uParam2)//Position - 0x5C0C
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_68(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x62C3
{
	if (bParam2)
	{
...
int func_69(var uParam0)//Position - 0x630A
{
...
bool func_70(int iParam0)//Position - 0x6365
{
	return func_71(iParam0, 0, 1);
}

int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x6375
{
	if (bParam2)
	{
...
int func_72(int iParam0)//Position - 0x63D5
{
	switch (iParam0)
	{
		case 0:
...
int func_73()//Position - 0x66BA
{
	return Global_25233;
}

int func_74(int iParam0)//Position - 0x66C5
{
	return func_71(iParam0, 5, 1);
}

int func_75(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x66D5
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0, bool bParam1)//Position - 0x6777
{
	switch (iParam0)
	{
		case -1:
...
int func_77(int iParam0)//Position - 0x6D16
{
	if (iParam0 != func_86())
	{
...
Vector3 func_78(int iParam0, int iParam1)//Position - 0x6D74
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_79(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6E22
{
	struct<4> Var0;
	vector3 vVar1;
	struct<4> Var2;
...
Vector3 func_80(vector3 vParam0, float fParam1)//Position - 0x6EB7
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
struct<6> func_81(int iParam0)//Position - 0x6EFB
{
	struct<6> Var0;
...
struct<6> func_82(int iParam0)//Position - 0x707F
{
	return func_83(iParam0);
}

struct<6> func_83(int iParam0)//Position - 0x708D
{
	struct<6> Var0;
...
int func_84(int iParam0, var uParam1)//Position - 0x7B54
{
	switch (iParam0)
	{
		case 0:
...
int func_85(int iParam0)//Position - 0x7BD6
{
	if (iParam0 != func_86())
	{
...
int func_86()//Position - 0x7C34
{
	return -1;
}

Vector3 func_87(int iParam0)//Position - 0x7C3D
{
	switch (iParam0)
	{
		case 1:
...
int func_88(int iParam0)//Position - 0x7DDA
{
	return func_71(iParam0, 0, 0);
}

int func_89(int iParam0)//Position - 0x7DEA
{
	switch (iParam0)
	{
		case -1:
...
bool func_90()//Position - 0x8077
{
	return Global_92885.f_315 > 0;
}

var func_91()//Position - 0x8088
{
	var uVar0;
...
void func_92(var uParam0, int iParam1)//Position - 0x80CE
{
	if (iParam1 <= 0)
	{
		return;
...
void func_93(var uParam0, int iParam1)//Position - 0x8154
{
...
void func_94(var uParam0, int iParam1)//Position - 0x8187
{
	int iVar0;
	int iVar1;
...
int func_95(int iParam0, int iParam1)//Position - 0x81D8
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_96(int iParam0)//Position - 0x827A
{
	return (system::shift_right(iParam0, 26) & 31 * func_97(unk_0xC80D31E4B587871C(iParam0, 31), -1, 1)) + 2011;
}

int func_97(bool bParam0, int iParam1, int iParam2)//Position - 0x829F
{
	if (bParam0)
	{
		return iParam1;
...
int func_98(var uParam0)//Position - 0x82B6
{
	return uParam0 & 15;
}

void func_99(var uParam0, int iParam1)//Position - 0x82C3
{
...
void func_100(var uParam0, int iParam1)//Position - 0x82FD
{
...
void func_101(var uParam0, int iParam1)//Position - 0x8338
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_102()//Position - 0x8374
{
	func_55();
	return Global_104555.f_2353.f_539.f_4301;
}

void func_103(int iParam0)//Position - 0x838D
{
	var uVar0;
	vector3 vVar1[24];
...
void func_104(char* sParam0, int iParam1, int iParam2)//Position - 0x83E6
{
...
bool func_105(bool bParam0)//Position - 0x8428
{
...
struct<2> func_106(int iParam0)//Position - 0x8453
{
	struct<2> Var0;
...
void func_107(int iParam0, var uParam1)//Position - 0x88A0
{
	switch (iParam0)
	{
		case 0:
...
int func_109(int iParam0)//Position - 0x9B78
{
	switch (iParam0)
	{
		case 0:
...
int func_110(int iParam0)//Position - 0x9EBE
{
	int iVar0;
...
void func_111(int iParam0)//Position - 0x9F62
{
	struct<2> Var0;
...
void func_112(int iParam0)//Position - 0x9FFD
{
	if (iParam0 < 63)
	{
		func_113();
...
void func_114(int iParam0)//Position - 0xA05B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_115(int iParam0)//Position - 0xA0B4
{
...
int func_116(int iParam0)//Position - 0xA137
{
	int iVar0;
...
void func_117(int iParam0, int iParam1, int iParam2)//Position - 0xA168
{
	func_118(iParam0, iParam1, iParam2, 0, 0);
}

void func_118(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0xA17C
{
	int iVar0;
...
int func_120(int iParam0, int iParam1, int iParam2)//Position - 0xA224
{
...
int func_121(int iParam0, int iParam1, int iParam2)//Position - 0xA23F
{
	int iVar0;
...
int func_122(int iParam0)//Position - 0xA28B
{
	int iVar0;
...
int func_123(int iParam0)//Position - 0xA2D4
{
	if (func_184(iParam0))
	{
		if (!unk_0x3AB6A1A9084FB0A4(iParam0))
...
int func_124(int iParam0)//Position - 0xA2F4
{
	switch (iParam0)
	{
		case 5:
...
int func_126(int iParam0)//Position - 0xA3C4
{
	switch (iParam0)
	{
		case 5:
...
void func_127(var uParam0, bool bParam1, bool bParam2)//Position - 0xA417
{
	int iVar0;
...
int func_128(int iParam0)//Position - 0xA50C
{
	switch (iParam0)
	{
		case 5:
...
void func_129(bool bParam0)//Position - 0xA577
{
	int iVar0;
...
void func_130(bool bParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xA5B3
{
	if (bParam0)
	{
...
bool func_131()//Position - 0xA6CC
{
	return unk_0xC80D31E4B587871C(Global_1595693[unk_0x9EB17624F44A8DA4() /*680*/].f_39.f_18, 14);
}

bool func_132(int iParam0, int iParam1)//Position - 0xA6E9
{
	bool bVar0;
...
int func_133(int iParam0, bool bParam1)//Position - 0xA734
{
	int iVar0;
	int iVar1;
...
int func_134(int iParam0)//Position - 0xA775
{
...
bool func_135()//Position - 0xA7B7
{
	return unk_0xC80D31E4B587871C(Global_2359302, 3);
}

int func_136(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xA7C8
{
	int iVar0;
...
void func_138(int iParam0)//Position - 0xA822
{
	if (iParam0 == 1)
	{
...
int func_139(char* sParam0)//Position - 0xA845
{
...
void func_140()//Position - 0xA882
{
	Global_14622 = 0;
	func_141();
}

void func_141()//Position - 0xA892
{
...
int func_144(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xA956
{
...
void func_145(int iParam0)//Position - 0xAAE5
{
	if (!unk_0x191BE1BC8F26F3C1(iParam0, 0))
	{
...
void func_147(int iParam0)//Position - 0xAB62
{
...
void func_148(int iParam0)//Position - 0xAB8B
{
	if (Global_14615)
	{
		func_149(0, 0);
...
void func_149(bool bParam0, bool bParam1)//Position - 0xABFB
{
	if (bParam0)
	{
		if (func_150(0))
...
int func_150(int iParam0)//Position - 0xAC6F
{
	if (iParam0 == 1)
	{
		if (Global_14453.f_1 > 3)
...
int func_151(int iParam0)//Position - 0xACC9
{
...
int func_152(int iParam0)//Position - 0xAD0A
{
	int iVar0;
...
void func_153(int iParam0)//Position - 0xAD4F
{
...
int func_154(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xAD81
{
	int iVar0;
...
void func_155(var uParam0, int iParam1)//Position - 0xAEB8
{
	int iVar0;
...
bool func_156(int iParam0)//Position - 0xAF07
{
	return func_157(iParam0, Global_35861);
}

int func_157(int iParam0, int iParam1)//Position - 0xAF18
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_158(int iParam0)//Position - 0xB0F9
{
	if (Global_35861 == 15)
	{
		return 0;
...
int func_159()//Position - 0xB11B
{
	return func_160(unk_0x436287B7DB306165(), 0);
}

int func_160(char* sParam0, int iParam1)//Position - 0xB12C
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
void func_162(int iParam0, int iParam1)//Position - 0xB199
{
	switch (iParam0)
	{
		case 0:
			*iParam1 = func_163(-1604,668f, 5239,1f, 3,01f, 0);
			unk_0x4B4040A0EC7DBA81(*iParam1, 66);
			unk_0x0C71C8E276E3EC54(*iParam1, 42);
			break;
		
		case 1:
			*iParam1 = func_163(-1592,84f, 5214,04f, 3,01f, 0);
		...
		case 2:
		case 3:
			*iParam1 = func_163(190,26f, -956,35f, 29,63f, 0);
		...
		case 4:
			*iParam1 = func_163(414f, -761f, 29f, 0);
		...
		case 9:
			*iParam1 = func_163(-1622,89f, 4204,87f, 83,3f, 0);
			unk_0x4B4040A0EC7DBA81(*iParam1, 66);
			unk_0x0C71C8E276E3EC54(*iParam1, 42);
			break;
		...
		case 13:
			if (iParam0 == 11)
			{
				*iParam1 = func_163(1835,53f, 4705,86f, 38,1f, 0);
			}
			else if (iParam0 == 12)
			{
				*iParam1 = func_163(1826,13f, 4698,88f, 38,92f, 0);
			}
			else
			{
				*iParam1 = func_163(637,02f, 119,7093f, 89,5f, 0);
			}
		...
		case 19:
			if (iParam0 == 18)
			{
				*iParam1 = func_163(-954,19f, -2760,05f, 14,64f, 0);
			}
			else
			{
				*iParam1 = func_163(-63,8f, -809,5f, 321,8f, 0);
			}
		...
		case 23:
			if (iParam0 == 21)
			{
				*iParam1 = func_163(-1877,82f, -440,649f, 45,05f, 0);
			}
			else
			{
				*iParam1 = func_163(-915,6f, 6139,2f, 5,5f, 0);
			}
		...
		case 27:
			*iParam1 = func_163(-1104,93f, 291,25f, 64,3f, 0);
			unk_0x4B4040A0EC7DBA81(*iParam1, 66);
			unk_0x0C71C8E276E3EC54(*iParam1, 44);
			break;
		...
		case 34:
			*iParam1 = func_163(-303,82f, 6211,29f, 31,05f, 0);
			unk_0x4B4040A0EC7DBA81(*iParam1, 386);
			unk_0x0C71C8E276E3EC54(*iParam1, 44);
			break;
		
		case 43:
			*iParam1 = func_163(-44,75f, -1288,67f, 28,21f, 0);
			unk_0x4B4040A0EC7DBA81(*iParam1, 149);
			unk_0x0C71C8E276E3EC54(*iParam1, 44);
			break;
		
		case 46:
			*iParam1 = func_163(-149,75f, 285,81f, 93,67f, 0);
			unk_0x4B4040A0EC7DBA81(*iParam1, 66);
			unk_0x0C71C8E276E3EC54(*iParam1, 43);
			break;
		...
		case 48:
			if (iParam0 == 47)
			{
				*iParam1 = func_163(-70,71f, 301,43f, 106,79f, 0);
			}
			else
			{
				*iParam1 = func_163(-257,22f, 292,85f, 90,63f, 0);
			}
...
int func_163(vector3 vParam0, bool bParam1)//Position - 0xB620
{
	int iVar0;
	
	iVar0 = unk_0x6F4378873333A0C2(vParam0);
	unk_0xA5D25D3F884FF516(iVar0, func_164(unk_0x3A711520F83BAE98(), 1f, 1f));
	unk_0xAAAC88CC20771601(iVar0, bParam1);
	return iVar0;
}

float func_164(bool bParam0, float fParam1, float fParam2)//Position - 0xB64C
{
	if (bParam0)
	{
		return fParam1;
...
int func_165(int iParam0)//Position - 0xB663
{
	switch (iParam0)
	{
		case 0:
...
int func_166(var uParam0)//Position - 0xB6F2
{
	if (*uParam0 == 18)
	{
		if (unk_0x0F3033474C49912D(unk_0xFC1458A37D98B502(), -954,5357f, -2760,553f, 11,91636f, -947,6847f, -2749,719f, 15,63161f, 26f, 0, true, 0))
		{
			if (!unk_0x88DDBE9908752BF0(unk_0xFC1458A37D98B502(), 0))
			{
...
int func_167(int iParam0, int iParam1)//Position - 0xB799
{
	if (func_123(iParam0))
	{
...
int func_168(var uParam0, int iParam1)//Position - 0xB7CC
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_169()//Position - 0xBFAF
{
	func_27(&(Global_95149.f_2875), &Global_95149, 0, 1, 1, 0);
}

int func_170(var uParam0)//Position - 0xBFCA
{
	float fVar0;
...
void func_171(int iParam0, int iParam1)//Position - 0xC059
{
	if (iParam0 == 1)
	{
		if (!func_126(iParam1))
...
int func_172(bool bParam0)//Position - 0xC0BD
{
	int iVar0;
...
int func_173(int iParam0)//Position - 0xC154
{
	if (func_184(iParam0))
	{
		if (unk_0xB8DE76287EDC4957(iParam0, 0))
...
int func_174(int iParam0)//Position - 0xC17E
{
	int iVar0;
...
var func_175()//Position - 0xC89B
{
	return Global_92872.f_1;
}

int func_176()//Position - 0xC8A9
{
	if (Global_89900 != -1)
	{
...
bool func_179()//Position - 0xC913
{
	return Global_92885.f_316 > 0;
}

bool func_180(int iParam0, int iParam1)//Position - 0xC924
{
	switch (iParam0)
	{
		case 5:
...
var func_181()//Position - 0xC95F
{
	return Global_1312854;
}

int func_182()//Position - 0xC96B
{
	if (!unk_0x3A711520F83BAE98())
	{
...
void func_183(char* sParam0, int iParam1)//Position - 0xC987
{
	unk_0x67129637F30DEB3F(sParam0);
	unk_0x376CFA11DE0FE521(0, 0, true, iParam1);
}

int func_184(int iParam0)//Position - 0xC99E
{
	if (unk_0x6ADD12BF4D6D2587(iParam0))
	{
		if (!unk_0x191BE1BC8F26F3C1(iParam0, 0))
...
int func_186(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xC9E1
{
	var uVar0;
	
	if ((((func_184(unk_0xFC1458A37D98B502()) && func_184(iParam0->f_28[0])) && !func_185()) && (unk_0x53C562FD2B9E3AB0() - iParam0->f_60) > iParam6) && func_190(unk_0xFC1458A37D98B502(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
...
void func_187(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCA69
{
...
void func_188(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCAA4
{
...
void func_189(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xCAFA
{
...
float func_190(int iParam0, vector3 vParam1, bool bParam2)//Position - 0xCB95
{
	vector3 vVar0;
...
void func_191(int iParam0)//Position - 0xCBCF
{
...
void func_192(int iParam0, char* sParam1, vector3 vParam2)//Position - 0xCBFC
{
	if (unk_0x5BEF7A5AB8F17255(unk_0x9EB17624F44A8DA4()))
	{
		if (!unk_0xAB019B170BF1309C(sParam1))
		{
			...
			{
				if (func_190(unk_0xFC1458A37D98B502(), vParam2, 1) <= 100f)
				{
					func_195(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_190(unk_0xFC1458A37D98B502(), vParam2, 1) > 120f)
				{
					func_197(iParam0);
				}
			}
...
void func_193(int iParam0, bool bParam1)//Position - 0xCCED
{
	if (iParam0 == -1)
	{
		return;
...
int func_194(int iParam0)//Position - 0xCD29
{
	if (Global_70852 == iParam0)
	{
		if (Global_70853 == -1)
...
void func_195(int iParam0, int iParam1)//Position - 0xCD62
{
	bool bVar0;
	int iVar1;
...
bool func_196()//Position - 0xCE00
{
	return Global_90287;
}

void func_197(int iParam0)//Position - 0xCE0C
{
	unk_0x7042DDDE71665936(0);
	unk_0xA6C03E3E2533F8F3();
	func_198(iParam0);
...
void func_198(int iParam0)//Position - 0xCE23
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_199(int iParam0)//Position - 0xCF0B
{
	if (iParam0 == -1)
	{
		iParam0 = func_159();
...
int func_200(var uParam0, bool bParam1)//Position - 0xCF33
{
	struct<27> Var0;
...
void func_201(int iParam0, var uParam1, int iParam2)//Position - 0xD1A6
{
	int iVar0;
	int iVar1;
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_203(uParam1) || !unk_0xA5F6598E13F98E08(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_203(uParam1) && uParam1->f_4 == 0) && unk_0xBE3C4023003180FC(unk_0xB3328BA8976B416C(unk_0xFC1458A37D98B502(), 1), unk_0xB3328BA8976B416C(iParam0, 1), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
int func_202(int iParam0)//Position - 0xD4FE
{
...
int func_203(var uParam0)//Position - 0xD51E
{
...
int func_204(var uParam0)//Position - 0xD536
{
...
void func_205(var uParam0)//Position - 0xD55B
{
	int iVar0;
	int iVar1;
...
void func_206(int iParam0)//Position - 0xD85F
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
...
void func_207(var uParam0)//Position - 0xD88A
{
	int iVar0;
...
int func_208(var uParam0, bool bParam1, bool bParam2)//Position - 0xD90A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_209(int iParam0, int iParam1)//Position - 0xDAC8
{
	int iVar0;
...
int func_210(var uParam0, bool bParam1, int iParam2)//Position - 0xDAF8
{
	int iVar0;
	int iVar1;
...
int func_211(int iParam0)//Position - 0xDDB4
{
...
int func_212(int iParam0, float fParam1)//Position - 0xDDE8
{
	float fVar0;
...
bool func_213(int iParam0, float fParam1)//Position - 0xDE5E
{
	return func_214(iParam0, unk_0xFC1458A37D98B502(), fParam1, 1, 250, 7);
}

bool func_214(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xDE76
{
	var uVar0;
	vector3 vVar1;
	int iVar2;
	
	iVar2 = func_222(iParam0, iParam1);
	if (!func_184(iParam0) || !func_184(iParam1))
	{
		if (iVar2 != -1)
		{
			func_221(&(Local_37[iVar2 /*4*/]));
		}
		return 0;
	}
	...
	uVar0 = func_215(&(Local_37[iVar2 /*4*/]), vVar1, iParam1, &(Local_37[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (unk_0x53C562FD2B9E3AB0() - Local_37[iVar2 /*4*/].f_3) < iParam4);
}

int func_215(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xDF37
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
	...
	if (*uParam0 == 0)
	{
		vVar1 = { func_216(iParam2, iParam5) };
...
Vector3 func_216(int iParam0, int iParam1)//Position - 0xE063
{
	int iVar0;
...
int func_218(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE172
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_220(unk_0xB3328BA8976B416C(iParam1, 1) - unk_0xB3328BA8976B416C(iParam0, 1)) };
	...
	{
		vVar1 = { func_220(unk_0xD0E00576168D19BB(iParam0, 31086, 0f, 5f, 0f) - unk_0xD0E00576168D19BB(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar2 = func_219(vVar1, vVar0);
...
float func_219(vector3 vParam0, vector3 vParam1)//Position - 0xE203
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

Vector3 func_220(vector3 vParam0)//Position - 0xE224
{
	float fVar0;
	float fVar1;
...
void func_221(var uParam0)//Position - 0xE263
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_222(int iParam0, int iParam1)//Position - 0xE27E
{
	int iVar0;
...
int func_223(int iParam0)//Position - 0xE2BD
{
...
int func_224(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE2E5
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_225(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE3E0
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_226(int iParam0, float fParam1)//Position - 0xE4EC
{
	var uVar0;
	vector3 vVar1;
	...
	{
		if (func_227(iParam0, vVar1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_227(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0xE581
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_220(vParam1 - unk_0xB3328BA8976B416C(iParam0, 1)) };
	if (fParam2 < 0,1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_228(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xE60F
{
	if (bParam1)
	{
		if (unk_0x08765A6321A42CA1(unk_0xFC1458A37D98B502()))
...
int func_229(int iParam0)//Position - 0xE657
{
...
void func_230(int iParam0)//Position - 0xE6A1
{
	int iVar0;
...
int func_231(int iParam0)//Position - 0xE73E
{
	if (iParam0 == -1)
	{
		iParam0 = func_159();
...
int func_232(int iParam0)//Position - 0xE7D6
{
...
int func_235(int iParam0)//Position - 0xE858
{
...
int func_237(int iParam0)//Position - 0xE8CA
{
	if (func_105(0))
	{
...
int func_238(int iParam0)//Position - 0xE8F2
{
	switch (*iParam0)
	{
		case 17:
...
int func_239(var uParam0)//Position - 0xE967
{
	int iVar0[1];
	int iVar1;
...
void func_240(int iParam0, vector3 vParam1, float fParam2)//Position - 0xEA6B
{
	func_241(iParam0, iLocal_53, vParam1, fParam2, 26);
	unk_0xE537629E02E8DA21(*iParam0);
	unk_0xB89BC60EFF7F2571(*iParam0, 0);
	unk_0x296D39391436DC64(*iParam0, "EXTREME LAUNCHER RC");
}

void func_241(int iParam0, int iParam1, vector3 vParam2, float fParam3, int iParam4)//Position - 0xEA9D
{
	func_242(iParam0);
	*iParam0 = unk_0xAC992EFAD62C33BF(iParam4, iParam1, vParam2, fParam3, 0, false);
}

void func_242(int iParam0)//Position - 0xEABE
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
		if (!unk_0x191BE1BC8F26F3C1(*iParam0, 0))
...
int func_243(var uParam0)//Position - 0xEAFF
{
	if (func_204(uParam0))
	{
...
int func_244(int iParam0)//Position - 0xEB29
{
	int iVar0;
...
void func_245(var uParam0, char* sParam1, char* sParam2, char* sParam3)//Position - 0xEB5A
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
int func_246(var uParam0)//Position - 0xEB96
{
	int iVar0[1];
	int iVar1;
	bool bVar2;
		...
		case 2:
			...
			if (!unk_0x6ADD12BF4D6D2587(uParam0->f_28[0]))
			{
				if (func_247(&(uParam0->f_28[0]), 52, -63,8f, -809,5f, 321,8f, -62f, "EXTREME LAUNCHER RC", 1))
				{
					...
					unk_0x9E058151726E58DE(uParam0->f_28[0], joaat("gadget_parachute"), 1, false, false);
...
int func_247(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)//Position - 0xED29
{
...
int func_248(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)//Position - 0xED85
{
	int iVar0;
...
int func_249(var uParam0, int iParam1)//Position - 0xEE13
{
	int iVar0;
...
int func_250(var uParam0)//Position - 0xEE59
{
	int iVar0[3];
	int iVar1;
	bool bVar2;
		...
		case 2:
			...
			if (!unk_0x6ADD12BF4D6D2587(uParam0->f_28[0]))
			{
				if (func_247(&(uParam0->f_28[0]), 52, -954,19f, -2760,05f, 14,64f, -31,79f, "EXTREME LAUNCHER RC", 1))
				{
					...
					unk_0xB18E1DBC397238E1(uParam0->f_28[0], false, 0);
					unk_0x03924C68EFCBC511(uParam0->f_28[0], 8, 1, 0, 0);
			...
			if (!unk_0x6ADD12BF4D6D2587(uParam0->f_35[2]))
			{
				...
				unk_0x4C44781F822B0B00(uParam0->f_35[2], false, 0);
			}
			if (bVar2)
			{
				iLocal_51 = 3;
...
void func_251(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xF15D
{
	func_252(iParam0);
...
void func_252(int iParam0)//Position - 0xF19F
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
		if (!unk_0x9761C10D57B68069(*iParam0))
...
int func_253(var uParam0)//Position - 0xF23B
{
	int iVar0[1];
	int iVar1;
...
int func_254(int iParam0)//Position - 0xF327
{
	struct<27> Var0;
	int iVar1;
...
int func_255(int iParam0)//Position - 0xF37B
{
	char* sVar0;
...
int func_256(int iParam0)//Position - 0xF434
{
	var uVar0;
...
int func_257(int iParam0)//Position - 0xF4F5
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_258(int iParam0, char* sParam1)//Position - 0xF57A
{
...
bool func_259(int iParam0)//Position - 0xF65C
{
...
bool func_260(int iParam0)//Position - 0xF68A
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_261(int iParam0)//Position - 0xF6B8
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_262(int iParam0)//Position - 0xF6E6
{
	if (func_232(iParam0))
	{
		return 0;
...
void func_263()//Position - 0xF71B
{
	func_280("Running end routines.");
	Global_104273 = (Global_104273 - 1);
}

int func_264(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xF735
{
	int iVar0;
...
int func_265(int iParam0, vector3 vParam1, float fParam2, var uParam3)//Position - 0xF79A
{
	int iVar0;
	struct<7> Var1;
...
int func_266(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0xF818
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_267(int iParam0, bool bParam1)//Position - 0xF893
{
	if (*iParam0 == 18)
	{
...
int func_268(var uParam0)//Position - 0xF974
{
	if (func_204(uParam0))
	{
		if (unk_0x3A801AA34DD821BE(*uParam0))
...
void func_269(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xF9AA
{
...
void func_270(var uParam0, bool bParam1)//Position - 0xF9CA
{
	func_271(&(uParam0->f_41), bParam1);
}

void func_271(var uParam0, bool bParam1)//Position - 0xF9DC
{
	int iVar0;
...
void func_272(int iParam0, bool bParam1)//Position - 0xFA1A
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
		if (unk_0x6049C20F5D5C185B(*iParam0))
...
void func_273(var uParam0, bool bParam1)//Position - 0xFA55
{
	func_274(&(uParam0->f_35), bParam1);
}

void func_274(var uParam0, bool bParam1)//Position - 0xFA67
{
	int iVar0;
...
void func_275(int iParam0)//Position - 0xFAA4
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
...
void func_276(var uParam0, int iParam1)//Position - 0xFADC
{
	func_277(&(uParam0->f_28), iParam1);
}

void func_277(var uParam0, int iParam1)//Position - 0xFAEE
{
	int iVar0;
...
void func_278(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xFB2F
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
		if (!unk_0x3AB6A1A9084FB0A4(*iParam0))
...
void func_279(var uParam0)//Position - 0xFB7F
{
	if (*uParam0 == -1)
	{
		return;
...
void func_280(char* sParam0)//Position - 0xFBBC
{
	if (!unk_0xAB019B170BF1309C(sParam0))
	{
	}
...
void func_281(var uParam0)//Position - 0xFBCE
{
	*uParam0 = -1;
...
void func_282()//Position - 0xFC01
{
	func_280("Running start routines.");
	Global_104273++;
}

int func_283(int iParam0)//Position - 0xFC1B
{
	if (!func_36(iParam0))
	{
		return Global_104555.f_28020[iParam0 /*29*/];
