...
void __EntryFunction__()//Position - 0x0
{
	...
	if (unk_0x7D9C4B359376D38A(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_103642[Var0 /*10*/].f_9 != -1)
			{
				...
				func_283(&(Global_103642[Var0 /*10*/].f_9));
			}
		}
		func_266(&Var0, 1);
	}
	iVar3[0] = 0;
	iVar3[1] = 1;
	if (!func_263(&iVar3, &Var0, vVar1, 1f))
	{
		func_262();
	...
	while (true)
	{
		...
		func_204(Var0);
		func_197(&iLocal_56, &(Var0.f_9), vVar1);
		switch (Var0)
		{
			case 0:
				func_188(&Var2, &(Var0.f_28[0]), "SONAR_PRE");
				break;
			
			case 1:
				func_183(&Var0, vVar1, "SONARAU", "SONAR_CALL", 3, "ABIGAIL", 10000, 1101004800);
				break;
		}
		if (func_168(&Var0, 0))
		{
...
void func_4(int iParam0)//Position - 0x43B
{
	int iVar0;
	int iVar1;
...
void func_6(int iParam0)//Position - 0x648
{
	switch (iParam0)
	{
		case 2:
...
void func_7(int iParam0)//Position - 0xA30
{
	Global_55896 = 1;
	Global_55899 = 1;
	if (Global_67998 > 15)
...
void func_8(int iParam0)//Position - 0xA7B
{
...
struct<2> func_9(int iParam0)//Position - 0xAAF
{
	struct<2> Var0;
	char[] cVar1[8];
...
var func_15(int iParam0)//Position - 0xC01
{
	var uVar0;
...
void func_17(int iParam0)//Position - 0xC3F
{
	Global_71116 = iParam0;
	Global_71117 = iParam0;
}

void func_18()//Position - 0xC53
{
	int iVar0;
...
void func_21(char* sParam0)//Position - 0xCF8
{
...
void func_22(char[4] cParam0, int iParam1)//Position - 0xD0B
{
	unk_0x0EE72DB1CD8A3B86(&(Global_92833.f_20), 17);
	func_23(cParam0, iParam1, 0);
}

void func_23(char[4] cParam0, int iParam1, int iParam2)//Position - 0xD28
{
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x1A01
{
	int iVar0;
	int iVar1;
...
int func_26(var uParam0)//Position - 0x2889
{
...
void func_27(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x28AB
{
	int iVar0;
...
int func_28(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2933
{
...
int func_29(int iParam0)//Position - 0x2973
{
	int iVar0;
...
void func_30(var uParam0, int iParam1, int iParam2)//Position - 0x29A1
{
...
int func_31(int iParam0)//Position - 0x2A7D
{
	int iVar0;
...
int func_32(int iParam0)//Position - 0x2ABF
{
	int iVar0;
...
int func_33(int iParam0, int iParam1, int iParam2)//Position - 0x2B22
{
	int iVar0;
...
int func_34(int iParam0, int iParam1)//Position - 0x2BB0
{
	struct<82> Var0;
...
void func_35(int iParam0, var uParam1, int iParam2)//Position - 0x2BF2
{
	int iVar0;
...
bool func_36(int iParam0)//Position - 0x2E4E
{
	return iParam0 < 3;
}

void func_37(int iParam0, var uParam1)//Position - 0x2E5A
{
	int iVar0;
...
int func_38(int iParam0)//Position - 0x3105
{
	switch (iParam0)
	{
		case 1:
...
int func_39(int iParam0, var uParam1, var uParam2)//Position - 0x31B5
{
	int iVar0;
	int iVar1;
...
int func_40(int iParam0)//Position - 0x328F
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_41(var uParam0)//Position - 0x32AF
{
	int iVar0;
...
int func_42(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x3360
{
	char* sVar0;
...
int func_43(int iParam0, int iParam1, bool bParam2)//Position - 0x348F
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_44(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x3500
{
...
int func_45(int iParam0)//Position - 0x35D9
{
	int iVar0;
	int iVar1;
...
int func_46(int iParam0)//Position - 0x3616
{
	if (func_36(iParam0))
	{
...
void func_47(int iParam0, var uParam1, int iParam2)//Position - 0x3640
{
	int iVar0;
	int iVar1;
...
int func_48(int iParam0, int iParam1, int iParam2)//Position - 0x37EA
{
	int iVar0;
	var uVar1;
...
int func_49(var uParam0)//Position - 0x381C
{
	int iVar0;
	int iVar1;
...
int func_50()//Position - 0x3850
{
	return Global_1312736;
}

int func_51(int iParam0, int iParam1)//Position - 0x385C
{
	var uVar0;
	var uVar1;
...
void func_52(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x3888
{
	int iVar0;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3DD0
{
	int iVar0;
...
int func_54()//Position - 0x4012
{
	func_55();
	return Global_104555.f_2353.f_539.f_4301;
}

void func_55()//Position - 0x402B
{
	int iVar0;
...
bool func_56(int iParam0)//Position - 0x4128
{
	return Global_35861 == iParam0;
}

void func_57(int iParam0, bool bParam1)//Position - 0x4136
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_58(int iParam0, var uParam1)//Position - 0x4229
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_59(int iParam0)//Position - 0x44B3
{
	switch (iParam0)
	{
		case -1258515792:
...
int func_60(int iParam0)//Position - 0x454E
{
...
int func_61(int iParam0, int iParam1)//Position - 0x46C2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_62(int iParam0, var uParam1)//Position - 0x5233
{
	int iVar0;
	int iVar1;
...
int func_63(int iParam0)//Position - 0x526E
{
	int iVar0;
...
void func_64(int iParam0)//Position - 0x54E2
{
	int iVar0;
...
void func_65(var uParam0, int iParam1)//Position - 0x551E
{
	int iVar0;
	vector3 vVar1;
	var uVar2;
...
int func_66(vector3 vParam0, char* sParam1, vector3 vParam2)//Position - 0x5A79
{
	int iVar0;
	int iVar1;
...
bool func_67(int iParam0, var uParam1, var uParam2)//Position - 0x5ABD
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_68(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x6174
{
	if (bParam2)
	{
...
int func_69(var uParam0)//Position - 0x61BB
{
...
bool func_70(int iParam0)//Position - 0x6216
{
	return func_71(iParam0, 0, 1);
}

int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x6226
{
	if (bParam2)
	{
...
int func_72(int iParam0)//Position - 0x6286
{
	switch (iParam0)
	{
		case 0:
...
int func_73()//Position - 0x656B
{
	return Global_25233;
}

int func_74(int iParam0)//Position - 0x6576
{
	return func_71(iParam0, 5, 1);
}

int func_75(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x6586
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0, bool bParam1)//Position - 0x6628
{
	switch (iParam0)
	{
		case -1:
...
int func_77(int iParam0)//Position - 0x6BC7
{
	if (iParam0 != func_86())
	{
...
Vector3 func_78(int iParam0, int iParam1)//Position - 0x6C25
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_79(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6CD3
{
	struct<4> Var0;
	vector3 vVar1;
	struct<4> Var2;
...
Vector3 func_80(vector3 vParam0, float fParam1)//Position - 0x6D68
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
struct<6> func_81(int iParam0)//Position - 0x6DAC
{
	struct<6> Var0;
...
struct<6> func_82(int iParam0)//Position - 0x6F30
{
	return func_83(iParam0);
}

struct<6> func_83(int iParam0)//Position - 0x6F3E
{
	struct<6> Var0;
...
int func_84(int iParam0, var uParam1)//Position - 0x7A05
{
	switch (iParam0)
	{
		case 0:
...
int func_85(int iParam0)//Position - 0x7A87
{
	if (iParam0 != func_86())
	{
...
int func_86()//Position - 0x7AE5
{
	return -1;
}

Vector3 func_87(int iParam0)//Position - 0x7AEE
{
	switch (iParam0)
	{
		case 1:
...
int func_88(int iParam0)//Position - 0x7C8B
{
	return func_71(iParam0, 0, 0);
}

int func_89(int iParam0)//Position - 0x7C9B
{
	switch (iParam0)
	{
		case -1:
...
bool func_90()//Position - 0x7F28
{
	return Global_92885.f_315 > 0;
}

var func_91()//Position - 0x7F39
{
	var uVar0;
...
void func_92(var uParam0, int iParam1)//Position - 0x7F7F
{
	if (iParam1 <= 0)
	{
		return;
...
void func_104(char* sParam0, var uParam1, int iParam2)//Position - 0x8298
{
...
int func_183(var uParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xC7CC
{
	var uVar0;
	
	if ((((func_124(unk_0xFC1458A37D98B502()) && func_124(uParam0->f_28[0])) && !func_143()) && (unk_0x53C562FD2B9E3AB0() - uParam0->f_60) > iParam6) && func_187(unk_0xFC1458A37D98B502(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
...
void func_184(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC854
{
...
void func_185(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC88F
{
...
void func_186(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xC8E5
{
...
float func_187(int iParam0, vector3 vParam1, bool bParam2)//Position - 0xC980
{
	vector3 vVar0;
...
void func_188(int iParam0, var uParam1, char* sParam2)//Position - 0xC9BA
{
	if (func_124(*uParam1) && func_124(unk_0xFC1458A37D98B502()))
	{
		switch (*iParam0)
		{
			case 0:
				...
				unk_0x12C9D41D52A560D6(*uParam1, cLocal_55, "base", 1000f, -8f, -1, 1, 0, 0, 0, 0);
				*iParam0 = 1;
				break;
			...
			case 1:
				...
				{
					if (unk_0x0F3033474C49912D(unk_0xFC1458A37D98B502(), vLocal_52, vLocal_53, 8f, 0, true, 0))
					{
						unk_0x12C9D41D52A560D6(*uParam1, cLocal_55, "intro", 8f, -8f, -1, 2, 0, 0, 0, 0);
						*iParam0 = 3;
					}
				...
				if (unk_0xA5F6598E13F98E08(*uParam1, cLocal_55, "outro", 3) && unk_0x7A70772AE40E3821(*uParam1, cLocal_55, "outro") > 0,99f)
				{
					unk_0x12C9D41D52A560D6(*uParam1, cLocal_55, "base", 8f, -8f, -1, 1, 0, 0, 0, 0);
				}
				break;
			
			case 3:
				if (unk_0xA5F6598E13F98E08(*uParam1, cLocal_55, "intro", 3) && unk_0x7A70772AE40E3821(*uParam1, cLocal_55, "intro") > 0,99f)
				{
					*iParam0 = 4;
				}
				break;
			...
			case 4:
				if (func_189(&(iParam0->f_1), "SONARAU", sParam2, 4, 0, 0, 0))
				{
					if (unk_0x0F3033474C49912D(unk_0xFC1458A37D98B502(), vLocal_52, vLocal_53, 8f, 0, true, 0))
					{
						unk_0x12C9D41D52A560D6(*uParam1, cLocal_55, "loop_talk", 8f, -8f, -1, 1, 0, 0, 0, 0);
					}
					*iParam0 = 5;
				}
				break;
			...
			case 5:
				if (!func_143())
				{
					if (unk_0xA5F6598E13F98E08(*uParam1, cLocal_55, "loop_talk", 3))
					{
						if (unk_0x7A70772AE40E3821(*uParam1, cLocal_55, "loop_talk") > 0,99f)
						{
							iParam0->f_166 = (unk_0x53C562FD2B9E3AB0() + unk_0x63A6486593EC7EC3(7000, 10000));
							if (!unk_0x0F3033474C49912D(unk_0xFC1458A37D98B502(), vLocal_52, vLocal_53, 8f, 0, true, 0))
							{
								unk_0x12C9D41D52A560D6(*uParam1, cLocal_55, "outro", 8f, -8f, -1, 2, 0, 0, 0, 0);
								*iParam0 = 1;
							}
							else
							{
								unk_0x12C9D41D52A560D6(*uParam1, cLocal_55, "loop_look", 8f, -8f, -1, 1, 0, 0, 0, 0);
								*iParam0 = 2;
							}
						}
					}
			...
			case 2:
				if (unk_0xA5F6598E13F98E08(*uParam1, cLocal_55, "loop_look", 3) && unk_0x7A70772AE40E3821(*uParam1, cLocal_55, "loop_look") > 0,99f)
				{
					if (unk_0x0F3033474C49912D(unk_0xFC1458A37D98B502(), vLocal_52, vLocal_53, 8f, 0, true, 0))
					{
						if (unk_0x53C562FD2B9E3AB0() > iParam0->f_166)
...
bool func_189(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xCCB6
{
...
int func_190(char* sParam0, int iParam1, bool bParam2)//Position - 0xCD04
{
	Global_15757 = 0;
...
float func_196(int iParam0, int iParam1, bool bParam2)//Position - 0xD22A
{
	vector3 vVar0;
	vector3 vVar1;
...
void func_197(int iParam0, char* sParam1, vector3 vParam2)//Position - 0xD288
{
	if (unk_0x5BEF7A5AB8F17255(unk_0x9EB17624F44A8DA4()))
	{
...
void func_198(int iParam0, bool bParam1)//Position - 0xD379
{
	if (iParam0 == -1)
	{
		return;
...
int func_199(int iParam0)//Position - 0xD3B5
{
	if (Global_70852 == iParam0)
	{
		if (Global_70853 == -1)
...
void func_200(int iParam0, int iParam1)//Position - 0xD3EE
{
	bool bVar0;
	int iVar1;
...
bool func_201()//Position - 0xD48C
{
	return Global_90287;
}

void func_202(int iParam0)//Position - 0xD498
{
	unk_0x7042DDDE71665936(0);
	unk_0xA6C03E3E2533F8F3();
	func_203(iParam0);
...
void func_203(int iParam0)//Position - 0xD4AF
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_204(int iParam0)//Position - 0xD597
{
	if (iParam0 == -1)
	{
		iParam0 = func_161();
...
int func_205(int iParam0, bool bParam1)//Position - 0xD5BF
{
	struct<27> Var0;
...
void func_206(int iParam0, var uParam1, int iParam2)//Position - 0xD832
{
	int iVar0;
	int iVar1;
...
int func_207(int iParam0)//Position - 0xDB8A
{
...
int func_208(var uParam0)//Position - 0xDBAA
{
...
int func_209(var uParam0)//Position - 0xDBC2
{
...
void func_211(int iParam0)//Position - 0xDEE5
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
...
void func_212(var uParam0)//Position - 0xDF10
{
	int iVar0;
...
int func_213(var uParam0, bool bParam1, bool bParam2)//Position - 0xDF90
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_214(int iParam0, int iParam1)//Position - 0xE14E
{
	int iVar0;
...
int func_215(var uParam0, bool bParam1, int iParam2)//Position - 0xE17E
{
	int iVar0;
	int iVar1;
...
int func_216(int iParam0)//Position - 0xE43A
{
...
int func_217(int iParam0, float fParam1)//Position - 0xE46E
{
	float fVar0;
...
bool func_218(int iParam0, float fParam1)//Position - 0xE4E4
{
	return func_219(iParam0, unk_0xFC1458A37D98B502(), fParam1, 1, 250, 7);
}

bool func_219(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE4FC
{
	var uVar0;
	vector3 vVar1;
	int iVar2;
...
int func_220(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xE5BD
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
Vector3 func_221(int iParam0, int iParam1)//Position - 0xE6E9
{
	int iVar0;
...
int func_223(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE7F8
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
...
float func_224(vector3 vParam0, vector3 vParam1)//Position - 0xE889
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

Vector3 func_225(vector3 vParam0)//Position - 0xE8AA
{
	float fVar0;
	float fVar1;
...
void func_226(var uParam0)//Position - 0xE8E9
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_227(int iParam0, int iParam1)//Position - 0xE904
{
	int iVar0;
...
int func_228(int iParam0)//Position - 0xE943
{
...
int func_229(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE96B
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_230(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xEA66
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_231(int iParam0, float fParam1)//Position - 0xEB72
{
	var uVar0;
	vector3 vVar1;
...
int func_232(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0xEC07
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
...
int func_233(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xEC95
{
	if (bParam1)
	{
		if (unk_0x08765A6321A42CA1(unk_0xFC1458A37D98B502()))
...
int func_234(int iParam0)//Position - 0xECDD
{
...
void func_235(int iParam0)//Position - 0xED27
{
	int iVar0;
...
int func_236(int iParam0)//Position - 0xEDC4
{
	if (iParam0 == -1)
	{
		iParam0 = func_161();
...
int func_237(int iParam0)//Position - 0xEE5C
{
...
int func_240(int iParam0)//Position - 0xEEDE
{
...
int func_242(int iParam0)//Position - 0xEF50
{
	if (func_105(0))
	{
...
int func_243(int iParam0)//Position - 0xEF78
{
	switch (*iParam0)
	{
		case 0:
...
int func_244(var uParam0)//Position - 0xEFBF
{
	int iVar0[2];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			unk_0x6450931B826B49D9(cLocal_55);
			func_251(&(uParam0->f_48), cLocal_55, "base", 0);
			iLocal_51 = 1;
			break;
		
		case 1:
			if (!func_250(&iVar0) || !unk_0x3A801AA34DD821BE(cLocal_55))
			{
				return 0;
			}
			iLocal_51 = 2;
...
void func_245(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xF171
{
	func_246(iParam0);
...
void func_246(int iParam0)//Position - 0xF1B3
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
...
int func_247(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)//Position - 0xF24F
{
...
int func_248(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)//Position - 0xF2AB
{
	int iVar0;
...
int func_249(var uParam0, int iParam1)//Position - 0xF339
{
	int iVar0;
...
int func_250(int iParam0)//Position - 0xF37F
{
	int iVar0;
...
void func_251(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xF3B0
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_252(var uParam0)//Position - 0xF3EC
{
	int iVar0;
	bool bVar1;
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!unk_0x9A0B2ED5055D3F0B(iVar0) || !unk_0x3A801AA34DD821BE(cLocal_55))
			{
				return 0;
			}
			iLocal_51 = 2;
...
int func_253(int iParam0)//Position - 0xF4F7
{
	struct<27> Var0;
	int iVar1;
...
int func_254(int iParam0)//Position - 0xF54B
{
	char* sVar0;
...
int func_255(int iParam0)//Position - 0xF604
{
	var uVar0;
...
int func_256(int iParam0)//Position - 0xF6C5
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_257(int iParam0, char* sParam1)//Position - 0xF74A
{
...
bool func_258(int iParam0)//Position - 0xF82C
{
...
bool func_259(int iParam0)//Position - 0xF85A
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_260(int iParam0)//Position - 0xF888
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_261(int iParam0)//Position - 0xF8B6
{
	if (func_237(iParam0))
	{
		return 0;
...
void func_262()//Position - 0xF8EB
{
	func_284("Running end routines.");
	Global_104273 = (Global_104273 - 1);
}

int func_263(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xF905
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_264((*iParam0)[0], vParam2, fParam3, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_264((*iParam0)[iVar0], vParam2, fParam3, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_264(int iParam0, vector3 vParam1, float fParam2, var uParam3)//Position - 0xF96A
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_265(Var1.f_6, vParam1, fParam2, 0))
	{
...
int func_265(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0xF9E8
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_266(int iParam0, bool bParam1)//Position - 0xFA63
{
	char* sVar0;
...
void func_267(char* sParam0)//Position - 0xFAEA
{
	if (!unk_0xAB019B170BF1309C(sParam0))
	{
		if (func_270(sParam0))
...
int func_270(char* sParam0)//Position - 0xFB3A
{
	struct<6> Var0;
...
struct<6> func_271()//Position - 0xFB5A
{
	struct<6> Var0;
...
void func_272(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xFB7E
{
...
void func_273(var uParam0, bool bParam1)//Position - 0xFB9E
{
	func_274(&(uParam0->f_41), bParam1);
}

void func_274(var uParam0, bool bParam1)//Position - 0xFBB0
{
	int iVar0;
...
void func_275(int iParam0, bool bParam1)//Position - 0xFBEE
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
		if (unk_0x6049C20F5D5C185B(*iParam0))
...
void func_276(var uParam0, bool bParam1)//Position - 0xFC29
{
	func_277(&(uParam0->f_35), bParam1);
}

void func_277(var uParam0, bool bParam1)//Position - 0xFC3B
{
	int iVar0;
...
void func_278(int iParam0)//Position - 0xFC78
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
...
void func_279(var uParam0, int iParam1)//Position - 0xFCB0
{
	func_280(&(uParam0->f_28), iParam1);
}

void func_280(var uParam0, int iParam1)//Position - 0xFCC2
{
	int iVar0;
...
void func_281(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xFD03
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
		if (!unk_0x3AB6A1A9084FB0A4(*iParam0))
...
void func_282(int iParam0)//Position - 0xFD53
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
		if (!unk_0x191BE1BC8F26F3C1(*iParam0, 0))
...
void func_283(var uParam0)//Position - 0xFD94
{
	if (*uParam0 == -1)
	{
		return;
...
void func_284(char* sParam0)//Position - 0xFDD1
{
	if (!unk_0xAB019B170BF1309C(sParam0))
	{
	}
...
void func_285(var uParam0)//Position - 0xFDE3
{
	*uParam0 = -1;
...
void func_286()//Position - 0xFE16
{
	func_284("Running start routines.");
	Global_104273++;
}

int func_287(int iParam0)//Position - 0xFE30
{
	if (!func_36(iParam0))
	{
		return Global_104555.f_28020[iParam0 /*29*/];
