...
void __EntryFunction__()//Position - 0x0
{
	...
	if (func_436())
	{
		...
		func_435(vLocal_53, fLocal_54, 1, 0);
		func_470("*** Replay setup started");
		Global_71101 = 1;
		iLocal_37 = 0;
		while (!func_424(&Local_386))
		{
			system::wait(0);
		}
		func_470("*** Josh 4 scene set up");
		func_423(&Local_386, 0, 1);
		Global_71101 = 0;
	}
	if (func_422(Local_386.f_28[1]))
	{
		unk_0x8BB5ECF21DDE505B(Local_386.f_28[1], 1);
	}
	if (func_422(Local_386.f_28[2]))
	{
		unk_0x8BB5ECF21DDE505B(Local_386.f_28[2], 1);
	}
	...
	if (func_436())
	{
		...
		func_324(&iLocal_44, -1100,04f, 280,6f, 63,53f, 267,48f, 0, 0, 1, 1, 0, joaat("asterope"), 0, 145, 1);
	...
	while (true)
	{
		...
		system::wait(0);
		func_301(Local_386.f_9, 0, 0, 0, 0, 0);
		switch (iLocal_45)
		{
			case 0:
				func_293();
...
void func_1()//Position - 0x233
{
	...
	switch (iLocal_46)
	{
		case 0:
			func_423(&Local_386, 0, 1);
			if (func_422(iLocal_390))
			{
				unk_0xD38F266C132F2897(iLocal_390, false, false, false, false, false, false, 0, false);
			}
			if (func_422(iLocal_391))
			{
				unk_0xD38F266C132F2897(iLocal_391, false, false, false, false, false, false, 0, false);
			}
			...
			unk_0x8D3373CFE9542320(-1140,223f, 271,745f, 50f, -1082,403f, 344,8568f, 80f, false, 0);
			unk_0x60225D4F755DFDB1(-1114,788f, 319,3401f, 66,1226f, 20,5f, 0);
			if (func_422(Local_386.f_28[0]))
			{
				unk_0x60C06BFD037BB7CF(Local_386.f_28[0], unk_0xFC1458A37D98B502(), -1, 0, 2);
			}
			unk_0xC234848D21B6064E(2);
			iLocal_394 = unk_0x53C562FD2B9E3AB0();
			iLocal_46 = 1;
			break;
		...
		case 1:
			...
			if (unk_0xF5D0CBECCA41314A(unk_0x98EC0789D9F0703B()) <= 0 && !func_205())
			{
				...
				{
					if (func_422(Local_386.f_28[iVar0]))
					{
				...
				{
					if (unk_0xA8D0477084E86A92(unk_0xFC1458A37D98B502(), iLocal_390, 0))
					{
						func_202(777);
					}
				}
...
bool func_5(bool bParam0)//Position - 0x5BE
{
...
void func_6(int iParam0, int iParam1, int iParam2)//Position - 0x5E9
{
	bool bVar0;
...
int func_8()//Position - 0xB92
{
	return Global_25233;
}

int func_9(int iParam0, int iParam1)//Position - 0xB9D
{
	int iVar0;
...
int func_10(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xBEE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_11()//Position - 0x10BA
{
	return Global_1312736;
}

void func_12()//Position - 0x10C6
{
	func_29();
	func_21();
	func_17();
...
void func_13(int iParam0)//Position - 0x111F
{
	if (iParam0 == 1)
	{
...
void func_15()//Position - 0x1166
{
	StringCopy(&Global_71088, "", 16);
	StringCopy(&Global_71092, "", 16);
}

void func_16()//Position - 0x1182
{
	int iVar0;
...
void func_20(int iParam0)//Position - 0x1254
{
	if (iParam0 == 1)
	{
		Global_36410 = 1;
...
void func_21()//Position - 0x126D
{
	func_22(&Global_98118);
}

void func_22(var uParam0)//Position - 0x127D
{
	int iVar0;
	int iVar1;
...
void func_23(var uParam0)//Position - 0x180D
{
	*uParam0 = -1;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_24(var uParam0)//Position - 0x1828
{
...
void func_25(var uParam0)//Position - 0x1857
{
	int iVar0;
...
void func_26(var uParam0)//Position - 0x1908
{
	*uParam0 = { 0f, 0f, 0f };
	uParam0->f_3 = 0f;
	uParam0->f_4 = 0;
...
void func_27(var uParam0)//Position - 0x1926
{
	int iVar0;
...
void func_28(var uParam0)//Position - 0x1A07
{
	*uParam0 = -15;
}

void func_29()//Position - 0x1A15
{
	StringCopy(&Global_95141, "", 32);
	func_22(&Global_95149);
}

void func_30()//Position - 0x1A2F
{
...
int func_32(int iParam0, int iParam1, int iParam2)//Position - 0x1B6D
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_33(int iParam0, int iParam1, int iParam2)//Position - 0x1D2A
{
	int iVar0;
...
int func_34(int iParam0)//Position - 0x1DB6
{
	switch (iParam0)
	{
...
int func_35(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x1DF1
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_36(int iParam0, int iParam1, int iParam2)//Position - 0x25FD
{
	int iVar0;
	int iVar1;
...
int func_37(int iParam0, int iParam1, int iParam2)//Position - 0x2687
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_38(int iParam0, int iParam1, int iParam2)//Position - 0x2765
{
	Global_70671[1 /*14*/] = { func_83(iParam0, iParam1, iParam2) };
	return unk_0xC80D31E4B587871C(Global_70671[1 /*14*/].f_6, 2);
}

int func_39(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x278F
{
	var uVar0;
	int iVar1;
...
int func_40(int iParam0, int iParam1, int iParam2)//Position - 0x2D93
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_41(int iParam0, int iParam1, int iParam2)//Position - 0x2E2C
{
	int iVar0;
	int iVar1;
...
int func_42(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x2ECD
{
	int iVar0;
...
int func_43(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x31D4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_44(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x3D87
{
	int iVar0;
...
int func_45(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x406D
{
	int iVar0;
...
int func_46(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4334
{
	int iVar0;
	int iVar1;
...
int func_47(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x436B
{
	int iVar0;
...
int func_48(int iParam0, int iParam1, int iParam2)//Position - 0x4394
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_49(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x465E
{
	int iVar0;
...
int func_50(int iParam0, int iParam1, int iParam2)//Position - 0x48E8
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_51(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4A3F
{
	int iVar0;
...
int func_52(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4AD7
{
	switch (iParam0)
	{
...
int func_53(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4BA5
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
...
int func_54(int iParam0, int iParam1)//Position - 0x4D01
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_55(int iParam0)//Position - 0x50A8
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_56(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5109
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_57(int iParam0, int iParam1)//Position - 0x5205
{
	int iVar0;
...
int func_58(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5343
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
...
int func_59(int iParam0)//Position - 0x5423
{
	switch (iParam0)
	{
		case 0:
...
int func_60(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x54A9
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_61(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5726
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_62(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5B4B
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_63(int iParam0, int iParam1)//Position - 0x5E3E
{
	int iVar0;
	int iVar1;
...
int func_64(int iParam0, int iParam1)//Position - 0x5E84
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_65(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5EE4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_66(int iParam0)//Position - 0x5F68
{
...
void func_67(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x6020
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_68(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x606A
{
	int iVar0;
...
int func_69(var uParam0)//Position - 0x609A
{
	int iVar0;
	int iVar1;
...
int func_70(int iParam0, int iParam1, int iParam2)//Position - 0x60CE
{
	int iVar0;
	var uVar1;
...
bool func_71(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x6100
{
	int iVar0;
...
int func_72(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x7925
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_73(int iParam0)//Position - 0x8845
{
	if (!unk_0xC80D31E4B587871C(Global_70671[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_74(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8896
{
	int iVar0;
...
int func_75(int iParam0)//Position - 0x892C
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_76(int iParam0, int iParam1)//Position - 0x89DC
{
	int iVar0;
	struct<10> Var1;
...
void func_77(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x930B
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar2;
...
void func_78(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x9435
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_79(int iParam0, int iParam1)//Position - 0x947D
{
	int iVar0;
	struct<17> Var1;
...
void func_80(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB2C5
{
	int iVar0;
	struct<5> Var1;
	vector3 vVar2;
...
int func_81(int iParam0)//Position - 0xB4AF
{
	switch (iParam0)
	{
		case 0:
...
void func_82(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xB55F
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
struct<14> func_83(int iParam0, int iParam1, int iParam2)//Position - 0xB5D0
{
	func_147();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_84(int iParam0, int iParam1)//Position - 0xB622
{
	switch (iParam0)
	{
		case 0:
...
void func_85(int iParam0)//Position - 0xB712
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_86(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xC98A
{
	int iVar0;
	int iVar1;
...
bool func_87(int iParam0, int iParam1, var uParam2)//Position - 0xCD1B
{
	*uParam2 = 975;
	switch (iParam1)
	{
...
int func_88(int iParam0, int iParam1)//Position - 0xD120
{
	switch (iParam1)
	{
		case 0:
...
int func_89(int iParam0, int iParam1)//Position - 0xD51B
{
	switch (iParam1)
	{
		case 0:
...
int func_90(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xD916
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_91(int iParam0)//Position - 0xD958
{
	return Global_35861 == iParam0;
}

int func_92(int iParam0)//Position - 0xD966
{
	switch (iParam0)
	{
		case -1:
...
void func_93(int iParam0, int iParam1, int iParam2)//Position - 0xDA3A
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
...
void func_94(int iParam0)//Position - 0xDCB5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_95(int iParam0)//Position - 0xDE0B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_96(int iParam0)//Position - 0xE318
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_97(int iParam0)//Position - 0xE38C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_98(int iParam0)//Position - 0xE3FF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_99(int iParam0)//Position - 0xE4E5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_100(int iParam0)//Position - 0xE847
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_101(int iParam0)//Position - 0xEA57
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_102(int iParam0)//Position - 0xEC86
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_103(int iParam0)//Position - 0xED95
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_104(int iParam0)//Position - 0xF733
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_105(int iParam0)//Position - 0x102A6
{
	if (iParam0 < 136)
	{
		func_107(iParam0);
...
void func_106(int iParam0)//Position - 0x102DA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_108(int iParam0)//Position - 0x11DEC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_109(int iParam0)//Position - 0x11F18
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_110(int iParam0, int iParam1)//Position - 0x12015
{
	switch (iParam0)
	{
		case 0:
...
void func_111(int iParam0)//Position - 0x12105
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_112(int iParam0)//Position - 0x135F5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_113(int iParam0)//Position - 0x13745
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_114(int iParam0)//Position - 0x13C4F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_116(int iParam0)//Position - 0x14330
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_117(int iParam0)//Position - 0x143FF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_118(int iParam0)//Position - 0x1492E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_119(int iParam0)//Position - 0x14AC4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_120(int iParam0)//Position - 0x152C1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_121(int iParam0)//Position - 0x153D0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_122(int iParam0)//Position - 0x162FA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_123(int iParam0)//Position - 0x16FB6
{
	if (iParam0 < 107)
	{
		func_126(iParam0);
...
void func_124(int iParam0)//Position - 0x16FFB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_125(int iParam0)//Position - 0x17AA0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_126(int iParam0)//Position - 0x18890
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_127(int iParam0)//Position - 0x194D9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_128(int iParam0)//Position - 0x19751
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_129(int iParam0, int iParam1)//Position - 0x19896
{
	switch (iParam0)
	{
		case 0:
...
void func_130(int iParam0)//Position - 0x19986
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_131(int iParam0)//Position - 0x1A70F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_132(int iParam0)//Position - 0x1A888
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_133(int iParam0)//Position - 0x1ADFE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_134(int iParam0)//Position - 0x1B327
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_135(int iParam0)//Position - 0x1B39A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_136(int iParam0)//Position - 0x1B469
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_137(int iParam0)//Position - 0x1B940
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_138(int iParam0)//Position - 0x1BBA8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_139(int iParam0)//Position - 0x1BE7D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_140(int iParam0)//Position - 0x1C046
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_141(int iParam0)//Position - 0x1CB99
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_142(int iParam0)//Position - 0x1D7E2
{
	if (iParam0 < 60)
	{
		func_144(iParam0);
...
void func_143(int iParam0)//Position - 0x1D816
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_144(int iParam0)//Position - 0x1E5B6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_145(int iParam0)//Position - 0x1EC42
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_146(int iParam0)//Position - 0x1ED28
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_147()//Position - 0x1EE25
{
...
int func_148(int iParam0, int iParam1, int iParam2)//Position - 0x1EE9E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_149(int iParam0)//Position - 0x1F0F6
{
	int iVar0;
	int iVar1;
...
int func_150(int iParam0)//Position - 0x1F133
{
	if (func_151(iParam0))
	{
...
bool func_151(int iParam0)//Position - 0x1F15D
{
	return iParam0 < 3;
}

void func_152(char* sParam0, int iParam1)//Position - 0x1F169
{
...
void func_154()//Position - 0x1F209
{
	int iVar0;
...
struct<2> func_155(int iParam0)//Position - 0x1F306
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_156(int iParam0)//Position - 0x1F33E
{
	struct<2> Var0;
...
void func_157(int iParam0, int iParam1)//Position - 0x1F78B
{
...
void func_158(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1F7D5
{
...
void func_159(int iParam0, int iParam1, int iParam2)//Position - 0x1F872
{
	struct<4> Var0;
	char* sVar1;
...
void func_160(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x1F8B1
{
...
void func_161(int iParam0, var uParam1)//Position - 0x1F8F6
{
	switch (iParam0)
	{
		case 0:
...
int func_163(int iParam0)//Position - 0x20BCF
{
	switch (iParam0)
	{
		case 0:
...
void func_164(int iParam0)//Position - 0x20F15
{
	Global_36412 = (unk_0x53C562FD2B9E3AB0() + iParam0);
}

void func_165()//Position - 0x20F27
{
	if (Global_90290)
	{
		func_154();
...
char* func_166(var uParam0)//Position - 0x20F5A
{
	uParam0 = uParam0;
	return "";
}

void func_167()//Position - 0x20F6A
{
	vector3 vVar0[24];
...
void func_168(int iParam0, int iParam1)//Position - 0x20FAD
{
	Global_90285 = iParam0;
	Global_90286 = iParam1;
}

void func_169()//Position - 0x20FC1
{
	if (Global_71110 != 6)
	{
	}
...
void func_170(var uParam0)//Position - 0x20FF9
{
	if (*uParam0 == -1)
	{
		return;
...
void func_171(int iParam0, bool bParam1)//Position - 0x21036
{
	struct<26> Var0;
	int iVar1;
	bool bVar2;
...
int func_172(int iParam0)//Position - 0x211BD
{
	switch (iParam0)
	{
		case 0:
...
void func_173(int iParam0)//Position - 0x21544
{
	func_175(iParam0, 1);
...
int func_174()//Position - 0x2157A
{
	return (Global_104555.f_9986.f_21 + Global_104555.f_18544.f_380);
}

void func_175(var uParam0, bool bParam1)//Position - 0x21596
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_176(int iParam0)//Position - 0x218BA
{
...
void func_177(int iParam0)//Position - 0x218ED
{
	switch (iParam0)
	{
		case 30:
...
void func_178(int iParam0, bool bParam1)//Position - 0x21922
{
	if (iParam0 == -1)
	{
		return;
...
void func_179(int iParam0, int iParam1, bool bParam2)//Position - 0x2197F
{
	if (iParam0 == -1)
	{
		return;
...
bool func_180(int iParam0, int iParam1)//Position - 0x219BA
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_181(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x219DD
{
	if (iParam0 != 198)
	{
		if (Global_70856)
...
void func_182(int iParam0, int iParam1)//Position - 0x21A38
{
	switch (iParam0)
	{
		case 12:
...
void func_183(int iParam0, bool bParam1)//Position - 0x21B21
{
	if (bParam1)
	{
...
bool func_184(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x21B4A
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_186()//Position - 0x224E2
{
	return Global_25234;
}

int func_187(var uParam0, int iParam1)//Position - 0x224ED
{
	int iVar0;
...
int func_188(int iParam0)//Position - 0x25D2C
{
	switch (iParam0)
	{
		case 46:
...
void func_189(int iParam0, bool bParam1)//Position - 0x25E1E
{
	switch (iParam0)
	{
		case 46:
...
void func_190(int iParam0, bool bParam1)//Position - 0x25E6F
{
	int iVar0;
...
void func_191(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x25ED5
{
	func_192(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_192(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x25EF7
{
	int iVar0;
...
void func_193()//Position - 0x260CB
{
	int iVar0;
...
int func_194(int iParam0)//Position - 0x261EB
{
	int iVar0;
	int iVar1;
...
int func_197(int iParam0)//Position - 0x26426
{
...
void func_198(int iParam0, int iParam1)//Position - 0x26453
{
...
int func_199(char* sParam0)//Position - 0x26490
{
	int iVar0;
...
int func_200()//Position - 0x264F0
{
	return func_201(unk_0x436287B7DB306165(), 0);
}

int func_201(char* sParam0, int iParam1)//Position - 0x26501
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
void func_202(int iParam0)//Position - 0x2654A
{
	bool bVar0;
	int iVar1;
...
int func_203(int iParam0)//Position - 0x265BB
{
	if (func_422(iParam0))
	{
...
void func_204(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x265E5
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
		if (!unk_0x3AB6A1A9084FB0A4(*iParam0))
...
void func_206()//Position - 0x26657
{
	if (iLocal_414 == 0)
	{
...
float func_207(int iParam0, vector3 vParam1, bool bParam2)//Position - 0x2669D
{
	vector3 vVar0;
...
void func_208()//Position - 0x266D7
{
	if (iLocal_409 == 0)
	{
		if (!unk_0x0F3033474C49912D(unk_0xFC1458A37D98B502(), -1208,581f, 309,8494f, 80,69189f, -1041,645f, 319,5811f, 60,40263f, 178,5f, 0, true, 0))
		{
			while (func_205())
			{
				func_223();
			...
			func_222(&uLocal_221, 2, unk_0xFC1458A37D98B502(), "TREVOR", 0, 1);
	...
	else if (iLocal_409 == 1)
	{
		if (iLocal_49 != 0)
		{
			if ((unk_0x53C562FD2B9E3AB0() - iLocal_412) > 6000)
			{
				if (iLocal_49 == 3)
				{
				...
				else if (iLocal_49 == 1)
				{
					if (func_422(Local_386.f_28[0]))
					{
						if (func_209(unk_0xFC1458A37D98B502(), Local_386.f_28[0], 1) < 75f)
						{
...
float func_209(int iParam0, int iParam1, bool bParam2)//Position - 0x26820
{
	vector3 vVar0;
	vector3 vVar1;
...
bool func_210(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2687E
{
...
int func_211(char* sParam0, int iParam1, bool bParam2)//Position - 0x268CC
{
	Global_15757 = 0;
...
void func_212()//Position - 0x26B98
{
	int iVar0;
...
void func_213()//Position - 0x26BCA
{
...
void func_216()//Position - 0x26D1F
{
	if (func_91(14))
	{
...
int func_217()//Position - 0x26DC1
{
	func_154();
	return Global_104555.f_2353.f_539.f_4301;
}

void func_218()//Position - 0x26DDA
{
	int iVar0;
...
bool func_219(int iParam0, int iParam1)//Position - 0x26E32
{
	switch (iParam0)
	{
		case 5:
...
void func_220()//Position - 0x26E6D
{
...
void func_221(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x26EC4
{
...
void func_222(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x26F1A
{
...
void func_223()//Position - 0x26FB5
{
	Global_14622 = 0;
	func_224();
}

void func_224()//Position - 0x26FC5
{
	if (unk_0x42111BD51D233AAB())
	{
		unk_0x495EB1DD7306493A();
...
void func_225()//Position - 0x26FE9
{
	switch (iLocal_49)
	{
		case 0:
			if (iLocal_48 == 3)
			{
				if (func_422(Local_386.f_28[0]))
				{
					unk_0xB8E08BD5B184DF4E(Local_386.f_28[0]);
					if (func_203(iLocal_391))
					{
						if (unk_0x396220A87B46A7B8(-1138,421f, 298,0307f, 65,90032f, 4f, 0, 1, 0, 0, 0, iLocal_391, 0))
						{
							func_470("Back gate blocked");
							vLocal_55 = { -1130,35f, 307,92f, 65,19f };
							unk_0x6931076730A4AC5D(&iLocal_389);
							unk_0x380C1E7B7740D618(0, vLocal_55, 2f, 20000, 1f, 1, 1193033728);
							...
							unk_0x1B16DD5C115FE009(iLocal_389);
							unk_0xE9B3D12A64CC7C1A(Local_386.f_28[0], true);
							unk_0xAB30B1CF01A198C1(Local_386.f_28[0], iLocal_389);
						}
						else
						{
							...
							if (func_203(iLocal_391))
							{
								unk_0xD2C269DBF147B406(0, iLocal_391, unk_0xFC1458A37D98B502(), 8, 30f, 786469, 500f, 0,1f, 1);
							}
							else
							{
								unk_0xD68E88A8E0BE8697(0, unk_0xFC1458A37D98B502(), 500f, -1, 0, 0);
					...
					else
					{
						...
						if (func_203(iLocal_391))
						{
							unk_0x6F8C8278B7C06889(0, iLocal_391, 20000, -1, 2f, 1, 0);
							unk_0xD2C269DBF147B406(0, iLocal_391, unk_0xFC1458A37D98B502(), 8, 30f, 786469, 500f, 0,1f, 1);
						}
						else
						{
					...
					unk_0xE17958D3FD0F9EE9(Local_386.f_28[0], 2, true);
					unk_0xFAA3EF7FF92E1F9E(&iLocal_389);
				}
				iLocal_413 = unk_0x53C562FD2B9E3AB0();
				unk_0xC854D7A2E956B946(Local_386.f_28[0], 1);
				unk_0xAE01EF4BC84AFE7C(Local_386.f_28[0], 177, true);
				iLocal_49 = 1;
			}
			break;
		...
		case 1:
			if (func_422(Local_386.f_28[0]))
			{
				if (!iLocal_406)
				{
					...
					{
						if (func_209(Local_386.f_28[0], unk_0xFC1458A37D98B502(), 0) < 20f)
						{
							func_222(&uLocal_221, 2, unk_0xFC1458A37D98B502(), "TREVOR", 0, 1);
							func_222(&uLocal_221, 4, Local_386.f_28[0], "JOSH", 0, 1);
							if (func_205())
				...
				if (func_203(iLocal_391))
				{
					if (unk_0xA8D0477084E86A92(Local_386.f_28[0], iLocal_391, 1))
					{
						if (unk_0xA7B0253B80B52B2B(iLocal_391) < 20f)
						{
							unk_0xB8E08BD5B184DF4E(Local_386.f_28[0]);
							unk_0x16416C5B54FDBCBB(Local_386.f_28[0], 0, 4416);
							unk_0xD68E88A8E0BE8697(Local_386.f_28[0], unk_0xFC1458A37D98B502(), 510f, -1, 0, 0);
							func_228(&iLocal_391);
						}
					}
					if (func_422(unk_0xFC1458A37D98B502()))
					{
						if (unk_0xA8D0477084E86A92(unk_0xFC1458A37D98B502(), iLocal_391, 1))
						{
							unk_0xB8E08BD5B184DF4E(Local_386.f_28[0]);
							unk_0xD68E88A8E0BE8697(Local_386.f_28[0], unk_0xFC1458A37D98B502(), 510f, -1, 0, 0);
							func_228(&iLocal_391);
					...
					if (unk_0x27C8A4034A05DC21(Local_386.f_28[0]))
					{
						if (iLocal_407 == 0)
						{
				...
				if (func_209(unk_0xFC1458A37D98B502(), Local_386.f_28[0], 1) > 350f)
				{
				...
				if (func_422(unk_0xFC1458A37D98B502()) && func_422(Local_386.f_28[0]))
				{
					if (iLocal_410 < 3)
					{
						if (func_209(unk_0xFC1458A37D98B502(), Local_386.f_28[0], 1) < 10f)
						{
							if (!func_205() && (unk_0x53C562FD2B9E3AB0() - iLocal_413) > 8000)
							{
			...
			{
				if (unk_0xEBE499597C718EB8(Local_386.f_28[0], unk_0xFC1458A37D98B502(), 1))
				{
...
void func_226(int iParam0)//Position - 0x2750D
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
...
void func_227(int iParam0)//Position - 0x275A9
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
		if (!unk_0x191BE1BC8F26F3C1(*iParam0, 0))
...
void func_228(int iParam0)//Position - 0x275EA
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
...
void func_229(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x27622
{
...
void func_230()//Position - 0x2765D
{
	Global_14622 = 0;
	func_220();
}

void func_231()//Position - 0x2766D
{
	switch (Local_47.f_11)
	{
		case 0:
			...
			while (iLocal_393 <= 4)
			{
				if (unk_0x0F3033474C49912D(unk_0xFC1458A37D98B502(), Local_415[iLocal_393 /*7*/], Local_415[iLocal_393 /*7*/].f_3, Local_415[iLocal_393 /*7*/].f_6, 0, true, 2))
				{
					func_232("Player detected inside flee direction trigger: ", iLocal_393);
					unk_0x6FF834D85E2DD4C6(iLocal_43);
					unk_0x6FF834D85E2DD4C6(iLocal_42);
					...
					unk_0x0D9525F20FB71C52(Local_47.f_9, Local_47.f_10);
					while ((!unk_0x0840F461D7BD8859(Local_47.f_9, Local_47.f_10) || !unk_0x9A0B2ED5055D3F0B(iLocal_43)) || !unk_0x9A0B2ED5055D3F0B(iLocal_42))
					{
						system::wait(0);
					}
		...
		case 1:
			if (!unk_0x6ADD12BF4D6D2587(Local_47.f_7))
			{
				Local_47.f_7 = unk_0xEA60F3B426BB095B(iLocal_43, Local_47, 0f, true, true, false);
				unk_0xACE486395AA1867D(Local_47.f_7, 1084227584);
				unk_0x47F55B6102CA9143(Local_47.f_7, Local_47.f_3, Local_47.f_4, Local_47.f_5, Local_47.f_6);
				Local_47.f_8 = unk_0x00D1A9572426E8DD(Local_47.f_7, 6, iLocal_42, -1, 1, true);
				unk_0x9E058151726E58DE(Local_47.f_8, joaat("weapon_pistol"), -1, false, true);
				unk_0x771A86309E0CA47B(Local_47.f_8, true);
				unk_0xB8E08BD5B184DF4E(Local_47.f_8);
		...
		case 2:
			...
			{
				if (func_422(Local_47.f_8))
				{
					if (unk_0x88DDBE9908752BF0(Local_47.f_8, 0))
					{
						unk_0x8D7ABC97ED508270(Local_47.f_7, Local_47.f_9, Local_47.f_10, 1);
						unk_0x62429167B5AEF353(Local_47.f_7, 1);
						func_232("*** m_AI_FleeCar.iRecNum: ", Local_47.f_9);
						switch (Local_47.f_9)
						{
							case 0:
								unk_0x3998782E46B46C7F(Local_47.f_7, 1,5f);
								break;
							
							case 1:
								unk_0x3998782E46B46C7F(Local_47.f_7, 1f);
								break;
							
							case 2:
								unk_0x3998782E46B46C7F(Local_47.f_7, 1,4f);
								break;
		...
		case 3:
			if (func_203(Local_47.f_7))
			{
				if (!unk_0x8DDE799D31A3D099(Local_47.f_7))
				{
					if (unk_0x0840F461D7BD8859(Local_47.f_9, Local_47.f_10))
					{
						unk_0x9E6ACDF1473CD846(Local_47.f_9, Local_47.f_10);
		...
		case 4:
			if (func_203(Local_47.f_7))
			{
				if (func_422(Local_47.f_8))
				{
					unk_0x771A86309E0CA47B(Local_47.f_8, false);
...
void func_232(char* sParam0, int iParam1)//Position - 0x27A42
{
	sParam0 = sParam0;
	iParam1 = iParam1;
}

void func_233()//Position - 0x27A52
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	switch (iLocal_48)
	{
		case 0:
			...
			if ((unk_0x53C562FD2B9E3AB0() - iLocal_394) > 4000)
			{
			...
			while (iVar0 <= (Local_386.f_28 - 1))
			{
				if (func_422(Local_386.f_28[iVar0]))
				{
					if (func_209(Local_386.f_28[iVar0], unk_0xFC1458A37D98B502(), 0) > 10f)
					{
		...
		case 2:
			if ((unk_0x53C562FD2B9E3AB0() - iLocal_394) > 20000)
			{
				func_470("************************************** TIMEOUT - ARREST next frame");
				if (func_422(Local_386.f_28[1]))
				{
					unk_0xB8E08BD5B184DF4E(Local_386.f_28[1]);
					unk_0x771A86309E0CA47B(Local_386.f_28[1], false);
					unk_0x121437322D07DD56(Local_386.f_28[1], unk_0xFC1458A37D98B502());
				}
				iLocal_48 = 4;
				iLocal_394 = unk_0x53C562FD2B9E3AB0();
			}
			...
			while (iVar0 <= (Local_386.f_28 - 1))
			{
				if (func_422(Local_386.f_28[iVar0]))
				{
					if (func_209(Local_386.f_28[iVar0], unk_0xFC1458A37D98B502(), 0) > 12f)
					{
		...
		case 3:
			...
			if (!iLocal_399)
			{
				...
				while (iVar0 <= (Local_386.f_28 - 1))
				{
					if (func_422(Local_386.f_28[iVar0]))
					{
						unk_0xB8E08BD5B184DF4E(Local_386.f_28[iVar0]);
						unk_0x771A86309E0CA47B(Local_386.f_28[iVar0], false);
						unk_0x6931076730A4AC5D(&iLocal_389);
						unk_0xDF28F1574E61F9EA(0, unk_0xFC1458A37D98B502(), -1, -687903391);
						unk_0x1B16DD5C115FE009(iLocal_389);
						unk_0xAB30B1CF01A198C1(Local_386.f_28[iVar0], iLocal_389);
						unk_0xFAA3EF7FF92E1F9E(&iLocal_389);
					}
					iVar0++;
				}
				func_222(&uLocal_56, 2, unk_0xFC1458A37D98B502(), "TREVOR", 0, 1);
				...
				iLocal_399 = 1;
				iLocal_411 = unk_0x53C562FD2B9E3AB0();
			}
			else
			{
				iVar1 = 1;
				...
				{
					if (func_422(Local_386.f_28[iVar1]))
					{
						if (func_209(Local_386.f_28[iVar1], unk_0xFC1458A37D98B502(), 1) > 20f)
						{
							unk_0xBB3CC641B6AED5E5(Local_386.f_28[iVar1], 75);
						}
						else
						{
							unk_0xBB3CC641B6AED5E5(Local_386.f_28[iVar1], 1);
						}
					}
					iVar1++;
				}
				if ((unk_0x53C562FD2B9E3AB0() - iLocal_411) > 15000)
				{
					iVar1 = 1;
					while (iVar1 <= (Local_386.f_28 - 1))
					{
						if (func_422(Local_386.f_28[iVar1]))
						{
							if (func_209(Local_386.f_28[iVar1], unk_0xFC1458A37D98B502(), 1) >= 50f)
							{
	...
	if (iLocal_48 != 3)
	{
		...
		while (iVar0 <= (Local_386.f_28 - 1))
		{
			if (func_422(Local_386.f_28[iVar0]))
			{
				if (unk_0x7B46BDDD99441E94(unk_0x9EB17624F44A8DA4(), Local_386.f_28[iVar0]))
				{
				...
				if (iLocal_48 != 4)
				{
					if (func_209(Local_386.f_28[iVar0], unk_0xFC1458A37D98B502(), 0) < 2,3f)
					{
...
int func_234(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)//Position - 0x27F59
{
	vector3 vVar0;
...
int func_235(int iParam0, float fParam1)//Position - 0x28016
{
	float fVar0;
...
bool func_236(int iParam0, float fParam1)//Position - 0x2808C
{
	return func_237(iParam0, unk_0xFC1458A37D98B502(), fParam1, 1, 250, 7);
}

bool func_237(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x280A4
{
	var uVar0;
	vector3 vVar1;
	int iVar2;
...
int func_238(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0x28165
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
Vector3 func_239(int iParam0, int iParam1)//Position - 0x28291
{
	int iVar0;
...
int func_241(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x283A0
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
...
float func_242(vector3 vParam0, vector3 vParam1)//Position - 0x28431
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

Vector3 func_243(vector3 vParam0)//Position - 0x28452
{
	float fVar0;
	float fVar1;
...
void func_244(var uParam0)//Position - 0x28491
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_245(int iParam0, int iParam1)//Position - 0x284AC
{
	int iVar0;
...
int func_246(int iParam0)//Position - 0x284EB
{
...
bool func_247(int iParam0, int iParam1, float fParam2)//Position - 0x28513
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_248(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x2855A
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_249(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x28655
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_250(int iParam0, float fParam1)//Position - 0x28761
{
	var uVar0;
	vector3 vVar1;
...
int func_251(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0x287F6
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
...
int func_252(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x28884
{
	if (bParam1)
	{
		if (unk_0x08765A6321A42CA1(unk_0xFC1458A37D98B502()))
...
void func_253()//Position - 0x288CC
{
	if (!iLocal_395)
	{
		func_222(&uLocal_56, 2, unk_0xFC1458A37D98B502(), "TREVOR", 0, 1);
	...
	else
	{
		...
		{
			case 0:
				if ((unk_0x53C562FD2B9E3AB0() - iLocal_52) > 1000)
				{
					iLocal_50 = 1;
				}
				break;
...
void func_254(char* sParam0, int iParam1, int iParam2)//Position - 0x28A08
{
	iParam2 = iParam2;
...
void func_255()//Position - 0x28A21
{
	if (iLocal_45 == 1)
	{
		if (unk_0xA8113D347D14630F())
		{
			if (unk_0xE57A999388F7FD02() > 14000 && !iLocal_403)
			{
...
void func_256()//Position - 0x28AB4
{
	int iVar0;
	vector3 vVar1;
	float fVar2;
	...
	if (unk_0x8AD07B6FC24F47C4())
	{
		if (func_422(Local_386.f_28[1]))
		{
			...
			unk_0x6A39A6ADDC38ABE4("Cop_standing_idle", Local_386.f_28[1], 0);
		}
		if (func_422(Local_386.f_28[2]))
		{
			func_470("Trying to set Cop 2 component variation (intro loop)");
			unk_0x6A39A6ADDC38ABE4("Cop_with_notepad", Local_386.f_28[2], 0);
		}
	}
	switch (iLocal_46)
	{
		case 0:
			if (!unk_0x74C475EB8E73D398(sLocal_41, ""))
			{
				if (iLocal_400 == 0)
				{
		...
		case 1:
			switch (iLocal_408)
			{
				case 0:
					if (func_284(1, 1093140480, 0))
					{
						...
						if (func_203(iVar0))
						{
							...
							else if (unk_0x0F3033474C49912D(iVar0, -1115,984f, 285,5924f, 61,94241f, -1097,599f, 285,1346f, 66,34669f, 33f, 0, true, 0))
							{
						...
						if (func_203(iLocal_390))
						{
							unk_0xBD8D47FDC6902B2D(iLocal_390, -1107,5f, 280,33f, 64,01f, 1, false, 0, 1);
							unk_0x48ED7B2293A96722(iLocal_390, 97,97f);
							unk_0xACE486395AA1867D(iLocal_390, 1084227584);
						}
						iLocal_408++;
					}
					break;
				...
				case 1:
					...
					unk_0x6FF834D85E2DD4C6(iLocal_392);
					iLocal_408++;
					break;
				
				case 2:
					if (((unk_0x3A801AA34DD821BE("rcmjosh4") && unk_0x3A801AA34DD821BE("combat@gestures@pistol@halt")) && unk_0x3A801AA34DD821BE("combat@gestures@pistol@glances")) && unk_0x9A0B2ED5055D3F0B(iLocal_392))
					{
						iLocal_408++;
					}
					break;
...
void func_257(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x28EE6
{
	int iVar0;
...
int func_258(int iParam0)//Position - 0x28F8D
{
	if (func_422(iParam0))
	{
		if (!unk_0x3AB6A1A9084FB0A4(iParam0))
...
void func_259(bool bParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x28FAD
{
	if (bParam0)
	{
...
bool func_260()//Position - 0x290C6
{
	return unk_0xC80D31E4B587871C(Global_1595693[unk_0x9EB17624F44A8DA4() /*680*/].f_39.f_18, 14);
}

bool func_261(int iParam0, int iParam1)//Position - 0x290E3
{
	bool bVar0;
...
int func_262(int iParam0, bool bParam1)//Position - 0x2912E
{
	int iVar0;
	int iVar1;
...
int func_263(int iParam0)//Position - 0x2916F
{
...
bool func_264()//Position - 0x291B1
{
	return unk_0xC80D31E4B587871C(Global_2359302, 3);
}

int func_265(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x291C2
{
	int iVar0;
...
void func_266(int iParam0)//Position - 0x291F5
{
	if (iParam0 == 1)
	{
...
void func_267()//Position - 0x29218
{
	if (unk_0xBBC745B9F75E27D0("Josh", 0))
	{
		if (func_422(Local_386.f_28[0]))
		{
			...
			unk_0xAB30B1CF01A198C1(Local_386.f_28[0], iLocal_389);
			unk_0xFAA3EF7FF92E1F9E(&iLocal_389);
			unk_0x31BBD48AA2503617(Local_386.f_28[0], 247561816, false, 1, 0);
		}
	}
	if (unk_0xBBC745B9F75E27D0("Security_guard_pistol", 0))
	{
		if (func_422(iLocal_387) && func_422(Local_386.f_28[1]))
		{
			unk_0x21E9EF6609513ECD(iLocal_387, Local_386.f_28[1]);
			func_470("*** Gave idle cop gun");
		}
	}
	if (unk_0xBBC745B9F75E27D0("FBI_Agent_1_Gun", 0))
	{
		if (func_422(iLocal_388) && func_422(Local_386.f_28[2]))
		{
			unk_0x21E9EF6609513ECD(iLocal_388, Local_386.f_28[2]);
	...
	if (unk_0xBBC745B9F75E27D0("Cop_standing_idle", 0))
	{
		if (func_422(Local_386.f_28[1]))
		{
			unk_0x31BBD48AA2503617(Local_386.f_28[1], 1063765679, false, 1, 0);
			unk_0x6931076730A4AC5D(&iLocal_389);
			...
			unk_0x1B16DD5C115FE009(iLocal_389);
			unk_0xAB30B1CF01A198C1(Local_386.f_28[1], iLocal_389);
			unk_0xFAA3EF7FF92E1F9E(&iLocal_389);
	...
	if (unk_0xBBC745B9F75E27D0("Cop_with_notepad", 0))
	{
		if (func_422(Local_386.f_28[2]))
		{
			unk_0x31BBD48AA2503617(Local_386.f_28[2], 1063765679, false, 1, 0);
			unk_0x6931076730A4AC5D(&iLocal_389);
			unk_0x60C06BFD037BB7CF(0, unk_0xFC1458A37D98B502(), -1, 1026, 2);
			unk_0x28D62AF360997F32(0, -1103,72f, 289,46f, 63,23f, unk_0xFC1458A37D98B502(), 1f, false, 0,1f, 1082130432, 1, 0, 1, -957453492, 20000);
			unk_0x28D62AF360997F32(0, -1106,08f, 288,55f, 63,31f, unk_0xFC1458A37D98B502(), 1f, false, 0,1f, 1082130432, 1, 0, 1, -957453492, 20000);
			unk_0x9627C22EF3C3F4D6(0, unk_0xFC1458A37D98B502(), -1, 1);
			unk_0x1B16DD5C115FE009(iLocal_389);
			unk_0xAB30B1CF01A198C1(Local_386.f_28[2], iLocal_389);
			unk_0xFAA3EF7FF92E1F9E(&iLocal_389);
...
void func_269(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)//Position - 0x294B7
{
	int iVar0;
...
void func_270(int iParam0, bool bParam1)//Position - 0x29675
{
...
Vector3 func_271(int iParam0)//Position - 0x296B1
{
	return unk_0xB3328BA8976B416C(unk_0x25D049AAC4603E65(iParam0), 0);
}

void func_272(bool bParam0)//Position - 0x296C4
{
	int iVar0;
...
Vector3 func_273()//Position - 0x29700
{
	return 2,55f, 5,665f, 2,55f;
}

void func_274(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)//Position - 0x29717
{
	func_275(vParam0, vParam1, fParam2, vParam3, fParam4, vParam5, bParam6, bParam7, bParam8, bParam9, bParam10);
}

void func_275(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)//Position - 0x29741
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_276(vector3 vParam0)//Position - 0x29B35
{
...
int func_277(int iParam0, int iParam1, bool bParam2)//Position - 0x29B5F
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_278(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x29BD0
{
...
int func_279(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3)//Position - 0x29CB0
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
...
int func_280(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)//Position - 0x29FA6
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_281(int iParam0)//Position - 0x2A05A
{
	if (unk_0x6ADD12BF4D6D2587(iParam0))
	{
		if (unk_0xB8DE76287EDC4957(iParam0, 0))
...
void func_282()//Position - 0x2A0BF
{
	int iVar0;
...
void func_283()//Position - 0x2A0DF
{
	if (func_422(unk_0xFC1458A37D98B502()))
	{
	...
	if (func_422(Local_386.f_28[0]))
	{
		unk_0x4982ECE0928DA13D(Local_386.f_28[0], "Josh", 0, 0, 0);
		func_470("*** Registered Josh");
	}
	if (func_422(Local_386.f_28[1]))
	{
		iLocal_387 = unk_0xD50A2A2DB03A5CF0(joaat("weapon_pistol"), -1, unk_0xB3328BA8976B416C(Local_386.f_28[1], 1), 1, 1065353216, 0, 0, 1);
		unk_0x4982ECE0928DA13D(Local_386.f_28[1], "Cop_standing_idle", 0, 0, 0);
		func_470("*** Registered Cop standing");
	}
	if (func_422(Local_386.f_28[2]))
	{
		iLocal_388 = unk_0xD50A2A2DB03A5CF0(joaat("weapon_pistol"), -1, unk_0xB3328BA8976B416C(Local_386.f_28[2], 1), 1, 1065353216, 0, 0, 1);
		unk_0x4982ECE0928DA13D(Local_386.f_28[2], "Cop_with_notepad", 0, 0, 0);
		func_470("*** Registered Cop with notepad");
	}
	if (func_422(iLocal_387))
	{
		unk_0x4982ECE0928DA13D(iLocal_387, "Security_guard_pistol", 0, 0, 0);
		func_470("*** Registered idle cop gun");
	}
	if (func_422(iLocal_388))
	{
		unk_0x4982ECE0928DA13D(iLocal_388, "FBI_Agent_1_Gun", 0, 0, 0);
...
int func_284(int iParam0, float fParam1, int iParam2)//Position - 0x2A223
{
	int iVar0;
...
bool func_285()//Position - 0x2A2F7
{
	bool bVar0;
...
void func_286()//Position - 0x2A31A
{
...
int func_287(int iParam0, int iParam1)//Position - 0x2A36B
{
	if (func_258(iParam0))
	{
...
int func_288(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x2A39E
{
...
void func_289(int iParam0)//Position - 0x2A52D
{
	if (!unk_0x191BE1BC8F26F3C1(iParam0, 0))
	{
...
void func_290(int iParam0)//Position - 0x2A559
{
	iLocal_45 = iParam0;
	iLocal_46 = 0;
}

void func_291(int iParam0)//Position - 0x2A568
{
	unk_0x6450931B826B49D9("combat@gestures@pistol@halt");
	unk_0x6450931B826B49D9("combat@gestures@pistol@glances");
	unk_0x6FF834D85E2DD4C6(iLocal_392);
	while ((!unk_0x3A801AA34DD821BE("combat@gestures@pistol@halt") || !unk_0x3A801AA34DD821BE("combat@gestures@pistol@glances")) || !unk_0x9A0B2ED5055D3F0B(iLocal_392))
	{
		system::wait(0);
	}
	...
	if (func_422(Local_386.f_28[0]))
	{
		if (iParam0 == 1)
		{
			unk_0xBD8D47FDC6902B2D(Local_386.f_28[0], -1103,962f, 291,3401f, 63,367f, 1, false, 0, 1);
			unk_0x48ED7B2293A96722(Local_386.f_28[0], 193,1737f);
			unk_0x12C9D41D52A560D6(Local_386.f_28[0], "rcmjosh4", "josh_leadout_loop", 8f, -8f, -1, 1, 0, 0, 0, 0);
		}
		unk_0x35829E9BFCED1A3F(Local_386.f_28[0], true);
		unk_0x5C5D33A1B2711D21(Local_386.f_28[0], true);
	}
	if (iParam0 == 1)
	{
		if (func_422(Local_386.f_28[2]))
		{
			unk_0x9E058151726E58DE(Local_386.f_28[2], joaat("weapon_pistol"), -1, true, true);
			unk_0xBD8D47FDC6902B2D(Local_386.f_28[2], -1106,08f, 288,55f, 63,31f, 1, false, 0, 1);
			unk_0x6931076730A4AC5D(&iLocal_389);
			unk_0x9627C22EF3C3F4D6(0, unk_0xFC1458A37D98B502(), -1, 1);
			unk_0x1B16DD5C115FE009(iLocal_389);
			unk_0xAB30B1CF01A198C1(Local_386.f_28[2], iLocal_389);
			unk_0xFAA3EF7FF92E1F9E(&iLocal_389);
			unk_0x771A86309E0CA47B(Local_386.f_28[2], true);
		}
	}
	if (iParam0 == 1)
	{
		if (func_422(Local_386.f_28[1]))
		{
			unk_0x9E058151726E58DE(Local_386.f_28[1], joaat("weapon_pistol"), -1, true, true);
			unk_0xBD8D47FDC6902B2D(Local_386.f_28[1], -1102,41f, 289,73f, 63,18f, 1, false, 0, 1);
			unk_0x6931076730A4AC5D(&iLocal_389);
			unk_0x9627C22EF3C3F4D6(0, unk_0xFC1458A37D98B502(), -1, 1);
			unk_0x1B16DD5C115FE009(iLocal_389);
			unk_0xAB30B1CF01A198C1(Local_386.f_28[1], iLocal_389);
			unk_0xFAA3EF7FF92E1F9E(&iLocal_389);
			unk_0x771A86309E0CA47B(Local_386.f_28[1], true);
		}
	}
	if (func_422(Local_386.f_28[1]))
	{
		unk_0xAE6EBBBBD8B9FB30(Local_386.f_28[1], 23, true);
	}
	if (func_422(Local_386.f_28[2]))
	{
		unk_0xAE6EBBBBD8B9FB30(Local_386.f_28[2], 23, true);
	}
	if (func_203(Local_386.f_35[1]))
	{
		unk_0x4BEFCD5DAE410A90(Local_386.f_35[1], 1);
	}
	func_222(&uLocal_221, 2, unk_0xFC1458A37D98B502(), "TREVOR", 0, 1);
	iLocal_395 = 0;
	iLocal_396 = 0;
...
void func_292(char* sParam0, bool bParam1)//Position - 0x2A858
{
	func_272(bParam1);
	unk_0x393584863A2F304E(sParam0, 8);
}

void func_293()//Position - 0x2A86E
{
	func_295();
	if (unk_0x8AD07B6FC24F47C4())
	{
	...
	{
		case 0:
			if (!func_5(0) && unk_0x0F3033474C49912D(unk_0xFC1458A37D98B502(), -1107,353f, 281,626f, 61,46451f, -1099,521f, 282,5073f, 65,99223f, 16f, 0, true, 0))
			{
		...
		case 1:
			if (!func_5(0) && unk_0x0F3033474C49912D(unk_0xFC1458A37D98B502(), -1107,353f, 281,626f, 61,46451f, -1099,521f, 282,5073f, 65,99223f, 16f, 0, true, 0))
			{
				if (func_422(unk_0xFC1458A37D98B502()) && func_258(Local_386.f_28[0]))
				{
					if (unk_0x0F3033474C49912D(unk_0xFC1458A37D98B502(), -1105,571f, 290,008f, 62,87176f, -1100,577f, 290,4298f, 66,45212f, 4,5f, 0, true, 0))
					{
						if (!func_294())
						{
							if (!func_287(unk_0xFC1458A37D98B502(), -875674219))
							{
								unk_0xAC838A977FB6E6BC(unk_0xFC1458A37D98B502(), Local_386.f_28[0], 0);
							}
						}
						else
						{
				...
				if (!iLocal_400)
				{
					...
					{
						if (unk_0xA5F6598E13F98E08(Local_386.f_28[0], "rcmjosh4", "beckon_a_josh", 3) && !func_205())
						{
							unk_0x12C9D41D52A560D6(Local_386.f_28[0], "rcmjosh4", "josh_4_leadin_josh", 2f, -8f, -1, 2, 0, 0, 0, 0);
							func_470("Done Josh leadin anim");
							if (func_258(Local_386.f_28[2]))
							{
								unk_0x12C9D41D52A560D6(Local_386.f_28[2], "rcmjosh4", "josh_4_leadin_cop_a", 8f, -8f, -1, 2, 0, 0, 0, 0);
								func_470("Done Notepad cop leadin anim");
							}
							if (func_258(Local_386.f_28[1]))
							{
								unk_0x12C9D41D52A560D6(Local_386.f_28[1], "rcmjosh4", "josh_4_leadin_cop_b", 8f, -8f, -1, 2, 0, 0, 0, 0);
				...
				{
					if ((func_422(unk_0xFC1458A37D98B502()) && func_258(Local_386.f_28[0])) && !func_294())
					{
						if (!func_287(unk_0xFC1458A37D98B502(), -875674219))
						{
							unk_0xAC838A977FB6E6BC(unk_0xFC1458A37D98B502(), Local_386.f_28[0], 0);
					...
					if (func_258(Local_386.f_28[0]))
					{
						if (unk_0xA5F6598E13F98E08(Local_386.f_28[0], "rcmjosh4", "josh_4_leadin_josh", 3))
						{
							if (unk_0x7A70772AE40E3821(Local_386.f_28[0], "rcmjosh4", "josh_4_leadin_josh") > 0,276f)
							{
								if (iLocal_401 == 0)
								{
							...
							if (unk_0x7A70772AE40E3821(Local_386.f_28[0], "rcmjosh4", "josh_4_leadin_josh") > 0,98f)
							{
								func_290(1);
							}
							if (func_209(unk_0xFC1458A37D98B502(), Local_386.f_28[0], 1) <= 2f)
							{
								if (func_205())
								{
									func_223();
...
void func_295()//Position - 0x2AC79
{
	func_297(0);
	func_286();
	func_296();
...
void func_296()//Position - 0x2AC8E
{
	if (unk_0x5BEF7A5AB8F17255(unk_0x9EB17624F44A8DA4()))
	{
		if (unk_0x88DDBE9908752BF0(unk_0xFC1458A37D98B502(), 0))
...
void func_297(int iParam0)//Position - 0x2ACE6
{
...
void func_298(int iParam0)//Position - 0x2AD0F
{
	if (Global_14615)
	{
		func_299(0, 0);
...
void func_299(bool bParam0, bool bParam1)//Position - 0x2AD7F
{
	if (bParam0)
	{
		if (func_300(0))
...
int func_300(int iParam0)//Position - 0x2ADF3
{
	if (iParam0 == 1)
	{
		if (Global_14453.f_1 > 3)
...
void func_301(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2AE4D
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_71110 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !unk_0x3E9CABD07B829173())
			{
				...
				Var4 = { func_303(Global_71111, Global_71113, iParam5) };
				if (fVar6 == -0,014f)
				{
				}
...
float func_302(char* sParam0)//Position - 0x2B132
{
	unk_0x0792909D8327DAEA(sParam0);
	return unk_0xF2A1AF58CC57C564(1);
}

struct<2> func_303(int iParam0, int iParam1, int iParam2)//Position - 0x2B145
{
	struct<2> Var0;
	int iVar1;
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar1)
			{
				...
				default:
					StringCopy(&Var0, func_304(iVar1), 8);
					break;
			}
			break;
...
char* func_304(int iParam0)//Position - 0x2B21C
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_305(int iParam0)//Position - 0x2B384
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_306(int iParam0)//Position - 0x2B3B9
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_307(int iParam0)//Position - 0x2B3EE
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_308(int iParam0)//Position - 0x2B423
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_309(int iParam0)//Position - 0x2B458
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_310(int iParam0)//Position - 0x2B497
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_311(int iParam0)//Position - 0x2B4CC
{
	struct<2> Var0;
...
int func_312(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x2B539
{
...
bool func_313(bool bParam0)//Position - 0x2B652
{
	if (bParam0)
	{
...
int func_314(int iParam0)//Position - 0x2B67B
{
	if (Global_35861 == 15)
	{
		return 0;
...
bool func_315(int iParam0)//Position - 0x2B69D
{
	return func_316(iParam0, Global_35861);
}

int func_316(int iParam0, int iParam1)//Position - 0x2B6AE
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_317()//Position - 0x2B88F
{
	if (func_422(Local_386.f_28[1]))
	{
		unk_0xAA93B7B448E10E40(Local_386.f_28[1], -1102,48f, 290,2f, 64,22f, 0, 0, 1);
		unk_0x48ED7B2293A96722(Local_386.f_28[1], 177,74f);
	}
	else
	{
		Local_386.f_28[1] = unk_0xAC992EFAD62C33BF(6, iLocal_42, -1102,92f, 290,12f, -200f, 40,46f, 0, false);
	}
	if (func_422(Local_386.f_28[2]))
	{
		unk_0xAA93B7B448E10E40(Local_386.f_28[2], -1103,94f, 290,21f, 64,28f, 0, 0, 1);
		unk_0x48ED7B2293A96722(Local_386.f_28[2], -167,67f);
	}
	else
	{
		Local_386.f_28[2] = unk_0xAC992EFAD62C33BF(6, iLocal_42, -1102,73f, 290,91f, -200f, 92,06f, 0, false);
	}
	if (!func_323())
	{
		func_322(unk_0xFC1458A37D98B502(), vLocal_53, fLocal_54, 1, 1);
		unk_0x7C9705890EF6612E(0f, 1065353216);
		unk_0xBB9A3C553EECB180(0f);
	}
	func_291(1);
	unk_0x6FF834D85E2DD4C6(iLocal_392);
	while (!unk_0x9A0B2ED5055D3F0B(iLocal_392))
	{
		system::wait(0);
	}
	func_290(2);
...
void func_318(int iParam0, int iParam1, int iParam2)//Position - 0x2BA2F
{
...
void func_319(int iParam0, int iParam1, int iParam2)//Position - 0x2BA63
{
...
int func_320(bool bParam0, bool bParam1)//Position - 0x2BB27
{
	int iVar0;
...
int func_321(bool bParam0, bool bParam1)//Position - 0x2BB95
{
	int iVar0;
...
int func_322(int iParam0, vector3 vParam1, float fParam2, bool bParam3, int iParam4)//Position - 0x2BC3B
{
	bool bVar0;
	float fVar1;
...
bool func_323()//Position - 0x2BC97
{
	return unk_0xC80D31E4B587871C(Global_92833.f_20, 13);
}

void func_324(int iParam0, vector3 vParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x2BCAB
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		if (!func_415(iParam4, iParam5, iParam6, iParam11))
		{
			iVar0 = 0;
		}
	}
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_393(vParam1, fParam2);
	}
	else if (iParam7 == 1)
	{
		if (func_392(vParam1, 0f, 0f, 0f, 0))
		{
			vParam1 = { Global_98118.f_2875 };
			fParam2 = Global_98118.f_2875.f_6;
		}
		unk_0x247EAA2E93D4A021(vParam1, 5f, 1, 0, 0, false);
		func_386(vParam1, 5f, 0);
		if (func_151(iParam10))
		{
			func_384(iParam10, 0);
			while (!func_325(iParam0, iParam10, vParam1, fParam2, 1, 0))
			{
				system::wait(0);
			}
		}
...
int func_325(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4, int iParam5)//Position - 0x2BE3F
{
	int iVar0;
	var uVar1;
	struct<97> Var2;
		...
		else
		{
			...
			if (unk_0x9A0B2ED5055D3F0B(Var2))
			{
				...
				*iParam0 = unk_0xEA60F3B426BB095B(Var2, vParam2, fParam3, true, true, false);
				...
				func_378(iParam0, &(Var2.f_31), &(Var2.f_81));
				unk_0xC0E8D21B09ADD40A(*iParam0, Var2.f_96);
				if (iParam1 == 1)
				{
...
void func_326(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x2CC84
{
	var uVar0;
	int iVar1;
	int iVar2;
...
int func_327(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)//Position - 0x2D898
{
	int iVar0;
	int iVar1;
	char* sVar2;
...
bool func_328(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)//Position - 0x2D90B
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
float func_329(int iParam0)//Position - 0x2EEAD
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_330(int iParam0, var uParam1, var uParam2)//Position - 0x2EF5D
{
	int iVar0;
	int iVar1;
...
int func_331(int iParam0, bool bParam1, var uParam2)//Position - 0x2F037
{
	int iVar0;
	bool bVar1;
...
int func_332(int iParam0)//Position - 0x2F197
{
	int iVar0;
...
int func_333(int iParam0)//Position - 0x2F1D2
{
	if (iParam0 != func_336())
	{
...
int func_334(int iParam0)//Position - 0x2F218
{
	switch (iParam0)
	{
		case 0:
...
int func_335(int iParam0, bool bParam1, bool bParam2)//Position - 0x2F4DC
{
	int iVar0;
...
int func_336()//Position - 0x2F526
{
	return -1;
}

int func_337(int iParam0)//Position - 0x2F52F
{
	switch (iParam0)
	{
		case -2118308144:
...
int func_338(int iParam0)//Position - 0x2F564
{
...
int func_339(int iParam0)//Position - 0x2F593
{
...
int func_340(int iParam0)//Position - 0x2F64C
{
	if (!unk_0x6ADD12BF4D6D2587(iParam0) || !unk_0xB8DE76287EDC4957(iParam0, 0))
	{
		return 0;
...
int func_341(int iParam0)//Position - 0x2F682
{
	switch (iParam0)
	{
		case 562680400:
...
int func_342(int iParam0, bool bParam1)//Position - 0x2F6CF
{
	switch (unk_0x82FF3DFBC3965CC0(iParam0))
	{
...
int func_343(int iParam0)//Position - 0x2F72A
{
	int iVar0;
...
int func_344(int iParam0, int iParam1)//Position - 0x2F764
{
	if (iParam1 == 0)
	{
...
bool func_345()//Position - 0x2F944
{
	return unk_0x21EA5D4DC72DE119(2067165443);
}

bool func_346()//Position - 0x2F955
{
	return unk_0x21EA5D4DC72DE119(-957277403);
}

bool func_347()//Position - 0x2F966
{
	return unk_0x21EA5D4DC72DE119(210122941);
}

bool func_348()//Position - 0x2F977
{
	return unk_0x21EA5D4DC72DE119(-1894522408);
}

bool func_349()//Position - 0x2F988
{
	return unk_0x21EA5D4DC72DE119(1630677557);
}

int func_350(int iParam0, int iParam1)//Position - 0x2F999
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
int func_351(int iParam0)//Position - 0x2FC0C
{
	if (iParam0 != func_336())
	{
		if (func_335(iParam0, 1, 1))
...
int func_352(int iParam0)//Position - 0x2FC6B
{
	if (iParam0 != func_336())
	{
		if (func_335(iParam0, 1, 1))
...
int func_353(int iParam0)//Position - 0x2FCCB
{
	if (iParam0 != func_336())
	{
		if (func_335(iParam0, 1, 1))
...
int func_354(int iParam0, bool bParam1, var uParam2)//Position - 0x2FD12
{
	bool bVar0;
...
int func_355(int iParam0)//Position - 0x3012A
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_356(int iParam0, int iParam1)//Position - 0x30153
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_357(int iParam0, var uParam1)//Position - 0x30355
{
	int iVar0;
...
int func_358(int iParam0)//Position - 0x30602
{
	switch (iParam0)
	{
		case 1:
...
int func_359(int iParam0)//Position - 0x306B2
{
	switch (iParam0)
	{
		case joaat("granger"):
...
int func_360(int iParam0)//Position - 0x306D2
{
...
int func_361(int iParam0)//Position - 0x307AF
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_362(int iParam0, bool bParam1)//Position - 0x30960
{
	int iVar0;
	struct<2> Var1;
...
int func_363(int iParam0)//Position - 0x30AEE
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_365(int iParam0)//Position - 0x30BD9
{
	int iVar0;
	int iVar1;
...
int func_366()//Position - 0x32461
{
	return 0;
}

int func_367()//Position - 0x3246A
{
	return 1;
}

int func_368()//Position - 0x32473
{
	return 1;
}

int func_369()//Position - 0x3247C
{
...
int func_371(int iParam0)//Position - 0x32550
{
	int iVar0;
	char* sVar1;
...
int func_372(int iParam0)//Position - 0x32597
{
	int iVar0;
...
int func_373(int iParam0)//Position - 0x32613
{
	int iVar0;
...
int func_374(int iParam0)//Position - 0x326FB
{
	int iVar0;
...
void func_375(int iParam0, int iParam1)//Position - 0x3275E
{
	int iVar0;
...
void func_376(int iParam0)//Position - 0x327E0
{
	if (!func_377(*iParam0))
	{
...
bool func_377(int iParam0)//Position - 0x3280B
{
	return unk_0x7C7056D6F2A31BF6(iParam0, 5);
}

int func_378(int iParam0, var uParam1, var uParam2)//Position - 0x3281A
{
	int iVar0;
	int iVar1;
	...
	if (func_350(unk_0x82FF3DFBC3965CC0(*iParam0), 1) && unk_0xF928889F6E5C7677(*iParam0, 24) != func_381(*iParam0, ((*uParam1)[38] - 1)))
	{
		unk_0xA9EF3F93CBFFF6D0(*iParam0, 24, func_381(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_380(iParam0);
	if (func_379(*iParam0))
	{
...
int func_379(int iParam0)//Position - 0x32998
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_380(var uParam0)//Position - 0x32A76
{
...
int func_381(int iParam0, int iParam1)//Position - 0x32AB6
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_382(var uParam0, int iParam1)//Position - 0x32B9B
{
	if (unk_0x3A711520F83BAE98())
	{
	}
...
void func_383(int iParam0, var uParam1, int iParam2)//Position - 0x32BDC
{
	int iVar0;
...
void func_384(int iParam0, int iParam1)//Position - 0x32E3D
{
	int iVar0;
...
int func_385(int iParam0, int iParam1)//Position - 0x32EDB
{
	struct<82> Var0;
...
void func_386(vector3 vParam0, float fParam1, bool bParam2)//Position - 0x32F1D
{
	int iVar0;
...
void func_387(int iParam0)//Position - 0x32F6D
{
	bool bVar0;
...
void func_388(var uParam0, var uParam1)//Position - 0x330DF
{
...
int func_389(int iParam0, int iParam1)//Position - 0x331AB
{
	int iVar0;
...
int func_390(var uParam0)//Position - 0x3321D
{
	return *uParam0;
}

int func_391(var uParam0, int iParam1)//Position - 0x33228
{
	int iVar0;
	int iVar1;
...
bool func_392(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x34925
{
	if (bParam2)
	{
...
int func_393(vector3 vParam0, float fParam1)//Position - 0x3496C
{
	return func_394(&(Global_98118.f_2875), vParam0, fParam1, 0);
}

int func_394(var uParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0x34986
{
	int iVar0;
	vector3 vVar1;
	bool bVar2;
...
int func_395(int iParam0)//Position - 0x34C39
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_396(int iParam0, vector3 vParam1, bool bParam2)//Position - 0x34CFC
{
	int iVar0;
	var uVar1[3];
	int iVar2;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_398(iParam0, uVar1[iVar3], 1) && func_397(unk_0xB3328BA8976B416C(uVar1[iVar3], 1), 2136,133f, 4780,563f, 39,9702f, 5f, 0))
				{
					if ((!bParam2 || func_392(vParam1, 0f, 0f, 0f, 0)) || unk_0xBE3C4023003180FC(unk_0xB3328BA8976B416C(iParam0, 1), unk_0xB3328BA8976B416C(uVar1[iVar3], 1), true) < 10f)
					{
						unk_0xC91FE17AD7353B70(&iParam0);
						return 1;
					}
...
int func_397(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0x34F04
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
int func_398(int iParam0, int iParam1, bool bParam2)//Position - 0x34F7F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_399(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x34FE0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_400(int iParam0, int iParam1)//Position - 0x35532
{
	int iVar0;
	int iVar1;
...
bool func_401()//Position - 0x35597
{
	return unk_0x21EA5D4DC72DE119(-1691188696);
}

int func_402(int iParam0)//Position - 0x355A8
{
	int iVar0;
...
int func_403(int iParam0)//Position - 0x355F6
{
	if (unk_0x88DDBE9908752BF0(unk_0xFC1458A37D98B502(), 0))
	{
...
int func_404(int iParam0)//Position - 0x3567D
{
...
int func_405(int iParam0)//Position - 0x356AF
{
...
int func_406(int iParam0)//Position - 0x356CC
{
...
int func_407(int iParam0, int iParam1)//Position - 0x356EF
{
...
int func_408(int iParam0)//Position - 0x3572A
{
	if (func_407(iParam0, 0))
	{
...
int func_409(int iParam0, int iParam1)//Position - 0x3574D
{
	int iVar0;
...
int func_410(var uParam0)//Position - 0x3579A
{
	if (func_411(uParam0))
	{
...
int func_411(var uParam0)//Position - 0x357CF
{
...
bool func_412()//Position - 0x3582E
{
	return func_410(&(Global_98118.f_2875));
}

void func_413()//Position - 0x35841
{
	func_414(&(Global_98118.f_2875));
}

void func_414(var uParam0)//Position - 0x35854
{
	if (func_411(uParam0))
	{
...
int func_415(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x35872
{
...
int func_417(int iParam0)//Position - 0x35975
{
	switch (iParam0)
	{
		case joaat("police"):
...
bool func_418()//Position - 0x359CE
{
	return func_411(&(Global_98118.f_2875));
}

void func_419(int iParam0, int iParam1, bool bParam2)//Position - 0x359E1
{
	Global_3009 = iParam0;
...
void func_420()//Position - 0x35B8B
{
	char cVar0[64];
	char cVar1[64];
	char* sVar2;
...
void func_421()//Position - 0x35C0E
{
	vLocal_53 = { -1102,906f, 284,731f, 63,0602f };
	fLocal_54 = 9,4866f;
...
int func_422(int iParam0)//Position - 0x35F28
{
	if (unk_0x6ADD12BF4D6D2587(iParam0))
	{
		if (!unk_0x191BE1BC8F26F3C1(iParam0, 0))
...
void func_423(var uParam0, bool bParam1, bool bParam2)//Position - 0x35F49
{
	int iVar0;
...
int func_424(var uParam0)//Position - 0x3603E
{
	int iVar0[4];
	int iVar1;
	float fVar2;
		...
		case 2:
			...
			if (!unk_0x6ADD12BF4D6D2587(uParam0->f_28[1]))
			{
				...
				if (func_422(uParam0->f_28[1]))
				{
					...
					unk_0x9E058151726E58DE(uParam0->f_28[1], joaat("weapon_pistol"), -1, false, true);
					if (unk_0x3A801AA34DD821BE("rcmjosh4"))
					{
			...
			if (!unk_0x6ADD12BF4D6D2587(uParam0->f_28[2]))
			{
				...
				if (func_422(uParam0->f_28[2]))
				{
					...
					unk_0x9E058151726E58DE(uParam0->f_28[2], joaat("weapon_pistol"), -1, false, true);
					if (unk_0x3A801AA34DD821BE("rcmjosh4"))
					{
			...
			if (!unk_0x6ADD12BF4D6D2587(uParam0->f_35[1]))
			{
				...
				if (func_203(uParam0->f_35[1]))
				{
					...
					fVar2 = unk_0xA7B0253B80B52B2B(uParam0->f_35[1]);
					fVar2 = (fVar2 / 2f);
					unk_0xB38E13EF2EC6F0E9(uParam0->f_35[1], fVar2);
...
void func_425(int iParam0, bool bParam1)//Position - 0x36438
{
	vector3 vVar0;
	float fVar1;
	...
	func_426(iParam0, iLocal_39, vVar0, fVar1);
	unk_0x207466E78DA21033(*iParam0, 4);
	unk_0x4BEFCD5DAE410A90(*iParam0, 3);
	unk_0x4C44781F822B0B00(*iParam0, false, 0);
	unk_0xFA87254221D30EB8(*iParam0, 1);
}

void func_426(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0x364AC
{
	func_226(iParam0);
...
void func_427(int iParam0, int iParam1, vector3 vParam2, float fParam3, int iParam4)//Position - 0x364EE
{
	func_227(iParam0);
	*iParam0 = unk_0xAC992EFAD62C33BF(iParam4, iParam1, vParam2, fParam3, 0, false);
}

int func_428(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)//Position - 0x3650F
{
	if (func_429(iParam0, iParam1, vParam2, fParam3, 1))
	{
		if (unk_0x6ADD12BF4D6D2587(*iParam0))
		{
			if (!unk_0x191BE1BC8F26F3C1(*iParam0, 0))
...
int func_429(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)//Position - 0x3656B
{
	int iVar0;
...
int func_430(var uParam0, int iParam1)//Position - 0x365F9
{
	int iVar0;
...
int func_431(var uParam0)//Position - 0x3663F
{
	if (func_432(uParam0))
	{
...
int func_432(var uParam0)//Position - 0x36669
{
...
int func_433(int iParam0)//Position - 0x3668E
{
	int iVar0;
...
void func_434(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x366BF
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
void func_435(vector3 vParam0, float fParam1, int iParam2, int iParam3)//Position - 0x366FB
{
	if (func_436())
	{
...
void func_437()//Position - 0x367B4
{
	int iVar0;
	...
	func_438(&Local_386, 1, 0, 0);
	unk_0x14776E43F90DD454(iLocal_43);
	unk_0x14776E43F90DD454(iLocal_42);
	unk_0x96A3D9A8A4C7AFD4();
}

void func_438(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x36886
{
...
void func_439(var uParam0, bool bParam1)//Position - 0x368A6
{
	func_440(&(uParam0->f_41), bParam1);
}

void func_440(var uParam0, bool bParam1)//Position - 0x368B8
{
	int iVar0;
...
void func_441(int iParam0, bool bParam1)//Position - 0x368F6
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
...
void func_442(int iParam0)//Position - 0x36931
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
		if (unk_0x6049C20F5D5C185B(*iParam0))
...
void func_443(var uParam0, bool bParam1)//Position - 0x3695C
{
	func_444(&(uParam0->f_35), bParam1);
}

void func_444(var uParam0, bool bParam1)//Position - 0x3696E
{
	int iVar0;
...
void func_445(var uParam0, int iParam1)//Position - 0x369AB
{
	func_446(&(uParam0->f_28), iParam1);
}

void func_446(var uParam0, int iParam1)//Position - 0x369BD
{
	int iVar0;
...
void func_448(bool bParam0)//Position - 0x36A9F
{
	int iVar0;
...
void func_449(char* sParam0, int iParam1)//Position - 0x36B6F
{
	if (Global_92833 != 12)
	{
...
int func_450(char* sParam0, int iParam1, int iParam2)//Position - 0x36B97
{
	int iVar0;
	struct<32> Var1;
	int iVar2;
	...
	if (func_456())
	{
		...
		{
			iVar2 = func_451(unk_0x436287B7DB306165());
			if (iVar2 > -1)
			{
...
int func_451(char* sParam0)//Position - 0x36D29
{
...
int func_453(char* sParam0, bool bParam1)//Position - 0x36DA7
{
	int iVar0;
	int iVar1;
...
int func_454(int iParam0, bool bParam1)//Position - 0x36DD1
{
	int iVar0;
...
void func_457(bool bParam0)//Position - 0x36EC3
{
	unk_0x4255E93FCCDE108E(bParam0);
	unk_0x9B47B379EE749C38(bParam0);
}

void func_458(int iParam0)//Position - 0x36ED7
{
	if (iParam0 == 1)
	{
		unk_0x6489707B038D749C();
...
void func_459(int iParam0)//Position - 0x36F14
{
	if (iParam0 == 1)
	{
...
void func_460()//Position - 0x36F51
{
	Global_17162.f_5 = 1;
}

void func_461()//Position - 0x36F5F
{
	Global_17162.f_5 = 0;
}

void func_462(bool bParam0)//Position - 0x36F6D
{
	if (bParam0)
	{
		func_463();
...
void func_463()//Position - 0x36FD0
{
...
void func_464()//Position - 0x36FF9
{
	Global_87154 = 0;
	Global_87155 = 0;
}

int func_465()//Position - 0x3700B
{
	if (((Global_92833 == 13 || Global_92833 == 10) || Global_92833 == 11) || Global_92833 == 12)
	{
		return 0;
...
void func_466()//Position - 0x37049
{
	Global_92868 = 1;
...
void func_467(char* sParam0)//Position - 0x3713E
{
...
void func_468(var uParam0)//Position - 0x37150
{
...
void func_469(var uParam0)//Position - 0x37170
{
	int iVar0;
...
void func_470(char* sParam0)//Position - 0x371AA
{
	sParam0 = sParam0;
}

int func_471(int iParam0)//Position - 0x371B6
{
	if (!func_151(iParam0))
	{
		return Global_104555.f_28020[iParam0 /*29*/];
