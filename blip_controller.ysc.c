							...
							if (unk_0xC80D31E4B587871C(Global_25578[iVar2 /*23*/].f_11, 19))
							{
								switch (iLocal_53)
								{
									...
									case 2:
										...
										{
											Global_25578[iVar2 /*23*/].f_19 = unk_0x6F4378873333A0C2(Global_25578[iVar2 /*23*/][iLocal_53 /*3*/]);
											unk_0x4B4040A0EC7DBA81(Global_25578[iVar2 /*23*/].f_19, Global_25578[iVar2 /*23*/].f_12[iLocal_53]);
										}
										break;
						...
						else
						{
							if (unk_0xC80D31E4B587871C(Global_25578[iVar2 /*23*/].f_11, 19))
							{
								switch (iLocal_53)
								{
									...
									case 0:
									case 2:
										unk_0x645FF8D8B599FD84(Global_25578[iVar2 /*23*/].f_19, Global_25578[iVar2 /*23*/][iLocal_53 /*3*/]);
										break;
			...
			if (unk_0x5BEF7A5AB8F17255(unk_0x9EB17624F44A8DA4()))
			{
				...
				else
				{
					...
					if (!func_8(138))
					{
						if (unk_0x8F38E94BBF3404CD(joaat("chop")) == 0)
						{
							if (unk_0xBE3C4023003180FC(unk_0xB3328BA8976B416C(unk_0xFC1458A37D98B502(), 1), -11,15f, -1425,56f, 29,67f, true) > 50f)
							{
								func_7(138, 1, 0);
							}
						}
...
void func_10()//Position - 0xB1D
{
	...
	vVar0 = { func_16(unk_0x98EC0789D9F0703B()) };
	iVar1 = -1;
	fVar2 = 1000000f;
	iVar3 = 0;
	iVar3 = 0;
	while (iVar3 < 7)
	{
		...
		{
			if (unk_0xA6DECE14FC9A8C51(Global_25578[iLocal_51[iVar3] /*23*/].f_19))
			{
				fVar4 = unk_0xBE3C4023003180FC(vVar0, unk_0x67247AA13B7486A3(Global_25578[iLocal_51[iVar3] /*23*/].f_19), true);
				if (fVar4 < fVar2)
				{
					fVar2 = fVar4;
					iVar1 = iVar3;
	...
	while (iVar3 < 7)
	{
		if (iLocal_51[iVar3] != -1)
		{
			...
			else if (unk_0xA6DECE14FC9A8C51(Global_25578[iLocal_51[iVar3] /*23*/].f_19))
			{
...
void func_19(int iParam0, int iParam1)//Position - 0xEDC
{
	...
	iVar0 = func_1();
	unk_0x103AA766DC1F5AAF(iParam0, 1);
	unk_0xF27F72CA15E148EE(iParam0, 2);
	unk_0x0C71C8E276E3EC54(iParam0, func_21(iParam1));
	if (Global_25578[iParam1 /*23*/].f_16 == 4 || Global_25578[iParam1 /*23*/].f_16 == 8)
	{
		switch (iVar0)
		{
			case 0:
				unk_0x0C71C8E276E3EC54(iParam0, 42);
				break;
			
			case 1:
				unk_0x0C71C8E276E3EC54(iParam0, 43);
				break;
			
			case 2:
				unk_0x0C71C8E276E3EC54(iParam0, 44);
				break;
			}
	}
	...
	if (!unk_0xAB019B170BF1309C(&(Global_25578[iParam1 /*23*/].f_20)))
	{
		...
		{
			unk_0x62BD54E491535B76(iParam0, &(Global_25578[iParam1 /*23*/].f_20));
		}
	}
	...
	if (bVar3 && !bVar4)
	{
		unk_0x66DAED36FB41050D(iParam0, false);
	}
	else
	{
		unk_0x66DAED36FB41050D(iParam0, true);
	}
	if (bVar2 && bVar1)
	{
	...
	else
	{
		if (bVar2)
		{
			unk_0x3ED68ABD7299EAA3(iParam0, 5);
		}
		if (bVar1)
		{
			unk_0x3ED68ABD7299EAA3(iParam0, 3);
		}
	}
	switch (Global_25578[iParam1 /*23*/].f_16)
	{
		case 7:
			unk_0xF27F72CA15E148EE(iParam0, 2);
			unk_0x500C932DA034E5AD(iParam0, 0);
			break;
		...
		case 1:
			unk_0xF27F72CA15E148EE(iParam0, 3);
			unk_0x500C932DA034E5AD(iParam0, 1);
			break;
		
		case 9:
			unk_0xF27F72CA15E148EE(iParam0, 1);
			unk_0x1B43A8C070CAD58C(iParam0, 10);
			unk_0x500C932DA034E5AD(iParam0, 0);
			break;
		...
		case 8:
			...
			{
				unk_0xF27F72CA15E148EE(iParam0, 5);
			}
			if (unk_0xC80D31E4B587871C(Global_25578[iParam1 /*23*/].f_11, 8))
			{
				if (!func_28(iParam1))
				{
					...
					else
					{
						...
						{
							unk_0x66DAED36FB41050D(iParam0, unk_0xC80D31E4B587871C(Global_25578[iParam1 /*23*/].f_11, 5));
							unk_0xF27F72CA15E148EE(iParam0, 3);
							unk_0x66DAED36FB41050D(iParam0, true);
							unk_0x312E513AE531074E(iParam0, 1);
							unk_0xA5D25D3F884FF516(iParam0, 0,77f);
						}
						else
						{
							unk_0xA5D25D3F884FF516(iParam0, 0,72f);
						}
					}
				}
				else
				{
					if (unk_0xC80D31E4B587871C(Global_25578[iParam1 /*23*/].f_11, 28))
					{
						unk_0xF20857E4CB32A2B7(iParam0, 128);
					}
					if (Global_25578[iParam1 /*23*/].f_16 == 8)
					{
						unk_0x312E513AE531074E(iParam0, 0);
					}
				}
			}
			break;
	...
	{
		unk_0x87B0371CE9DBCAE4(iParam0, 0);
	}
	if (unk_0xC80D31E4B587871C(Global_25578[iParam1 /*23*/].f_11, 20))
	{
		unk_0xBEEB69DEBE7C3C0D(iParam0, 1);
	}
	else
	{
		unk_0xBEEB69DEBE7C3C0D(iParam0, 0);
	}
	if (unk_0xC80D31E4B587871C(Global_25578[iParam1 /*23*/].f_11, 29))
	{
		unk_0x0C71C8E276E3EC54(iParam0, 39);
	}
}
...
{
	if (iLocal_57 && unk_0xC80D31E4B587871C(Global_25578[iParam0 /*23*/].f_11, 13))
	{
		unk_0x872F1C1F8587CCC7(&(Global_25578[iParam0 /*23*/].f_11), 18);
		return 1;
	}
	if (iLocal_58 && ((unk_0xC80D31E4B587871C(Global_25578[iParam0 /*23*/].f_11, 7) || unk_0xC80D31E4B587871C(Global_25578[iParam0 /*23*/].f_11, 11)) || unk_0xC80D31E4B587871C(Global_25578[iParam0 /*23*/].f_11, 16)))
	{
		unk_0x872F1C1F8587CCC7(&(Global_25578[iParam0 /*23*/].f_11), 18);
		return 1;
	}
	if (iLocal_59 && unk_0xC80D31E4B587871C(Global_25578[iParam0 /*23*/].f_11, 14))
	{
		unk_0x872F1C1F8587CCC7(&(Global_25578[iParam0 /*23*/].f_11), 18);
		return 1;
	}
	if (iLocal_54 && ((unk_0xC80D31E4B587871C(Global_25578[iParam0 /*23*/].f_11, 10) || unk_0xC80D31E4B587871C(Global_25578[iParam0 /*23*/].f_11, 8)) || unk_0xC80D31E4B587871C(Global_25578[iParam0 /*23*/].f_11, 19)))
	{
		unk_0x872F1C1F8587CCC7(&(Global_25578[iParam0 /*23*/].f_11), 18);
		return 1;
	}
	...
	if (iLocal_61 && unk_0xC80D31E4B587871C(Global_25578[iParam0 /*23*/].f_11, 27))
	{
		unk_0x872F1C1F8587CCC7(&(Global_25578[iParam0 /*23*/].f_11), 18);
		return 1;
	}
	if ((iLocal_62 && (unk_0xC80D31E4B587871C(Global_25578[iParam0 /*23*/].f_11, 1) || unk_0xC80D31E4B587871C(Global_25578[iParam0 /*23*/].f_11, 2))) || Global_25578[iParam0 /*23*/].f_16 == 1)
	{
		unk_0x872F1C1F8587CCC7(&(Global_25578[iParam0 /*23*/].f_11), 18);
		return 1;
	}
...
{
	if (unk_0xF5D0CBECCA41314A(unk_0x98EC0789D9F0703B()) != iLocal_45)
	{
		iLocal_45 = unk_0xF5D0CBECCA41314A(unk_0x98EC0789D9F0703B());
		return 1;
	}
	return 0;
}
...
int func_40()//Position - 0x1B72
{
	...
	if (unk_0x674C9438180770FE() != iLocal_44)
	{
		iLocal_44 = unk_0x674C9438180770FE();
		return 1;
	}
	return 0;
}
...
char* func_48(int iParam0, int iParam1)//Position - 0x209D
{
	switch (iParam0)
	{
		case -1:
...
int func_49(int iParam0)//Position - 0x241E
{
	switch (iParam0)
	{
		case -1:
