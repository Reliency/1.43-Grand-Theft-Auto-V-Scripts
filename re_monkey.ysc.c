...
int func_1()//Position - 0x119
{
	...
	else if (iLocal_46 == 1)
	{
		...
		{
			func_43(unk_0xFC1458A37D98B502(), -347,4067f, -93,5801f, 44,6639f, 306,0178f);
		}
...
int func_12()//Position - 0xE0B
{
	return Global_1312736;
}

int func_13(int iParam0, int iParam1)//Position - 0xE17
{
	switch (iParam0)
	{
		case 0:
...
int func_14(int iParam0)//Position - 0x118B
{
	switch (iParam0)
	{
		case 29:
...
void func_15(int iParam0)//Position - 0x11BA
{
	int iVar0;
	int iVar1;
...
void func_16(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x11FC
{
	func_17(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_17(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x121E
{
	int iVar0;
...
bool func_21(int iParam0)//Position - 0x1655
{
	return Global_35861 == iParam0;
}

bool func_22(int iParam0)//Position - 0x1663
{
	return iParam0 < 3;
}

int func_23(int iParam0)//Position - 0x166F
{
	int iVar0;
	int iVar1;
...
int func_24(int iParam0)//Position - 0x16AC
{
	if (func_22(iParam0))
	{
...
int func_25(int iParam0)//Position - 0x16D6
{
	int iVar0;
	int iVar1;
...
void func_26(int iParam0, int iParam1)//Position - 0x1719
{
	unk_0x872F1C1F8587CCC7(&(Global_104555.f_24965.f_8[iParam0]), iParam1);
}

int func_27(int iParam0)//Position - 0x1734
{
	int iVar0;
...
int func_29(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x1802
{
...
void func_30()//Position - 0x19DC
{
	func_31(1751306471, 6, func_34(), 133, 30000, 10000, -1, 0, -1, 0, 0);
}

int func_31(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x1A00
{
	struct<14> Var0;
...
void func_32(int iParam0)//Position - 0x1B1B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_33(int iParam0)//Position - 0x1BDF
{
	switch (iParam0)
	{
		case 0:
...
int func_35(int iParam0)//Position - 0x1C81
{
	int iVar0;
	int iVar1;
...
void func_36(int iParam0)//Position - 0x1DA8
{
	int iVar0;
	struct<10> Var1;
...
void func_37(int iParam0)//Position - 0x1E61
{
	int iVar0;
	struct<14> Var1;
...
void func_38(int iParam0)//Position - 0x1F29
{
	struct<15> Var0;
	int iVar1;
	int iVar2;
...
void func_39(int iParam0)//Position - 0x1FD6
{
	struct<15> Var0;
	int iVar1;
	int iVar2;
	...
	while (iVar1 < Global_104555.f_7658.f_198)
	{
		...
		{
			func_40(Global_104555.f_7658.f_137[iVar1 /*15*/].f_6);
			iVar2 = iVar1;
...
int func_40(int iParam0)//Position - 0x2092
{
	int iVar0;
...
void func_41(int iParam0, int iParam1)//Position - 0x2103
{
	if (Global_117[iParam0 /*10*/].f_8 != 140)
	{
		if (iParam1 > 3)
...
void func_42(int iParam0)//Position - 0x2146
{
	int iVar0;
	int iVar1;
	struct<15> Var2;
...
void func_43(int iParam0, vector3 vParam1, float fParam2)//Position - 0x2221
{
	unk_0xBD8D47FDC6902B2D(iParam0, vParam1, 1, false, 0, 1);
	unk_0x48ED7B2293A96722(iParam0, fParam2);
}

int func_44(int iParam0)//Position - 0x223F
{
	if (unk_0x6ADD12BF4D6D2587(iParam0))
	{
...
void func_45()//Position - 0x2260
{
	...
	while (iVar0 < 4)
	{
		...
		switch (iVar1)
		{
			...
			case 1:
				iLocal_58[iVar1] = unk_0x5E35CF35E65D69B9(joaat("prop_paints_can02"), -335,66f, -95,24f, 46,16f, true, true, false);
				unk_0xAA93B7B448E10E40(iLocal_58[iVar1], -335,66f, -95,24f, 46,16f, 0, 0, 1);
				unk_0x59AF3B40AE222194(iLocal_58[iVar1], -2,32f, 0,66f, -0,8f, 2, 1);
				break;
			
			case 2:
				iLocal_58[iVar1] = unk_0x5E35CF35E65D69B9(joaat("prop_paint_brush05"), -336,04f, -94,9f, 46,02f, true, true, false);
				unk_0xAA93B7B448E10E40(iLocal_58[iVar1], -336,04f, -94,9f, 46,02f, 0, 0, 1);
				unk_0x59AF3B40AE222194(iLocal_58[iVar1], 0,01f, 3,85f, 2,72f, 2, 1);
				break;
			
			case 3:
				iLocal_58[iVar1] = unk_0x5E35CF35E65D69B9(joaat("prop_paint_spray01b"), -336,34f, -95,66f, 46,02f, true, true, false);
				unk_0xAA93B7B448E10E40(iLocal_58[iVar1], -336,34f, -95,66f, 46,02f, 0, 0, 1);
				unk_0x59AF3B40AE222194(iLocal_58[iVar1], -2,86f, 0,76f, 28,89f, 2, 1);
				break;
		}
		iVar0++;
	}
...
int func_49()//Position - 0x241F
{
	...
	else if (iLocal_46 == 1)
	{
		if (func_44(unk_0xFC1458A37D98B502()))
		{
			func_43(unk_0xFC1458A37D98B502(), -366,6139f, -79,7531f, 44,6616f, 230,7299f);
		}
		unk_0xBB9A3C553EECB180(0f);
		unk_0x7C9705890EF6612E(0f, 1065353216);
		unk_0x59C3AC31C7544A28(250);
	...
	else if (iLocal_46 == 2)
	{
		...
		{
			if (unk_0xA7E3B4C3A60721A5(iLocal_48, 1))
			{
				func_144();
			}
		}
		...
		switch (iLocal_47)
		{
			...
			case 1:
				if (func_50())
				{
					...
					{
						if (unk_0x702E29F19ACB576E(30f, 31086, 0,8f, 0,7f, 0,25f, 1090519040, 1051361018, 31086, 24818) == iLocal_48)
						{
							iLocal_69 = unk_0x53C562FD2B9E3AB0() + 2000;
							iLocal_47++;
						}
					}
				}
			...
			case 2:
				if (iLocal_69 < unk_0x53C562FD2B9E3AB0())
				{
					iLocal_52 = 1;
					iLocal_47++;
				}
...
int func_51()//Position - 0x255E
{
	...
	{
		unk_0x6FF834D85E2DD4C6(1813637474);
		if (unk_0x9A0B2ED5055D3F0B(1813637474))
		{
			iLocal_48 = unk_0xAC992EFAD62C33BF(26, 1813637474, vLocal_49, fLocal_50, 1, true);
			unk_0x14776E43F90DD454(1813637474);
			iLocal_58[0] = unk_0x5E35CF35E65D69B9(joaat("prop_cs_spray_can"), vLocal_59, true, true, false);
			unk_0xA9D382E7BA095148(iLocal_58[0], iLocal_48, unk_0xDD09837E5235FE91(iLocal_48, 28422), 0f, -0,01f, -0,02f, vLocal_66, 1, 1, 0, 0, 2, 1);
			unk_0xE9B3D12A64CC7C1A(iLocal_48, true);
			unk_0xAE01EF4BC84AFE7C(iLocal_48, 42, true);
			iLocal_53 = func_62(iLocal_48, 0, 145);
			func_52(1);
			unk_0xCE93FCB8A8D8DF0B(iLocal_48, 1862763509);
			unk_0xC820D40994BFF79C(iLocal_48, 2,5f);
		}
	}
	return 0;
}

int func_52(int iParam0)//Position - 0x261F
{
	if (func_56())
	{
		Global_104545 = 1;
...
void func_53(int iParam0)//Position - 0x2672
{
	switch (iParam0)
	{
		case 0:
...
void func_54(char* sParam0, int iParam1)//Position - 0x2753
{
	unk_0x67129637F30DEB3F(sParam0);
	unk_0x376CFA11DE0FE521(0, 0, true, iParam1);
}

char* func_55(int iParam0)//Position - 0x276A
{
	char* sVar0;
...
int func_56()//Position - 0x27AE
{
	switch (func_57(&Global_25292, 0, 5, 0, unk_0xBBA15366508D1BDE()))
	{
		case 1:
			return 1;
			break;
...
int func_57(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x27E4
{
	int iVar0;
...
void func_58(var uParam0, int iParam1)//Position - 0x291B
{
	int iVar0;
...
bool func_59(int iParam0)//Position - 0x296A
{
	return func_60(iParam0, Global_35861);
}

int func_60(int iParam0, int iParam1)//Position - 0x297B
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_61(int iParam0)//Position - 0x2B5C
{
	if (Global_35861 == 15)
	{
		return 0;
...
int func_62(int iParam0, bool bParam1, int iParam2)//Position - 0x2B7E
{
	int iVar0;
...
int func_63(int iParam0, bool bParam1, bool bParam2)//Position - 0x2BD0
{
	int iVar0;
	...
	{
		unk_0xA5D25D3F884FF516(iVar0, func_64(unk_0x3A711520F83BAE98(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		unk_0xA5D25D3F884FF516(iVar0, func_64(unk_0x3A711520F83BAE98(), 0,7f, 0,7f));
		unk_0xDB6E56C09E5CF0AA(iVar0, bParam1);
	}
...
float func_64(bool bParam0, float fParam1, float fParam2)//Position - 0x2C74
{
	if (bParam0)
	{
		return fParam1;
...
void func_65()//Position - 0x2C8B
{
	func_66();
	if (!unk_0x42F1FE4C7EC5F51E() && iLocal_51 < 3)
	{
		func_144();
	}
}

void func_66()//Position - 0x2CAC
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
	...
	if (func_44(iLocal_48))
	{
		...
		bVar1 = func_44(unk_0xFC1458A37D98B502());
		vVar2 = { unk_0xB3328BA8976B416C(iLocal_48, 0) };
		fVar4 = 7,5f;
		vVar5 = { fVar4, fVar4, fVar4 };
		if (bVar1)
		{
			vVar3 = { unk_0xB3328BA8976B416C(unk_0xFC1458A37D98B502(), 0) };
			bVar6 = unk_0x88DDBE9908752BF0(unk_0xFC1458A37D98B502(), 0);
			bVar7 = unk_0xFCB32314B66A3503(unk_0xFC1458A37D98B502());
		}
		if (iLocal_51 < 3)
		{
			if (unk_0x5679106BC7ED79EE(vVar2, fVar4, 0) || unk_0xF1DE6FAA2EFAA34F(vVar2 - vVar5, vVar2 + vVar5, 0))
			{
				iLocal_51 = 3;
			}
		}
		...
		{
			case 0:
				unk_0x6450931B826B49D9(sLocal_62);
				if (unk_0x3A801AA34DD821BE(sLocal_62))
				{
					unk_0x771A86309E0CA47B(iLocal_48, true);
					unk_0x12C9D41D52A560D6(iLocal_48, sLocal_62, sLocal_63, 1000f, -8f, -1, 8193, 0, 0, 0, 0);
					iLocal_51++;
				}
				break;
			...
			case 1:
				...
				if (func_76(unk_0xFC1458A37D98B502(), iLocal_48, 35f))
				{
					unk_0x6931076730A4AC5D(&iLocal_68);
					unk_0x12C9D41D52A560D6(0, sLocal_62, sLocal_64, 8f, -8f, -1, 8192, 0, 0, 0, 0);
					unk_0x12C9D41D52A560D6(0, sLocal_62, sLocal_65, 8f, -2f, -1, 8193, 0, 0, 0, 0);
					unk_0x1B16DD5C115FE009(iLocal_68);
					unk_0xAB30B1CF01A198C1(iLocal_48, iLocal_68);
					unk_0xFAA3EF7FF92E1F9E(&iLocal_68);
					unk_0xFCCDDE0E48CF9588(sLocal_62);
					iLocal_51++;
				}
				break;
			...
			case 2:
				...
				if ((bVar0 && bVar1) && func_76(unk_0xFC1458A37D98B502(), iLocal_48, fVar8))
				{
					iLocal_51 = 3;
				}
				if (iLocal_52)
			...
			case 4:
				unk_0xE17958D3FD0F9EE9(iLocal_48, 8, true);
				unk_0xE17958D3FD0F9EE9(iLocal_48, 32, true);
				unk_0x6931076730A4AC5D(&iLocal_68);
				unk_0xAC838A977FB6E6BC(0, unk_0xFC1458A37D98B502(), 800);
				unk_0xD68E88A8E0BE8697(0, unk_0xFC1458A37D98B502(), 9999f, -1, 1, 0);
				unk_0x1B16DD5C115FE009(iLocal_68);
				unk_0xAB30B1CF01A198C1(iLocal_48, iLocal_68);
				unk_0xFAA3EF7FF92E1F9E(&iLocal_68);
				iLocal_51++;
			...
			case 5:
				...
				if (!unk_0x841ED61760A7D07B(iLocal_48) && system::vdist2(vVar2, unk_0xB3328BA8976B416C(unk_0xFC1458A37D98B502(), 0)) > 2500f)
				{
					iLocal_67 = unk_0x8941008352A0F66A(vVar3, vVar2, 1, 0, 7);
					iLocal_51++;
				}
				break;
			...
			case 6:
				...
				iVar13 = unk_0x16ACABF450EB00B4(iLocal_67, &iVar9, &uVar10, &uVar11, &uVar12);
				if (iVar13 == 2)
				{
					if (iVar9 == 1)
					{
	...
	else if (unk_0x6ADD12BF4D6D2587(iLocal_48))
	{
		unk_0xEDC33A771FAEB393(iLocal_48, false);
	}
}

int func_67()//Position - 0x2FD3
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	...
	{
		case 0:
			if (unk_0xA5F6598E13F98E08(iLocal_48, sLocal_62, sLocal_65, 3))
			{
				fLocal_54 = 0,349f;
				iLocal_55 = 900;
				vLocal_57 = { vVar0 };
			...
			else if (unk_0xA5F6598E13F98E08(iLocal_48, sLocal_62, sLocal_64, 3))
			{
				fLocal_54 = unk_0x7A70772AE40E3821(iLocal_48, sLocal_62, sLocal_64);
				...
				if (fLocal_54 != 0,2f)
				{
					...
					vLocal_57 = { unk_0xB3328BA8976B416C(iLocal_48, 0) - Vector(1f, 0f, 0f) };
					iLocal_56 = 1;
				}
				else
				{
		...
		case 1:
			...
			unk_0x12C9D41D52A560D6(iLocal_48, sLocal_62, sLocal_64, 4f, -8f, -1, 0, fLocal_54, 1, 0, 0);
			iLocal_69 = unk_0x53C562FD2B9E3AB0();
			func_70(&iLocal_53);
			func_69();
			if (unk_0x6ADD12BF4D6D2587(iLocal_58[0]))
			{
				unk_0x6B7C10B19928914F(iLocal_58[0], 1, true);
			}
			iLocal_56++;
			break;
		
		case 2:
			if (unk_0xA5F6598E13F98E08(iLocal_48, sLocal_62, sLocal_64, 3))
			{
				iVar3 = (unk_0x53C562FD2B9E3AB0() - iLocal_69);
				...
				unk_0xCBF5827EA5303F2B(iLocal_48, sLocal_62, sLocal_64, fVar5);
				fVar6 = (fVar4 - 0,12f);
				fVar6 = func_71(fVar6, 0f, 0,8f);
				vVar7 = { func_68(vLocal_57, vVar1, fVar6) };
				unk_0xBD8D47FDC6902B2D(iLocal_48, vVar7, 0, true, 0, 1);
				if (fVar5 == 0,161f)
				{
					unk_0xEDC33A771FAEB393(iLocal_48, false);
					return 1;
...
Vector3 func_68(vector3 vParam0, vector3 vParam1, float fParam2)//Position - 0x31E1
{
	return FtoV((1f - fParam2)) * vParam0 + Vector(fParam2, fParam2, fParam2) * vParam1;
}

void func_69()//Position - 0x31FC
{
	if (iLocal_60 != 0)
	{
		unk_0x990DE45B7A2B6426(iLocal_60, 0);
		iLocal_60 = 0;
	}
}

void func_70(int iParam0)//Position - 0x3214
{
...
float func_71(float fParam0, float fParam1, float fParam2)//Position - 0x3234
{
	if (fParam0 > fParam2)
	{
		return fParam2;
...
void func_72()//Position - 0x325B
{
	float fVar0;
	
	if (unk_0xA5F6598E13F98E08(iLocal_48, sLocal_62, sLocal_64, 3))
	{
		fVar0 = unk_0x7A70772AE40E3821(iLocal_48, sLocal_62, sLocal_64);
		if (fVar0 < 0,383793f)
		{
			func_69();
		}
	...
	else if (unk_0xA5F6598E13F98E08(iLocal_48, sLocal_62, sLocal_65, 3))
	{
		fVar0 = unk_0x7A70772AE40E3821(iLocal_48, sLocal_62, sLocal_65);
		if (fVar0 < 0,1124f)
		{
			func_69();
		}
...
void func_73()//Position - 0x331C
{
	if (iLocal_60 == 0)
	{
		iLocal_60 = unk_0x1E3116EEB28D5F17(sLocal_61, iLocal_58[0], vLocal_66, vLocal_66, 1f, 0, 0, 0);
		unk_0xBCEA363B5EFB935C(iLocal_60, 1f, 1f, 1f, 0);
		unk_0x309CD09F0BAB8E6E(iLocal_60, 0,2f);
	}
}

bool func_74(vector3 vParam0, vector3 vParam1)//Position - 0x335C
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_75()//Position - 0x33B5
{
	return (unk_0x0F3033474C49912D(unk_0xFC1458A37D98B502(), -334,4651f, -93,42171f, 48,57328f, -332,2641f, -82,78552f, 45,8103f, 3f, 0, true, 0) && !unk_0x0F3033474C49912D(unk_0xFC1458A37D98B502(), -329,1134f, -83,87273f, 45,79989f, -331,0937f, -88,05348f, 48,71878f, 3f, 0, true, 0));
}

int func_76(int iParam0, int iParam1, float fParam2)//Position - 0x3417
{
	float fVar0;
	...
	if (unk_0x6ADD12BF4D6D2587(iParam0) && unk_0x6ADD12BF4D6D2587(iParam1))
	{
		...
		return system::vdist2(unk_0xB3328BA8976B416C(iParam0, 0), unk_0xB3328BA8976B416C(iParam1, 0)) <= fVar0;
	}
	return 0;
}

int func_77(int iParam0)//Position - 0x3453
{
	if (!func_78(iLocal_48, iParam0) && !func_78(iLocal_48, 1805844857))
	{
		func_70(&iLocal_53);
		unk_0xD68E88A8E0BE8697(iLocal_48, unk_0xFC1458A37D98B502(), 9999f, -1, 1, 0);
		return 1;
	}
	return 0;
}

bool func_78(int iParam0, int iParam1)//Position - 0x3495
{
	int iVar0;
...
void func_79(vector3 vParam0)//Position - 0x34B5
{
	if (func_83(vParam0))
	{
		func_80(33);
...
void func_80(int iParam0)//Position - 0x34D9
{
	if (iParam0 == -1)
	{
		iParam0 = func_28();
...
void func_82(int iParam0)//Position - 0x354C
{
	Global_104544 = iParam0;
}

int func_83(vector3 vParam0)//Position - 0x355A
{
...
bool func_85()//Position - 0x3649
{
	return func_86(func_87(), 5);
}

bool func_86(int iParam0, int iParam1)//Position - 0x365A
{
	if (iParam0 == -1)
	{
		return 0;
...
bool func_88(int iParam0)//Position - 0x36B8
{
...
int func_89(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x36E6
{
	bool bVar0;
	vector3 vVar1;
	int iVar2;
	...
	if (!bVar0)
	{
		if (unk_0x5BEF7A5AB8F17255(unk_0x9EB17624F44A8DA4()) && !unk_0x3AB6A1A9084FB0A4(unk_0xFC1458A37D98B502()))
		{
			...
			if (system::vmag2(unk_0x8FD9FCCB6E4BD999(unk_0xFC1458A37D98B502())) > 1369f && !func_143())
			{
				return 0;
			}
		}
		...
		if (!func_127(Global_104555.f_24965.f_43[iParam1]))
		{
			return 0;
		}
...
bool func_90(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x3A80
{
	if (bParam2)
	{
...
bool func_91(int iParam0)//Position - 0x3AC7
{
	int iVar0;
...
int func_92(int iParam0)//Position - 0x3AE8
{
	return func_93(iParam0, 1);
}

int func_93(int iParam0, int iParam1)//Position - 0x3AF7
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_94(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x3B4A
{
	func_95(func_106(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_95(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0x3B68
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_96(float fParam0, float fParam1, float fParam2)//Position - 0x3D69
{
	float fVar0;
...
int func_97(int iParam0, int iParam1)//Position - 0x3DAB
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_98(int iParam0)//Position - 0x3E4D
{
	return system::shift_right(iParam0, 20) & 63;
}

int func_99(int iParam0)//Position - 0x3E60
{
	return system::shift_right(iParam0, 14) & 63;
}

int func_100(int iParam0)//Position - 0x3E73
{
	return system::shift_right(iParam0, 9) & 31;
}

int func_101(int iParam0)//Position - 0x3E86
{
	return system::shift_right(iParam0, 4) & 31;
}

int func_102(int iParam0)//Position - 0x3E98
{
	return (system::shift_right(iParam0, 26) & 31 * func_103(unk_0xC80D31E4B587871C(iParam0, 31), -1, 1)) + 2011;
}

int func_103(bool bParam0, int iParam1, int iParam2)//Position - 0x3EBD
{
	if (bParam0)
	{
		return iParam1;
...
int func_104(int iParam0)//Position - 0x3ED4
{
	return iParam0 & 15;
}

int func_105(int iParam0, int iParam1)//Position - 0x3EE1
{
	int iVar0;
	int iVar1;
...
void func_107(var uParam0, int iParam1)//Position - 0x4035
{
	if (iParam1 <= 0)
	{
		return;
...
void func_108(var uParam0, int iParam1)//Position - 0x40BB
{
...
void func_109(var uParam0, int iParam1)//Position - 0x40EE
{
	int iVar0;
	int iVar1;
...
void func_110(var uParam0, int iParam1)//Position - 0x413F
{
...
void func_111(var uParam0, int iParam1)//Position - 0x4179
{
...
void func_112(var uParam0, int iParam1)//Position - 0x41B4
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_113(int iParam0)//Position - 0x41F0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_114(int iParam0, int iParam1)//Position - 0x42CC
{
...
int func_115(int iParam0)//Position - 0x42EF
{
	int iVar0;
		...
		if (unk_0x6ADD12BF4D6D2587(unk_0xFC1458A37D98B502()))
		{
			if (!unk_0x3AB6A1A9084FB0A4(unk_0xFC1458A37D98B502()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!unk_0x85C9285BFFF225F4(unk_0x9EB17624F44A8DA4()) || unk_0x0ACC2116170FA204(unk_0xFC1458A37D98B502())) || unk_0x0F299BBD0DC14B18(unk_0xFC1458A37D98B502())) || unk_0x9F887157983E8EFC(unk_0xFC1458A37D98B502())) || unk_0x81FE9C1618BDF46B(unk_0xFC1458A37D98B502())) || unk_0xEA18004FB7FEACF1(unk_0x9EB17624F44A8DA4(), 1)) || unk_0x5EDC8E26D8E9BD2A(unk_0x9EB17624F44A8DA4())) || unk_0x7ED4D0E480A6EC43(unk_0xFC1458A37D98B502(), 0)) || func_124()) || Global_103602) || Global_25235) || func_123()) || func_122(8, -1)) || func_121()) || func_120()) || func_119()) || func_118()) || Global_104555.f_7658.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((unk_0xEA18004FB7FEACF1(unk_0x9EB17624F44A8DA4(), 1) || func_124()) || Global_25235) || func_123()) || func_122(8, -1)) || func_119()) || func_121()) || func_120()) || func_118()) || Global_104555.f_7658.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!unk_0x85C9285BFFF225F4(unk_0x9EB17624F44A8DA4()) || unk_0x0ACC2116170FA204(unk_0xFC1458A37D98B502())) || unk_0x0F299BBD0DC14B18(unk_0xFC1458A37D98B502())) || unk_0x9F887157983E8EFC(unk_0xFC1458A37D98B502())) || unk_0x81FE9C1618BDF46B(unk_0xFC1458A37D98B502())) || unk_0xEA18004FB7FEACF1(unk_0x9EB17624F44A8DA4(), 1)) || unk_0x5EDC8E26D8E9BD2A(unk_0x9EB17624F44A8DA4())) || unk_0x7ED4D0E480A6EC43(unk_0xFC1458A37D98B502(), 0)) || func_124()) || Global_103602) || Global_25235) || func_123()) || func_122(8, -1)) || func_119()) || func_121()) || func_120()) || func_118()) || Global_104555.f_7658.f_919[iVar0] == 5) || Global_36408 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((unk_0x9F887157983E8EFC(unk_0xFC1458A37D98B502()) || unk_0x81FE9C1618BDF46B(unk_0xFC1458A37D98B502())) || unk_0xEA18004FB7FEACF1(unk_0x9EB17624F44A8DA4(), 1)) || unk_0x7ED4D0E480A6EC43(unk_0xFC1458A37D98B502(), 0)) || func_124()) || Global_103602) || Global_25235) || func_123()) || func_122(8, -1)) || func_121()) || func_120()) || func_118()) || Global_104555.f_7658.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_124() || unk_0xF5D0CBECCA41314A(unk_0x9EB17624F44A8DA4()) > 0) || func_122(8, -1)) || func_118()) || func_117()) || Global_104555.f_7658.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (unk_0x6ADD12BF4D6D2587(unk_0xFC1458A37D98B502()))
						{
							if ((((((((((((((unk_0x7ED4D0E480A6EC43(unk_0xFC1458A37D98B502(), 0) || unk_0xF5D0CBECCA41314A(unk_0x9EB17624F44A8DA4()) > 0) || unk_0x0ACC2116170FA204(unk_0xFC1458A37D98B502())) || unk_0x9F887157983E8EFC(unk_0xFC1458A37D98B502())) || unk_0x81FE9C1618BDF46B(unk_0xFC1458A37D98B502())) || unk_0xEA18004FB7FEACF1(unk_0x9EB17624F44A8DA4(), 1)) || unk_0x5EDC8E26D8E9BD2A(unk_0x9EB17624F44A8DA4())) || func_124()) || Global_25235) || func_123()) || func_122(8, -1)) || func_120()) || func_119()) || func_118()) || Global_104555.f_7658.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
...
var func_116()//Position - 0x4A0C
{
	return Global_92872.f_1;
}

int func_117()//Position - 0x4A1A
{
	if (Global_89900 != -1)
	{
...
bool func_120()//Position - 0x4A84
{
	return Global_92885.f_316 > 0;
}

bool func_121()//Position - 0x4A95
{
	return Global_92885.f_315 > 0;
}

bool func_122(int iParam0, int iParam1)//Position - 0x4AA6
{
	switch (iParam0)
	{
		case 5:
...
var func_123()//Position - 0x4AE1
{
	return Global_1312854;
}

int func_124()//Position - 0x4AED
{
...
bool func_127(int iParam0)//Position - 0x4BD3
{
	return func_105(func_106(), iParam0);
}

int func_128(int iParam0, int iParam1, int iParam2)//Position - 0x4BE5
{
	int iVar0;
	int iVar1;
...
int func_129(int iParam0)//Position - 0x4CC9
{
	if (!func_22(iParam0))
	{
		return 7;
...
bool func_130(int iParam0)//Position - 0x4CED
{
	int iVar0;
	bool bVar1;
...
int func_131(float fParam0, bool bParam1)//Position - 0x4D4B
{
	struct<27> Var0;
	int iVar1;
	int iVar2;
...
void func_132(int iParam0, var uParam1)//Position - 0x4E02
{
	switch (iParam0)
	{
		case 0:
...
int func_134(int iParam0)//Position - 0x60DA
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_135(int iParam0)//Position - 0x6420
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_136(int iParam0)//Position - 0x6458
{
	struct<2> Var0;
...
int func_137()//Position - 0x68A5
{
	func_20();
	return Global_104555.f_2353.f_539.f_4301;
}

int func_138()//Position - 0x68BE
{
	int iVar0;
...
bool func_140()//Position - 0x6934
{
	return Global_104273 > 0;
}

int func_141()//Position - 0x6942
{
	if (Global_89900 != -1)
	{
		return 1;
...
void func_145(int iParam0)//Position - 0x69B5
{
	char cVar0[64];
	...
	if (func_156())
	{
		...
		func_148(30000);
		StringCopy(&cVar0, func_147(Global_104544, 1), 64);
	...
	func_146(&Global_25292);
	Global_104545 = 0;
	func_82(-1);
}

void func_146(var uParam0)//Position - 0x6A6A
{
	if (*uParam0 == -1)
	{
		return;
...
char* func_147(int iParam0, bool bParam1)//Position - 0x6AA7
{
	switch (iParam0)
	{
		case 0:
...
void func_148(int iParam0)//Position - 0x6CF0
{
	Global_36412 = (unk_0x53C562FD2B9E3AB0() + iParam0);
}

void func_149(int iParam0)//Position - 0x6D02
{
	func_150(iParam0, 0, func_155(iParam0));
}

void func_150(int iParam0, int iParam1, int iParam2)//Position - 0x6D17
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_151(var uParam0)//Position - 0x6D46
{
	struct<16> Var0;
	int iVar1;
...
void func_152(int iParam0, var uParam1)//Position - 0x6E17
{
	Global_104555.f_24965.f_43[iParam0] = *uParam1;
}

void func_153(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x6E2F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_154(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x6FB1
{
...
int func_155(int iParam0)//Position - 0x6FE9
{
	int iVar0;
