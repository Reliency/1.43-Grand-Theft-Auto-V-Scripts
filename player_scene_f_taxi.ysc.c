...
int func_2()//Position - 0x11B
{
	...
	if (!func_3(&uVar0))
	{
		vVar1 = { unk_0xB3328BA8976B416C(iLocal_68, 0) };
		fVar2 = system::vdist2(vLocal_170 + vLocal_173, vVar1);
		if (fVar2 < (4,5f * 4,5f))
		{
			unk_0x96247F0EC873C446(iLocal_68, iLocal_70, fLocal_171, 786599);
			return 1;
		}
	}
	return 0;
...
int func_4()//Position - 0x1B6
{
	...
	if (!func_3(&uVar0))
	{
		...
		else if (unk_0xD56F740235B1E8F0(Global_90308))
		{
			...
			if (!func_5(Global_92619, iLocal_70, 2))
			{
				if (fVar1 >= 0,9f)
				{
					unk_0xBB0358802AA14401(Global_92619, iLocal_70, 2);
				}
			}
			if (!iLocal_172)
			{
				unk_0xEDC33A771FAEB393(iLocal_68, false);
				iLocal_172 = 1;
			}
			unk_0x181B5054237CD6BD(iLocal_68, iLocal_70, 6, 50);
		}
		else
		{
			if (!func_5(Global_92619, iLocal_70, 2))
			...
			unk_0xBD1486160AB0661B(iLocal_70, -8f, 1);
			system::wait(100);
			if (!func_3(&uVar0))
			{
				unk_0x6931076730A4AC5D(&iVar2);
				unk_0x181B5054237CD6BD(0, iLocal_70, 24, 50);
				unk_0xB6A7F1EF9625AE96(0, 2000);
				unk_0x87A3E70B0AB01608(0, iLocal_70, vLocal_170 + vLocal_173, fLocal_171, 0, iLocal_71, 786599, ((4,5f / 2f) - 1f), 10f);
				unk_0x1B16DD5C115FE009(iVar2);
				unk_0xAB30B1CF01A198C1(iLocal_68, iVar2);
...
bool func_16(int iParam0)//Position - 0x620
{
	return Global_35861 == iParam0;
}

void func_17()//Position - 0x62E
{
	if (!unk_0x1E06D00B67177A18())
	{
...
void func_18()//Position - 0x66E
{
	func_19((Global_92621 - 1));
}

void func_19(int iParam0)//Position - 0x680
{
	Global_92621 = iParam0;
}

void func_20()//Position - 0x68E
{
	func_19(0);
}

void func_21()//Position - 0x69B
{
	int iVar0;
	
	unk_0x6FF834D85E2DD4C6(iLocal_69);
	unk_0x2E4932E63763FE26(iLocal_69, true);
	iLocal_70 = unk_0xB306EEF0A280A8F5(vLocal_173 + vLocal_169, 15f, iLocal_71, 2);
	iVar0 = 0;
	while ((!unk_0x6ADD12BF4D6D2587(Global_92619) || !unk_0x6ADD12BF4D6D2587(iLocal_70)) || (!unk_0x9A0B2ED5055D3F0B(iLocal_69) && iVar0 < 400))
	{
	...
	{
		unk_0xA15269351F50F113(iLocal_70, true, true, 0);
		unk_0x4BEFCD5DAE410A90(iLocal_70, 2);
		unk_0xACE486395AA1867D(iLocal_70, 1084227584);
		iLocal_68 = unk_0x00D1A9572426E8DD(iLocal_70, 4, iLocal_69, -1, 1, true);
		unk_0x230697B667C63948(iLocal_68, 0);
		unk_0x14776E43F90DD454(iLocal_69);
	}
}

void func_22()//Position - 0x797
{
	char[] cVar0[8];
	var uVar1;
	struct<109> Var2;
	...
	Var2 = 0;
	Var2.f_2 = iLocal_66;
	Var2.f_3 = Global_90456.f_45;
	func_25(Var2, &Var3);
	func_23(iLocal_66, &sLocal_175, &cLocal_191, &cLocal_191, &uVar4, &uVar5);
}

int func_23(int iParam0, char* sParam1, char* sParam2, char* sParam3, var uParam4, var uParam5)//Position - 0x89B
{
	*uParam4 = 9;
	*uParam5 = 8;
	switch (iParam0)
...
void func_24(char* sParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5)//Position - 0xFAA
{
...
int func_25(struct<109> Param0, var uParam1)//Position - 0xFC4
{
	uParam1->f_119 = 0;
	switch (Param0.f_2)
	{
		...
		case 155:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_26(uParam1, 17, 1785177548, 1785177548, unk_0x5B811202FCBE9E9D(-5f, 5f), unk_0x5B811202FCBE9E9D(-5f, 5f), 0f, unk_0x5B811202FCBE9E9D(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 158:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_26(uParam1, 144, 1785177548, 1785177548, unk_0x5B811202FCBE9E9D(-5f, 5f), unk_0x5B811202FCBE9E9D(-5f, 5f), 0f, unk_0x5B811202FCBE9E9D(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 196:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_26(uParam1, 43, 1785177548, 1785177548, unk_0x5B811202FCBE9E9D(-5f, 5f), unk_0x5B811202FCBE9E9D(-5f, 5f), 0f, unk_0x5B811202FCBE9E9D(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
...
void func_26(var uParam0, int iParam1, int iParam2, int iParam3, vector3 vParam4, float fParam5)//Position - 0x4343
{
...
void func_27(var uParam0)//Position - 0x436D
{
	func_26(uParam0, 145, 1435919172, 1435919172, 0f, 0f, 0f, 0f);
}

int func_28(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x438B
{
	uParam2->f_3 = 1000;
	uParam2->f_1 = 0;
	uParam2->f_84 = 255;
...
void func_29(int iParam0, var uParam1, int iParam2)//Position - 0x77FD
{
	int iVar0;
...
int func_30(int iParam0, var uParam1, int iParam2)//Position - 0x7A59
{
...
int func_31(int iParam0, bool bParam1)//Position - 0x7C90
{
	int iVar0;
	struct<2> Var1;
...
int func_32(int iParam0)//Position - 0x7E1E
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_34(int iParam0)//Position - 0x7F01
{
	int iVar0;
	int iVar1;
...
int func_35()//Position - 0x978A
{
	return 0;
}

int func_36()//Position - 0x9793
{
	return 1;
}

int func_37()//Position - 0x979C
{
	return 1;
}

int func_38()//Position - 0x97A5
{
...
int func_40(int iParam0)//Position - 0x9879
{
...
int func_41(int iParam0, var uParam1, var uParam2, char* sParam3)//Position - 0x9AF9
{
	int iVar0;
...
bool func_42(var uParam0)//Position - 0x9CF4
{
	int iVar0;
	vector3 vVar1;
	float fVar2;
...
bool func_43(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x9DAF
{
	if (bParam2)
	{
...
int func_44(int iParam0, var uParam1, char* sParam2)//Position - 0x9DF6
{
	vector3 vVar0;
	int iVar1;
	var uVar2;
...
int func_45(int iParam0, int iParam1, var uParam2, var uParam3)//Position - 0xC3F9
{
	switch (iParam1)
	{
		case 0:
...
int func_47(int iParam0, var uParam1, var uParam2)//Position - 0xE367
{
	switch (iParam0)
	{
		case 11:
...
char* func_48(int iParam0)//Position - 0xECD6
{
	switch (iParam0)
	{
		case 2014101067:
...
void func_49()//Position - 0xED69
{
	if (!unk_0x191BE1BC8F26F3C1(iLocal_68, 0) && unk_0xCB234F3DD6FF9368(iLocal_68, 1))
	{
		unk_0x486F346ADFE56674(&iLocal_68);
	}
	if (!unk_0x191BE1BC8F26F3C1(iLocal_70, 0) && unk_0xCB234F3DD6FF9368(iLocal_70, 1))
	{
		unk_0x5380482A432E314E(&iLocal_70);
	}
	unk_0x2E4932E63763FE26(iLocal_69, false);
	unk_0x14776E43F90DD454(iLocal_69);
