...
void __EntryFunction__()//Position - 0x0
{
	...
	iLocal_54 = unk_0xD50D486F1F311BFC(joaat("weapon_sniperrifle"));
	iLocal_55 = unk_0x7FAE56FC172FD992(joaat("component_at_scope_large"));
	iLocal_56 = unk_0x7FAE56FC172FD992(joaat("component_at_ar_supp_02"));
	...
	if (unk_0x7D9C4B359376D38A(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_103642[Var0 /*10*/].f_9 != -1)
			{
				...
				func_267(&(Global_103642[Var0 /*10*/].f_9));
			}
		}
		func_255(&Var0, 1);
	}
	...
	unk_0x247EAA2E93D4A021(vVar1, 3f, 1, 0, 0, false);
	while (true)
	{
		system::wait(0);
		if (!func_192(&Var0, 1))
		...
		if (func_164(&Var0, 0) && unk_0xE97272C977DEADD3((vVar1.z - vVar3.z)) < 2,5f)
		{
			if (!func_2(&Var0))
			{
				func_255(&Var0, 1);
...
bool func_68(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x61A8
{
	if (bParam2)
	{
...
int func_69(var uParam0)//Position - 0x61EF
{
...
bool func_70(int iParam0)//Position - 0x624A
{
	return func_71(iParam0, 0, 1);
}

int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x625A
{
	if (bParam2)
	{
...
int func_72(int iParam0)//Position - 0x62BA
{
	switch (iParam0)
	{
		case 0:
...
int func_73()//Position - 0x659F
{
	return Global_25233;
}

int func_74(int iParam0)//Position - 0x65AA
{
	return func_71(iParam0, 5, 1);
}

int func_75(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x65BA
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0, bool bParam1)//Position - 0x665C
{
	switch (iParam0)
	{
		case -1:
...
int func_77(int iParam0)//Position - 0x6BFB
{
	if (iParam0 != func_86())
	{
...
Vector3 func_78(int iParam0, int iParam1)//Position - 0x6C59
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_79(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6D07
{
	struct<4> Var0;
	vector3 vVar1;
	struct<4> Var2;
...
Vector3 func_80(vector3 vParam0, float fParam1)//Position - 0x6D9C
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
struct<6> func_81(int iParam0)//Position - 0x6DE0
{
	struct<6> Var0;
...
struct<6> func_82(int iParam0)//Position - 0x6F64
{
	return func_83(iParam0);
}

struct<6> func_83(int iParam0)//Position - 0x6F72
{
	struct<6> Var0;
...
int func_84(int iParam0, var uParam1)//Position - 0x7A39
{
	switch (iParam0)
	{
		case 0:
...
int func_85(int iParam0)//Position - 0x7ABB
{
	if (iParam0 != func_86())
	{
...
int func_86()//Position - 0x7B19
{
	return -1;
}

Vector3 func_87(int iParam0)//Position - 0x7B22
{
	switch (iParam0)
	{
		case 1:
...
int func_88(int iParam0)//Position - 0x7CBF
{
	return func_71(iParam0, 0, 0);
}

int func_89(int iParam0)//Position - 0x7CCF
{
	switch (iParam0)
	{
		case -1:
...
bool func_90()//Position - 0x7F5C
{
	return Global_92885.f_315 > 0;
}

var func_91()//Position - 0x7F6D
{
	var uVar0;
...
void func_92(var uParam0, int iParam1)//Position - 0x7FB3
{
	if (iParam1 <= 0)
	{
		return;
...
void func_93(var uParam0, int iParam1)//Position - 0x803D
{
...
void func_94(var uParam0, int iParam1)//Position - 0x8070
{
	int iVar0;
	int iVar1;
...
int func_95(int iParam0, int iParam1)//Position - 0x80C1
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_96(int iParam0)//Position - 0x8163
{
	return (system::shift_right(iParam0, 26) & 31 * func_97(unk_0xC80D31E4B587871C(iParam0, 31), -1, 1)) + 2011;
}

int func_97(bool bParam0, int iParam1, int iParam2)//Position - 0x8188
{
	if (bParam0)
	{
		return iParam1;
...
int func_98(var uParam0)//Position - 0x819F
{
	return uParam0 & 15;
}

void func_99(var uParam0, int iParam1)//Position - 0x81AC
{
...
void func_100(var uParam0, int iParam1)//Position - 0x81E6
{
...
void func_101(var uParam0, int iParam1)//Position - 0x8221
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_102()//Position - 0x825D
{
	func_55();
	return Global_104555.f_2353.f_539.f_4301;
}

void func_103(int iParam0)//Position - 0x8276
{
	var uVar0;
	vector3 vVar1[24];
...
void func_104(char* sParam0, int iParam1, int iParam2)//Position - 0x82CF
{
...
bool func_105(bool bParam0)//Position - 0x8311
{
...
struct<2> func_106(int iParam0)//Position - 0x833C
{
	struct<2> Var0;
...
void func_107(int iParam0, var uParam1)//Position - 0x8789
{
	switch (iParam0)
	{
		case 0:
...
int func_109(int iParam0)//Position - 0x9A61
{
	switch (iParam0)
	{
		case 0:
...
int func_110(int iParam0)//Position - 0x9DA7
{
	int iVar0;
...
void func_111(int iParam0)//Position - 0x9E4B
{
	struct<2> Var0;
...
void func_112(int iParam0)//Position - 0x9EE6
{
	if (iParam0 < 63)
	{
		func_113();
...
void func_114(int iParam0)//Position - 0x9F44
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_115(int iParam0)//Position - 0x9F9D
{
...
int func_116(int iParam0)//Position - 0xA020
{
	int iVar0;
...
void func_117(int iParam0, int iParam1, int iParam2)//Position - 0xA051
{
	func_118(iParam0, iParam1, iParam2, 0, 0);
}

void func_118(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0xA065
{
	int iVar0;
...
int func_120(int iParam0, int iParam1, int iParam2)//Position - 0xA10D
{
...
int func_121(int iParam0, int iParam1, int iParam2)//Position - 0xA128
{
	int iVar0;
...
int func_122(int iParam0)//Position - 0xA174
{
	int iVar0;
...
int func_123(int iParam0)//Position - 0xA1BD
{
	if (func_124(iParam0))
	{
		if (!unk_0x3AB6A1A9084FB0A4(iParam0))
...
int func_124(int iParam0)//Position - 0xA1DD
{
	if (unk_0x6ADD12BF4D6D2587(iParam0))
	{
...
int func_125(int iParam0)//Position - 0xA1FE
{
	switch (iParam0)
	{
		case 5:
...
int func_127(int iParam0)//Position - 0xA2CE
{
	switch (iParam0)
	{
		case 5:
...
void func_128(var uParam0, bool bParam1, bool bParam2)//Position - 0xA321
{
	int iVar0;
...
int func_129(int iParam0)//Position - 0xA416
{
	switch (iParam0)
	{
		case 5:
...
void func_130(bool bParam0)//Position - 0xA481
{
	int iVar0;
...
void func_131(bool bParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xA4BD
{
	if (bParam0)
	{
...
bool func_132()//Position - 0xA5D6
{
	return unk_0xC80D31E4B587871C(Global_1595693[unk_0x9EB17624F44A8DA4() /*680*/].f_39.f_18, 14);
}

bool func_133(int iParam0, int iParam1)//Position - 0xA5F3
{
	bool bVar0;
...
int func_134(int iParam0, bool bParam1)//Position - 0xA63E
{
	int iVar0;
	int iVar1;
...
int func_135(int iParam0)//Position - 0xA67F
{
...
bool func_136()//Position - 0xA6C1
{
	return unk_0xC80D31E4B587871C(Global_2359302, 3);
}

int func_137(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xA6D2
{
	int iVar0;
...
void func_139(int iParam0)//Position - 0xA72C
{
	if (iParam0 == 1)
	{
...
int func_140(char* sParam0)//Position - 0xA74F
{
...
void func_141()//Position - 0xA78C
{
	Global_14622 = 0;
	func_142();
}

void func_142()//Position - 0xA79C
{
...
int func_146(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xA882
{
...
void func_147(int iParam0)//Position - 0xAA11
{
	if (!unk_0x191BE1BC8F26F3C1(iParam0, 0))
	{
...
void func_149(int iParam0)//Position - 0xAA8E
{
...
void func_150(int iParam0)//Position - 0xAAB7
{
	if (Global_14615)
	{
		func_151(0, 0);
...
void func_151(bool bParam0, bool bParam1)//Position - 0xAB27
{
	if (bParam0)
	{
		if (func_152(0))
...
int func_152(int iParam0)//Position - 0xAB9B
{
	if (iParam0 == 1)
	{
		if (Global_14453.f_1 > 3)
...
int func_153(int iParam0)//Position - 0xABF5
{
...
int func_154(int iParam0)//Position - 0xAC36
{
	int iVar0;
...
void func_155(int iParam0)//Position - 0xAC7B
{
...
int func_156(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xACAD
{
	int iVar0;
...
void func_157(var uParam0, int iParam1)//Position - 0xADE4
{
	int iVar0;
...
bool func_158(int iParam0)//Position - 0xAE33
{
	return func_159(iParam0, Global_35861);
}

int func_159(int iParam0, int iParam1)//Position - 0xAE44
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_160(int iParam0)//Position - 0xB025
{
	if (Global_35861 == 15)
	{
		return 0;
...
int func_161()//Position - 0xB047
{
	return func_162(unk_0x436287B7DB306165(), 0);
}

int func_162(char* sParam0, int iParam1)//Position - 0xB058
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_164(int iParam0, int iParam1)//Position - 0xB0C5
{
	switch (iParam0->f_16)
	{
		case 0:
...
void func_165()//Position - 0xB8A8
{
	func_27(&(Global_95149.f_2875), &Global_95149, 0, 1, 1, 0);
}

int func_166(var uParam0)//Position - 0xB8C3
{
	float fVar0;
...
void func_167(int iParam0, int iParam1)//Position - 0xB951
{
	if (iParam0 == 1)
	{
		if (!func_127(iParam1))
...
int func_168(bool bParam0)//Position - 0xB9B5
{
	int iVar0;
...
int func_169(int iParam0)//Position - 0xBA4C
{
	if (func_124(iParam0))
	{
		if (unk_0xB8DE76287EDC4957(iParam0, 0))
...
int func_170(int iParam0)//Position - 0xBA76
{
	int iVar0;
...
var func_171()//Position - 0xC194
{
	return Global_92872.f_1;
}

int func_172()//Position - 0xC1A2
{
	if (Global_89900 != -1)
	{
...
bool func_175()//Position - 0xC20C
{
	return Global_92885.f_316 > 0;
}

bool func_176(int iParam0, int iParam1)//Position - 0xC21D
{
	switch (iParam0)
	{
		case 5:
...
var func_177()//Position - 0xC258
{
	return Global_1312854;
}

int func_178()//Position - 0xC264
{
	if (!unk_0x3A711520F83BAE98())
	{
...
int func_179(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xC280
{
	var uVar0;
	
	if ((((func_124(unk_0xFC1458A37D98B502()) && func_124(iParam0->f_28[0])) && !func_143()) && (unk_0x53C562FD2B9E3AB0() - iParam0->f_60) > iParam6) && func_183(unk_0xFC1458A37D98B502(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
		func_182(&uVar0, iParam4, iParam0->f_28[0], sParam5, 0, 1);
...
void func_180(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC308
{
...
void func_181(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC343
{
...
void func_182(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xC399
{
...
float func_183(int iParam0, vector3 vParam1, bool bParam2)//Position - 0xC434
{
	vector3 vVar0;
...
void func_184(int iParam0, char* sParam1, vector3 vParam2)//Position - 0xC46E
{
	if (unk_0x5BEF7A5AB8F17255(unk_0x9EB17624F44A8DA4()))
	{
		if (!unk_0xAB019B170BF1309C(sParam1))
		{
			...
			{
				if (func_183(unk_0xFC1458A37D98B502(), vParam2, 1) <= 100f)
				{
					func_187(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_183(unk_0xFC1458A37D98B502(), vParam2, 1) > 120f)
				{
					func_189(iParam0);
				}
			}
...
void func_185(int iParam0, bool bParam1)//Position - 0xC55F
{
	if (iParam0 == -1)
	{
		return;
...
int func_186(int iParam0)//Position - 0xC59B
{
	if (Global_70852 == iParam0)
	{
		if (Global_70853 == -1)
...
void func_187(int iParam0, int iParam1)//Position - 0xC5D4
{
	bool bVar0;
	int iVar1;
...
bool func_188()//Position - 0xC672
{
	return Global_90287;
}

void func_189(int iParam0)//Position - 0xC67E
{
	unk_0x7042DDDE71665936(0);
	unk_0xA6C03E3E2533F8F3();
	func_190(iParam0);
...
void func_190(int iParam0)//Position - 0xC695
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_191(int iParam0)//Position - 0xC77D
{
	if (iParam0 == -1)
	{
		iParam0 = func_161();
...
int func_192(int iParam0, bool bParam1)//Position - 0xC7A5
{
	struct<27> Var0;
	...
	func_107(*iParam0, &Var0);
	if ((func_229(*iParam0) || func_227(*iParam0)) || Global_71101 == 1)
	{
		return 1;
	}
	if (!unk_0x42F1FE4C7EC5F51E())
...
void func_193(int iParam0, var uParam1, int iParam2)//Position - 0xCA18
{
	int iVar0;
	int iVar1;
	...
	if (func_124(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_195(uParam1) || !unk_0xA5F6598E13F98E08(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_194(iParam2) && !unk_0xCA3C40448996C9BA(iParam0, unk_0xFC1458A37D98B502(), 25f))
					{
						unk_0xAC838A977FB6E6BC(iParam0, unk_0xFC1458A37D98B502(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_195(uParam1) && uParam1->f_4 == 0) && unk_0xBE3C4023003180FC(unk_0xB3328BA8976B416C(unk_0xFC1458A37D98B502(), 1), unk_0xB3328BA8976B416C(iParam0, 1), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_194(iParam2) || unk_0xCA3C40448996C9BA(iParam0, unk_0xFC1458A37D98B502(), 10f))
				{
					if (func_68(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						unk_0x12C9D41D52A560D6(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
...
int func_194(int iParam0)//Position - 0xCD70
{
...
int func_195(var uParam0)//Position - 0xCD90
{
...
int func_196(var uParam0)//Position - 0xCDA8
{
...
void func_197(var uParam0)//Position - 0xCDCD
{
	int iVar0;
	int iVar1;
...
void func_198(int iParam0)//Position - 0xD0D1
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
...
void func_199(var uParam0)//Position - 0xD0FC
{
	int iVar0;
...
int func_200(var uParam0, bool bParam1, bool bParam2)//Position - 0xD17C
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (unk_0x6ADD12BF4D6D2587(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_201(unk_0xFC1458A37D98B502(), uParam0->f_35[iVar0]))
							{
...
int func_201(int iParam0, int iParam1)//Position - 0xD33A
{
	int iVar0;
...
int func_202(var uParam0, bool bParam1, int iParam2)//Position - 0xD36A
{
	int iVar0;
	int iVar1;
...
int func_203(int iParam0)//Position - 0xD626
{
...
int func_204(int iParam0, float fParam1)//Position - 0xD65A
{
	float fVar0;
	
	if (func_124(unk_0xFC1458A37D98B502()) && func_124(iParam0))
	{
		if (func_215(iParam0) || unk_0x7B46BDDD99441E94(unk_0x9EB17624F44A8DA4(), iParam0))
		{
...
bool func_205(int iParam0, float fParam1)//Position - 0xD6D0
{
	return func_206(iParam0, unk_0xFC1458A37D98B502(), fParam1, 1, 250, 7);
}

bool func_206(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD6E8
{
	var uVar0;
	vector3 vVar1;
	int iVar2;
...
int func_207(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xD7A9
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
Vector3 func_208(int iParam0, int iParam1)//Position - 0xD8D5
{
	int iVar0;
...
int func_210(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xD9E4
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_212(unk_0xB3328BA8976B416C(iParam1, 1) - unk_0xB3328BA8976B416C(iParam0, 1)) };
	...
	{
		vVar1 = { func_212(unk_0xD0E00576168D19BB(iParam0, 31086, 0f, 5f, 0f) - unk_0xD0E00576168D19BB(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_211(vector3 vParam0, vector3 vParam1)//Position - 0xDA75
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

Vector3 func_212(vector3 vParam0)//Position - 0xDA96
{
	float fVar0;
	float fVar1;
...
void func_213(var uParam0)//Position - 0xDAD5
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_214(int iParam0, int iParam1)//Position - 0xDAF0
{
	int iVar0;
...
int func_215(int iParam0)//Position - 0xDB2F
{
...
int func_216(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xDB57
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_217(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xDC52
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_218(int iParam0, float fParam1)//Position - 0xDD5E
{
	var uVar0;
	vector3 vVar1;
...
int func_219(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0xDDF3
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_212(vParam1 - unk_0xB3328BA8976B416C(iParam0, 1)) };
	if (fParam2 < 0,1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_220(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xDE81
{
	if (bParam1)
	{
		if (unk_0x08765A6321A42CA1(unk_0xFC1458A37D98B502()))
...
int func_221(int iParam0)//Position - 0xDEC9
{
...
void func_222(int iParam0)//Position - 0xDF13
{
	int iVar0;
...
int func_223(int iParam0)//Position - 0xDFB0
{
	if (iParam0 == -1)
	{
		iParam0 = func_161();
...
int func_224(int iParam0)//Position - 0xE048
{
...
int func_227(int iParam0)//Position - 0xE0CA
{
	if ((func_228() && Global_92833.f_11 == 6) && iParam0 == func_162(&(Global_92833.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_229(int iParam0)//Position - 0xE13C
{
	if (func_105(0))
	{
...
int func_230(int iParam0)//Position - 0xE164
{
	switch (*iParam0)
	{
		case 25:
...
int func_231(var uParam0)//Position - 0xE1AB
{
	int iVar0[5];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			unk_0x6450931B826B49D9("rcmhunting2");
			iLocal_51 = 1;
			break;
		
		case 1:
			if (!func_238(&iVar0) || !unk_0x3A801AA34DD821BE("rcmhunting2"))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			{
				if (func_235(&(uParam0->f_28[0]), 54, -683,3276f, 5841,042f, 17,217f, 8,33f, "RC HUNTER 2", 1))
				{
					unk_0x9E058151726E58DE(uParam0->f_28[0], joaat("weapon_pumpshotgun"), 0, true, true);
				}
				else
				{
					bVar2 = false;
			...
			{
				func_232(&(uParam0->f_35[0]), -685,2281f, 5833,982f, 16,331f, 313,2204f, 0);
			}
			if (!unk_0x6ADD12BF4D6D2587(iLocal_58))
			{
				iLocal_58 = unk_0xD50A2A2DB03A5CF0(joaat("weapon_sniperrifle"), 0, vLocal_57, 0, 1065353216, 0, 0, 1);
				unk_0x0DF81B88D0C53746(iLocal_58, joaat("component_at_scope_large"));
				unk_0x0DF81B88D0C53746(iLocal_58, joaat("component_at_ar_supp_02"));
			}
			if (bVar2)
			{
				iLocal_51 = 3;
		...
		case 3:
			...
			{
				if (unk_0x3A801AA34DD821BE("rcmhunting2"))
				{
					unk_0x22F63D02D1D91EBC(uParam0->f_28[0], "rcmhunting2", "_idle_loop", -683,152f, 5841,281f, 17,32f, 0f, 0f, 17,024f, 1000f, -8f, -1, 790537, 0f, 2, 1);
				}
			}
			unk_0x60C06BFD037BB7CF(uParam0->f_28[0], unk_0xFC1458A37D98B502(), -1, 3088, 2);
			if (unk_0x50126692B8A3590A(vLocal_57, 1f, iLocal_54, 0))
			{
				unk_0x59AF3B40AE222194(iLocal_58, 0f, -90f, -162,64f, 2, 1);
			}
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
...
void func_232(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0xE3E0
{
	...
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
		...
		unk_0x7B3133EBCD34B431(*iParam0, 2, false);
		unk_0x7B3133EBCD34B431(*iParam0, 3, true);
...
void func_233(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xE446
{
	func_234(iParam0);
...
void func_234(int iParam0)//Position - 0xE488
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
...
int func_235(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)//Position - 0xE524
{
...
int func_236(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)//Position - 0xE580
{
	int iVar0;
...
int func_237(var uParam0, int iParam1)//Position - 0xE60E
{
	int iVar0;
...
int func_238(int iParam0)//Position - 0xE654
{
	int iVar0;
...
int func_239(var uParam0)//Position - 0xE685
{
	int iVar0[2];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_241(&(uParam0->f_48), "special_ped@cletus@base", "cletus_base", 0);
			unk_0x6450931B826B49D9("special_ped@cletus@base");
			iLocal_51 = 1;
			break;
		
		case 1:
			if ((!func_238(&iVar0) || !func_240(&(uParam0->f_48))) || !unk_0x3A801AA34DD821BE("special_ped@cletus@base"))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			if (!unk_0x6ADD12BF4D6D2587(uParam0->f_28[0]))
			{
				if (func_235(&(uParam0->f_28[0]), 54, 1804,33f, 3931,33f, 33,83f, 91,63f, "RC HUNTER 1", 1))
				{
					unk_0x9E058151726E58DE(uParam0->f_28[0], joaat("weapon_sniperrifle"), 0, true, true);
				}
				else
				{
					bVar2 = false;
			...
			if (!unk_0x6ADD12BF4D6D2587(uParam0->f_35[0]))
			{
				func_232(&(uParam0->f_35[0]), 1806,732f, 3934,353f, 33,3275f, 76,1155f, 0);
				unk_0x9B8406983378711E(1804,501f, 3922,917f, 32,8091f, 2f, 0, 0, 0, 0, false, 0);
			}
			if (bVar2)
			{
				iLocal_51 = 3;
		...
		case 3:
			if (func_124(uParam0->f_28[0]))
			{
				unk_0x3A41B9B06FB233AE(uParam0->f_28[0], joaat("weapon_sniperrifle"), joaat("component_at_ar_supp_02"));
				unk_0xAE01EF4BC84AFE7C(uParam0->f_28[0], 104, true);
				unk_0x385A213BEB355C2B(uParam0->f_28[0], joaat("weapon_sniperrifle"), true);
				if (unk_0x3A801AA34DD821BE("special_ped@cletus@base"))
				{
					unk_0x12C9D41D52A560D6(uParam0->f_28[0], "special_ped@cletus@base", "cletus_base", 8f, -8f, -1, 1, 0, 0, 0, 0);
				}
			}
			unk_0x60225D4F755DFDB1(1801,159f, 3919,606f, 33,0662f, 5f, 0);
			unk_0xBB0951717202666D(1803,603f, 3920,191f, 32,9855f, 1798,416f, 3918,291f, 35,0579f);
			unk_0x60225D4F755DFDB1(1797,286f, 3927,359f, 33,0176f, 4f, 0);
			unk_0xBB0951717202666D(1793,765f, 3926,749f, 35,1276f, 1799,73f, 3927,815f, 32,9875f);
			if (unk_0xDE7062A3928EAE5E("WORLD_HUMAN_HANG_OUT_STREET"))
			{
				unk_0xFA85ECEE588094C7("WORLD_HUMAN_HANG_OUT_STREET", 0);
			}
			if (unk_0xDE7062A3928EAE5E("WORLD_HUMAN_DRINKING"))
			{
				unk_0xFA85ECEE588094C7("WORLD_HUMAN_DRINKING", 0);
			}
			if (unk_0xDE7062A3928EAE5E("WORLD_HUMAN_SMOKING"))
			{
				unk_0xFA85ECEE588094C7("WORLD_HUMAN_SMOKING", 0);
			}
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
...
int func_240(var uParam0)//Position - 0xE93A
{
	if (func_196(uParam0))
	{
...
void func_241(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xE964
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_242(int iParam0)//Position - 0xE9A0
{
	struct<27> Var0;
	int iVar1;
...
int func_243(int iParam0)//Position - 0xE9F4
{
	char* sVar0;
...
int func_244(int iParam0)//Position - 0xEAAD
{
	var uVar0;
...
int func_245(int iParam0)//Position - 0xEB6E
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_246(int iParam0, char* sParam1)//Position - 0xEBF3
{
...
bool func_247(int iParam0)//Position - 0xECD5
{
...
bool func_248(int iParam0)//Position - 0xED03
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_249(int iParam0)//Position - 0xED31
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_250(int iParam0)//Position - 0xED5F
{
	if (func_224(iParam0))
	{
		return 0;
...
void func_251()//Position - 0xED94
{
	func_268("Running end routines.");
	Global_104273 = (Global_104273 - 1);
}

int func_252(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xEDAE
{
	int iVar0;
...
int func_253(int iParam0, vector3 vParam1, float fParam2, var uParam3)//Position - 0xEE13
{
	int iVar0;
	struct<7> Var1;
...
int func_254(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0xEE91
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_255(int iParam0, bool bParam1)//Position - 0xEF0C
{
	if (bParam1)
	{
...
void func_256(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xEF59
{
...
void func_257(var uParam0, bool bParam1)//Position - 0xEF79
{
	func_258(&(uParam0->f_41), bParam1);
}

void func_258(var uParam0, bool bParam1)//Position - 0xEF8B
{
	int iVar0;
...
void func_259(int iParam0, bool bParam1)//Position - 0xEFC9
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
		if (unk_0x6049C20F5D5C185B(*iParam0))
...
void func_260(var uParam0, bool bParam1)//Position - 0xF004
{
	func_261(&(uParam0->f_35), bParam1);
}

void func_261(var uParam0, bool bParam1)//Position - 0xF016
{
	int iVar0;
...
void func_262(int iParam0)//Position - 0xF053
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
...
void func_263(var uParam0, int iParam1)//Position - 0xF08B
{
	func_264(&(uParam0->f_28), iParam1);
}

void func_264(var uParam0, int iParam1)//Position - 0xF09D
{
	int iVar0;
...
void func_265(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xF0DE
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
		if (!unk_0x3AB6A1A9084FB0A4(*iParam0))
...
void func_266(int iParam0)//Position - 0xF12E
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
		if (!unk_0x191BE1BC8F26F3C1(*iParam0, 0))
...
void func_267(var uParam0)//Position - 0xF16F
{
	if (*uParam0 == -1)
	{
		return;
...
void func_268(char* sParam0)//Position - 0xF1AC
{
	if (!unk_0xAB019B170BF1309C(sParam0))
	{
	}
...
void func_269(var uParam0)//Position - 0xF1BE
{
	*uParam0 = -1;
...
void func_270()//Position - 0xF1F1
{
	func_268("Running start routines.");
	Global_104273++;
}

int func_271(int iParam0)//Position - 0xF20B
{
	if (!func_36(iParam0))
	{
		return Global_104555.f_28020[iParam0 /*29*/];
