...
int func_2()//Position - 0x108
{
	...
	fVar0 = system::vdist2(unk_0xB3328BA8976B416C(unk_0xFC1458A37D98B502(), 1), vLocal_70);
	if (fVar0 > (100f * 100f))
	{
		return 1;
	}
...
bool func_14(int iParam0)//Position - 0x4CA
{
	return Global_35861 == iParam0;
}

void func_15()//Position - 0x4D8
{
	if (!unk_0x1E06D00B67177A18())
	{
...
void func_16()//Position - 0x518
{
	func_17((Global_92621 - 1));
}

void func_17(int iParam0)//Position - 0x52A
{
	Global_92621 = iParam0;
}

void func_18()//Position - 0x538
{
	func_17(0);
}

void func_19()//Position - 0x545
{
	int iVar0;
	int iVar1;
	bool bVar2;
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_69)
		{
			...
			{
				unk_0x6FF834D85E2DD4C6(iLocal_69[iVar0]);
				if (!unk_0x9A0B2ED5055D3F0B(iLocal_69[iVar0]))
				{
					unk_0x6FF834D85E2DD4C6(iLocal_69[iVar0]);
					bVar2 = false;
				}
		...
		if (!unk_0xAB019B170BF1309C(&cLocal_75))
		{
			unk_0x6450931B826B49D9(&cLocal_75);
			if (!unk_0x3A801AA34DD821BE(&cLocal_75))
			{
				unk_0x6450931B826B49D9(&cLocal_75);
				bVar2 = false;
			}
	...
	while (iVar0 < iLocal_68)
	{
		if (iLocal_69[iVar0] != 0)
		{
			iLocal_68[iVar0] = unk_0xAC992EFAD62C33BF(26, iLocal_69[iVar0], vLocal_70 + vLocal_72[iVar0 /*3*/], 0f, 1, true);
			unk_0x59AF3B40AE222194(iLocal_68[iVar0], Vector(uLocal_71, 0f, 0f) + vLocal_73[iVar0 /*3*/], 2, 1);
			unk_0x230697B667C63948(iLocal_68[iVar0], 0);
			if (iLocal_66 == 288)
			{
				unk_0x03924C68EFCBC511(iLocal_68[iVar0], 3, 1, 0, 0);
				unk_0x03924C68EFCBC511(iLocal_68[iVar0], 4, 0, 0, 0);
			}
			else
			{
				unk_0x230697B667C63948(iLocal_68[iVar0], 0);
			}
			unk_0xAE6EBBBBD8B9FB30(iLocal_68[iVar0], 13, false);
			...
			unk_0x22F63D02D1D91EBC(iLocal_68[iVar0], &cLocal_75, &(Local_80[iVar0 /*8*/]), vLocal_70 + vLocal_72[iVar0 /*3*/], Vector(uLocal_71, 0f, 0f) + vLocal_73[iVar0 /*3*/], 1000f, -8f, -1, iLocal_81, 0, 2, 0);
			unk_0x9A0C1F836B24E46E(iLocal_68[iVar0], 0, 0);
			unk_0xE9B3D12A64CC7C1A(iLocal_68[iVar0], true);
			unk_0x2217C45231E6A537(iLocal_68[iVar0], 55, true);
			if (iLocal_83[iVar0] > 0)
			{
				unk_0x3CD9FD87290536F1(iLocal_68[iVar0], 1, 0,36f, 0,71f, "ShotgunSmall");
				unk_0x4CCB38E6EFCF7CD6(iLocal_68[iVar0], 1, 0,81f, 0,733f, 4);
				unk_0x4CCB38E6EFCF7CD6(iLocal_68[iVar0], 0, 0,94f, 0,59f, 3);
				unk_0x4CCB38E6EFCF7CD6(iLocal_68[iVar0], 3, 0,24f, 0,62f, 4);
				unk_0x4CCB38E6EFCF7CD6(iLocal_68[iVar0], 2, 0f, 0,15f, 2);
				unk_0x4CCB38E6EFCF7CD6(iLocal_68[iVar0], 5, 0,46f, 0,853f, 3);
				unk_0x4CCB38E6EFCF7CD6(iLocal_68[iVar0], 4, 0,308f, 0,786f, 3);
				unk_0x8B8D1CEBA80E6B77(iLocal_68[iVar0], 3, 0,375f, 0,398f, 0f, 1f, -1, 0f, "BasicSlash");
				unk_0x8B8D1CEBA80E6B77(iLocal_68[iVar0], 3, 0,5f, 0,6f, 0f, 1f, -1, 0f, "BasicSlash");
				unk_0x8B8D1CEBA80E6B77(iLocal_68[iVar0], 3, 0,6f, 0,25f, 50f, 0,5f, -1, 0f, "BasicSlash");
				unk_0x8B8D1CEBA80E6B77(iLocal_68[iVar0], 3, 0,65f, 0,325f, 50f, 0,5f, -1, 0f, "BasicSlash");
				unk_0x8B8D1CEBA80E6B77(iLocal_68[iVar0], 0, 0,58f, 0,704f, 0f, 1f, -1, 0f, "ShotgunLarge");
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < iLocal_82)
	{
		if (iLocal_83[iVar0] > 0)
		{
			...
			fVar10 = 1f;
			fVar11 = -1f;
			iLocal_82[iVar0] = unk_0x93B85673224CA2DE(iLocal_83[iVar0], vLocal_70 + vLocal_84[iVar0 /*3*/], vVar3, vVar4, fVar5, fVar6, fVar7, fVar8, fVar9, fVar10, fVar11, 0, 0, 0);
			system::wait(0);
		}
		iVar0++;
	}
...
Vector3 func_20(vector3 vParam0)//Position - 0x8CD
{
	float fVar0;
	float fVar1;
...
void func_21()//Position - 0x90C
{
	...
	switch (iLocal_66)
	{
		case 280:
			...
			iLocal_83[4] = 1015;
			iLocal_83[5] = 1015;
			vLocal_84[4 /*3*/] = { vLocal_84[0 /*3*/] + vLocal_84[2 /*3*/] / Vector(2f, 2f, 2f) + Vector(0f, unk_0x5B811202FCBE9E9D(0,5f, 0,5f), unk_0x5B811202FCBE9E9D(0,5f, 0,5f)) };
			vLocal_84[5 /*3*/] = { vLocal_84[1 /*3*/] + vLocal_84[2 /*3*/] / Vector(2f, 2f, 2f) + Vector(0f, unk_0x5B811202FCBE9E9D(0,5f, 0,5f), unk_0x5B811202FCBE9E9D(0,5f, 0,5f)) };
			break;
...
int func_22(struct<109> Param0, var uParam1)//Position - 0xD04
{
	uParam1->f_119 = 0;
	switch (Param0.f_2)
	{
		...
		case 155:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_23(uParam1, 17, 1785177548, 1785177548, unk_0x5B811202FCBE9E9D(-5f, 5f), unk_0x5B811202FCBE9E9D(-5f, 5f), 0f, unk_0x5B811202FCBE9E9D(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 158:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_23(uParam1, 144, 1785177548, 1785177548, unk_0x5B811202FCBE9E9D(-5f, 5f), unk_0x5B811202FCBE9E9D(-5f, 5f), 0f, unk_0x5B811202FCBE9E9D(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 196:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_23(uParam1, 43, 1785177548, 1785177548, unk_0x5B811202FCBE9E9D(-5f, 5f), unk_0x5B811202FCBE9E9D(-5f, 5f), 0f, unk_0x5B811202FCBE9E9D(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
...
void func_23(var uParam0, int iParam1, int iParam2, int iParam3, vector3 vParam4, float fParam5)//Position - 0x4080
{
...
void func_24(var uParam0)//Position - 0x40AA
{
	func_23(uParam0, 145, 1435919172, 1435919172, 0f, 0f, 0f, 0f);
}

int func_25(int iParam0, var uParam1, var uParam2, char* sParam3)//Position - 0x40C8
{
	int iVar0;
...
bool func_26(var uParam0)//Position - 0x42BB
{
	int iVar0;
	vector3 vVar1;
	float fVar2;
...
bool func_27(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x4376
{
	if (bParam2)
	{
...
int func_28(int iParam0, var uParam1, char* sParam2)//Position - 0x43BD
{
	vector3 vVar0;
	int iVar1;
	var uVar2;
...
int func_29(int iParam0, int iParam1, var uParam2, var uParam3)//Position - 0x688D
{
	switch (iParam1)
	{
		case 0:
...
int func_31(int iParam0, var uParam1, var uParam2)//Position - 0x8800
{
	switch (iParam0)
	{
		case 11:
...
char* func_32(int iParam0)//Position - 0x916F
{
	switch (iParam0)
	{
		case 2014101067:
...
void func_33()//Position - 0x91F9
{
	...
	while (iVar0 < iLocal_69)
	{
		if (iLocal_69[iVar0] != 0)
		{
			unk_0x14776E43F90DD454(iLocal_69[iVar0]);
		}
		iVar0++;
	}
	if (!unk_0xAB019B170BF1309C(&cLocal_75))
	{
		unk_0xFCCDDE0E48CF9588(&cLocal_75);
	}
	iVar0 = 0;
	while (iVar0 < iLocal_82)
	{
		if (unk_0x8776C378FB34DE2A(iLocal_82[iVar0]))
		{
		}
		iVar0++;
	}
