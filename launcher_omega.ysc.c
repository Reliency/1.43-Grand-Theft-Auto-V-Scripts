...
void __EntryFunction__()//Position - 0x0
{
	...
	if (unk_0x7D9C4B359376D38A(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_103642[Var0 /*10*/].f_9 != -1)
			{
				...
				func_278(&(Global_103642[Var0 /*10*/].f_9));
			}
		}
		func_262(&Var0, 1);
	}
	if (!func_259(&iVar2, &Var0, vVar1, 1f))
	{
		func_258();
	...
	while (true)
	{
		...
		func_197(Var0);
		func_190(&iLocal_53, &(Var0.f_9), vVar1);
		if (Var0 == 44)
		{
			func_182(&Var0, vVar1, "SCRAPAU", "SCRAP_1_AMB", 3, "OMEGA", &uLocal_54);
			func_181();
		}
		else if (Var0 == 45)
		{
			func_182(&Var0, vVar1, "SCRAPAU", "SCRAP_2_AMB", 3, "OMEGA", &uLocal_55);
			func_179(&Var0);
		}
		if (func_164(&Var0, 0))
		{
...
void func_4(int iParam0)//Position - 0x3FE
{
	int iVar0;
	int iVar1;
...
void func_6(int iParam0)//Position - 0x60B
{
	switch (iParam0)
	{
		case 2:
...
void func_7(int iParam0)//Position - 0x9F3
{
	Global_55896 = 1;
	Global_55899 = 1;
	if (Global_67998 > 15)
...
void func_8(int iParam0)//Position - 0xA3E
{
...
struct<2> func_9(int iParam0)//Position - 0xA72
{
	struct<2> Var0;
	char[] cVar1[8];
...
void func_13()//Position - 0xB64
{
	Global_56062 = 0;
}

void func_14()//Position - 0xB70
{
	Global_55922 = 0;
...
var func_15(int iParam0)//Position - 0xBC4
{
	var uVar0;
...
void func_17(int iParam0)//Position - 0xC02
{
...
void func_21(char* sParam0)//Position - 0xCBB
{
...
void func_22(char[4] cParam0, int iParam1)//Position - 0xCCE
{
	unk_0x0EE72DB1CD8A3B86(&(Global_92833.f_20), 17);
	func_23(cParam0, iParam1, 0);
}

void func_23(char[4] cParam0, int iParam1, int iParam2)//Position - 0xCEB
{
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x19C4
{
	int iVar0;
	int iVar1;
...
int func_26(var uParam0)//Position - 0x284C
{
...
void func_27(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x286E
{
	int iVar0;
...
int func_28(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x28F6
{
...
int func_29(int iParam0)//Position - 0x2936
{
	int iVar0;
...
void func_30(var uParam0, int iParam1, int iParam2)//Position - 0x2964
{
...
int func_31(int iParam0)//Position - 0x2A40
{
	int iVar0;
...
int func_32(int iParam0)//Position - 0x2A82
{
	int iVar0;
...
int func_33(int iParam0, int iParam1, int iParam2)//Position - 0x2AE5
{
	int iVar0;
...
int func_34(int iParam0, int iParam1)//Position - 0x2B73
{
	struct<82> Var0;
...
void func_35(int iParam0, var uParam1, int iParam2)//Position - 0x2BB5
{
	int iVar0;
...
bool func_36(int iParam0)//Position - 0x2E11
{
	return iParam0 < 3;
}

void func_37(int iParam0, var uParam1)//Position - 0x2E1D
{
	int iVar0;
...
int func_38(int iParam0)//Position - 0x30C8
{
	switch (iParam0)
	{
		case 1:
...
int func_39(int iParam0, var uParam1, var uParam2)//Position - 0x3178
{
	int iVar0;
	int iVar1;
...
int func_40(int iParam0)//Position - 0x3252
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_41(var uParam0)//Position - 0x3272
{
	int iVar0;
...
int func_42(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x3323
{
	char* sVar0;
...
int func_43(int iParam0, int iParam1, bool bParam2)//Position - 0x3452
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_44(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x34C3
{
...
int func_45(int iParam0)//Position - 0x359C
{
	int iVar0;
	int iVar1;
...
int func_46(int iParam0)//Position - 0x35D9
{
	if (func_36(iParam0))
	{
...
void func_47(int iParam0, var uParam1, int iParam2)//Position - 0x3603
{
	int iVar0;
	int iVar1;
...
int func_48(int iParam0, int iParam1, int iParam2)//Position - 0x37AD
{
	int iVar0;
	var uVar1;
...
int func_49(var uParam0)//Position - 0x37DF
{
	int iVar0;
	int iVar1;
...
int func_50()//Position - 0x3813
{
	return Global_1312736;
}

int func_51(int iParam0, int iParam1)//Position - 0x381F
{
	var uVar0;
	var uVar1;
...
void func_52(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x384B
{
	int iVar0;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3D93
{
	int iVar0;
...
int func_54()//Position - 0x3FD4
{
	func_55();
	return Global_104555.f_2353.f_539.f_4301;
}

void func_55()//Position - 0x3FED
{
	int iVar0;
...
bool func_56(int iParam0)//Position - 0x40ED
{
	return Global_35861 == iParam0;
}

void func_57(int iParam0, bool bParam1)//Position - 0x40FB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_58(int iParam0, var uParam1)//Position - 0x41EE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_59(int iParam0)//Position - 0x4478
{
	switch (iParam0)
	{
		case -1258515792:
...
int func_60(int iParam0)//Position - 0x4513
{
...
int func_61(int iParam0, int iParam1)//Position - 0x4687
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_62(int iParam0, var uParam1)//Position - 0x51F8
{
	int iVar0;
	int iVar1;
...
int func_63(int iParam0)//Position - 0x5233
{
	int iVar0;
...
void func_64(int iParam0)//Position - 0x54A7
{
	int iVar0;
...
void func_65(var uParam0, int iParam1)//Position - 0x54E3
{
	int iVar0;
	vector3 vVar1;
	var uVar2;
...
int func_66(vector3 vParam0, char* sParam1, vector3 vParam2)//Position - 0x5A3E
{
	int iVar0;
	int iVar1;
...
bool func_67(int iParam0, var uParam1, var uParam2)//Position - 0x5A82
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_68(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x6139
{
	if (bParam2)
	{
...
int func_69(var uParam0)//Position - 0x6180
{
...
bool func_70(int iParam0)//Position - 0x61DB
{
	return func_71(iParam0, 0, 1);
}

int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x61EB
{
	if (bParam2)
	{
...
int func_72(int iParam0)//Position - 0x624B
{
	switch (iParam0)
	{
		case 0:
...
int func_73()//Position - 0x6530
{
	return Global_25233;
}

int func_74(int iParam0)//Position - 0x653B
{
	return func_71(iParam0, 5, 1);
}

int func_75(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x654B
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0, bool bParam1)//Position - 0x65ED
{
	switch (iParam0)
	{
		case -1:
...
int func_77(int iParam0)//Position - 0x6B8C
{
	if (iParam0 != func_86())
	{
...
Vector3 func_78(int iParam0, int iParam1)//Position - 0x6BEA
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_79(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6C98
{
	struct<4> Var0;
	vector3 vVar1;
	struct<4> Var2;
...
Vector3 func_80(vector3 vParam0, float fParam1)//Position - 0x6D2D
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
struct<6> func_81(int iParam0)//Position - 0x6D71
{
	struct<6> Var0;
...
struct<6> func_82(int iParam0)//Position - 0x6EF5
{
	return func_83(iParam0);
}

struct<6> func_83(int iParam0)//Position - 0x6F03
{
	struct<6> Var0;
...
int func_84(int iParam0, var uParam1)//Position - 0x79CA
{
	switch (iParam0)
	{
		case 0:
...
int func_85(int iParam0)//Position - 0x7A4C
{
	if (iParam0 != func_86())
	{
...
int func_86()//Position - 0x7AAA
{
	return -1;
}

Vector3 func_87(int iParam0)//Position - 0x7AB3
{
	switch (iParam0)
	{
		case 1:
...
int func_88(int iParam0)//Position - 0x7C50
{
	return func_71(iParam0, 0, 0);
}

int func_89(int iParam0)//Position - 0x7C60
{
	switch (iParam0)
	{
		case -1:
...
bool func_90()//Position - 0x7EED
{
	return Global_92885.f_315 > 0;
}

var func_91()//Position - 0x7EFE
{
	var uVar0;
...
void func_92(var uParam0, int iParam1)//Position - 0x7F44
{
	if (iParam1 <= 0)
	{
		return;
...
void func_93(var uParam0, int iParam1)//Position - 0x7FCA
{
...
void func_94(var uParam0, int iParam1)//Position - 0x7FFD
{
	int iVar0;
	int iVar1;
...
int func_95(int iParam0, int iParam1)//Position - 0x8051
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_96(int iParam0)//Position - 0x80F3
{
	return (system::shift_right(iParam0, 26) & 31 * func_97(unk_0xC80D31E4B587871C(iParam0, 31), -1, 1)) + 2011;
}

int func_97(bool bParam0, int iParam1, int iParam2)//Position - 0x8118
{
	if (bParam0)
	{
		return iParam1;
...
int func_98(var uParam0)//Position - 0x812F
{
	return uParam0 & 15;
}

void func_99(var uParam0, int iParam1)//Position - 0x813C
{
...
void func_100(var uParam0, int iParam1)//Position - 0x8176
{
...
void func_101(var uParam0, int iParam1)//Position - 0x81B1
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_102()//Position - 0x81ED
{
	func_55();
	return Global_104555.f_2353.f_539.f_4301;
}

void func_103(int iParam0)//Position - 0x8206
{
	var uVar0;
	vector3 vVar1[24];
...
void func_104(char* sParam0, int iParam1, int iParam2)//Position - 0x825F
{
...
bool func_105(bool bParam0)//Position - 0x82A1
{
...
struct<2> func_106(int iParam0)//Position - 0x82CC
{
	struct<2> Var0;
...
void func_107(int iParam0, var uParam1)//Position - 0x8719
{
	switch (iParam0)
	{
		case 0:
...
int func_109(int iParam0)//Position - 0x99F1
{
	switch (iParam0)
	{
		case 0:
...
int func_110(int iParam0)//Position - 0x9D37
{
	int iVar0;
...
void func_111(int iParam0)//Position - 0x9DDB
{
	struct<2> Var0;
...
void func_112(int iParam0)//Position - 0x9E76
{
	if (iParam0 < 63)
	{
		func_113();
...
void func_114(int iParam0)//Position - 0x9ED4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_115(int iParam0)//Position - 0x9F2D
{
...
int func_116(int iParam0)//Position - 0x9FB0
{
	int iVar0;
...
void func_117(int iParam0, int iParam1, int iParam2)//Position - 0x9FE1
{
	func_118(iParam0, iParam1, iParam2, 0, 0);
}

void func_118(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x9FF5
{
	int iVar0;
...
int func_120(int iParam0, int iParam1, int iParam2)//Position - 0xA09D
{
...
int func_121(int iParam0, int iParam1, int iParam2)//Position - 0xA0B8
{
	int iVar0;
...
int func_122(int iParam0)//Position - 0xA104
{
	int iVar0;
...
int func_123(int iParam0)//Position - 0xA14D
{
	if (func_124(iParam0))
	{
		if (!unk_0x3AB6A1A9084FB0A4(iParam0))
...
int func_124(int iParam0)//Position - 0xA16D
{
	if (unk_0x6ADD12BF4D6D2587(iParam0))
	{
...
int func_125(int iParam0)//Position - 0xA18E
{
	switch (iParam0)
	{
		case 5:
...
int func_127(int iParam0)//Position - 0xA25E
{
	switch (iParam0)
	{
		case 5:
...
void func_128(var uParam0, bool bParam1, bool bParam2)//Position - 0xA2B1
{
	int iVar0;
...
int func_129(int iParam0)//Position - 0xA3A6
{
	switch (iParam0)
	{
		case 5:
...
void func_130(bool bParam0)//Position - 0xA411
{
	int iVar0;
...
void func_131(bool bParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xA44D
{
	if (bParam0)
	{
...
bool func_132()//Position - 0xA566
{
	return unk_0xC80D31E4B587871C(Global_1595693[unk_0x9EB17624F44A8DA4() /*680*/].f_39.f_18, 14);
}

bool func_133(int iParam0, int iParam1)//Position - 0xA583
{
	bool bVar0;
...
int func_134(int iParam0, bool bParam1)//Position - 0xA5CE
{
	int iVar0;
	int iVar1;
...
int func_135(int iParam0)//Position - 0xA60F
{
...
bool func_136()//Position - 0xA651
{
	return unk_0xC80D31E4B587871C(Global_2359302, 3);
}

int func_137(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xA662
{
	int iVar0;
...
void func_139(int iParam0)//Position - 0xA6BC
{
	if (iParam0 == 1)
	{
...
int func_140(char* sParam0)//Position - 0xA6DF
{
...
void func_141()//Position - 0xA71C
{
	Global_14622 = 0;
	func_142();
}

void func_142()//Position - 0xA72C
{
...
int func_146(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xA812
{
...
void func_147(int iParam0)//Position - 0xA9A1
{
	if (!unk_0x191BE1BC8F26F3C1(iParam0, 0))
	{
...
void func_149(int iParam0)//Position - 0xAA1E
{
...
void func_150(int iParam0)//Position - 0xAA47
{
	if (Global_14615)
	{
		func_151(0, 0);
...
void func_151(bool bParam0, bool bParam1)//Position - 0xAAB7
{
	if (bParam0)
	{
		if (func_152(0))
...
int func_152(int iParam0)//Position - 0xAB2B
{
	if (iParam0 == 1)
	{
		if (Global_14453.f_1 > 3)
...
int func_153(int iParam0)//Position - 0xAB85
{
...
int func_154(int iParam0)//Position - 0xABC6
{
	int iVar0;
...
void func_155(int iParam0)//Position - 0xAC0B
{
...
int func_156(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xAC3D
{
	int iVar0;
...
void func_157(var uParam0, int iParam1)//Position - 0xAD74
{
	int iVar0;
...
bool func_158(int iParam0)//Position - 0xADC3
{
	return func_159(iParam0, Global_35861);
}

int func_159(int iParam0, int iParam1)//Position - 0xADD4
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_160(int iParam0)//Position - 0xAFB5
{
	if (Global_35861 == 15)
	{
		return 0;
...
int func_161()//Position - 0xAFD7
{
	return func_162(unk_0x436287B7DB306165(), 0);
}

int func_162(char* sParam0, int iParam1)//Position - 0xAFE8
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_164(int iParam0, int iParam1)//Position - 0xB055
{
	switch (iParam0->f_16)
	{
		case 0:
...
void func_165()//Position - 0xB838
{
	func_27(&(Global_95149.f_2875), &Global_95149, 0, 1, 1, 0);
}

int func_166(var uParam0)//Position - 0xB853
{
	float fVar0;
...
void func_167(int iParam0, int iParam1)//Position - 0xB8E1
{
	if (iParam0 == 1)
	{
		if (!func_127(iParam1))
...
int func_168(bool bParam0)//Position - 0xB945
{
	int iVar0;
...
int func_169(int iParam0)//Position - 0xB9DC
{
	if (func_124(iParam0))
	{
		if (unk_0xB8DE76287EDC4957(iParam0, 0))
...
int func_170(int iParam0)//Position - 0xBA06
{
	int iVar0;
...
var func_171()//Position - 0xC124
{
	return Global_92872.f_1;
}

int func_172()//Position - 0xC132
{
	if (Global_89900 != -1)
	{
...
bool func_175()//Position - 0xC19C
{
	return Global_92885.f_316 > 0;
}

bool func_176(int iParam0, int iParam1)//Position - 0xC1AD
{
	switch (iParam0)
	{
		case 5:
...
var func_177()//Position - 0xC1E8
{
	return Global_1312854;
}

int func_178()//Position - 0xC1F4
{
	if (!unk_0x3A711520F83BAE98())
	{
...
void func_179(int iParam0)//Position - 0xC210
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	...
	if ((unk_0x53C562FD2B9E3AB0() - iLocal_58) > 1250)
	{
		if (func_124(iParam0->f_28[0]) && !unk_0x841ED61760A7D07B(iParam0->f_28[0]))
		{
			if (func_124(unk_0xFC1458A37D98B502()) && !func_180(unk_0xFC1458A37D98B502(), iParam0->f_28[0], 50f, 1))
			{
				vVar0 = { unk_0xB3328BA8976B416C(iParam0->f_28[0], 1) };
				vVar1 = { unk_0xB3328BA8976B416C(unk_0xFC1458A37D98B502(), 1) };
				fVar3 = (vVar1.x - vVar0.x);
				fVar4 = (vVar1.y - vVar0.y);
				if (fVar4 != 0f)
				{
					fVar2 = unk_0xF5596B3A7E5F3C68(fVar3, fVar4);
				}
				else if (fVar3 < 0f)
				{
					fVar2 = -90f;
				...
				unk_0x48ED7B2293A96722(iParam0->f_28[0], fVar2);
			}
		}
...
void func_181()//Position - 0xC31B
{
	...
	unk_0x008F3E3CC076EA0E(iLocal_56, "SET_COLOUR");
	...
	unk_0x008F3E3CC076EA0E(iLocal_56, "SET_DISTANCE");
	unk_0x9499D7329FB840A2(10f);
	unk_0x271AA5469AF471B3();
	unk_0x7913685BF7335C7B(iLocal_57);
	fVar0 = 0,1f;
	fVar1 = 0,24f;
	fVar2 = 0,21f;
	fVar3 = 0,51f;
	...
	unk_0x0EB9853DF8BC0D87(iLocal_56, fVar0, fVar1, fVar2, fVar3, 100, 100, 100, 255, 0);
	if ((unk_0x53C562FD2B9E3AB0() - iLocal_58) > 1250)
	{
		unk_0x23A4CE7F9EBB02D4(iLocal_59, "IDLE_BEEP", 2468,51f, 3437,39f, 49,9f, "EPSILONISM_04_SOUNDSET", 0, 0, 0);
		iLocal_58 = unk_0x53C562FD2B9E3AB0();
	}
}

int func_182(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, var uParam6)//Position - 0xC40D
{
	var uVar0;
	...
	if (!*uParam6 == 3)
	{
		if (func_170(2))
		{
			if (!func_143())
			{
				if ((func_124(unk_0xFC1458A37D98B502()) && func_124(iParam0->f_28[0])) && func_189(unk_0xFC1458A37D98B502(), vParam1, 1) < 20f)
				{
					func_279("start conversation");
					uVar0 = 16;
					if (*uParam6 == 0)
					{
					...
					{
						func_279("conversation ended");
						*uParam6 = 3;
						return 1;
					}
				}
			}
			else if (func_184(sParam3))
			{
				if (!*uParam6 == 1)
				{
			...
			if (func_189(unk_0xFC1458A37D98B502(), vParam1, 1) < 20f && *uParam6 == 1)
			{
				func_279("unpause conversation");
				func_183(0);
				*uParam6 = 2;
			}
		}
...
void func_183(int iParam0)//Position - 0xC52F
{
	Global_16767 = iParam0;
}

int func_184(char* sParam0)//Position - 0xC53C
{
	struct<6> Var0;
...
struct<6> func_185()//Position - 0xC55C
{
	struct<6> Var0;
...
void func_186(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC580
{
...
void func_187(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC5BB
{
...
void func_188(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xC611
{
...
float func_189(int iParam0, vector3 vParam1, bool bParam2)//Position - 0xC6AC
{
	vector3 vVar0;
...
void func_190(int iParam0, char* sParam1, vector3 vParam2)//Position - 0xC6E6
{
	if (unk_0x5BEF7A5AB8F17255(unk_0x9EB17624F44A8DA4()))
	{
...
void func_191(int iParam0, bool bParam1)//Position - 0xC7D7
{
	if (iParam0 == -1)
	{
		return;
...
int func_192(int iParam0)//Position - 0xC813
{
	if (Global_70852 == iParam0)
	{
		if (Global_70853 == -1)
...
void func_193(int iParam0, int iParam1)//Position - 0xC84C
{
	bool bVar0;
	int iVar1;
...
bool func_194()//Position - 0xC8EA
{
	return Global_90287;
}

void func_195(int iParam0)//Position - 0xC8F6
{
	unk_0x7042DDDE71665936(0);
	unk_0xA6C03E3E2533F8F3();
	func_196(iParam0);
...
void func_196(int iParam0)//Position - 0xC90D
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_197(int iParam0)//Position - 0xC9F5
{
	if (iParam0 == -1)
	{
		iParam0 = func_161();
...
int func_198(int iParam0, bool bParam1)//Position - 0xCA1D
{
	struct<27> Var0;
	...
	func_107(*iParam0, &Var0);
	if ((func_235(*iParam0) || func_233(*iParam0)) || Global_71101 == 1)
	{
		return 1;
	}
	if (!unk_0x42F1FE4C7EC5F51E())
	...
	if (func_202(&(iParam0->f_48)) && bParam1)
	{
		func_199(iParam0->f_28[0], &(iParam0->f_48), *iParam0);
	}
	return 1;
}

void func_199(int iParam0, var uParam1, int iParam2)//Position - 0xCC90
{
	int iVar0;
	int iVar1;
	...
	if (func_124(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_201(uParam1) || !unk_0xA5F6598E13F98E08(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_200(iParam2) && !unk_0xCA3C40448996C9BA(iParam0, unk_0xFC1458A37D98B502(), 25f))
					{
						unk_0xAC838A977FB6E6BC(iParam0, unk_0xFC1458A37D98B502(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_201(uParam1) && uParam1->f_4 == 0) && unk_0xBE3C4023003180FC(unk_0xB3328BA8976B416C(unk_0xFC1458A37D98B502(), 1), unk_0xB3328BA8976B416C(iParam0, 1), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_200(iParam2) || unk_0xCA3C40448996C9BA(iParam0, unk_0xFC1458A37D98B502(), 10f))
				{
					if (func_68(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						unk_0x12C9D41D52A560D6(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
...
int func_200(int iParam0)//Position - 0xCFE8
{
...
int func_201(var uParam0)//Position - 0xD008
{
...
int func_202(var uParam0)//Position - 0xD020
{
...
void func_203(var uParam0)//Position - 0xD045
{
	int iVar0;
	int iVar1;
...
void func_204(int iParam0)//Position - 0xD349
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
...
void func_205(var uParam0)//Position - 0xD374
{
	int iVar0;
...
int func_206(var uParam0, bool bParam1, bool bParam2)//Position - 0xD3F4
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (unk_0x6ADD12BF4D6D2587(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_207(unk_0xFC1458A37D98B502(), uParam0->f_35[iVar0]))
							{
...
int func_207(int iParam0, int iParam1)//Position - 0xD5B2
{
	int iVar0;
...
int func_208(var uParam0, bool bParam1, int iParam2)//Position - 0xD5E2
{
	int iVar0;
	int iVar1;
...
int func_209(int iParam0)//Position - 0xD89E
{
...
int func_210(int iParam0, float fParam1)//Position - 0xD8D2
{
	float fVar0;
	
	if (func_124(unk_0xFC1458A37D98B502()) && func_124(iParam0))
	{
		if (func_221(iParam0) || unk_0x7B46BDDD99441E94(unk_0x9EB17624F44A8DA4(), iParam0))
		{
...
bool func_211(int iParam0, float fParam1)//Position - 0xD948
{
	return func_212(iParam0, unk_0xFC1458A37D98B502(), fParam1, 1, 250, 7);
}

bool func_212(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD960
{
	var uVar0;
	vector3 vVar1;
	int iVar2;
	...
	uVar0 = func_213(&(Local_37[iVar2 /*4*/]), vVar1, iParam1, &(Local_37[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (unk_0x53C562FD2B9E3AB0() - Local_37[iVar2 /*4*/].f_3) < iParam4);
}

int func_213(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xDA21
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
	...
	if (*uParam0 == 0)
	{
		vVar1 = { func_214(iParam2, iParam5) };
...
Vector3 func_214(int iParam0, int iParam1)//Position - 0xDB4D
{
	int iVar0;
...
int func_216(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xDC5C
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_218(unk_0xB3328BA8976B416C(iParam1, 1) - unk_0xB3328BA8976B416C(iParam0, 1)) };
	...
	{
		vVar1 = { func_218(unk_0xD0E00576168D19BB(iParam0, 31086, 0f, 5f, 0f) - unk_0xD0E00576168D19BB(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar2 = func_217(vVar1, vVar0);
...
float func_217(vector3 vParam0, vector3 vParam1)//Position - 0xDCED
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

Vector3 func_218(vector3 vParam0)//Position - 0xDD0E
{
	float fVar0;
	float fVar1;
...
void func_219(var uParam0)//Position - 0xDD4D
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_220(int iParam0, int iParam1)//Position - 0xDD68
{
	int iVar0;
...
int func_221(int iParam0)//Position - 0xDDA7
{
...
int func_222(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xDDCF
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_223(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xDECA
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_224(int iParam0, float fParam1)//Position - 0xDFD6
{
	var uVar0;
	vector3 vVar1;
	...
	{
		if (func_225(iParam0, vVar1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_225(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0xE06B
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_218(vParam1 - unk_0xB3328BA8976B416C(iParam0, 1)) };
	if (fParam2 < 0,1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_226(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xE0F9
{
	if (bParam1)
	{
		if (unk_0x08765A6321A42CA1(unk_0xFC1458A37D98B502()))
...
int func_227(int iParam0)//Position - 0xE141
{
...
void func_228(int iParam0)//Position - 0xE18B
{
	int iVar0;
...
int func_229(int iParam0)//Position - 0xE228
{
	if (iParam0 == -1)
	{
		iParam0 = func_161();
...
int func_230(int iParam0)//Position - 0xE2C0
{
...
int func_233(int iParam0)//Position - 0xE342
{
	if ((func_234() && Global_92833.f_11 == 6) && iParam0 == func_162(&(Global_92833.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_235(int iParam0)//Position - 0xE3B4
{
	if (func_105(0))
	{
...
void func_236()//Position - 0xE3DC
{
	iLocal_58 = unk_0x53C562FD2B9E3AB0();
}

void func_237()//Position - 0xE3EA
{
	iLocal_56 = unk_0xD704C81492296A37("digiscanner");
	while (!unk_0x34D11AB5BA7922C2(iLocal_56))
	{
		system::wait(0);
	}
	...
	if (unk_0x7118556A56307B25("digiscanner"))
	{
		iLocal_57 = unk_0x3B46B5E6947B1597("digiscanner");
	}
	iLocal_59 = unk_0xD0CA83418A236CB4();
	iLocal_58 = unk_0x53C562FD2B9E3AB0();
}

int func_238(int iParam0)//Position - 0xE452
{
	switch (*iParam0)
	{
		case 44:
...
int func_239(var uParam0)//Position - 0xE499
{
	int iVar0[2];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_247(&(uParam0->f_48), "rcmrc_omega_2", "omega_idle_looking_around", 0);
			iLocal_51 = 1;
			break;
		
		case 1:
			if (!func_246(&iVar0) || !func_245(&(uParam0->f_48)))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			{
				if (!func_242(&(uParam0->f_28[0]), 69, 2319,443f, 2583,588f, 46,7663f, 220f, "OMEGA LAUNCHER RC", 1))
				{
					bVar2 = false;
				}
			}
			...
			{
				func_240(&(uParam0->f_35[0]), iVar0[1], 2331,08f, 2573,53f, 46,13f, 358,61f);
			}
			if (bVar2)
			{
				iLocal_51 = 3;
...
void func_240(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xE667
{
	func_241(iParam0);
...
void func_241(int iParam0)//Position - 0xE6A9
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
...
int func_242(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)//Position - 0xE745
{
...
int func_243(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)//Position - 0xE7A1
{
	int iVar0;
...
int func_244(var uParam0, int iParam1)//Position - 0xE82F
{
	int iVar0;
...
int func_245(var uParam0)//Position - 0xE875
{
	if (func_202(uParam0))
	{
...
int func_246(int iParam0)//Position - 0xE89F
{
	int iVar0;
...
void func_247(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xE8D0
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_248(var uParam0)//Position - 0xE90C
{
	int iVar0[3];
	int iVar1;
	bool bVar2;
	...
	iVar0[0] = uLocal_52;
	iVar0[1] = unk_0xD50D486F1F311BFC(joaat("weapon_digiscanner"));
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_247(&(uParam0->f_48), "rcmrc_omega_1", "omega_idle_geiger_counter", 0);
			iLocal_51 = 1;
			break;
		...
		case 2:
			...
			if (!unk_0x6ADD12BF4D6D2587(uParam0->f_28[0]))
			{
				if (!func_242(&(uParam0->f_28[0]), 69, 2468,51f, 3437,39f, 49,9f, 180f, "OMEGA LAUNCHER RC", 1))
				{
					bVar2 = false;
				}
			}
			...
			{
				uParam0->f_41[0] = unk_0x5E35CF35E65D69B9(iVar0[1], 2468,51f, 3437,39f, 55f, true, true, false);
			}
			if (!unk_0x6ADD12BF4D6D2587(uParam0->f_41[1]))
			{
				uParam0->f_41[1] = unk_0x5E35CF35E65D69B9(iVar0[2], 2468,51f, 3437,39f, 57f, true, true, false);
			}
			if ((func_124(uParam0->f_28[0]) && unk_0x6ADD12BF4D6D2587(uParam0->f_41[0])) && unk_0x6ADD12BF4D6D2587(uParam0->f_41[1]))
			{
				unk_0xA9D382E7BA095148(uParam0->f_41[0], uParam0->f_28[0], unk_0xDD09837E5235FE91(uParam0->f_28[0], 18905), 0,09f, 0,072f, -0,006f, 298f, 194f, 178f, 0, 0, 0, 0, 2, 1);
				unk_0xA9D382E7BA095148(uParam0->f_41[1], uParam0->f_28[0], unk_0xDD09837E5235FE91(uParam0->f_28[0], 64729), 0,1f, 0,08f, 0f, 162,72f, 5,4f, 1,8f, 0, 0, 0, 0, 2, 1);
			}
			else
			{
				bVar2 = false;
...
int func_249(int iParam0)//Position - 0xEB8E
{
	struct<27> Var0;
	int iVar1;
...
int func_250(int iParam0)//Position - 0xEBE2
{
	char* sVar0;
...
int func_251(int iParam0)//Position - 0xEC9B
{
	var uVar0;
...
int func_252(int iParam0)//Position - 0xED5C
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_253(int iParam0, char* sParam1)//Position - 0xEDE1
{
...
bool func_254(int iParam0)//Position - 0xEEC3
{
...
bool func_255(int iParam0)//Position - 0xEEF1
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_256(int iParam0)//Position - 0xEF1F
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_257(int iParam0)//Position - 0xEF4D
{
	if (func_230(iParam0))
	{
		return 0;
...
void func_258()//Position - 0xEF82
{
	func_279("Running end routines.");
	Global_104273 = (Global_104273 - 1);
}

int func_259(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xEF9C
{
	int iVar0;
...
int func_260(int iParam0, vector3 vParam1, float fParam2, var uParam3)//Position - 0xF001
{
	int iVar0;
	struct<7> Var1;
...
int func_261(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0xF07F
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_262(int iParam0, bool bParam1)//Position - 0xF0FA
{
	char* sVar0;
	...
	if (bParam1)
	{
		...
		if (*iParam0 == 44 && unk_0x6ADD12BF4D6D2587(iParam0->f_41[1]))
		{
			unk_0x3A703774620FDB42(&(iParam0->f_41[1]));
		}
...
void func_263(char* sParam0)//Position - 0xF1CA
{
	if (!unk_0xAB019B170BF1309C(sParam0))
	{
		if (func_184(sParam0))
...
void func_264()//Position - 0xF1E9
{
	Global_14622 = 0;
	func_265();
}

void func_265()//Position - 0xF1F9
{
	unk_0x495EB1DD7306493A();
	Global_16767 = 0;
	if (unk_0x42111BD51D233AAB())
...
int func_266(var uParam0)//Position - 0xF21A
{
	if (func_202(uParam0))
	{
		if (unk_0x3A801AA34DD821BE(*uParam0))
...
void func_267(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xF250
{
...
void func_268(var uParam0, bool bParam1)//Position - 0xF270
{
	func_269(&(uParam0->f_41), bParam1);
}

void func_269(var uParam0, bool bParam1)//Position - 0xF282
{
	int iVar0;
...
void func_270(int iParam0, bool bParam1)//Position - 0xF2C0
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
		if (unk_0x6049C20F5D5C185B(*iParam0))
...
void func_271(var uParam0, bool bParam1)//Position - 0xF2FB
{
	func_272(&(uParam0->f_35), bParam1);
}

void func_272(var uParam0, bool bParam1)//Position - 0xF30D
{
	int iVar0;
...
void func_273(int iParam0)//Position - 0xF34A
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
...
void func_274(var uParam0, int iParam1)//Position - 0xF382
{
	func_275(&(uParam0->f_28), iParam1);
}

void func_275(var uParam0, int iParam1)//Position - 0xF394
{
	int iVar0;
...
void func_276(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xF3D5
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
		if (!unk_0x3AB6A1A9084FB0A4(*iParam0))
...
void func_277(int iParam0)//Position - 0xF425
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
		if (!unk_0x191BE1BC8F26F3C1(*iParam0, 0))
...
void func_278(var uParam0)//Position - 0xF466
{
	if (*uParam0 == -1)
	{
		return;
...
void func_279(char* sParam0)//Position - 0xF4A3
{
	if (!unk_0xAB019B170BF1309C(sParam0))
	{
	}
...
void func_280(var uParam0)//Position - 0xF4B5
{
	*uParam0 = -1;
...
void func_281()//Position - 0xF4E8
{
	func_279("Running start routines.");
	Global_104273++;
}

int func_282(int iParam0)//Position - 0xF502
{
	if (!func_36(iParam0))
	{
		return Global_104555.f_28020[iParam0 /*29*/];
