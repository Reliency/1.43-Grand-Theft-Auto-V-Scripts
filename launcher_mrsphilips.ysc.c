...
void __EntryFunction__()//Position - 0x0
{
	...
	if (unk_0x7D9C4B359376D38A(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_103642[Var0 /*10*/].f_9 != -1)
			{
				...
				func_254(&(Global_103642[Var0 /*10*/].f_9));
			}
		}
		func_241(&Var0, 1);
	}
	iVar2[0] = 35;
	if (!func_238(&iVar2, &Var0, vVar1, 1f))
	{
		func_237();
	...
	func_226(&Var0);
	iLocal_52 = unk_0xCB389937EDB1519A(vVar1 - Vector(20f, 20f, 20f), vVar1 + Vector(20f, 20f, 20f), 0, 1, 1, 1);
	...
	while (true)
	{
		...
		func_187(Var0);
		func_179(&iLocal_51, &(Var0.f_9), vVar1);
		if (func_164(&Var0, 0))
		{
			if (Var0 == 35)
			{
...
void func_4(int iParam0)//Position - 0x3FA
{
	int iVar0;
	int iVar1;
...
void func_6(int iParam0)//Position - 0x607
{
	switch (iParam0)
	{
		case 2:
...
void func_7(int iParam0)//Position - 0x9EF
{
	Global_55896 = 1;
	Global_55899 = 1;
	if (Global_67998 > 15)
...
void func_8(int iParam0)//Position - 0xA3A
{
...
struct<2> func_9(int iParam0)//Position - 0xA6E
{
	struct<2> Var0;
	char[] cVar1[8];
...
void func_13()//Position - 0xB5E
{
	Global_56062 = 0;
}

void func_14()//Position - 0xB6A
{
	Global_55922 = 0;
...
var func_15(int iParam0)//Position - 0xBBE
{
	var uVar0;
...
void func_17(int iParam0)//Position - 0xBFC
{
	Global_71116 = iParam0;
	Global_71117 = iParam0;
}

void func_18()//Position - 0xC10
{
	int iVar0;
...
void func_22(char[4] cParam0, int iParam1)//Position - 0xCC6
{
	unk_0x0EE72DB1CD8A3B86(&(Global_92833.f_20), 17);
	func_23(cParam0, iParam1, 0);
}

void func_23(char[4] cParam0, int iParam1, int iParam2)//Position - 0xCE3
{
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x19BB
{
	int iVar0;
	int iVar1;
...
int func_40(int iParam0)//Position - 0x3248
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_41(var uParam0)//Position - 0x3268
{
	int iVar0;
...
int func_42(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x3318
{
	char* sVar0;
...
int func_43(int iParam0, int iParam1, bool bParam2)//Position - 0x3447
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_44(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x34B8
{
...
int func_45(int iParam0)//Position - 0x3590
{
	int iVar0;
	int iVar1;
...
int func_46(int iParam0)//Position - 0x35CD
{
	if (func_36(iParam0))
	{
...
void func_47(int iParam0, var uParam1, int iParam2)//Position - 0x35F7
{
	int iVar0;
	int iVar1;
...
int func_48(int iParam0, int iParam1, int iParam2)//Position - 0x37A1
{
	int iVar0;
	var uVar1;
...
int func_49(var uParam0)//Position - 0x37D3
{
	int iVar0;
	int iVar1;
...
int func_50()//Position - 0x3807
{
	return Global_1312736;
}

int func_51(int iParam0, int iParam1)//Position - 0x3813
{
	var uVar0;
	var uVar1;
...
void func_52(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x383F
{
	int iVar0;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3D87
{
	int iVar0;
...
int func_54()//Position - 0x3FC8
{
	func_55();
	return Global_104555.f_2353.f_539.f_4301;
}

void func_55()//Position - 0x3FE1
{
	int iVar0;
...
bool func_105(bool bParam0)//Position - 0x8292
{
...
struct<2> func_106(int iParam0)//Position - 0x82BD
{
	struct<2> Var0;
...
void func_107(int iParam0, var uParam1)//Position - 0x8709
{
	switch (iParam0)
	{
		case 0:
...
int func_109(int iParam0)//Position - 0x994F
{
	switch (iParam0)
	{
		case 0:
...
int func_110(int iParam0)//Position - 0x9C95
{
	int iVar0;
...
void func_111(int iParam0)//Position - 0x9D39
{
	struct<2> Var0;
...
void func_112(int iParam0)//Position - 0x9DD4
{
	if (iParam0 < 63)
	{
		func_113();
...
void func_114(int iParam0)//Position - 0x9E32
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_115(int iParam0)//Position - 0x9E8B
{
...
int func_116(int iParam0)//Position - 0x9F0E
{
	int iVar0;
...
void func_117(int iParam0, int iParam1, int iParam2)//Position - 0x9F3F
{
	func_118(iParam0, iParam1, iParam2, 0, 0);
}

void func_118(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x9F53
{
	int iVar0;
...
int func_120(int iParam0, int iParam1, int iParam2)//Position - 0x9FFB
{
...
int func_121(int iParam0, int iParam1, int iParam2)//Position - 0xA016
{
	int iVar0;
...
int func_122(int iParam0)//Position - 0xA062
{
	int iVar0;
...
int func_123(int iParam0)//Position - 0xA0AB
{
	if (func_124(iParam0))
	{
		if (!unk_0x3AB6A1A9084FB0A4(iParam0))
...
int func_124(int iParam0)//Position - 0xA0CB
{
	if (unk_0x6ADD12BF4D6D2587(iParam0))
	{
...
int func_125(int iParam0)//Position - 0xA0EC
{
	switch (iParam0)
	{
		case 5:
...
int func_127(int iParam0)//Position - 0xA1BC
{
	switch (iParam0)
	{
		case 5:
...
void func_128(var uParam0, bool bParam1, bool bParam2)//Position - 0xA20F
{
	int iVar0;
...
int func_129(int iParam0)//Position - 0xA304
{
	switch (iParam0)
	{
		case 5:
...
void func_130(bool bParam0)//Position - 0xA36F
{
	int iVar0;
...
void func_131(bool bParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xA3AB
{
	if (bParam0)
	{
...
bool func_132()//Position - 0xA4C4
{
	return unk_0xC80D31E4B587871C(Global_1595693[unk_0x9EB17624F44A8DA4() /*680*/].f_39.f_18, 14);
}

bool func_133(int iParam0, int iParam1)//Position - 0xA4E1
{
	bool bVar0;
...
int func_134(int iParam0, bool bParam1)//Position - 0xA52C
{
	int iVar0;
	int iVar1;
...
int func_135(int iParam0)//Position - 0xA56D
{
...
bool func_136()//Position - 0xA5AF
{
	return unk_0xC80D31E4B587871C(Global_2359302, 3);
}

int func_137(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xA5C0
{
	int iVar0;
...
void func_139(int iParam0)//Position - 0xA61A
{
	if (iParam0 == 1)
	{
...
int func_140(char* sParam0)//Position - 0xA63D
{
...
void func_141()//Position - 0xA67A
{
	Global_14622 = 0;
	func_142();
}

void func_142()//Position - 0xA68A
{
...
int func_146(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xA770
{
...
void func_147(int iParam0)//Position - 0xA8FF
{
	if (!unk_0x191BE1BC8F26F3C1(iParam0, 0))
	{
...
void func_149(int iParam0)//Position - 0xA97C
{
...
void func_150(int iParam0)//Position - 0xA9A5
{
	if (Global_14615)
	{
		func_151(0, 0);
...
void func_151(bool bParam0, bool bParam1)//Position - 0xAA15
{
	if (bParam0)
	{
		if (func_152(0))
...
int func_152(int iParam0)//Position - 0xAA89
{
	if (iParam0 == 1)
	{
		if (Global_14453.f_1 > 3)
...
int func_153(int iParam0)//Position - 0xAAE3
{
...
int func_154(int iParam0)//Position - 0xAB24
{
	int iVar0;
...
void func_155(int iParam0)//Position - 0xAB69
{
...
int func_156(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xAB9B
{
	int iVar0;
...
void func_157(var uParam0, int iParam1)//Position - 0xACD2
{
	int iVar0;
...
bool func_158(int iParam0)//Position - 0xAD21
{
	return func_159(iParam0, Global_35861);
}

int func_159(int iParam0, int iParam1)//Position - 0xAD32
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_160(int iParam0)//Position - 0xAF13
{
	if (Global_35861 == 15)
	{
		return 0;
...
int func_161()//Position - 0xAF35
{
	return func_162(unk_0x436287B7DB306165(), 0);
}

int func_162(char* sParam0, int iParam1)//Position - 0xAF46
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_164(var uParam0, int iParam1)//Position - 0xAFB3
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_165()//Position - 0xB796
{
	func_27(&(Global_95149.f_2875), &Global_95149, 0, 1, 1, 0);
}

int func_166(var uParam0)//Position - 0xB7B1
{
	float fVar0;
...
void func_167(int iParam0, int iParam1)//Position - 0xB83F
{
	if (iParam0 == 1)
	{
		if (!func_127(iParam1))
...
int func_168(bool bParam0)//Position - 0xB8A3
{
	int iVar0;
...
int func_169(int iParam0)//Position - 0xB93A
{
	if (func_124(iParam0))
	{
		if (unk_0xB8DE76287EDC4957(iParam0, 0))
...
int func_170(int iParam0)//Position - 0xB964
{
	int iVar0;
...
var func_171()//Position - 0xC084
{
	return Global_92872.f_1;
}

int func_172()//Position - 0xC092
{
	if (Global_89900 != -1)
	{
...
bool func_175()//Position - 0xC0FC
{
	return Global_92885.f_316 > 0;
}

bool func_176(int iParam0, int iParam1)//Position - 0xC10D
{
	switch (iParam0)
	{
		case 5:
...
var func_177()//Position - 0xC148
{
	return Global_1312854;
}

int func_178()//Position - 0xC154
{
	if (!unk_0x3A711520F83BAE98())
	{
...
void func_179(int iParam0, char* sParam1, vector3 vParam2)//Position - 0xC170
{
	if (unk_0x5BEF7A5AB8F17255(unk_0x9EB17624F44A8DA4()))
	{
...
void func_180(int iParam0, bool bParam1)//Position - 0xC261
{
	if (iParam0 == -1)
	{
		return;
...
int func_181(int iParam0)//Position - 0xC29D
{
	if (Global_70852 == iParam0)
	{
		if (Global_70853 == -1)
...
void func_182(int iParam0, int iParam1)//Position - 0xC2D6
{
	bool bVar0;
	int iVar1;
...
float func_183(int iParam0, vector3 vParam1, bool bParam2)//Position - 0xC374
{
	vector3 vVar0;
...
bool func_184()//Position - 0xC3AE
{
	return Global_90287;
}

void func_185(int iParam0)//Position - 0xC3BA
{
	unk_0x7042DDDE71665936(0);
	unk_0xA6C03E3E2533F8F3();
	func_186(iParam0);
...
void func_186(int iParam0)//Position - 0xC3D1
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_187(int iParam0)//Position - 0xC4B9
{
	if (iParam0 == -1)
	{
		iParam0 = func_161();
...
int func_188(var uParam0, bool bParam1)//Position - 0xC4E1
{
	struct<27> Var0;
...
void func_189(int iParam0, var uParam1, int iParam2)//Position - 0xC754
{
	int iVar0;
	int iVar1;
...
int func_190(int iParam0)//Position - 0xCAAC
{
...
int func_191(var uParam0)//Position - 0xCACC
{
...
int func_192(var uParam0)//Position - 0xCAE4
{
...
void func_193(var uParam0)//Position - 0xCB09
{
	int iVar0;
	int iVar1;
...
void func_194(int iParam0)//Position - 0xCE0D
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
...
void func_195(var uParam0)//Position - 0xCE38
{
	int iVar0;
...
int func_196(var uParam0, bool bParam1, bool bParam2)//Position - 0xCEB8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_197(int iParam0, int iParam1)//Position - 0xD076
{
	int iVar0;
...
int func_198(var uParam0, bool bParam1, int iParam2)//Position - 0xD0A6
{
	int iVar0;
	int iVar1;
...
int func_199(int iParam0)//Position - 0xD362
{
...
int func_200(int iParam0, float fParam1)//Position - 0xD396
{
	float fVar0;
...
bool func_201(int iParam0, float fParam1)//Position - 0xD40C
{
	return func_202(iParam0, unk_0xFC1458A37D98B502(), fParam1, 1, 250, 7);
}

bool func_202(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD424
{
	var uVar0;
	vector3 vVar1;
	int iVar2;
...
int func_203(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xD4E5
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
Vector3 func_204(int iParam0, int iParam1)//Position - 0xD611
{
	int iVar0;
...
int func_206(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xD720
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
...
float func_207(vector3 vParam0, vector3 vParam1)//Position - 0xD7B1
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

Vector3 func_208(vector3 vParam0)//Position - 0xD7D2
{
	float fVar0;
	float fVar1;
...
void func_209(var uParam0)//Position - 0xD811
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_210(int iParam0, int iParam1)//Position - 0xD82C
{
	int iVar0;
...
int func_211(int iParam0)//Position - 0xD86B
{
...
int func_212(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xD893
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_213(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xD98E
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_214(int iParam0, float fParam1)//Position - 0xDA9A
{
	var uVar0;
	vector3 vVar1;
...
int func_215(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0xDB2F
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
...
int func_216(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xDBBD
{
	if (bParam1)
	{
		if (unk_0x08765A6321A42CA1(unk_0xFC1458A37D98B502()))
...
int func_217(int iParam0)//Position - 0xDC05
{
...
void func_218(int iParam0)//Position - 0xDC4F
{
	int iVar0;
...
int func_219(int iParam0)//Position - 0xDCEC
{
	if (iParam0 == -1)
	{
		iParam0 = func_161();
...
int func_220(int iParam0)//Position - 0xDD84
{
...
int func_223(int iParam0)//Position - 0xDE06
{
...
int func_225(int iParam0)//Position - 0xDE78
{
	if (func_105(0))
	{
...
void func_226(int iParam0)//Position - 0xDEA0
{
	if (!unk_0x42F1FE4C7EC5F51E())
	{
...
void func_227(int iParam0)//Position - 0xDECD
{
	iParam0->f_16 = 5;
...
int func_228(int iParam0)//Position - 0xDF22
{
	struct<27> Var0;
	int iVar1;
...
int func_229(int iParam0)//Position - 0xDF76
{
	char* sVar0;
...
int func_230(int iParam0)//Position - 0xE02F
{
	var uVar0;
...
int func_231(int iParam0)//Position - 0xE0F0
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_232(int iParam0, char* sParam1)//Position - 0xE175
{
...
bool func_233(int iParam0)//Position - 0xE255
{
...
bool func_234(int iParam0)//Position - 0xE283
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_235(int iParam0)//Position - 0xE2B1
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_236(int iParam0)//Position - 0xE2DF
{
	if (func_220(iParam0))
	{
		return 0;
...
void func_237()//Position - 0xE314
{
	func_255("Running end routines.");
	Global_104273 = (Global_104273 - 1);
}

int func_238(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xE32E
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_239((*iParam0)[0], vParam2, fParam3, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_239((*iParam0)[iVar0], vParam2, fParam3, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_239(int iParam0, vector3 vParam1, float fParam2, var uParam3)//Position - 0xE393
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_240(Var1.f_6, vParam1, fParam2, 0))
	{
...
int func_240(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0xE411
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_241(int iParam0, bool bParam1)//Position - 0xE48C
{
	if (bParam1)
	{
...
void func_242(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xE4E0
{
...
void func_243(var uParam0, bool bParam1)//Position - 0xE500
{
	func_244(&(uParam0->f_41), bParam1);
}

void func_244(var uParam0, bool bParam1)//Position - 0xE512
{
	int iVar0;
...
void func_245(int iParam0, bool bParam1)//Position - 0xE550
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
		if (unk_0x6049C20F5D5C185B(*iParam0))
...
void func_246(var uParam0, bool bParam1)//Position - 0xE58B
{
	func_247(&(uParam0->f_35), bParam1);
}

void func_247(var uParam0, bool bParam1)//Position - 0xE59D
{
	int iVar0;
...
void func_248(int iParam0)//Position - 0xE5DA
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
...
void func_249(int iParam0)//Position - 0xE612
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
...
void func_250(var uParam0, int iParam1)//Position - 0xE6AE
{
	func_251(&(uParam0->f_28), iParam1);
}

void func_251(var uParam0, int iParam1)//Position - 0xE6C0
{
	int iVar0;
...
void func_252(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xE701
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
		if (!unk_0x3AB6A1A9084FB0A4(*iParam0))
...
void func_253(int iParam0)//Position - 0xE751
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
		if (!unk_0x191BE1BC8F26F3C1(*iParam0, 0))
...
void func_254(var uParam0)//Position - 0xE792
{
	if (*uParam0 == -1)
	{
		return;
...
void func_255(char* sParam0)//Position - 0xE7CF
{
	if (!unk_0xAB019B170BF1309C(sParam0))
	{
	}
...
void func_256(var uParam0)//Position - 0xE7E1
{
	*uParam0 = -1;
