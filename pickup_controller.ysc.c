...
void func_3(int iParam0, int iParam1, vector3 vParam2, bool bParam3, bool bParam4)//Position - 0x10B
{
	int iVar0;
	...
	iLocal_29[iParam0] = unk_0x85CE54AA667066FE(iParam1, func_4(iParam0), vParam2, iVar0, -1, 2, 1, 0);
	unk_0x3339BF0D359C2758(iLocal_29[iParam0], 600000);
}
...
void func_7(int iParam0, int iParam1, vector3 vParam2, bool bParam3, bool bParam4)//Position - 0x1E7
{
	int iVar0;
	...
	iLocal_27[iParam0] = unk_0x85CE54AA667066FE(iParam1, func_8(iParam0), vParam2, iVar0, -1, 2, 1, 0);
	unk_0x3339BF0D359C2758(iLocal_27[iParam0], 600000);
}
...
void func_11(int iParam0, int iParam1, vector3 vParam2, bool bParam3, bool bParam4)//Position - 0x3FC
{
	int iVar0;
	...
	iLocal_24[iParam0] = unk_0x85CE54AA667066FE(iParam1, func_12(iParam0), vParam2, iVar0, -1, 2, 1, 0);
	unk_0x3339BF0D359C2758(iLocal_24[iParam0], 600000);
}

Vector3 func_12(int iParam0)//Position - 0x487
{
	switch (iParam0)
	{
		case 0:
...
void func_14()//Position - 0x5B9
{
	switch (Global_25474)
	{
		...
		case 1:
			...
			{
				case 0:
					if (unk_0xB8B3E5529EDB87D4(iLocal_20[Global_25476]) && unk_0x4C6D8414E075A2B8(iLocal_20[Global_25476]))
					{
						Global_25477 = 0;
					}
					else
				...
				case 1:
					if (unk_0xB8B3E5529EDB87D4(iLocal_22[Global_25476]) && unk_0x4C6D8414E075A2B8(iLocal_22[Global_25476]))
					{
						Global_25477 = 0;
					}
					else
				...
				case 2:
					if (unk_0xB8B3E5529EDB87D4(iLocal_23[Global_25476]) && unk_0x4C6D8414E075A2B8(iLocal_23[Global_25476]))
					{
						Global_25477 = 0;
					}
					else
...
void func_16()//Position - 0x6E2
{
	...
	while (iVar0 < 1)
	{
		if (unk_0xB8B3E5529EDB87D4(iLocal_29[iVar0]))
		{
			unk_0x60727D07B2D72C82(iLocal_29[iVar0]);
		}
		iVar0++;
	}
	iLocal_30 = 0;
...
void func_17()//Position - 0x719
{
	...
	while (iVar0 < 1)
	{
		if (unk_0xB8B3E5529EDB87D4(iLocal_27[iVar0]))
		{
			unk_0x60727D07B2D72C82(iLocal_27[iVar0]);
		}
		iVar0++;
	}
	iLocal_28 = 0;
...
void func_18()//Position - 0x750
{
	...
	while (iVar0 < 9)
	{
		if (unk_0xB8B3E5529EDB87D4(iLocal_24[iVar0]))
		{
			unk_0x60727D07B2D72C82(iLocal_24[iVar0]);
		}
		iVar0++;
	}
	iLocal_25 = 0;
...
void func_19()//Position - 0x788
{
	...
	while (iVar0 < 102)
	{
		if (unk_0xB8B3E5529EDB87D4(iLocal_23[iVar0]))
		{
			unk_0x60727D07B2D72C82(iLocal_23[iVar0]);
		}
		iVar0++;
	}
}

void func_20()//Position - 0x7BA
{
	int iVar0;
	...
	while (iVar0 < 76)
	{
		if (unk_0xB8B3E5529EDB87D4(iLocal_22[iVar0]))
		{
			unk_0x60727D07B2D72C82(iLocal_22[iVar0]);
		}
		iVar0++;
	}
}

void func_21()//Position - 0x7EC
{
	int iVar0;
	...
	while (iVar0 < 19)
	{
		if (unk_0xB8B3E5529EDB87D4(iLocal_21[iVar0]))
		{
			unk_0x60727D07B2D72C82(iLocal_21[iVar0]);
		}
		iVar0++;
	}
}

void func_22()//Position - 0x81E
{
	int iVar0;
	...
	while (iVar0 < 45)
	{
		if (unk_0xB8B3E5529EDB87D4(iLocal_20[iVar0]))
		{
			unk_0x60727D07B2D72C82(iLocal_20[iVar0]);
		}
		iVar0++;
	}
}

bool func_23(int iParam0)//Position - 0x850
{
	return Global_35861 == iParam0;
}

void func_24()//Position - 0x85E
{
	func_36();
	func_33();
	func_29();
...
void func_26(int iParam0, int iParam1, vector3 vParam2, bool bParam3, bool bParam4, bool bParam5)//Position - 0xFF8
{
	int iVar0;
	...
	iLocal_23[iParam0] = unk_0x85CE54AA667066FE(iParam1, func_28(iParam0, 0), vParam2, iVar0, -1, 2, 1, 0);
	unk_0x3339BF0D359C2758(iLocal_23[iParam0], 600000);
	if (bParam4)
	{
		unk_0x6E795A41127FC848(iLocal_23[iParam0], func_27(iParam0));
	}
}

char* func_27(int iParam0)//Position - 0x1069
{
	switch (iParam0)
	{
		case 13:
...
Vector3 func_28(int iParam0, bool bParam1)//Position - 0x10DD
{
	switch (iParam0)
	{
		case 0:
...
void func_30(int iParam0, vector3 vParam1, bool bParam2, bool bParam3)//Position - 0x243A
{
	int iVar0;
	...
	iLocal_22[iParam0] = unk_0x85CE54AA667066FE(joaat("pickup_health_standard"), func_32(iParam0, 0), vParam1, iVar0, -1, 2, 1, 0);
	unk_0x3339BF0D359C2758(iLocal_22[iParam0], 600000);
	if (bParam3)
	{
		unk_0x6E795A41127FC848(iLocal_22[iParam0], func_31(iParam0));
	}
}

char* func_31(int iParam0)//Position - 0x24B2
{
	switch (iParam0)
	{
		case 2:
...
Vector3 func_32(int iParam0, bool bParam1)//Position - 0x259F
{
	switch (iParam0)
	{
		case 0:
...
void func_34(int iParam0, vector3 vParam1, bool bParam2)//Position - 0x3435
{
	int iVar0;
	...
	iLocal_21[iParam0] = unk_0x85CE54AA667066FE(joaat("pickup_weapon_petrolcan"), func_35(iParam0), vParam1, iVar0, -1, 2, 1, 0);
	unk_0x3339BF0D359C2758(iLocal_21[iParam0], 600000);
}

Vector3 func_35(int iParam0)//Position - 0x3496
{
	switch (iParam0)
	{
		case 0:
...
void func_37(int iParam0, vector3 vParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x3935
{
	int iVar0;
	...
	iLocal_20[iParam0] = unk_0x85CE54AA667066FE(joaat("pickup_armour_standard"), func_39(iParam0, 0), vParam1, iVar0, -1, 2, 1, 0);
	unk_0x3339BF0D359C2758(iLocal_20[iParam0], 600000);
	if (bParam3)
	{
		unk_0x6E795A41127FC848(iLocal_20[iParam0], func_38(iParam0));
	}
}

char* func_38(int iParam0)//Position - 0x39B1
{
	switch (iParam0)
	{
		case 28:
...
Vector3 func_39(int iParam0, bool bParam1)//Position - 0x39FA
{
	switch (iParam0)
	{
		case 0:
