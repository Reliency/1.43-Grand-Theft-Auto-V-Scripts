...
int func_6(char* sParam0)//Position - 0x137
{
...
void func_11(var uParam0)//Position - 0x21C
{
	...
	switch (uParam0->f_57.f_4)
	{
		...
		case 1:
			if (func_49(uParam0))
			{
				uParam0->f_57.f_6 = unk_0x53C562FD2B9E3AB0();
				func_50(uParam0, 2);
			}
			break;
		
		case 2:
			if (func_48(unk_0xFC1458A37D98B502(), uParam0[uParam0->f_57.f_2 /*14*/]))
			{
				...
				{
					if ((unk_0x53C562FD2B9E3AB0() - uParam0->f_57.f_6) > 150)
					{
						func_43(&(uParam0->f_57.f_5), 4, "MPJAC_SIT", 0, 0, 0, 0);
					}
				}
		...
		case 4:
			func_39(uParam0, &sVar0);
			func_38(uParam0, &sVar1);
			if (Var2 != 3)
			{
				vVar3 = { unk_0x09E51060F59912ED(&sVar0, &sVar1, func_37(uParam0), func_36(uParam0), 0, 2) };
				vVar4 = { unk_0x4AA2C5A4980B3F34(&sVar0, &sVar1, func_37(uParam0), func_36(uParam0), 0f, 2) };
				iVar5 = vVar4.z;
		...
		case 5:
			...
			if (iVar6 != 1 && iVar6 != 0)
			{
				uParam0->f_57.f_1 = unk_0x9CEC233AE69E2D39(func_37(uParam0), func_36(uParam0), 2, 1, 0, 1065353216, 0, 1065353216);
				unk_0x7C92B99DB7D4962F(unk_0xFC1458A37D98B502(), uParam0->f_57.f_1, &sVar0, &sVar1, 2f, -1000f, 13, 16, 1,5f, 0);
				unk_0x9C39944AA129D284(uParam0->f_57.f_1);
				uParam0->f_57.f_8.f_4 = unk_0x53C562FD2B9E3AB0();
		...
		case 6:
			...
			{
				func_51(&(uParam0->f_57), 10);
				func_24(uParam0);
			}
			func_26(uParam0);
			func_18(uParam0);
			iVar7 = unk_0x45D90ED1F569A489(uParam0->f_57.f_1);
			if (unk_0xD56F740235B1E8F0(iVar7))
			{
				if (unk_0x463C4747B41E35A3(iVar7) >= 1f)
				{
					...
					func_38(uParam0, &sVar1);
					uParam0->f_57.f_1 = unk_0x9CEC233AE69E2D39(func_37(uParam0), func_36(uParam0), 2, 1, 0, 1065353216, 0, 1065353216);
					unk_0x7C92B99DB7D4962F(unk_0xFC1458A37D98B502(), uParam0->f_57.f_1, &sVar0, &sVar1, 4f, -1,5f, 13, 16, 1000f, 0);
					unk_0x9C39944AA129D284(uParam0->f_57.f_1);
					func_25(&(uParam0->f_57), 8);
		...
		case 7:
			unk_0x0B0BB26D99CD7575(uParam0->f_57.f_1);
			func_50(uParam0, 8);
			break;
		
		case 8:
			iVar8 = unk_0x45D90ED1F569A489(uParam0->f_57.f_1);
...
void func_12(var uParam0, bool bParam1)//Position - 0x632
{
	...
	else
	{
		...
		if ((unk_0x53C562FD2B9E3AB0() - uParam0->f_57.f_8.f_4) >= 90000)
		{
			iVar1 = func_13(uParam0);
			if (iVar1 != uParam0->f_57.f_8.f_1)
			{
...
void func_18(var uParam0)//Position - 0x81A
{
	...
	if (uParam0->f_57.f_4 == 6)
	{
		...
		if ((uParam0->f_57.f_4 == 6 && !unk_0x7B82209ED5D8E168(unk_0xFC1458A37D98B502(), -1322051853)) && !func_8(&(uParam0->f_57), 12))
		{
			if (fVar1 >= 0,35f)
			{
				func_23(uParam0);
		...
		else
		{
			...
			if (((((!unk_0x0F30C1F1717A6437() && !func_8(&(uParam0->f_57), 0)) && !func_8(&(uParam0->f_57), 4)) && !func_21()) && !func_19(1)) && uParam0->f_57.f_8.f_2 != 3)
			{
				if (uParam0->f_57.f_5 == -1)
				{
					func_43(&(uParam0->f_57.f_5), 4, "MPJAC_EXIT", 0, 0, 0, 0);
				}
				if (uParam0->f_57.f_4 == 6)
				{
...
void func_24(var uParam0)//Position - 0xBC3
{
	...
	uParam0->f_57.f_1 = unk_0x9CEC233AE69E2D39(func_37(uParam0), func_36(uParam0), 2, 1, 0, 1065353216, 0, 1065353216);
	func_39(uParam0, &sVar0);
	unk_0x7C92B99DB7D4962F(unk_0xFC1458A37D98B502(), uParam0->f_57.f_1, &sVar0, "exit", 4f, -4f, 13, 16, 1000f, 0);
	unk_0x9C39944AA129D284(uParam0->f_57.f_1);
	func_9(&(uParam0->f_57.f_5));
	func_50(uParam0, 8);
}
...
void func_30()//Position - 0xD14
{
	unk_0x872F1C1F8587CCC7(&Global_2324, 4);
}

void func_31(int iParam0)//Position - 0xD24
{
...
void func_34(bool bParam0, bool bParam1)//Position - 0xDE4
{
	if (bParam0)
	{
		if (func_35(0))
...
int func_35(int iParam0)//Position - 0xE58
{
	if (iParam0 == 1)
	{
...
Vector3 func_36(var uParam0)//Position - 0xEB2
{
	vector3 vVar0;
...
Vector3 func_37(var uParam0)//Position - 0xEF0
{
	return (uParam0[uParam0->f_57.f_2 /*14*/])->f_8;
}

void func_38(var uParam0, char* sParam1)//Position - 0xF06
{
...
void func_39(var uParam0, char* sParam1)//Position - 0x1002
{
...
void func_40(var uParam0)//Position - 0x1142
{
	uParam0->f_57.f_8 = func_42((*uParam0)[uParam0->f_57.f_2 /*14*/]);
	uParam0->f_57.f_8.f_1 = func_41(uParam0);
	uParam0->f_57.f_8.f_2 = 3;
	uParam0->f_57.f_8.f_3 = 3;
}

int func_41(var uParam0)//Position - 0x117E
{
	int iVar0;
	...
	switch (uParam0->f_57.f_8)
	{
		...
		default:
			iVar0 = unk_0x63A6486593EC7EC3(0, func_14(uParam0->f_57.f_8));
	}
	return iVar0;
}

int func_42(int iParam0)//Position - 0x11C1
{
	if (iParam0 >= 11)
	{
		return 0;
...
void func_43(var uParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6)//Position - 0x120A
{
	int iVar0;
...
bool func_44(var uParam0)//Position - 0x1335
{
...
int func_45(var uParam0)//Position - 0x1364
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < unk_0xB72D370CB7ABC3EF())
	{
		if (unk_0x012BC3F18B8C7807(unk_0x2B957AC89DEBA5B6(iVar0)))
		{
			...
			if ((iVar1 != unk_0x9EB17624F44A8DA4() && func_46(iVar1, 1, 1)) && func_48(unk_0x25D049AAC4603E65(iVar1), uParam0[uParam0->f_57.f_2 /*14*/]))
			{
				return 1;
			}
		}
...
int func_46(int iParam0, bool bParam1, bool bParam2)//Position - 0x13CF
{
	int iVar0;
...
bool func_47(var uParam0)//Position - 0x1419
{
	return uParam0->f_57 & 31 > 0;
}

bool func_48(int iParam0, var uParam1)//Position - 0x142A
{
	return unk_0x0F3033474C49912D(iParam0, uParam1->f_1, uParam1->f_1.f_3, uParam1->f_1.f_6, 0, 1, 0);
}

int func_49(var uParam0)//Position - 0x144F
{
	int iVar0;
...
void func_50(var uParam0, int iParam1)//Position - 0x1496
{
	uParam0->f_57.f_4 = iParam1;
}

void func_51(int iParam0, int iParam1)//Position - 0x14A6
{
	unk_0x0EE72DB1CD8A3B86(iParam0, iParam1);
}

void func_52(var uParam0)//Position - 0x14B6
{
	if (uParam0->f_57.f_4 == 6)
	{
	}
	else if (uParam0->f_57.f_4 > 4)
	{
		...
		uParam0->f_57.f_7 = unk_0x4B64A8D052027742();
	}
	...
	else if ((unk_0x4B64A8D052027742() - uParam0->f_57.f_7) < 5)
	{
		unk_0x91AD7123A61E33F8(unk_0xFC1458A37D98B502(), func_53(uParam0));
	}
}

float func_53(var uParam0)//Position - 0x153A
{
...
void func_54(var uParam0)//Position - 0x158C
{
	func_55(&(uParam0->f_57), 4, func_56());
	func_55(&(uParam0->f_57), 1, unk_0x191BE1BC8F26F3C1(unk_0xFC1458A37D98B502(), 0));
	func_55(&(uParam0->f_57), 3, unk_0x88DDBE9908752BF0(unk_0xFC1458A37D98B502(), 1));
	func_55(&(uParam0->f_57), 0, func_35(0));
	func_55(&(uParam0->f_57), 2, unk_0xA57E3BD5C64527C7(unk_0xFC1458A37D98B502()));
}

void func_55(int iParam0, int iParam1, bool bParam2)//Position - 0x15E4
{
	int iVar0;
...
bool func_56()//Position - 0x1608
{
	return Global_68215;
}

int func_57()//Position - 0x1614
{
...
int func_58()//Position - 0x1647
{
	return -1;
}

int func_59()//Position - 0x1650
{
	var uVar0;
...
int func_61()//Position - 0x170E
{
	return Global_25233;
}

bool func_62()//Position - 0x1719
{
	return Global_2447174.f_586;
}

int func_63(int iParam0)//Position - 0x1728
{
...
bool func_64()//Position - 0x173F
{
	return Global_2456830;
}

bool func_65()//Position - 0x174B
{
	return Global_2447174.f_581;
}

void func_66(var uParam0)//Position - 0x175A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_67(int iParam0)//Position - 0x17CD
{
	vector3 vVar0;
	int iVar1;
	int iVar2;
...
int func_68(int iParam0, var uParam1)//Position - 0x184E
{
...
bool func_69(int iParam0)//Position - 0x18AD
{
	return unk_0x0F3033474C49912D(iParam0, 451,6327f, 4829,453f, -54,97165f, 499,981f, 4842,034f, -50,67961f, 30,75f, 0, 1, 0);
}

int func_70()//Position - 0x18E1
{
	if (Global_1595543 != func_58())
	{
		if (unk_0xA357031C5C05DD94("base_entrance_seats", Global_1595543, 1, 0))
		{
			return 0;
		}
...
void func_71()//Position - 0x192D
{
	int iVar0[2];
	
	iVar0[0] = 0;
	iVar0[1] = 1;
	func_72(0, &uLocal_138, &iVar0);
	iVar0[0] = 2;
	iVar0[1] = 3;
	func_72(1, &uLocal_138, &iVar0);
}

void func_72(int iParam0, var uParam1, int iParam2)//Position - 0x1964
{
	vector3 vVar0;
	float fVar1;
	int iVar2;
	
	func_79(iParam0, &vVar0, &fVar1);
	iVar2 = 0;
	while (iVar2 < 2)
	{
		(*uParam1)[(*iParam2)[iVar2] /*14*/] = 2;
		(uParam1[(*iParam2)[iVar2] /*14*/])->f_8 = { func_75(func_76(iVar2), fVar1) + vVar0 };
		(uParam1[(*iParam2)[iVar2] /*14*/])->f_8.f_3 = { 0f, 0f, (fVar1 + 174f) };
		(uParam1[(*iParam2)[iVar2] /*14*/])->f_1 = { func_75(func_74(iVar2), fVar1) + vVar0 };
		(uParam1[(*iParam2)[iVar2] /*14*/])->f_1.f_3 = { func_75(func_73(iVar2), fVar1) + vVar0 };
		(uParam1[(*iParam2)[iVar2] /*14*/])->f_1.f_6 = 1,42f;
		iVar2++;
	}
}

Vector3 func_73(int iParam0)//Position - 0x1A1F
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_74(int iParam0)//Position - 0x1A6D
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_75(vector3 vParam0, float fParam1)//Position - 0x1AAF
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0)//Position - 0x1AF3
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_77()//Position - 0x1B3F
{
	return func_78() + Vector(0f, -8,946f, 47,215f);
}

Vector3 func_78()//Position - 0x1B57
{
	return 345,0041f, 4842,001f, -59,9997f;
}

void func_79(int iParam0, var uParam1, var uParam2)//Position - 0x1B6E
{
	switch (iParam0)
	{
		case 0:
...
int func_80(int iParam0, int iParam1, bool bParam2)//Position - 0x1D0C
{
	int iVar0;
