	...
	while (func_31(23) && !func_30(134))
	{
		if (func_26() == 1)
		{
			if (unk_0x6ADD12BF4D6D2587(unk_0xFC1458A37D98B502()))
			{
				...
				{
					if ((!unk_0x81FE9C1618BDF46B(unk_0xFC1458A37D98B502()) && !unk_0x0BA31FF7931F3DD3(unk_0xFC1458A37D98B502())) && !unk_0x6B4C37F2EEC636CC(unk_0xFC1458A37D98B502()))
					{
						if (!bVar0)
						{
							if (!((func_25() || unk_0x1E06D00B67177A18()) || func_24()))
							{
								if (func_13())
								{
									bVar0 = true;
						...
						else
						{
							if (iLocal_28)
							{
								unk_0x59F2A26BF856E30A(unk_0x9EB17624F44A8DA4(), false, 384);
								unk_0x5C57ECBE59C08573(unk_0xFC1458A37D98B502(), 0f);
								unk_0x2DB625A7D089C175(0, 173, 1);
								unk_0x2DB625A7D089C175(0, 172, 1);
								unk_0x2DB625A7D089C175(0, 174, 1);
								unk_0x2DB625A7D089C175(0, 175, 1);
								unk_0x2DB625A7D089C175(0, 176, 1);
								unk_0x2DB625A7D089C175(0, 177, 1);
								unk_0x2DB625A7D089C175(0, 178, 1);
								unk_0x2DB625A7D089C175(0, 179, 1);
								unk_0x2DB625A7D089C175(0, 180, 1);
								unk_0x2DB625A7D089C175(0, 181, 1);
							}
							else
							{
							...
							switch (func_12())
							{
								...
								case -1989308064:
									func_7(12, 0);
									func_6(134, 1);
									unk_0xBFFF62F75445099D(joaat("sp_final_decision"), 2, 1);
									break;
								...
								case -1060930305:
									func_7(12, 1);
									func_6(134, 1);
									unk_0xBFFF62F75445099D(joaat("sp_final_decision"), 1, 1);
									break;
								
								case -1817481777:
									func_7(12, 2);
									func_6(134, 1);
									unk_0xBFFF62F75445099D(joaat("sp_final_decision"), 3, 1);
									break;
...
int func_13()//Position - 0x76D
{
	if (Global_14453.f_1 > 3)
	{
		unk_0x0EE72DB1CD8A3B86(&Global_2324, 0);
		func_21(0);
		return 0;
	}
	unk_0x872F1C1F8587CCC7(&Global_2324, 0);
	if (func_14(0, 0, 1, 1))
	{
		return 1;
	}
...
void func_20()//Position - 0xBCD
{
	...
	if (Global_70856 == 0)
	{
		...
		func_16(4, "CELL_23", 2, "appChecklist", 39, 1, 1, 0, 0);
		if ((Global_35861 == 15 && func_2(0) == 0) && Global_2328 == 0)
		{
...
void func_27()//Position - 0x1243
{
	...
	if (unk_0x6ADD12BF4D6D2587(unk_0xFC1458A37D98B502()))
	{
		if (func_29(Global_104555.f_2353.f_539.f_4301) != unk_0x82FF3DFBC3965CC0(unk_0xFC1458A37D98B502()))
		{
			...
			if (func_10(iVar0) && (!func_17(14) || Global_103506))
			{
...
{
	if (((iParam0 == 144 || iParam0 == 145) || iParam0 == 151) || iParam0 == 152)
	{
		return;
	}
	Global_36413[iParam0] = unk_0x53C562FD2B9E3AB0();
}

void func_36()//Position - 0x164E
{
	Global_36412 = unk_0x53C562FD2B9E3AB0();
}
...
void func_43(int iParam0)//Position - 0x1A58
{
	...
	while (iVar1 < Global_104555.f_7658.f_198)
	{
		...
		{
			func_44(Global_104555.f_7658.f_137[iVar1 /*15*/].f_6);
			iVar2 = iVar1;
