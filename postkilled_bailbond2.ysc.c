...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		if ((unk_0x53C562FD2B9E3AB0() - iVar4) > 100)
		{
			if (!unk_0x3AB6A1A9084FB0A4(unk_0xFC1458A37D98B502()))
			{
				...
				{
					if (system::vdist2(vVar0, unk_0xB3328BA8976B416C(iLocal_79[iVar1], 0)) >= IntToFloat((iVar3 * iVar3)) && unk_0xEC211A86AB3726B6(iLocal_79[iVar1]))
					{
				...
				else if (unk_0x6ADD12BF4D6D2587(iLocal_79[iVar1]))
				{
					func_6(&(iLocal_79[iVar1]), 1, 0, 1);
				}
				if (func_3(iLocal_79.f_5[iVar2]))
				{
					...
					{
						if (unk_0xEC211A86AB3726B6(iLocal_79.f_5[iVar2]) || unk_0xA8D0477084E86A92(unk_0xFC1458A37D98B502(), iLocal_79.f_5[iVar2], 0))
						{
							func_2(&(iLocal_79.f_5[iVar2]));
						}
					}
				}
				else if (unk_0x6ADD12BF4D6D2587(iLocal_79.f_5[iVar2]))
				{
					func_2(&(iLocal_79.f_5[iVar2]));
				}
				iVar1++;
...
int func_1()//Position - 0x210
{
	...
	{
		if (unk_0x6ADD12BF4D6D2587(iLocal_79.f_5[iVar0]))
		{
			return 0;
		}
		iVar0++;
	...
	{
		if (unk_0x6ADD12BF4D6D2587(iLocal_79[iVar0]))
		{
			return 0;
		}
		iVar0++;
...
int func_4(int iParam0)//Position - 0x2CB
{
	if (unk_0x6ADD12BF4D6D2587(iParam0))
	{
...
int func_5(int iParam0, var uParam1, int iParam2, int iParam3, bool bParam4, int iParam5, float fParam6, char* sParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x2EC
{
	if (iParam3 == 0)
	{
...
void func_6(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x4BF
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
		if (!unk_0x3AB6A1A9084FB0A4(*iParam0))
...
void func_7(int iParam0)//Position - 0x50F
{
	bool bVar0;
	struct<8> Var1;
...
int func_8(int iParam0)//Position - 0x581
{
	if (func_4(iParam0))
	{
		if (!unk_0x3AB6A1A9084FB0A4(iParam0))
...
{
	if (unk_0x8F38E94BBF3404CD(joaat("bailbond2")) == 0)
	{
		if (!func_16(4))
		{
			return 0;
...
bool func_12(int iParam0)//Position - 0x707
{
	return Global_35861 == iParam0;
}

bool func_13(int iParam0)//Position - 0x715
{
	return iParam0 < 3;
}

int func_14(int iParam0)//Position - 0x721
{
	int iVar0;
	int iVar1;
...
int func_15(int iParam0)//Position - 0x75E
{
	if (func_13(iParam0))
	{
...
bool func_16(int iParam0)//Position - 0x788
{
	return func_17(iParam0, Global_35861);
}

int func_17(int iParam0, int iParam1)//Position - 0x799
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_18()//Position - 0x97A
{
	int iVar0;
	
	unk_0x4DE114E3C7F8B7C2("ENEMIES", &iLocal_90);
	unk_0xF96119FCCD4D1889(5, 1862763509, iLocal_90);
	unk_0xF96119FCCD4D1889(5, iLocal_90, 1862763509);
	iVar0 = 0;
	while (iVar0 <= (iLocal_79.f_5 - 1))
	{
		if (func_3(iLocal_79.f_5[iVar0]))
		{
			unk_0xDD29FF4BAB8AFF9C(iLocal_79.f_5[iVar0], true, 1);
			vLocal_88[iVar0 /*3*/] = { unk_0xB3328BA8976B416C(iLocal_79.f_5[iVar0], 0) };
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= (iLocal_79 - 1))
	{
		...
		{
			unk_0xDD29FF4BAB8AFF9C(iLocal_79[iVar0], true, 1);
			unk_0xCE93FCB8A8D8DF0B(iLocal_79[iVar0], iLocal_90);
...
void func_19()//Position - 0xA45
{
	int iVar0;
	
	unk_0xD0E1599BE33B5E4A(5, 1862763509, iLocal_90);
	unk_0xD0E1599BE33B5E4A(5, iLocal_90, 1862763509);
	iVar0 = 0;
	while (iVar0 <= (iLocal_79 - 1))
	{
