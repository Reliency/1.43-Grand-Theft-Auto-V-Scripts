...
void func_2(char* sParam0)//Position - 0x1ED
{
	unk_0x7E099EB35339C80D(sParam0);
	unk_0x9748595E4799A2CF();
}

void func_3()//Position - 0x1FF
{
	int iVar0;
	int iVar1;
...
void func_6(bool bParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x272
{
	if (bParam0)
	{
...
bool func_7()//Position - 0x38B
{
	return unk_0xC80D31E4B587871C(Global_1595693[unk_0x9EB17624F44A8DA4() /*680*/].f_39.f_18, 14);
}

bool func_8(int iParam0, int iParam1)//Position - 0x3A8
{
	bool bVar0;
...
int func_9(int iParam0, bool bParam1)//Position - 0x3F3
{
	int iVar0;
	int iVar1;
...
int func_10()//Position - 0x434
{
	return Global_1312736;
}

int func_11(int iParam0)//Position - 0x440
{
	if (func_8(iParam0, 0))
	{
		return 1;
...
bool func_12()//Position - 0x482
{
	return unk_0xC80D31E4B587871C(Global_2359302, 3);
}

int func_13(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x493
{
	int iVar0;
...
void func_15(int iParam0)//Position - 0x4ED
{
	if (iParam0 == 1)
	{
...
void func_16(bool bParam0)//Position - 0x510
{
	int iVar0;
...
void func_17(int iParam0)//Position - 0x844
{
	switch (iParam0)
	{
		case 0:
...
void func_18(int iParam0, int iParam1, int iParam2)//Position - 0x9B4
{
	Local_22[iParam0] = iParam1;
	Local_22.f_17[iParam0] = iParam2;
}

void func_19(var uParam0, int iParam1)//Position - 0x9CE
{
	uParam0->f_22 = 0;
...
void func_20(var uParam0, int iParam1)//Position - 0x9F6
{
	uParam0->f_22 = 0;
...
void func_21(var uParam0, int iParam1)//Position - 0xA1E
{
	vector3 vVar0;
...
void func_22(var uParam0, vector3 vParam1, vector3 vParam2, int iParam3, float fParam4, float fParam5)//Position - 0x23C3
{
	uParam0->f_1 = { vParam1 };
	uParam0->f_4 = { vParam2 };
	uParam0->f_7 = iParam3;
...
void func_23(var uParam0, int iParam1, vector3 vParam2, vector3 vParam3, int iParam4, int iParam5, int iParam6)//Position - 0x23F5
{
...
void func_24(var uParam0, var uParam1, vector3 vParam2, vector3 vParam3, var uParam4, var uParam5, var uParam6)//Position - 0x2430
{
	*uParam0 = { vParam2 };
	uParam0->f_3 = { vParam3 };
	uParam0->f_6 = uParam4;
...
float func_25(float fParam0)//Position - 0x2462
{
	return (fParam0 * 57,29578f);
}

void func_26(var uParam0)//Position - 0x2472
{
	uParam0->f_154 = 0;
...
int func_27(char* sParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x248F
{
	int iVar0;
...
int func_28(char* sParam0, var uParam1, int iParam2)//Position - 0x24F4
{
	int iVar0;
...
int func_29(char* sParam0, int iParam1)//Position - 0x255C
{
	int iVar0;
...
char* func_30(int iParam0)//Position - 0x25B7
{
	char* sVar0;
...
void func_31(int iParam0, int iParam1)//Position - 0x2687
{
...
void func_32(bool bParam0)//Position - 0x2756
{
...
bool func_33(int iParam0)//Position - 0x27B0
{
...
void func_34(bool bParam0)//Position - 0x27CE
{
	if (bParam0)
	{
		func_38();
...
void func_35(int iParam0)//Position - 0x2831
{
	if (Global_14615)
	{
		func_36(0, 0);
...
void func_36(bool bParam0, bool bParam1)//Position - 0x28A1
{
	if (bParam0)
	{
		if (func_37(0))
...
int func_37(int iParam0)//Position - 0x2915
{
	if (iParam0 == 1)
	{
		if (Global_14453.f_1 > 3)
...
void func_41(int iParam0)//Position - 0x2AA3
{
...
void func_42(char* sParam0)//Position - 0x2B06
{
	unk_0xFCCDDE0E48CF9588(sParam0);
}

void func_43(int iParam0)//Position - 0x2B14
{
	if (iParam0 != 0)
	{
...
void func_44(var uParam0)//Position - 0x2B28
{
	int iVar0;
	char* sVar1;
	char* sVar2;
...
char* func_45(int iParam0)//Position - 0x2B9D
{
	char* sVar0;
...
char* func_46(int iParam0)//Position - 0x2BB3
{
	char* sVar0;
...
void func_47(var uParam0)//Position - 0x2BC8
{
	int iVar0;
...
void func_48(int iParam0)//Position - 0x2C14
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
...
void func_49(var uParam0)//Position - 0x2C55
{
	int iVar0;
...
void func_50(int iParam0)//Position - 0x2C7E
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
