...
{
	return unk_0x0F3033474C49912D(iParam0, 355,6093f, 4832,486f, -59,99951f, 338,4763f, 4841,36f, -56,99947f, 15f, 0, 1, 0);
}
...
int func_70()//Position - 0x18E1
{
	if (Global_1595543 != func_58())
	{
		if (unk_0xA357031C5C05DD94("base_corridor_seats", Global_1595543, 1, 0))
		{
			return 0;
		}
...
void func_71()//Position - 0x192D
{
	...
	iVar0[0] = 0;
	iVar0[1] = 1;
	func_72(5, &uLocal_138, &iVar0);
	iVar0[0] = 2;
	iVar0[1] = 3;
	func_72(6, &uLocal_138, &iVar0);
}
