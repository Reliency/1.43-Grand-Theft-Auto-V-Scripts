...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		if (func_6() || Global_1677759 == 1)
		{
			func_5();
		}
		if (func_1(&uLocal_21, &Global_285060))
		{
			func_5();
		}
		system::wait(0);
...
int func_1(var uParam0, var uParam1)//Position - 0x6D
{
	...
	if (uParam0->f_2)
	{
		if (unk_0xB89BB11E0945F6F0(unk_0x38F6270C9AE5FE40(unk_0x53C562FD2B9E3AB0(), uParam0->f_1)) >= uParam0->f_3)
		{
			func_4();
		}
	}
			...
			while (iVar2 <= iVar6)
			{
				if (iVar2 < iVar5)
				{
					...
					if (iVar2 >= Var3.f_4 && iVar2 != 27)
					{
						...
						{
							if (unk_0x8B54241DD3D4065E(iVar7, Var3.f_5, &fVar0))
							{
								if (fVar0 > Var3.f_1 || fVar0 < Var3)
								{
									uParam0->f_2 = 1;
									uParam0->f_3 = unk_0x63A6486593EC7EC3(20000, 30000);
									uParam0->f_1 = unk_0x53C562FD2B9E3AB0();
								}
							}
							else if (unk_0x79E6B0AAAFA5AA49(iVar7, Var3.f_5, &iVar1))
							{
...
int func_3(int iParam0)//Position - 0x1D141
{
	char cVar0[64];
...
void func_4()//Position - 0x1D350
{
	unk_0x9463953B0B684D8E();
	unk_0x6172A5A68FECD8FF(-9f, -9f, -9f, -10f, -10f, -10f, -25f, -25f, -25f, -28f, -28f, -28f, 0f, 0f, 0f, 0, 0, 0);
	unk_0xCB389937EDB1519A(-9f, -9f, -9f, -10f, -10f, -10f, 0, 1, 1, 1);
	func_4();
}

void func_5()//Position - 0x1D3CE
{
	unk_0x96A3D9A8A4C7AFD4();
}

int func_6()//Position - 0x1D3DA
{
	var uVar0;
	...
	if (func_7() != 0)
	{
		if (unk_0x8F38E94BBF3404CD(func_7()) == 0)
		{
			return 1;
		}
	}
...
int func_8()//Position - 0x1D498
{
	return Global_25233;
}

bool func_9()//Position - 0x1D4A3
{
	return Global_2447174.f_586;
}

int func_10(int iParam0)//Position - 0x1D4B2
{
...
bool func_11()//Position - 0x1D4C9
{
	return Global_2456830;
}

bool func_12()//Position - 0x1D4D5
{
	return Global_2447174.f_581;
}

void func_13(var uParam0)//Position - 0x1D4E4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_14(int iParam0)//Position - 0x1D557
{
	vector3 vVar0;
	int iVar1;
	int iVar2;
...
int func_15(int iParam0, var uParam1)//Position - 0x1D5D8
{
...
int func_16(int iParam0, bool bParam1, bool bParam2)//Position - 0x1D637
{
	int iVar0;
