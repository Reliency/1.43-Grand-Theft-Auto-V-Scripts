...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		if (system::vdist2(unk_0xB3328BA8976B416C(unk_0xFC1458A37D98B502(), 0), 1973,324f, 3815,594f, 31,42936f) < (fVar1 * fVar1))
		{
...
bool func_69(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x6005
{
	if (bParam2)
	{
...
int func_70(var uParam0)//Position - 0x604C
{
...
bool func_71(int iParam0)//Position - 0x60A7
{
	return func_72(iParam0, 0, 1);
}

int func_72(int iParam0, int iParam1, bool bParam2)//Position - 0x60B7
{
	if (bParam2)
	{
...
int func_73(int iParam0)//Position - 0x6117
{
	switch (iParam0)
	{
		case 0:
...
int func_74()//Position - 0x63FC
{
	return Global_25233;
}

int func_75(int iParam0)//Position - 0x6407
{
	return func_72(iParam0, 5, 1);
}

int func_76(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x6417
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_77(int iParam0, bool bParam1)//Position - 0x64B9
{
	switch (iParam0)
	{
		case -1:
...
int func_78(int iParam0)//Position - 0x6A58
{
	if (iParam0 != func_87())
	{
...
Vector3 func_79(int iParam0, int iParam1)//Position - 0x6AB6
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_80(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6B64
{
	struct<4> Var0;
	vector3 vVar1;
	struct<4> Var2;
...
Vector3 func_81(vector3 vParam0, float fParam1)//Position - 0x6BF9
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
struct<6> func_82(int iParam0)//Position - 0x6C3D
{
	struct<6> Var0;
...
struct<6> func_83(int iParam0)//Position - 0x6DC1
{
	return func_84(iParam0);
}

struct<6> func_84(int iParam0)//Position - 0x6DCF
{
	struct<6> Var0;
...
int func_85(int iParam0, var uParam1)//Position - 0x7896
{
	switch (iParam0)
	{
		case 0:
...
int func_86(int iParam0)//Position - 0x7918
{
	if (iParam0 != func_87())
	{
...
int func_87()//Position - 0x7976
{
	return -1;
}

Vector3 func_88(int iParam0)//Position - 0x797F
{
	switch (iParam0)
	{
		case 1:
...
int func_89(int iParam0)//Position - 0x7B1C
{
	return func_72(iParam0, 0, 0);
}

int func_90(int iParam0)//Position - 0x7B2C
{
	switch (iParam0)
	{
		case -1:
...
bool func_91()//Position - 0x7DB9
{
	return Global_92885.f_315 > 0;
}

var func_92()//Position - 0x7DCA
{
	var uVar0;
...
void func_93(var uParam0, int iParam1)//Position - 0x7E10
{
	if (iParam1 <= 0)
	{
		return;
...
void func_94(var uParam0, int iParam1)//Position - 0x7E96
{
...
void func_95(var uParam0, int iParam1)//Position - 0x7EC9
{
	int iVar0;
	int iVar1;
...
int func_96(int iParam0, int iParam1)//Position - 0x7F1A
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_97(int iParam0)//Position - 0x7FBC
{
	return (system::shift_right(iParam0, 26) & 31 * func_98(unk_0xC80D31E4B587871C(iParam0, 31), -1, 1)) + 2011;
}

int func_98(bool bParam0, int iParam1, int iParam2)//Position - 0x7FE1
{
	if (bParam0)
	{
		return iParam1;
...
int func_99(var uParam0)//Position - 0x7FF8
{
	return uParam0 & 15;
}

void func_100(var uParam0, int iParam1)//Position - 0x8006
{
...
void func_101(var uParam0, int iParam1)//Position - 0x8040
{
...
void func_102(var uParam0, int iParam1)//Position - 0x807B
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
void func_104(int iParam0)//Position - 0x80DB
{
	var uVar0;
	vector3 vVar1[24];
...
void func_105(char* sParam0, var uParam1, int iParam2)//Position - 0x8134
{
...
bool func_106(bool bParam0)//Position - 0x8175
{
...
struct<2> func_107(int iParam0)//Position - 0x81A0
{
	struct<2> Var0;
...
void func_108(int iParam0, var uParam1)//Position - 0x85EC
{
	switch (iParam0)
	{
		case 0:
...
int func_110(int iParam0)//Position - 0x9831
{
	switch (iParam0)
	{
		case 0:
...
void func_111()//Position - 0x9B77
{
	...
	func_112(36);
	system::start_new_script(sVar0, 23000);
	unk_0x9D2418D7FC697249(sVar0);
}

void func_112(int iParam0)//Position - 0x9BB8
{
	struct<2> Var0;
...
void func_113(int iParam0)//Position - 0x9C53
{
	if (iParam0 < 63)
	{
		func_114();
...
void func_115(int iParam0)//Position - 0x9CB1
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_116(int iParam0)//Position - 0x9D0A
{
...
int func_117(int iParam0)//Position - 0x9D8D
{
	int iVar0;
...
void func_118(int iParam0, int iParam1, int iParam2)//Position - 0x9DBE
{
	func_119(iParam0, iParam1, iParam2, 0, 0);
}

void func_119(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x9DD2
{
	int iVar0;
...
int func_121(int iParam0, int iParam1, int iParam2)//Position - 0x9E7A
{
...
int func_122(int iParam0, int iParam1, int iParam2)//Position - 0x9E95
{
	int iVar0;
...
int func_123(int iParam0)//Position - 0x9EE1
{
	int iVar0;
...
int func_124(int iParam0)//Position - 0x9F2A
{
	if (func_125(iParam0))
	{
		if (!unk_0x3AB6A1A9084FB0A4(iParam0))
...
int func_125(int iParam0)//Position - 0x9F4A
{
	if (unk_0x6ADD12BF4D6D2587(iParam0))
	{
...
int func_126(int iParam0)//Position - 0x9F6B
{
	switch (iParam0)
	{
		case 5:
...
void func_128(char* sParam0)//Position - 0xA03B
{
...
int func_129(int iParam0)//Position - 0xA04D
{
	if (iParam0 == -1)
	{
		iParam0 = func_139();
...
int func_130(int iParam0)//Position - 0xA0E5
{
...
int func_133(int iParam0)//Position - 0xA167
{
...
int func_134(char* sParam0, int iParam1)//Position - 0xA19B
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_136(int iParam0)//Position - 0xA222
{
	return func_137(iParam0, Global_35861);
}

int func_137(int iParam0, int iParam1)//Position - 0xA233
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_138(int iParam0)//Position - 0xA414
{
	if (func_106(0))
	{
...
int func_139()//Position - 0xA43C
{
	return func_134(unk_0x436287B7DB306165(), 0);
}

int func_140(int iParam0)//Position - 0xA44D
{
	int iVar0;
...
void func_141(int iParam0)//Position - 0xA492
{
...
int func_142(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xA4C4
{
	int iVar0;
...
void func_143(var uParam0, int iParam1)//Position - 0xA5FB
{
	int iVar0;
...
int func_144(int iParam0)//Position - 0xA64A
{
	if (Global_35861 == 15)
	{
		return 0;
...
int func_145(int iParam0)//Position - 0xA66C
{
	int iVar0;
...
var func_146()//Position - 0xAD89
{
	return Global_92872.f_1;
}

int func_147()//Position - 0xAD97
{
	if (Global_89900 != -1)
	{
...
bool func_150()//Position - 0xAE01
{
	return Global_92885.f_316 > 0;
}

bool func_151(int iParam0, int iParam1)//Position - 0xAE12
{
	switch (iParam0)
	{
		case 5:
...
var func_152()//Position - 0xAE4D
{
	return Global_1312854;
}

int func_153()//Position - 0xAE59
{
	if (!unk_0x3A711520F83BAE98())
	{
...
void func_155(int iParam0)//Position - 0xAEF2
{
	int iVar0;
	int iVar1;
...
void func_156(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0xAF34
{
	func_157(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_157(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0xAF55
{
	int iVar0;
...
int func_159(int iParam0)//Position - 0xB248
{
	int iVar0;
	int iVar1;
...
void func_160()//Position - 0xB28B
{
	func_161(1);
	func_2(1);
}

void func_161(bool bParam0)//Position - 0xB29D
{
	func_162(51, bParam0);
	func_162(52, bParam0);
	func_162(53, bParam0);
...
void func_162(int iParam0, bool bParam1)//Position - 0xB2D5
{
	if (iParam0 == -1)
	{
		return;
...
void func_163(int iParam0, int iParam1, bool bParam2)//Position - 0xB332
{
	if (iParam0 == -1)
	{
		return;
...
bool func_164(int iParam0, int iParam1)//Position - 0xB36D
{
	if (iParam0 == -1)
	{
		return 0;
...
bool func_166(int iParam0)//Position - 0xB3B7
{
...
int func_167()//Position - 0xB3E5
{
	func_56();
	return Global_104555.f_2353.f_539.f_4301;
}

int func_168(int iParam0)//Position - 0xB3FE
{
	int iVar0;
	int iVar1;
...
int func_170(int iParam0)//Position - 0xB479
{
	int iVar0;
	int iVar1;
