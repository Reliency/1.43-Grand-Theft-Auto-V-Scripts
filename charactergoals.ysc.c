...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		switch (iLocal_18)
		{
			...
			case 1:
				if (unk_0x5BEF7A5AB8F17255(unk_0x9EB17624F44A8DA4()))
				{
					...
					if (func_36(2, 999999))
					{
						...
						iLocal_22 = unk_0x53C562FD2B9E3AB0();
						iLocal_18 = 2;
					}
			...
			case 2:
				iLocal_21 = unk_0x53C562FD2B9E3AB0();
...
int func_2(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x2BC
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_3(bool bParam0)//Position - 0x8BB
{
	int iVar0;
	int iVar1;
...
void func_4(int iParam0)//Position - 0xB3D
{
	int iVar0;
...
void func_5(int iParam0)//Position - 0xB97
{
	bool bVar0;
	char cVar1[64];
...
char* func_6(int iParam0)//Position - 0xC6B
{
	switch (iParam0)
	{
		case 0:
...
int func_8(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xCF6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_9()//Position - 0x11BB
{
	return Global_1312736;
}

void func_10(int iParam0)//Position - 0x11C7
{
	func_32(93, iParam0);
	func_32(29, iParam0);
	func_32(30, iParam0);
...
bool func_11(int iParam0)//Position - 0x11E7
{
	if (iParam0 == 8)
	{
...
int func_12(int iParam0, int iParam1, int iParam2)//Position - 0x1235
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_14(int iParam0, int iParam1)//Position - 0x1532
{
	int iVar0;
...
int func_15(bool bParam0)//Position - 0x17CD
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_16(int iParam0, int iParam1)//Position - 0x1884
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_17(int iParam0, int iParam1)//Position - 0x189F
{
...
int func_18(var uParam0, int iParam1)//Position - 0x193C
{
	int iVar0;
	var uVar1[78];
...
int func_19(var uParam0, int iParam1)//Position - 0x19ED
{
	int iVar0;
...
bool func_20(var uParam0, int iParam1)//Position - 0x1A68
{
	return (*uParam0)[iParam1] == 78;
}

void func_21(var uParam0)//Position - 0x1A79
{
	int iVar0;
...
void func_22(var uParam0, int iParam1)//Position - 0x1AAD
{
	(*uParam0)[iParam1] = 78;
}

void func_23(var uParam0, float fParam1)//Position - 0x1ABD
{
	if (fParam1 == 0f)
	{
		uParam0->f_80 = 0f;
...
float func_24(var uParam0)//Position - 0x1ADA
{
	return uParam0->f_80;
}

bool func_25(var uParam0, int iParam1)//Position - 0x1AE6
{
	return func_26(uParam0, iParam1) != -1;
}

int func_26(var uParam0, int iParam1)//Position - 0x1AF8
{
	int iVar0;
...
bool func_27(var uParam0)//Position - 0x1B25
{
	return uParam0->f_79 == 1;
}

int func_28(int iParam0)//Position - 0x1B33
{
	switch (iParam0)
	{
		case 60:
...
bool func_29(int iParam0)//Position - 0x1B83
{
	return Global_35861 == iParam0;
}

int func_30(int iParam0, int iParam1)//Position - 0x1B91
{
	int iVar0;
...
void func_31(int iParam0, int iParam1)//Position - 0x1BE2
{
	int iVar0;
...
void func_32(int iParam0, int iParam1)//Position - 0x1C05
{
	int iVar0;
...
void func_34(char* sParam0, int iParam1, int iParam2)//Position - 0x1CD7
{
	iParam2 = iParam2;
...
void func_35(char* sParam0, char* sParam1, int iParam2, int iParam3)//Position - 0x1CF0
{
	iParam3 = iParam3;
	unk_0xCFFAC52CF8717D56(sParam0);
...
int func_36(int iParam0, int iParam1)//Position - 0x1D0F
{
...
void func_37(char* sParam0, int iParam1)//Position - 0x1D2A
{
...
void func_38(float fParam0, float fParam1, char* sParam2, int iParam3, int iParam4)//Position - 0x1D6D
{
...
void func_39(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1D8B
{
...
int func_40(int iParam0, int iParam1, bool bParam2, int iParam3)//Position - 0x1DCA
{
	if (func_46())
	{
		return 0;
...
int func_41(var uParam0, var uParam1, bool bParam2, int iParam3)//Position - 0x1DF5
{
...
void func_42(int iParam0)//Position - 0x1E59
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_43()//Position - 0x1ED3
{
}

int func_44()//Position - 0x1EDB
{
	int iVar0;
...
int func_45(struct<6> Param0, struct<6> Param1)//Position - 0x1FB5
{
	struct<4> Var0;
	struct<4> Var1;
	int iVar2;
...
int func_47(int iParam0, int iParam1, int iParam2)//Position - 0x20C7
{
	if (Global_104555.f_28020[iParam0 /*29*/].f_17 == 3)
	{
		return 0;
...
int func_48(int iParam0)//Position - 0x2110
{
	var uVar0;
