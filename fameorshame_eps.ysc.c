...
void __EntryFunction__()//Position - 0x0
{
	...
	func_35(1);
	unk_0x393584863A2F304E("FOS_EP_1_P6", 8);
	func_18(0);
	func_8(1, 1, 1, 0);
	while (true)
	{
...
void func_8(bool bParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x279
{
	if (bParam0)
	{
...
bool func_9()//Position - 0x392
{
	return unk_0xC80D31E4B587871C(Global_1595693[unk_0x9EB17624F44A8DA4() /*680*/].f_39.f_18, 14);
}

bool func_10(int iParam0, int iParam1)//Position - 0x3AF
{
	bool bVar0;
...
int func_11(int iParam0, bool bParam1)//Position - 0x3FA
{
	int iVar0;
	int iVar1;
...
int func_12()//Position - 0x43B
{
	return Global_1312736;
}

int func_13(int iParam0)//Position - 0x447
{
...
bool func_14()//Position - 0x489
{
	return unk_0xC80D31E4B587871C(Global_2359302, 3);
}

int func_15(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x49A
{
	int iVar0;
...
void func_17(int iParam0)//Position - 0x4F4
{
	if (iParam0 == 1)
	{
...
void func_18(bool bParam0)//Position - 0x517
{
	int iVar0;
...
void func_19(int iParam0)//Position - 0x84B
{
	switch (iParam0)
	{
		case 0:
...
void func_20(int iParam0, int iParam1, int iParam2)//Position - 0x9BB
{
	Local_22[iParam0] = iParam1;
	Local_22.f_17[iParam0] = iParam2;
}

void func_21(var uParam0, int iParam1)//Position - 0x9D5
{
	uParam0->f_22 = 0;
...
void func_22(var uParam0, int iParam1)//Position - 0x9FD
{
	uParam0->f_22 = 0;
...
void func_23(var uParam0, int iParam1)//Position - 0xA25
{
	vector3 vVar0;
...
void func_24(var uParam0, vector3 vParam1, vector3 vParam2, int iParam3, float fParam4, float fParam5)//Position - 0x23CA
{
	uParam0->f_1 = { vParam1 };
	uParam0->f_4 = { vParam2 };
	uParam0->f_7 = iParam3;
...
void func_25(var uParam0, int iParam1, vector3 vParam2, vector3 vParam3, int iParam4, int iParam5, int iParam6)//Position - 0x23FC
{
...
void func_26(var uParam0, var uParam1, vector3 vParam2, vector3 vParam3, var uParam4, var uParam5, var uParam6)//Position - 0x2437
{
	*uParam0 = { vParam2 };
	uParam0->f_3 = { vParam3 };
	uParam0->f_6 = uParam4;
...
float func_27(float fParam0)//Position - 0x2469
{
	return (fParam0 * 57,29578f);
}

void func_28(var uParam0)//Position - 0x2479
{
	uParam0->f_154 = 0;
...
int func_29(char* sParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x2496
{
	int iVar0;
...
int func_30(char* sParam0, var uParam1, int iParam2)//Position - 0x24FB
{
	int iVar0;
...
int func_31(char* sParam0, int iParam1)//Position - 0x2563
{
	int iVar0;
...
char* func_32(int iParam0)//Position - 0x25BE
{
	char* sVar0;
...
void func_33(int iParam0, int iParam1)//Position - 0x268E
{
...
void func_34(bool bParam0)//Position - 0x275D
{
...
void func_35(bool bParam0)//Position - 0x27B7
{
	if (bParam0)
	{
		func_39();
...
void func_36(int iParam0)//Position - 0x281A
{
	if (Global_14615)
	{
		func_37(0, 0);
...
void func_37(bool bParam0, bool bParam1)//Position - 0x288A
{
	if (bParam0)
	{
		if (func_38(0))
...
int func_38(int iParam0)//Position - 0x28FE
{
	if (iParam0 == 1)
	{
		if (Global_14453.f_1 > 3)
...
void func_42(int iParam0)//Position - 0x2A8C
{
...
void func_43(char* sParam0)//Position - 0x2AEF
{
	unk_0xFCCDDE0E48CF9588(sParam0);
}

void func_44(int iParam0)//Position - 0x2AFD
{
	if (iParam0 != 0)
	{
...
void func_45(var uParam0)//Position - 0x2B11
{
	int iVar0;
	char* sVar1;
	char* sVar2;
...
char* func_46(int iParam0)//Position - 0x2B86
{
	char* sVar0;
...
char* func_47(int iParam0)//Position - 0x2B9C
{
	char* sVar0;
...
void func_48(var uParam0)//Position - 0x2BB1
{
	int iVar0;
...
void func_49(int iParam0)//Position - 0x2BFD
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
...
void func_50(var uParam0)//Position - 0x2C3E
{
	int iVar0;
...
void func_51(int iParam0)//Position - 0x2C67
{
	if (unk_0x6ADD12BF4D6D2587(*iParam0))
	{
